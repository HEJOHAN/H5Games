! function(t, e) {
    ...
    class M extends k {
        ...
        destroy(t = !0) {
            super.destroy(t), this._vScrollBar && this._vScrollBar.destroy(), this._hScrollBar && this._hScrollBar.destroy(), this._vScrollBar = null, this._hScrollBar = null;
        }
        initialize() {
    ...
    class D extends c {
        ...
        getArray() {
            var t = [];
            for (let e of this._source) this.getParentOpenStatus(e) && (e.x = this._spaceLeft * this.getDepth(e), t.push(e));
            return t;
        }
        getDepth(t, e = 0) {
    ...
    class X extends e.Sprite {
        constructor() {
            super(), this.maskLayer = new e.Sprite(), this.popupEffect = function(t) {
