...
goog.exportPath_ = function(o, t, e) {
    o = o.split("."),
    e = e || goog.global,
    o[0]in e || !e.execScript || e.execScript("var " + o[0]);
    for (var r; o.length && (r = o.shift()); )
        !o.length && goog.isDef(t) ? e[r] = t : e = e[r] ? e[r] : e[r] = {};
}
,
...
goog.provide = function(o) {
    if (!COMPILED && goog.isProvided_(o))
...
goog.constructNamespace_ = function(o, t) {
    if (!COMPILED) {
        ...
        for (var e = o; (e = e.substring(0, e.lastIndexOf("."))) && !goog.getObjectByName(e); )
...
goog.module = function(o) {
    if (!goog.isString(o) || !o || -1 == o.search(goog.VALID_MODULE_RE_))
        throw Error("Invalid module identifier");
    if (!goog.isInModuleLoader_())
        throw Error("Module " + o + " has been loaded incorrectly.");
    if (goog.moduleLoaderState_.moduleName)
        throw Error("goog.module may only be called once per module.");
    if (goog.moduleLoaderState_.moduleName = o,
    !COMPILED) {
...
goog.module.getInternal_ = function(o) {
    if (!COMPILED)
        return goog.isProvided_(o) ? o in goog.loadedModules_ ? goog.loadedModules_[o] : goog.getObjectByName(o) : null;
}
,
...
goog.addDependency = function(o, t, e, r) {
    if (goog.DEPENDENCIES_ENABLED) {
        var i;
        o = o.replace(/\\/g, "/");
        for (var b = goog.dependencies_, n = 0; i = t[n]; n++)
            b.nameToPath[i] = o,
            b.pathIsModule[o] = !!r;
        for (r = 0; t = e[r]; r++)
            o in b.requires || (b.requires[o] = {}),
            b.requires[o][t] = !0;
    }
}
,
goog.ENABLE_DEBUG_LOADER = !0,
goog.logToConsole_ = function(o) {
...
goog.require = function(o) {
    if (!COMPILED) {
        ...
        goog.isProvided_(o))
            return goog.isInModuleLoader_() ? goog.module.getInternal_(o) : null;
        if (goog.ENABLE_DEBUG_LOADER) {
            var t = goog.getPathFromDeps_(o);
            if (t)
                return goog.writeScripts_(t),
                null;
        }
        throw o = "goog.require could not find: " + o,
        goog.logToConsole_(o),
        Error(o);
    }
}
,
...
goog.loadQueuedModules_ = function() {
    ...
    if (0 < o) {
        ...
        goog.queuedModules_ = [];
        for (var e = 0; e < o; e++)
            goog.maybeProcessDeferredPath_(t[e]);
    }
}
,
...
goog.maybeProcessDeferredPath_ = function(o) {
    if (o in goog.dependencies_.deferred) {
        ...
        delete goog.dependencies_.deferred[o],
        goog.globalEval(t);
    }
}
,
...
goog.writeScriptTag_ = function(o, t) {
    if (goog.inHtmlDocument_()) {
        ...
        e.write('<script type="text/javascript" src="' + o + '"' + r + "><\/script>")) : goog.ENABLE_CHROME_APP_SAFE_SCRIPT_LOADING ? goog.appendScriptSrcNode_(o) : goog.writeScriptSrcNode_(o) : e.write('<script type="text/javascript">' + t + "<\/script>"),
        !0;
    }
    return !1;
}
...
goog.onScriptLoad_ = function(o, t) {
    return "complete" == o.readyState && goog.lastNonModuleScriptIndex_ == t && goog.loadQueuedModules_(),
    !0;
}
,
goog.writeScripts_ = function(o) {
    ...
    o = 0; o < t.length; o++) {
        if (!(i = t[o]))
            throw goog.moduleLoaderState_ = n,
...
goog.loadFileSync_ = function(o) {
    if (goog.global.CLOSURE_LOAD_FILE_SYNC)
        return goog.global.CLOSURE_LOAD_FILE_SYNC(o);
    var t = new goog.global.XMLHttpRequest();
    return t.open("get", o, !1),
    t.send(),
    t.responseText;
}
,
goog.retrieveAndExecModule_ = function(o) {
    if (!COMPILED) {
        ...
        if (null == r)
            throw Error("load of " + o + "failed");
        r = goog.wrapModule_(o, r),
...
goog.inherits = function(o, t) {
    ...
    o.base = function(o, e, r) {
        for (var i = Array(arguments.length - 2), b = 2; b < arguments.length; b++)
            i[b - 2] = arguments[b];
...
goog.base = function(o, t, e) {
    ...
    if (r.superClass_) {
        for (var i = Array(arguments.length - 1), b = 1; b < arguments.length; b++)
            i[b - 1] = arguments[b];
        return r.superClass_.constructor.apply(o, i);
    }
    for (i = Array(arguments.length - 2),
    b = 2; b < arguments.length; b++)
        i[b - 2] = arguments[b];
    b = !1;
    ...
    if (o[t] === r)
        return o.constructor.prototype[t].apply(o, i);
...
goog.defineClass = function(o, t) {
    ...
    e = goog.defineClass.createSealingConstructor_(e, o),
    o && goog.inherits(e, o),
    delete t.constructor,
    delete t.statics,
    goog.defineClass.applyProperties_(e.prototype, t),
...
goog.defineClass.createSealingConstructor_ = function(o, t) {
    if (goog.defineClass.SEAL_CLASS_INSTANCES && Object.seal instanceof Function) {
        ...
        var e = function() {
            ...
            this.constructor === e && Object.seal(t),
            t;
        };
        return e;
    }
...
box2d.b2Color = function(o, t, e, r) {
    this.r = o,
    this.g = t,
    this.b = e,
...
box2d.b2Draw.prototype.DrawSolidCircle = function(o, t, e, r) {}
,
goog.exportProperty(box2d.b2Draw.prototype, "DrawSolidCircle", box2d.b2Draw.prototype.DrawSolidCircle),
box2d.b2Draw.prototype.DrawParticles = function(o, t, e, r) {}
,
...
box2d.b2Vec2.prototype.SelfMin = function(o) {
    return this.x = Math.min(this.x, o.x),
...
box2d.b2Vec2.prototype.SelfMax = function(o) {
    return this.x = Math.max(this.x, o.x),
...
box2d.b2Cross_S_V2 = function(o, t, e) {
    var r = t.x;
    return e.x = -o * t.y,
    e.y = o * r,
    e;
...
box2d.b2Add_V2_V2 = function(o, t, e) {
    return e.x = o.x + t.x,
    e.y = o.y + t.y,
    e;
}
...
box2d.b2Sub_V2_V2 = function(o, t, e) {
    return e.x = o.x - t.x,
    e.y = o.y - t.y,
    e;
}
...
box2d.b2Add_V2_S = function(o, t, e) {
    return e.x = o.x + t,
    e.y = o.y + t,
    e;
}
...
box2d.b2Sub_V2_S = function(o, t, e) {
    return e.x = o.x - t,
    e.y = o.y - t,
    e;
}
...
box2d.b2Mul_S_V2 = function(o, t, e) {
    return e.x = t.x * o,
    e.y = t.y * o,
    e;
}
...
box2d.b2Mul_V2_S = function(o, t, e) {
    return e.x = o.x * t,
    e.y = o.y * t,
    e;
}
...
box2d.b2Div_V2_S = function(o, t, e) {
    return e.x = o.x / t,
    e.y = o.y / t,
    e;
}
...
box2d.b2AddMul_V2_S_V2 = function(o, t, e, r) {
    return r.x = o.x + t * e.x,
    r.y = o.y + t * e.y,
    r;
}
,
goog.exportSymbol("box2d.b2AddMul_V2_S_V2", box2d.b2AddMul_V2_S_V2),
box2d.b2SubMul_V2_S_V2 = function(o, t, e, r) {
    return r.x = o.x - t * e.x,
    r.y = o.y - t * e.y,
    r;
}
...
box2d.b2AddCross_V2_S_V2 = function(o, t, e, r) {
    var i = e.x;
    return r.x = o.x - t * e.y,
    r.y = o.y + t * i,
    r;
}
,
goog.exportSymbol("box2d.b2AddCross_V2_S_V2", box2d.b2AddCross_V2_S_V2),
box2d.b2Mid_V2_V2 = function(o, t, e) {
...
box2d.b2Ext_V2_V2 = function(o, t, e) {
...
box2d.b2DistanceSquared = function(o, t) {
    var e = o.x - t.x
      , r = o.y - t.y;
    return e * e + r * r;
}
...
box2d.b2Sub_V3_V3 = function(o, t, e) {
    return e.x = o.x + t.x,
    e.y = o.y + t.y,
    e.z = o.z + t.z,
    e;
...
box2d.b2Vec4.prototype.SetZero = function() {
    return this.w = this.z = this.y = this.x = 0,
    this;
}
,
...
box2d.b2Abs_M22 = function(o, t) {
    ...
    t.ey.x = box2d.b2Abs(r.x),
    t.ey.y = box2d.b2Abs(r.y),
    t;
}
,
goog.exportSymbol("box2d.b2Abs_M22", box2d.b2Abs_M22),
box2d.b2Mul_M22_V2 = function(o, t, e) {
    var r = o.ex;
    o = o.ey;
    var i = t.x;
    return t = t.y,
...
box2d.b2MulT_M22_V2 = function(o, t, e) {
    var r = o.ex;
    o = o.ey;
    var i = t.x;
    return t = t.y,
...
box2d.b2Add_M22_M22 = function(o, t, e) {
    var r = o.ex;
    o = o.ey;
    var i = t.ex;
    return t = t.ey,
...
box2d.b2Mul_M22_M22 = function(o, t, e) {
    var r = o.ex.x
      , i = o.ex.y
      , b = o.ey.x;
    o = o.ey.y;
...
box2d.b2MulT_M22_M22 = function(o, t, e) {
    var r = o.ex.x
      , i = o.ex.y
      , b = o.ey.x;
    o = o.ey.y;
...
box2d.b2Mat33.prototype.Solve33 = function(o, t, e, r) {
    ...
    return 0 !== y && (y = 1 / y),
    r.x = y * (o * (s * x - a * l) + t * (a * d - p * x) + e * (p * l - s * d)),
    r.y = y * (i * (t * x - e * l) + b * (e * d - o * x) + n * (o * l - t * d)),
    r.z = y * (i * (s * e - a * t) + b * (a * o - p * e) + n * (p * t - s * o)),
    r;
}
,
...
box2d.b2Mul_M33_V3 = function(o, t, e) {
    var r = t.x
      , i = t.y;
    return t = t.z,
    e.x = o.ex.x * r + o.ey.x * i + o.ez.x * t,
    e.y = o.ex.y * r + o.ey.y * i + o.ez.y * t,
    e.z = o.ex.z * r + o.ey.z * i + o.ez.z * t,
    e;
}
,
goog.exportSymbol("box2d.b2Mul_M33_V3", box2d.b2Mul_M33_V3),
box2d.b2Mul_M33_X_Y_Z = function(o, t, e, r, i) {
    return i.x = o.ex.x * t + o.ey.x * e + o.ez.x * r,
    i.y = o.ex.y * t + o.ey.y * e + o.ez.y * r,
    i.z = o.ex.z * t + o.ey.z * e + o.ez.z * r,
    i;
}
,
goog.exportSymbol("box2d.b2Mul_M33_X_Y_Z", box2d.b2Mul_M33_X_Y_Z),
box2d.b2Mul22_M33_V2 = function(o, t, e) {
    var r = t.x;
    return t = t.y,
    e.x = o.ex.x * r + o.ey.x * t,
    e.y = o.ex.y * r + o.ey.y * t,
    e;
}
,
goog.exportSymbol("box2d.b2Mul22_M33_V2", box2d.b2Mul22_M33_V2),
box2d.b2Mul_M33_X_Y = function(o, t, e, r) {
    return r.x = o.ex.x * t + o.ey.x * e,
    r.y = o.ex.y * t + o.ey.y * e,
    r;
}
,
...
box2d.b2Rot.prototype.Set = function(o) {
    return Math.abs(this.angle - o) >= box2d.b2_epsilon && (this.angle = o,
    this.s = Math.sin(o),
    this.c = Math.cos(o)),
    this;
}
...
box2d.b2Mul_R_R = function(o, t, e) {
    ...
    return e.s = i * b + r * n,
    e.c = r * b - i * n,
    e.angle = box2d.b2WrapAngle(o.angle + t.angle),
    e;
}
,
goog.exportSymbol("box2d.b2Mul_R_R", box2d.b2Mul_R_R),
box2d.b2MulT_R_R = function(o, t, e) {
    var r = o.c
      , i = o.s
      , b = t.c
      , n = t.s;
...
box2d.b2Mul_R_V2 = function(o, t, e) {
    var r = o.c;
    o = o.s;
    var i = t.x;
    return t = t.y,
...
box2d.b2MulT_R_V2 = function(o, t, e) {
    var r = o.c;
    o = o.s;
    var i = t.x;
    return t = t.y,
...
box2d.b2MulT_X_V2 = function(o, t, e) {
    var r = o.q.c
      , i = o.q.s
      , b = t.x - o.p.x;
    return o = t.y - o.p.y,
...
box2d.b2Mul_X_X = function(o, t, e) {
    return box2d.b2Mul_R_R(o.q, t.q, e.q),
    box2d.b2Add_V2_V2(box2d.b2Mul_R_V2(o.q, t.p, e.p), o.p, e.p),
    e;
}
,
goog.exportSymbol("box2d.b2Mul_X_X", box2d.b2Mul_X_X),
box2d.b2MulT_X_X = function(o, t, e) {
    return box2d.b2MulT_R_R(o.q, t.q, e.q),
    box2d.b2MulT_R_V2(o.q, box2d.b2Sub_V2_V2(t.p, o.p, e.p), e.p),
    e;
}
,
...
box2d.b2Sweep.prototype.GetTransform = function(o, t) {
    var e = 1 - t;
    return o.p.x = e * this.c0.x + t * this.c.x,
    o.p.y = e * this.c0.y + t * this.c.y,
    o.q.SetAngle(e * this.a0 + t * this.a),
    o.p.SelfSub(box2d.b2Mul_R_V2(o.q, this.localCenter, box2d.b2Vec2.s_t0)),
    o;
}
,
...
box2d.b2Dot = function(o, t) {
    if (o instanceof box2d.b2Vec2 && t instanceof box2d.b2Vec2)
        return box2d.b2Dot_V2_V2(o, t);
    if (o instanceof box2d.b2Vec3 && t instanceof box2d.b2Vec3)
        return box2d.b2Dot_V3_V3(o, t);
    throw Error();
}
,
goog.exportSymbol("box2d.b2Dot", box2d.b2Dot),
box2d.b2Cross = function(o, t, e) {
    if (o instanceof box2d.b2Vec2 && t instanceof box2d.b2Vec2)
        return box2d.b2Cross_V2_V2(o, t);
    if (o instanceof box2d.b2Vec2 && "number" == typeof t && e instanceof box2d.b2Vec2)
        return box2d.b2Cross_V2_S(o, t, e);
    if ("number" == typeof o && t instanceof box2d.b2Vec2 && e instanceof box2d.b2Vec2)
        return box2d.b2Cross_S_V2(o, t, e);
    if (o instanceof box2d.b2Vec3 && t instanceof box2d.b2Vec3 && e instanceof box2d.b2Vec3)
        return box2d.b2Cross_V3_V3(o, t, e);
    throw Error();
}
,
goog.exportSymbol("box2d.b2Cross", box2d.b2Cross),
box2d.b2Add = function(o, t, e) {
    if (o instanceof box2d.b2Vec2 && t instanceof box2d.b2Vec2 && e instanceof box2d.b2Vec2)
        return box2d.b2Add_V2_V2(o, t, e);
    if (o instanceof box2d.b2Vec3 && t instanceof box2d.b2Vec3 && e instanceof box2d.b2Vec3)
        return box2d.b2Add_V3_V3(o, t, e);
    throw Error();
}
,
goog.exportSymbol("box2d.b2Add", box2d.b2Add),
box2d.b2Sub = function(o, t, e) {
    if (o instanceof box2d.b2Vec2 && t instanceof box2d.b2Vec2 && e instanceof box2d.b2Vec2)
        return box2d.b2Sub_V2_V2(o, t, e);
    if (o instanceof box2d.b2Vec3 && t instanceof box2d.b2Vec3 && e instanceof box2d.b2Vec3)
        return box2d.b2Sub_V3_V3(o, t, e);
    throw Error();
}
,
goog.exportSymbol("box2d.b2Sub", box2d.b2Sub),
box2d.b2Mul = function(o, t, e) {
    if (o instanceof box2d.b2Mat22 && t instanceof box2d.b2Vec2 && e instanceof box2d.b2Vec2)
        return box2d.b2Mul_M22_V2(o, t, e);
    if (o instanceof box2d.b2Mat22 && t instanceof box2d.b2Mat22 && e instanceof box2d.b2Mat22)
        return box2d.b2Mul_M22_M22(o, t, e);
    if (o instanceof box2d.b2Mat33 && t instanceof box2d.b2Vec3 && e instanceof box2d.b2Vec3)
        return box2d.b2Mul_M33_V3(o, t, e);
    if (o instanceof box2d.b2Rot && t instanceof box2d.b2Rot && e instanceof box2d.b2Rot)
        return box2d.b2Mul_R_R(o, t, e);
    if (o instanceof box2d.b2Rot && t instanceof box2d.b2Vec2 && e instanceof box2d.b2Vec2)
        return box2d.b2Mul_R_V2(o, t, e);
    if (o instanceof box2d.b2Transform && t instanceof box2d.b2Vec2 && e instanceof box2d.b2Vec2)
        return box2d.b2Mul_X_V2(o, t, e);
    if (o instanceof box2d.b2Transform && t instanceof box2d.b2Transform && e instanceof box2d.b2Transform)
        return box2d.b2Mul_X_X(o, t, e);
    throw Error();
}
,
goog.exportSymbol("box2d.b2Mul", box2d.b2Mul),
box2d.b2Mul22 = function(o, t, e) {
    if (o instanceof box2d.b2Mat33 && t instanceof box2d.b2Vec2)
        return box2d.b2Mul22_M33_V2(o, t, e);
    throw Error();
}
,
goog.exportSymbol("box2d.b2Mul22", box2d.b2Mul22),
box2d.b2MulT = function(o, t, e) {
    if (o instanceof box2d.b2Mat22 && t instanceof box2d.b2Vec2 && e instanceof box2d.b2Vec2)
        return box2d.b2MulT_M22_V2(o, t, e);
    if (o instanceof box2d.b2Mat22 && t instanceof box2d.b2Mat22 && e instanceof box2d.b2Mat22)
        return box2d.b2MulT_M22_M22(o, t, e);
    if (o instanceof box2d.b2Rot && t instanceof box2d.b2Rot && e instanceof box2d.b2Rot)
        return box2d.b2MulT_R_R(o, t, e);
    if (o instanceof box2d.b2Rot && t instanceof box2d.b2Vec2 && e instanceof box2d.b2Vec2)
        return box2d.b2MulT_R_V2(o, t, e);
    if (o instanceof box2d.b2Transform && t instanceof box2d.b2Vec2 && e instanceof box2d.b2Vec2)
        return box2d.b2MulT_X_V2(o, t, e);
    if (o instanceof box2d.b2Transform && t instanceof box2d.b2Transform && e instanceof box2d.b2Transform)
        return box2d.b2MulT_X_X(o, t, e);
    throw Error();
}
,
...
box2d.b2SimplexCache.prototype.Reset = function() {
    return this.count = this.metric = 0,
    this;
}
,
...
box2d.b2Simplex.prototype.ReadCache = function(o, t, e, r, i) {
    box2d.ENABLE_ASSERTS && box2d.b2Assert(0 <= o.count && 3 >= o.count),
    ...
    for (var b = this.m_vertices, n = 0; n < this.m_count; ++n) {
        ...
        box2d.b2Mul_X_V2(e, s, p.wA),
        box2d.b2Mul_X_V2(i, a, p.wB),
        box2d.b2Sub_V2_V2(p.wB, p.wA, p.w),
        p.a = 0;
    }
    1 < this.m_count && (o = o.metric,
    (n = this.GetMetric()) < .5 * o || 2 * o < n || n < box2d.b2_epsilon) && (this.m_count = 0),
    0 === this.m_count && ((p = b[0]).indexA = 0,
    p.indexB = 0,
    s = t.GetVertex(0),
    a = r.GetVertex(0),
    box2d.b2Mul_X_V2(e, s, p.wA),
...
box2d.b2Simplex.prototype.Solve2 = function() {
    ...
    this.m_v1.Copy(this.m_v2)) : (e = 1 / (t + o),
    this.m_v1.a = t * e,
    this.m_v2.a = o * e,
    this.m_count = 2);
}
...
box2d.b2Simplex.prototype.Solve3 = function() {
    ...
    a = box2d.b2Dot_V2_V2(e, a),
    d = -d,
    r = (n = box2d.b2Cross_V2_V2(r, n)) * box2d.b2Cross_V2_V2(t, e),
    e = n * box2d.b2Cross_V2_V2(e, o),
    o = n * box2d.b2Cross_V2_V2(o, t);
    0 >= i && 0 >= p ? this.m_count = this.m_v1.a = 1 : 0 < b && 0 < i && 0 >= o ? (s = 1 / (b + i),
    this.m_v1.a = b * s,
    this.m_v2.a = i * s,
    this.m_count = 2) : 0 < s && 0 < p && 0 >= e ? (b = 1 / (s + p),
    this.m_v1.a = s * b,
    this.m_v3.a = p * b,
    this.m_count = 2,
    this.m_v2.Copy(this.m_v3)) : 0 >= b && 0 >= d ? (this.m_count = this.m_v2.a = 1,
    this.m_v1.Copy(this.m_v2)) : 0 >= s && 0 >= a ? (this.m_count = this.m_v3.a = 1,
    this.m_v1.Copy(this.m_v3)) : 0 < a && 0 < d && 0 >= r ? (b = 1 / (a + d),
    this.m_v2.a = a * b,
    this.m_v3.a = d * b,
    this.m_count = 2,
    this.m_v1.Copy(this.m_v3)) : (b = 1 / (r + e + o),
    this.m_v1.a = r * b,
    this.m_v2.a = e * b,
    this.m_v3.a = o * b,
    this.m_count = 3);
...
box2d.b2ShapeDistance = function(o, t, e) {
    ++box2d.b2_gjkCalls;
    var r = e.proxyA
      , i = e.proxyB
      , b = e.transformA
    ...
    for (var s = p.m_vertices, a = box2d.b2Distance.s_saveA, d = box2d.b2Distance.s_saveB, l = 0, x = 0; 20 > x; ) {
        ...
        if (c.LengthSquared(),
        (y = p.GetSearchDirection(box2d.b2Distance.s_d)).LengthSquared() < box2d.b2_epsilon_sq)
            break;
        (c = s[p.m_count]).indexA = r.GetSupport(box2d.b2MulT_R_V2(b.q, box2d.b2Vec2.s_t0.Copy(y).SelfNeg(), box2d.b2Distance.s_supportA)),
        box2d.b2Mul_X_V2(b, r.GetVertex(c.indexA), c.wA),
        c.indexB = i.GetSupport(box2d.b2MulT_R_V2(n.q, y, box2d.b2Distance.s_supportB)),
        box2d.b2Mul_X_V2(n, i.GetVertex(c.indexB), c.wB),
        box2d.b2Sub_V2_V2(c.wB, c.wA, c.w),
        ++x,
        ++box2d.b2_gjkIters;
        var _ = !1;
        for (y = 0; y < l; ++y)
    ...
    box2d.b2_gjkMaxIters = box2d.b2Max(box2d.b2_gjkMaxIters, x),
    p.GetWitnessPoints(o.pointA, o.pointB),
    o.distance = box2d.b2Distance(o.pointA, o.pointB),
    o.iterations = x,
    p.WriteCache(t),
    e.useRadii && (t = r.m_radius,
    i = i.m_radius,
    o.distance > t + i && o.distance > box2d.b2_epsilon ? (o.distance -= t + i,
    (e = box2d.b2Sub_V2_V2(o.pointB, o.pointA, box2d.b2Distance.s_normal)).Normalize(),
    o.pointA.SelfMulAdd(t, e),
    o.pointB.SelfMulSub(i, e)) : (c = box2d.b2Mid_V2_V2(o.pointA, o.pointB, box2d.b2Distance.s_p),
    o.pointA.Copy(c),
    o.pointB.Copy(c),
    o.distance = 0));
}
...
box2d.b2WorldManifold.prototype.Initialize = function(o, t, e, r, i) {
    if (0 !== o.pointCount)
        ...
        case box2d.b2ManifoldType.e_circles:
            this.normal.Set(1, 0),
            t = box2d.b2Mul_X_V2(t, o.localPoint, box2d.b2WorldManifold.prototype.Initialize.s_pointA),
            ...
            box2d.b2Mid_V2_V2(b, n, this.points[0]),
            this.separations[0] = box2d.b2Dot_V2_V2(box2d.b2Sub_V2_V2(n, b, box2d.b2Vec2.s_t0), this.normal);
            break;
        case box2d.b2ManifoldType.e_faceA:
            ...
            for (var p = box2d.b2Mul_X_V2(t, o.localPoint, box2d.b2WorldManifold.prototype.Initialize.s_planePoint), s = 0, a = o.pointCount; s < a; ++s) {
                ...
                box2d.b2Mid_V2_V2(b, n, this.points[s]),
                this.separations[s] = box2d.b2Dot_V2_V2(box2d.b2Sub_V2_V2(n, b, box2d.b2Vec2.s_t0), this.normal);
            }
            break;
        case box2d.b2ManifoldType.e_faceB:
            for (box2d.b2Mul_R_V2(r.q, o.localNormal, this.normal),
            p = box2d.b2Mul_X_V2(r, o.localPoint, box2d.b2WorldManifold.prototype.Initialize.s_planePoint),
            s = 0,
            a = o.pointCount; s < a; ++s)
                d = box2d.b2Mul_X_V2(t, o.points[s].localPoint, box2d.b2WorldManifold.prototype.Initialize.s_clipPoint),
                ...
                box2d.b2Mid_V2_V2(b, n, this.points[s]),
                this.separations[s] = box2d.b2Dot_V2_V2(box2d.b2Sub_V2_V2(b, n, box2d.b2Vec2.s_t0), this.normal);
            this.normal.SelfNeg();
        }
}
,
...
box2d.b2GetPointStates = function(o, t, e, r) {
    ...
    for (b = box2d.b2_maxManifoldPoints; i < b; ++i)
        o[i] = box2d.b2PointState.b2_nullState;
    for (i = 0,
    b = r.pointCount; i < b; ++i)
        for (n = (n = r.points[i].id).key,
        t[i] = box2d.b2PointState.b2_addState,
        p = 0,
        s = e.pointCount; p < s; ++p)
            if (e.points[p].id.key === n) {
                t[i] = box2d.b2PointState.b2_persistState;
                break;
            }
    for (b = box2d.b2_maxManifoldPoints; i < b; ++i)
        t[i] = box2d.b2PointState.b2_nullState;
}
,
...
box2d.b2AABB.prototype.RayCast = function(o, t) {
    ...
    if (s < box2d.b2_epsilon) {
        if (i < this.lowerBound.x || this.upperBound.x < i)
            return !1;
    } else if (s = 1 / n,
    n = (this.lowerBound.x - i) * s,
    i = (this.upperBound.x - i) * s,
    s = -1,
    n > i && (s = n,
    n = i,
    i = s,
    ...
    if (a < box2d.b2_epsilon) {
        if (b < this.lowerBound.y || this.upperBound.y < b)
            return !1;
    } else if (s = 1 / p,
    n = (this.lowerBound.y - b) * s,
    i = (this.upperBound.y - b) * s,
    s = -1,
    n > i && (s = n,
    n = i,
    i = s,
    ...
    e > (r = box2d.b2Min(r, i)))
        return !1;
    return !(0 > e || t.maxFraction < e) && (o.fraction = e,
    !0);
}
,
...
box2d.b2ClipSegmentToLine = function(o, t, e, r, i) {
    var b = 0
      , n = t[0];
    t = t[1];
    var p = box2d.b2Dot_V2_V2(e, n.v) - r;
    return e = box2d.b2Dot_V2_V2(e, t.v) - r,
    0 >= p && o[b++].Copy(n),
    0 >= e && o[b++].Copy(t),
    0 > p * e && (e = p / (p - e),
    (r = o[b].v).x = n.v.x + e * (t.v.x - n.v.x),
    r.y = n.v.y + e * (t.v.y - n.v.y),
    (o = o[b].id).cf.indexA = i,
    o.cf.indexB = n.id.cf.indexB,
    o.cf.typeA = box2d.b2ContactFeatureType.e_vertex,
    o.cf.typeB = box2d.b2ContactFeatureType.e_face,
    ++b),
    b;
}
,
goog.exportSymbol("box2d.b2ClipSegmentToLine", box2d.b2ClipSegmentToLine),
box2d.b2TestOverlap_Shape = function(o, t, e, r, i, b) {
    var n = box2d.b2TestOverlap_Shape.s_input.Reset();
    return n.proxyA.SetShape(o, t),
    n.proxyB.SetShape(e, r),
    n.transformA.Copy(i),
    n.transformB.Copy(b),
    n.useRadii = !0,
    (o = box2d.b2TestOverlap_Shape.s_simplexCache.Reset()).count = 0,
    t = box2d.b2TestOverlap_Shape.s_output.Reset(),
    box2d.b2ShapeDistance(t, o, n),
...
box2d.b2TestOverlap = function(o, t, e, r, i, b) {
    if (o instanceof box2d.b2AABB && t instanceof box2d.b2AABB)
        return box2d.b2TestOverlap_AABB(o, t);
    if (o instanceof box2d.b2Shape && "number" == typeof t && e instanceof box2d.b2Shape && "number" == typeof r && i instanceof box2d.b2Transform && b instanceof box2d.b2Transform)
        return box2d.b2TestOverlap_Shape(o, t, e, r, i, b);
    throw Error();
}
,
...
box2d.b2CollideCircles = function(o, t, e, r, i) {
    o.pointCount = 0,
    e = box2d.b2Mul_X_V2(e, t.m_p, box2d.b2CollideCircles.s_pA),
    i = box2d.b2Mul_X_V2(i, r.m_p, box2d.b2CollideCircles.s_pB),
    ...
    o.pointCount = 1,
    o.points[0].localPoint.Copy(r.m_p),
    o.points[0].id.key = 0);
}
,
...
box2d.b2CollidePolygonAndCircle = function(o, t, e, r, i) {
    o.pointCount = 0,
    i = box2d.b2Mul_X_V2(i, r.m_p, box2d.b2CollidePolygonAndCircle.s_c),
    ...
    d = s[a = b],
    p = s[(a + 1) % p],
    n < box2d.b2_epsilon ? (o.pointCount = 1,
    o.type = box2d.b2ManifoldType.e_faceA,
    o.localNormal.Copy(t[b]),
    box2d.b2Mid_V2_V2(d, p, o.localPoint),
    o.points[0].localPoint.Copy(r.m_p),
    ...
    0 >= n ? box2d.b2DistanceSquared(e, d) > i * i || (o.pointCount = 1,
    o.type = box2d.b2ManifoldType.e_faceA,
    box2d.b2Sub_V2_V2(e, d, o.localNormal).SelfNormalize(),
    o.localPoint.Copy(d),
    o.points[0].localPoint.Copy(r.m_p),
    o.points[0].id.key = 0) : 0 >= b ? box2d.b2DistanceSquared(e, p) > i * i || (o.pointCount = 1,
    o.type = box2d.b2ManifoldType.e_faceA,
    box2d.b2Sub_V2_V2(e, p, o.localNormal).SelfNormalize(),
    o.localPoint.Copy(p),
    o.points[0].localPoint.Copy(r.m_p),
    o.points[0].id.key = 0) : (b = box2d.b2Mid_V2_V2(d, p, box2d.b2CollidePolygonAndCircle.s_faceCenter),
    (n = box2d.b2Dot_V2_V2(box2d.b2Sub_V2_V2(e, b, box2d.b2Vec2.s_t1), t[a])) > i || (o.pointCount = 1,
    o.type = box2d.b2ManifoldType.e_faceA,
    o.localNormal.Copy(t[a]).SelfNormalize(),
    o.localPoint.Copy(b),
    o.points[0].localPoint.Copy(r.m_p),
    o.points[0].id.key = 0)));
}
...
box2d.b2CollideEdgeAndCircle = function(o, t, e, r, i) {
    o.pointCount = 0,
    e = box2d.b2MulT_X_V2(e, box2d.b2Mul_X_V2(i, r.m_p, box2d.b2Vec2.s_t0), box2d.b2CollideEdgeAndCircle.s_Q);
    var b = t.m_vertex1
      , n = t.m_vertex2
    ...
    if ((i = box2d.b2CollideEdgeAndCircle.s_id).cf.indexB = 0,
    i.cf.typeB = box2d.b2ContactFeatureType.e_vertex,
    0 >= a) {
        var l = b;
        ...
        if (!((s = box2d.b2Dot_V2_V2(s, s)) > d * d)) {
            ...
            0 < box2d.b2Dot_V2_V2(t, box2d.b2Sub_V2_V2(b, e, box2d.b2Vec2.s_t0))))
                return;
            i.cf.indexA = 0,
            i.cf.typeA = box2d.b2ContactFeatureType.e_vertex,
            o.pointCount = 1,
            o.type = box2d.b2ManifoldType.e_circles,
            o.localNormal.SetZero(),
            o.localPoint.Copy(l),
            o.points[0].id.Copy(i),
            o.points[0].localPoint.Copy(r.m_p);
        }
    } else if (0 >= s) {
        if (l = n,
        s = box2d.b2Sub_V2_V2(e, l, box2d.b2CollideEdgeAndCircle.s_d),
        !((s = box2d.b2Dot_V2_V2(s, s)) > d * d)) {
            if (t.m_hasVertex3 && (b = box2d.b2Sub_V2_V2(t.m_vertex3, n, box2d.b2CollideEdgeAndCircle.s_e2),
            0 < box2d.b2Dot_V2_V2(b, box2d.b2Sub_V2_V2(e, n, box2d.b2Vec2.s_t0))))
                return;
            i.cf.indexA = 1,
            i.cf.typeA = box2d.b2ContactFeatureType.e_vertex,
            o.pointCount = 1,
        ...
        t = box2d.b2Dot_V2_V2(p, p),
        box2d.ENABLE_ASSERTS && box2d.b2Assert(0 < t),
        (l = box2d.b2CollideEdgeAndCircle.s_P).x = 1 / t * (s * b.x + a * n.x),
        l.y = 1 / t * (s * b.y + a * n.y),
        s = box2d.b2Sub_V2_V2(e, l, box2d.b2CollideEdgeAndCircle.s_d),
        (s = box2d.b2Dot_V2_V2(s, s)) > d * d || (l = box2d.b2CollideEdgeAndCircle.s_n.Set(-p.y, p.x),
        0 > box2d.b2Dot_V2_V2(l, box2d.b2Sub_V2_V2(e, b, box2d.b2Vec2.s_t0)) && l.Set(-l.x, -l.y),
        l.Normalize(),
        i.cf.indexA = 0,
        i.cf.typeA = box2d.b2ContactFeatureType.e_face,
        o.pointCount = 1,
        o.type = box2d.b2ManifoldType.e_faceA,
        o.localNormal.Copy(l),
        o.localPoint.Copy(b),
        o.points[0].id.Copy(i),
        o.points[0].localPoint.Copy(r.m_p));
}
...
box2d.b2EPCollider.prototype.Collide = function(o, t, e, r, i) {
    box2d.b2MulT_X_X(e, i, this.m_xf),
    box2d.b2Mul_X_V2(this.m_xf, r.m_centroid, this.m_centroidB),
    ...
    e = t.m_hasVertex0,
    t = t.m_hasVertex3,
    (i = box2d.b2Sub_V2_V2(this.m_v2, this.m_v1, box2d.b2EPCollider.s_edge1)).Normalize(),
    ...
    this.m_normal0.Set(n.y, -n.x),
    s = 0 <= box2d.b2Cross_V2_V2(n, i),
    n = box2d.b2Dot_V2_V2(this.m_normal0, box2d.b2Sub_V2_V2(this.m_centroidB, this.m_v0, box2d.b2Vec2.s_t0))),
    t && ((p = box2d.b2Sub_V2_V2(this.m_v3, this.m_v2, box2d.b2EPCollider.s_edge2)).Normalize(),
    this.m_normal2.Set(p.y, -p.x),
    a = 0 < box2d.b2Cross_V2_V2(i, p),
    p = box2d.b2Dot_V2_V2(this.m_normal2, box2d.b2Sub_V2_V2(this.m_centroidB, this.m_v2, box2d.b2Vec2.s_t0))),
    ...
    this.m_upperLimit.Copy(this.m_normal1).SelfNeg()) : s ? (this.m_front = 0 <= n || 0 <= b && 0 <= p) ? (this.m_normal.Copy(this.m_normal1),
    this.m_lowerLimit.Copy(this.m_normal0),
    this.m_upperLimit.Copy(this.m_normal1)) : (this.m_normal.Copy(this.m_normal1).SelfNeg(),
    this.m_lowerLimit.Copy(this.m_normal2).SelfNeg(),
    this.m_upperLimit.Copy(this.m_normal1).SelfNeg()) : a ? (this.m_front = 0 <= p || 0 <= n && 0 <= b) ? (this.m_normal.Copy(this.m_normal1),
    this.m_lowerLimit.Copy(this.m_normal1),
    this.m_upperLimit.Copy(this.m_normal2)) : (this.m_normal.Copy(this.m_normal1).SelfNeg(),
    this.m_lowerLimit.Copy(this.m_normal1).SelfNeg(),
    this.m_upperLimit.Copy(this.m_normal0).SelfNeg()) : (this.m_front = 0 <= n && 0 <= b && 0 <= p) ? (this.m_normal.Copy(this.m_normal1),
    this.m_lowerLimit.Copy(this.m_normal1),
    this.m_upperLimit.Copy(this.m_normal1)) : (this.m_normal.Copy(this.m_normal1).SelfNeg(),
    this.m_lowerLimit.Copy(this.m_normal2).SelfNeg(),
    this.m_upperLimit.Copy(this.m_normal0).SelfNeg()) : e ? s ? ((this.m_front = 0 <= n || 0 <= b) ? (this.m_normal.Copy(this.m_normal1),
    this.m_lowerLimit.Copy(this.m_normal0)) : (this.m_normal.Copy(this.m_normal1).SelfNeg(),
    this.m_lowerLimit.Copy(this.m_normal1)),
    this.m_upperLimit.Copy(this.m_normal1).SelfNeg()) : (this.m_front = 0 <= n && 0 <= b) ? (this.m_normal.Copy(this.m_normal1),
    this.m_lowerLimit.Copy(this.m_normal1),
    this.m_upperLimit.Copy(this.m_normal1).SelfNeg()) : (this.m_normal.Copy(this.m_normal1).SelfNeg(),
    this.m_lowerLimit.Copy(this.m_normal1),
    this.m_upperLimit.Copy(this.m_normal0).SelfNeg()) : t ? a ? (this.m_front = 0 <= b || 0 <= p) ? (this.m_normal.Copy(this.m_normal1),
    this.m_lowerLimit.Copy(this.m_normal1).SelfNeg(),
    this.m_upperLimit.Copy(this.m_normal2)) : (this.m_normal.Copy(this.m_normal1).SelfNeg(),
    this.m_lowerLimit.Copy(this.m_normal1).SelfNeg(),
    this.m_upperLimit.Copy(this.m_normal1)) : ((this.m_front = 0 <= b && 0 <= p) ? (this.m_normal.Copy(this.m_normal1),
    this.m_lowerLimit.Copy(this.m_normal1).SelfNeg()) : (this.m_normal.Copy(this.m_normal1).SelfNeg(),
    this.m_lowerLimit.Copy(this.m_normal2).SelfNeg()),
    this.m_upperLimit.Copy(this.m_normal1)) : (this.m_front = 0 <= b) ? (this.m_normal.Copy(this.m_normal1),
    this.m_lowerLimit.Copy(this.m_normal1).SelfNeg(),
    this.m_upperLimit.Copy(this.m_normal1).SelfNeg()) : (this.m_normal.Copy(this.m_normal1).SelfNeg(),
    this.m_lowerLimit.Copy(this.m_normal1),
    ...
    b = 0,
    n = r.m_count; b < n; ++b)
        box2d.b2Mul_X_V2(this.m_xf, r.m_vertices[b], this.m_polygonB.vertices[b]),
        box2d.b2Mul_R_V2(this.m_xf.q, r.m_normals[b], this.m_polygonB.normals[b]);
    if (this.m_radius = 2 * box2d.b2_polygonRadius,
    o.pointCount = 0,
    !((e = this.ComputeEdgeSeparation(box2d.b2EPCollider.s_edgeAxis)).type === box2d.b2EPAxisType.e_unknown || e.separation > this.m_radius || (t = this.ComputePolygonSeparation(box2d.b2EPCollider.s_polygonAxis),
    t.type !== box2d.b2EPAxisType.e_unknown && t.separation > this.m_radius))) {
        ...
        i = box2d.b2EPCollider.s_ie,
        t = box2d.b2EPCollider.s_rf,
        e.type === box2d.b2EPAxisType.e_edgeA) {
            for (o.type = box2d.b2ManifoldType.e_faceA,
            p = 0,
            s = box2d.b2Dot_V2_V2(this.m_normal, this.m_polygonB.normals[0]),
            b = 1,
            n = this.m_polygonB.count; b < n; ++b)
                (a = box2d.b2Dot_V2_V2(this.m_normal, this.m_polygonB.normals[b])) < s && (s = a,
                p = b);
            b = ((n = p) + 1) % this.m_polygonB.count,
            (p = i[0]).v.Copy(this.m_polygonB.vertices[n]),
            p.id.cf.indexA = 0,
            p.id.cf.indexB = n,
            p.id.cf.typeA = box2d.b2ContactFeatureType.e_face,
            p.id.cf.typeB = box2d.b2ContactFeatureType.e_vertex,
            (n = i[1]).v.Copy(this.m_polygonB.vertices[b]),
            n.id.cf.indexA = 0,
            n.id.cf.indexB = b,
            n.id.cf.typeA = box2d.b2ContactFeatureType.e_face,
            n.id.cf.typeB = box2d.b2ContactFeatureType.e_vertex,
            this.m_front ? (t.i1 = 0,
            t.i2 = 1,
            t.v1.Copy(this.m_v1),
            t.v2.Copy(this.m_v2),
            t.normal.Copy(this.m_normal1)) : (t.i1 = 1,
            t.i2 = 0,
            t.v1.Copy(this.m_v2),
            t.v2.Copy(this.m_v1),
            t.normal.Copy(this.m_normal1).SelfNeg());
        } else
            o.type = box2d.b2ManifoldType.e_faceB,
            (p = i[0]).v.Copy(this.m_v1),
            p.id.cf.indexA = 0,
            p.id.cf.indexB = e.index,
            p.id.cf.typeA = box2d.b2ContactFeatureType.e_vertex,
            p.id.cf.typeB = box2d.b2ContactFeatureType.e_face,
            (n = i[1]).v.Copy(this.m_v2),
            n.id.cf.indexA = 0,
            n.id.cf.indexB = e.index,
            n.id.cf.typeA = box2d.b2ContactFeatureType.e_vertex,
            n.id.cf.typeB = box2d.b2ContactFeatureType.e_face,
            t.i1 = e.index,
            t.i2 = (t.i1 + 1) % this.m_polygonB.count,
            t.v1.Copy(this.m_polygonB.vertices[t.i1]),
            t.v2.Copy(this.m_polygonB.vertices[t.i2]),
            t.normal.Copy(this.m_polygonB.normals[t.i1]);
        if (t.sideNormal1.Set(t.normal.y, -t.normal.x),
        t.sideNormal2.Copy(t.sideNormal1).SelfNeg(),
        t.sideOffset1 = box2d.b2Dot_V2_V2(t.sideNormal1, t.v1),
        t.sideOffset2 = box2d.b2Dot_V2_V2(t.sideNormal2, t.v2),
        b = box2d.b2EPCollider.s_clipPoints1,
        p = box2d.b2EPCollider.s_clipPoints2,
        n = 0,
        !((n = box2d.b2ClipSegmentToLine(b, i, t.sideNormal1, t.sideOffset1, t.i1)) < box2d.b2_maxManifoldPoints || (n = box2d.b2ClipSegmentToLine(p, b, t.sideNormal2, t.sideOffset2, t.i2),
        n < box2d.b2_maxManifoldPoints))) {
            for (e.type === box2d.b2EPAxisType.e_edgeA ? (o.localNormal.Copy(t.normal),
            o.localPoint.Copy(t.v1)) : (o.localNormal.Copy(r.m_normals[t.i1]),
            o.localPoint.Copy(r.m_vertices[t.i1])),
            b = r = 0,
            n = box2d.b2_maxManifoldPoints; b < n; ++b)
                box2d.b2Dot_V2_V2(t.normal, box2d.b2Sub_V2_V2(p[b].v, t.v1, box2d.b2Vec2.s_t0)) <= this.m_radius && (i = o.points[r],
                e.type === box2d.b2EPAxisType.e_edgeA ? (box2d.b2MulT_X_V2(this.m_xf, p[b].v, i.localPoint),
                i.id = p[b].id) : (i.localPoint.Copy(p[b].v),
                i.id.cf.typeA = p[b].id.cf.typeB,
                i.id.cf.typeB = p[b].id.cf.typeA,
                i.id.cf.indexA = p[b].id.cf.indexB,
                i.id.cf.indexB = p[b].id.cf.indexA),
                ++r);
            o.pointCount = r;
        }
    }
...
box2d.b2EPCollider.prototype.ComputeEdgeSeparation = function(o) {
    o.type = box2d.b2EPAxisType.e_edgeA,
    o.index = this.m_front ? 0 : 1,
    o.separation = box2d.b2_maxFloat;
...
box2d.b2EPCollider.prototype.ComputePolygonSeparation = function(o) {
    o.type = box2d.b2EPAxisType.e_unknown,
    o.index = -1,
    o.separation = -box2d.b2_maxFloat;
    for (var t = box2d.b2EPCollider.s_perp.Set(-this.m_normal.y, this.m_normal.x), e = 0, r = this.m_polygonB.count; e < r; ++e) {
        ...
        if ((b = box2d.b2Min(b, n)) > this.m_radius) {
            o.type = box2d.b2EPAxisType.e_edgeB,
            o.index = e,
            o.separation = b;
            break;
        }
        if (0 <= box2d.b2Dot_V2_V2(i, t)) {
            if (box2d.b2Dot_V2_V2(box2d.b2Sub_V2_V2(i, this.m_upperLimit, box2d.b2Vec2.s_t0), this.m_normal) < -box2d.b2_angularSlop)
                continue;
        } else if (box2d.b2Dot_V2_V2(box2d.b2Sub_V2_V2(i, this.m_lowerLimit, box2d.b2Vec2.s_t0), this.m_normal) < -box2d.b2_angularSlop)
            continue;
        b > o.separation && (o.type = box2d.b2EPAxisType.e_edgeB,
        o.index = e,
        o.separation = b);
    }
    return o;
...
box2d.b2FindMaxSeparation = function(o, t, e, r, i) {
    ...
    t = t.m_vertices,
    r = r.m_vertices,
    e = box2d.b2MulT_X_X(i, e, box2d.b2FindMaxSeparation.s_xf),
    i = 0;
...
box2d.b2FindIncidentEdge = function(o, t, e, r, i, b) {
    ...
    t = i.m_vertices,
    i = i.m_normals,
    box2d.ENABLE_ASSERTS && box2d.b2Assert(0 <= r && r < n),
    ...
    s = ((i = n) + 1) % s,
    e = o[0],
    box2d.b2Mul_X_V2(b, t[i], e.v),
    (e = e.id.cf).indexA = r,
    e.indexB = i,
    e.typeA = box2d.b2ContactFeatureType.e_face,
    e.typeB = box2d.b2ContactFeatureType.e_vertex,
    o = o[1],
    box2d.b2Mul_X_V2(b, t[s], o.v),
    (b = o.id.cf).indexA = r,
    b.indexB = s,
    b.typeA = box2d.b2ContactFeatureType.e_face,
    b.typeB = box2d.b2ContactFeatureType.e_vertex;
}
,
...
box2d.b2CollidePolygons = function(o, t, e, r, i) {
    ...
    if (((c = box2d.b2CollidePolygons.s_edgeA)[0] = 0,
    !((a = box2d.b2FindMaxSeparation(c, t, e, r, i)) > b)) && ((s = box2d.b2CollidePolygons.s_edgeB)[0] = 0,
    !((x = box2d.b2FindMaxSeparation(s, r, i, t, e)) > b))) {
        var n = 0
          , p = 0;
        x > .98 * a + .001 ? (a = r,
        r = t,
        ...
        o.type = box2d.b2ManifoldType.e_faceA,
        p = 0),
        c = box2d.b2CollidePolygons.s_incidentEdge,
        box2d.b2FindIncidentEdge(c, a, t, n, r, e),
        i = a.m_vertices;
        var s = n
          , a = (n + 1) % a.m_count
          , d = i[s]
        ...
        i = box2d.b2Cross_V2_S(n, 1, box2d.b2CollidePolygons.s_localNormal),
        r = box2d.b2Mid_V2_V2(d, l, box2d.b2CollidePolygons.s_planePoint);
        ...
        d = box2d.b2Mul_X_V2(t, d, box2d.b2CollidePolygons.s_v11),
        box2d.b2Mul_X_V2(t, l, box2d.b2CollidePolygons.s_v12));
        t = box2d.b2Dot_V2_V2(n, d);
        l = -box2d.b2Dot_V2_V2(x, d) + b,
        y = box2d.b2Dot_V2_V2(x, y) + b;
        var c, _ = box2d.b2CollidePolygons.s_clipPoints1, m = (d = box2d.b2CollidePolygons.s_clipPoints2,
        ...
        2 > c))) {
            for (o.localNormal.Copy(i),
            o.localPoint.Copy(r),
            s = c = 0; s < box2d.b2_maxManifoldPoints; ++s)
                i = d[s],
                box2d.b2Dot_V2_V2(n, i.v) - t <= b && (a = o.points[c],
                box2d.b2MulT_X_V2(e, i.v, a.localPoint),
                a.id.Copy(i.id),
                p && (i = a.id.cf,
                a.id.cf.indexA = i.indexB,
                a.id.cf.indexB = i.indexA,
                a.id.cf.typeA = i.typeB,
                a.id.cf.typeB = i.typeA),
                ++c);
            o.pointCount = c;
        }
    }
...
box2d.b2DynamicTree.prototype.RayCast = function(o, t) {
    if (null !== this.m_root) {
        ...
        box2d.ENABLE_ASSERTS && box2d.b2Assert(0 < i.LengthSquared()),
        i.Normalize();
        ...
        var b = box2d.b2Abs_V2(i, box2d.b2DynamicTree.s_abs_v)
          ...
          , s = e.x + n * (r.x - e.x)
          , a = e.y + n * (r.y - e.y);
        p.lowerBound.x = box2d.b2Min(e.x, s),
        p.lowerBound.y = box2d.b2Min(e.y, a),
        p.upperBound.x = box2d.b2Max(e.x, s),
        ...
        for (d.Push(this.m_root); 0 < d.GetCount(); )
            if (null !== (s = d.Pop()) && box2d.b2TestOverlap_AABB(s.aabb, p)) {
                ...
                if (!(0 < box2d.b2Abs(box2d.b2Dot_V2_V2(i, box2d.b2Sub_V2_V2(e, a, box2d.b2Vec2.s_t0))) - box2d.b2Dot_V2_V2(b, l)))
                    if (s.IsLeaf()) {
                        if ((a = box2d.b2DynamicTree.s_subInput).p1.Copy(t.p1),
                        a.p2.Copy(t.p2),
                        a.maxFraction = n,
                        0 === (s = o(a, s)))
                            break;
...
box2d.b2DynamicTree.prototype.CreateProxy = function(o, t) {
    ...
    return e.aabb.lowerBound.x = o.lowerBound.x - r,
    e.aabb.lowerBound.y = o.lowerBound.y - i,
    e.aabb.upperBound.x = o.upperBound.x + r,
    e.aabb.upperBound.y = o.upperBound.y + i,
    e.userData = t,
    e.height = 0,
    this.InsertLeaf(e),
    e;
...
box2d.b2DynamicTree.prototype.MoveProxy = function(o, t, e) {
    ...
    o.aabb.lowerBound.x = t.lowerBound.x - r,
    o.aabb.lowerBound.y = t.lowerBound.y - e,
    o.aabb.upperBound.x = t.upperBound.x + r,
    o.aabb.upperBound.y = t.upperBound.y + e,
    this.InsertLeaf(o),
    !0;
}
,
...
box2d.b2DynamicTree.prototype.InsertLeaf = function(o) {
    ...
    null === this.m_root)
        ...
        for (var e, r, i = this.m_root; !i.IsLeaf(); ) {
            ...
            var n, p = 2 * (s = p.GetPerimeter()), s = 2 * (s - b), a = box2d.b2DynamicTree.s_aabb;
            if (e.IsLeaf() ? (a.Combine2(t, e.aabb),
            b = a.GetPerimeter() + s) : (a.Combine2(t, e.aabb),
            n = e.aabb.GetPerimeter(),
            b = a.GetPerimeter() - n + s),
            r.IsLeaf() ? (a.Combine2(t, r.aabb),
            s = a.GetPerimeter() + s) : (a.Combine2(t, r.aabb),
            n = r.aabb.GetPerimeter(),
            s = a.GetPerimeter() - n + s),
            p < b && p < s)
                break;
            i = b < s ? e : r;
        }
        for (e = i.parent,
        (r = this.AllocateNode()).parent = e,
        r.userData = null,
        r.aabb.Combine2(t, i.aabb),
        r.height = i.height + 1,
        e ? (e.child1 === i ? e.child1 = r : e.child2 = r,
        r.child1 = i,
        r.child2 = o,
        i.parent = r,
        o.parent = r) : (r.child1 = i,
        r.child2 = o,
        i.parent = r,
        this.m_root = o.parent = r),
        i = o.parent; null !== i; )
            e = (i = this.Balance(i)).child1,
            r = i.child2,
            box2d.ENABLE_ASSERTS && box2d.b2Assert(null !== e),
            box2d.ENABLE_ASSERTS && box2d.b2Assert(null !== r),
            i.height = 1 + box2d.b2Max(e.height, r.height),
            i.aabb.Combine2(e.aabb, r.aabb),
            i = i.parent;
    }
}
,
...
box2d.b2DynamicTree.prototype.RemoveLeaf = function(o) {
    if (o === this.m_root)
        ...
        var t = o.parent
          , e = t.parent;
        if (o = t.child1 === o ? t.child2 : t.child1,
        e)
            for (e.child1 === t ? e.child1 = o : e.child2 = o,
            o.parent = e,
            this.FreeNode(t),
            t = e; t; )
                e = (t = this.Balance(t)).child1,
                o = t.child2,
                t.aabb.Combine2(e.aabb, o.aabb),
                t.height = 1 + box2d.b2Max(e.height, o.height),
                t = t.parent;
        else
            this.m_root = o,
            o.parent = null,
...
box2d.b2DynamicTree.prototype.Balance = function(o) {
    ...
    if (1 < (r = e.height - t.height)) {
        ...
        r.height > i.height ? (e.child2 = r,
        o.child2 = i,
        i.parent = o,
        o.aabb.Combine2(t.aabb, i.aabb),
        e.aabb.Combine2(o.aabb, r.aabb),
        o.height = 1 + box2d.b2Max(t.height, i.height),
        e.height = 1 + box2d.b2Max(o.height, r.height)) : (e.child2 = i,
        o.child2 = r,
        r.parent = o,
        o.aabb.Combine2(t.aabb, r.aabb),
        e.aabb.Combine2(o.aabb, i.aabb),
        o.height = 1 + box2d.b2Max(t.height, r.height),
        e.height = 1 + box2d.b2Max(o.height, i.height)),
        e;
    }
    return -1 > r ? (r = t.child1,
    i = t.child2,
    t.child1 = o,
    t.parent = o.parent,
    o.parent = t,
    ...
    r.height > i.height ? (t.child2 = r,
    o.child1 = i,
    i.parent = o,
    o.aabb.Combine2(e.aabb, i.aabb),
    t.aabb.Combine2(o.aabb, r.aabb),
    o.height = 1 + box2d.b2Max(e.height, i.height),
    t.height = 1 + box2d.b2Max(o.height, r.height)) : (t.child2 = i,
    o.child1 = r,
    r.parent = o,
    o.aabb.Combine2(e.aabb, r.aabb),
    t.aabb.Combine2(o.aabb, i.aabb),
    o.height = 1 + box2d.b2Max(e.height, r.height),
    t.height = 1 + box2d.b2Max(o.height, i.height)),
    t) : o;
}
,
...
box2d.b2DynamicTree.prototype.ComputeHeightNode = function(o) {
    ...
    return o = this.ComputeHeightNode(o.child2),
    1 + box2d.b2Max(t, o);
}
,
...
box2d.b2DynamicTree.prototype.ValidateStructure = function(o) {
    if (null !== o) {
        ...
        var t = o.child1
          , e = o.child2;
        o.IsLeaf() ? (box2d.ENABLE_ASSERTS && box2d.b2Assert(null === t),
        box2d.ENABLE_ASSERTS && box2d.b2Assert(null === e),
...
box2d.b2DynamicTree.prototype.ValidateMetrics = function(o) {
    if (null !== o) {
        var t, e = o.child1, r = o.child2;
        if (o.IsLeaf())
            box2d.ENABLE_ASSERTS && box2d.b2Assert(null === e),
            box2d.ENABLE_ASSERTS && box2d.b2Assert(null === r),
            box2d.ENABLE_ASSERTS && box2d.b2Assert(0 === o.height);
        else
            t = 1 + box2d.b2Max(e.height, r.height),
            box2d.ENABLE_ASSERTS && box2d.b2Assert(o.height === t),
            (t = box2d.b2DynamicTree.s_aabb).Combine2(e.aabb, r.aabb),
            box2d.ENABLE_ASSERTS && box2d.b2Assert(t.lowerBound === o.aabb.lowerBound),
            box2d.ENABLE_ASSERTS && box2d.b2Assert(t.upperBound === o.aabb.upperBound),
...
box2d.b2DynamicTree.prototype.GetMaxBalance = function() {
    ...
    o = box2d.b2Abs(o.child2.height - o.child1.height),
    o = box2d.b2Max(0, o)),
    o;
}
,
...
box2d.b2BroadPhase.prototype.UpdatePairs = function(o) {
    ...
    t = 0; t < this.m_pairCount; ) {
        ...
        for (o.AddPair(b, n),
        ++t; t < this.m_pairCount && ((b = this.m_pairBuffer[t]).proxyA.m_id === i.proxyA.m_id && b.proxyB.m_id === i.proxyB.m_id); )
            ++t;
    }
}
,
...
box2d.b2BroadPhase.prototype.UnBufferMove = function(o) {
    o = this.m_moveBuffer.indexOf(o),
    this.m_moveBuffer[o] = null;
}
,
...
box2d.b2CircleShape = function(o) {
    box2d.b2Shape.call(this, box2d.b2ShapeType.e_circleShape, o || 0),
...
box2d.b2CircleShape.prototype.Copy = function(o) {
    return box2d.b2Shape.prototype.Copy.call(this, o),
...
box2d.b2CircleShape.prototype.ComputeDistance = function(o, t, e, r) {
    ...
    box2d.b2Sub_V2_V2(t, o, e),
    e.Normalize() - this.m_radius;
}
,
...
box2d.b2CircleShape.prototype.RayCast = function(o, t, e, r) {
    ...
    o.fraction = b,
    box2d.b2AddMul_V2_S_V2(e, b, r, o.normal).SelfNormalize(),
    !0));
}
,
...
box2d.b2CircleShape.prototype.ComputeAABB = function(o, t, e) {
    ...
    o.lowerBound.Set(t.x - this.m_radius, t.y - this.m_radius),
    o.upperBound.Set(t.x + this.m_radius, t.y + this.m_radius);
}
,
...
box2d.b2CircleShape.prototype.ComputeMass = function(o, t) {
    ...
    o.I = o.mass * (.5 * e + box2d.b2Dot_V2_V2(this.m_p, this.m_p));
}
,
...
box2d.b2CircleShape.prototype.SetupDistanceProxy = function(o, t) {
    ...
    o.m_vertices[0].Copy(this.m_p),
    o.m_count = 1,
    o.m_radius = this.m_radius;
}
,
box2d.b2CircleShape.prototype.ComputeSubmergedArea = function(o, t, e, r) {
    if (e = box2d.b2Mul_X_V2(e, this.m_p, new box2d.b2Vec2()),
    (b = -(box2d.b2Dot_V2_V2(o, e) - t)) < -this.m_radius + box2d.b2_epsilon)
        return 0;
    if (b > this.m_radius)
        return r.Copy(e),
    ...
    return t = -2 / 3 * box2d.b2Pow(t - i, 1.5) / b,
    r.x = e.x + o.x * t,
    r.y = e.y + o.y * t,
    b;
}
...
box2d.b2EdgeShape.prototype.RayCast = function(o, t, e, r) {
    ...
    i = box2d.b2Sub_V2_V2(n, r, box2d.b2EdgeShape.prototype.RayCast.s_r),
    0 !== (n = box2d.b2Dot_V2_V2(i, i)) && (!(0 > (r = box2d.b2Dot_V2_V2(box2d.b2Sub_V2_V2(t, r, box2d.b2Vec2.s_t0), i) / n) || 1 < r) && (o.fraction = s,
    box2d.b2Mul_R_V2(e.q, o.normal, o.normal),
    0 < p && o.normal.SelfNeg(),
    !0))));
}
,
...
box2d.b2EdgeShape.prototype.ComputeAABB = function(o, t, e) {
    ...
    box2d.b2Min_V2_V2(e, t, o.lowerBound),
    box2d.b2Max_V2_V2(e, t, o.upperBound),
    t = this.m_radius,
    o.lowerBound.SelfSubXY(t, t),
    o.upperBound.SelfAddXY(t, t);
}
,
...
box2d.b2EdgeShape.prototype.ComputeMass = function(o, t) {
    o.mass = 0,
    box2d.b2Mid_V2_V2(this.m_vertex1, this.m_vertex2, o.center),
    o.I = 0;
}
,
...
box2d.b2EdgeShape.prototype.SetupDistanceProxy = function(o, t) {
    o.m_vertices = o.m_buffer,
    o.m_vertices[0].Copy(this.m_vertex1),
    o.m_vertices[1].Copy(this.m_vertex2),
    o.m_count = 2,
    o.m_radius = this.m_radius;
}
,
...
box2d.b2ChainShape.prototype.CreateLoop = function(o, t) {
    ...
    box2d.ENABLE_ASSERTS)
        for (var e = 1; e < t; ++e)
            box2d.b2Assert(box2d.b2DistanceSquared(o[e - 1], o[e]) > box2d.b2_linearSlop * box2d.b2_linearSlop);
    for (this.m_count = t + 1,
...
box2d.b2ChainShape.prototype.CreateChain = function(o, t) {
    ...
    e = 0; e < t; ++e)
        this.m_vertices[e].Copy(o[e]);
    return this.m_hasNextVertex = this.m_hasPrevVertex = !1,
...
box2d.b2ChainShape.prototype.GetChildEdge = function(o, t) {
    ...
    0 < t ? (o.m_vertex0.Copy(this.m_vertices[t - 1]),
...
box2d.b2ChainShape.prototype.ComputeDistance = function(o, t, e, r) {
    ...
    return this.GetChildEdge(i, r),
    i.ComputeDistance(o, t, e, 0);
}
,
...
box2d.b2ChainShape.prototype.RayCast = function(o, t, e, r) {
    ...
    return i.m_vertex1.Copy(this.m_vertices[r]),
    i.m_vertex2.Copy(this.m_vertices[(r + 1) % this.m_count]),
    i.RayCast(o, t, e, 0);
}
,
...
box2d.b2ChainShape.prototype.ComputeAABB = function(o, t, e) {
    ...
    t = box2d.b2Mul_X_V2(t, r, box2d.b2ChainShape.prototype.ComputeAABB.s_v2),
    box2d.b2Min_V2_V2(e, t, o.lowerBound),
    box2d.b2Max_V2_V2(e, t, o.upperBound);
}
,
...
box2d.b2PolygonShape.prototype.Copy = function(o) {
    box2d.b2Shape.prototype.Copy.call(this, o),
...
box2d.b2PolygonShape.prototype.SetAsBox = function(o, t, e, r) {
    if (this.m_count = 4,
    this.m_vertices[0].Set(-o, -t),
    this.m_vertices[1].Set(o, -t),
    this.m_vertices[2].Set(o, t),
    this.m_vertices[3].Set(-o, t),
    this.m_normals[0].Set(0, -1),
    this.m_normals[1].Set(1, 0),
    this.m_normals[2].Set(0, 1),
    this.m_normals[3].Set(-1, 0),
    this.m_centroid.SetZero(),
    e instanceof box2d.b2Vec2)
        for (r = "number" == typeof r ? r : 0,
        this.m_centroid.Copy(e),
        (o = new box2d.b2Transform()).SetPosition(e),
        o.SetRotationAngle(r),
        e = 0,
        r = this.m_count; e < r; ++e)
            box2d.b2Mul_X_V2(o, this.m_vertices[e], this.m_vertices[e]),
...
box2d.b2PolygonShape.prototype.Set = function(o, t, e) {
    if (t = "number" == typeof t ? t : o.length,
    ...
    n = r[0].x,
    b = 1; b < t; ++b)
        ((s = r[b].x) > n || s === n && r[b].y < r[o].y) && (o = b,
        n = s);
    for (i = box2d.b2PolygonShape.prototype.Set.s_hull,
    e = 0,
    b = o; ; ) {
        for (i[e] = b,
        p = 0,
        s = 1; s < t; ++s)
            if (p === b)
                ...
                0 > d && (p = s),
                0 === d && n.LengthSquared() > a.LengthSquared() && (p = s);
            }
        if (++e,
        b = p,
        p === o)
    ...
    for (this.m_count = e,
    b = 0; b < e; ++b)
        this.m_vertices[b].Copy(r[i[b]]);
    for (b = 0,
    t = e; b < t; ++b)
        r = box2d.b2Sub_V2_V2(this.m_vertices[(b + 1) % t], this.m_vertices[b], box2d.b2Vec2.s_t0),
...
box2d.b2PolygonShape.prototype.TestPoint = function(o, t) {
    for (var e = box2d.b2MulT_X_V2(o, t, box2d.b2PolygonShape.prototype.TestPoint.s_pLocal), r = 0, i = this.m_count; r < i; ++r)
        if (0 < box2d.b2Dot_V2_V2(this.m_normals[r], box2d.b2Sub_V2_V2(e, this.m_vertices[r], box2d.b2Vec2.s_t0)))
            return !1;
    return !0;
}
,
...
box2d.b2PolygonShape.prototype.ComputeDistance = function(o, t, e, r) {
    ...
    if (0 < i) {
        for (b = box2d.b2PolygonShape.prototype.ComputeDistance.s_minDistance.Copy(b),
        i *= i,
        ...
        return box2d.b2Mul_R_V2(o.q, b, e),
        e.Normalize(),
        Math.sqrt(i);
    }
    return box2d.b2Mul_R_V2(o.q, b, e),
...
box2d.b2PolygonShape.prototype.RayCast = function(o, t, e, r) {
    ...
    0 <= p && (o.fraction = b,
    box2d.b2Mul_R_V2(e.q, this.m_normals[p], o.normal),
    !0);
}
,
...
box2d.b2PolygonShape.prototype.ComputeAABB = function(o, t, e) {
    e = box2d.b2Mul_X_V2(t, this.m_vertices[0], o.lowerBound),
    o = o.upperBound.Copy(e);
    for (var r = 0, i = this.m_count; r < i; ++r) {
        ...
        box2d.b2Min_V2_V2(b, e, e),
        box2d.b2Max_V2_V2(b, o, o);
    }
    t = this.m_radius,
    e.SelfSubXY(t, t),
    o.SelfAddXY(t, t);
...
box2d.b2PolygonShape.prototype.ComputeMass = function(o, t) {
    ...
    for (var e = box2d.b2PolygonShape.prototype.ComputeMass.s_center.SetZero(), r = 0, i = 0, b = box2d.b2PolygonShape.prototype.ComputeMass.s_s.SetZero(), n = 0, p = this.m_count; n < p; ++n)
        b.SelfAdd(this.m_vertices[n]);
    b.SelfMul(1 / this.m_count);
    for (n = 0,
    p = this.m_count; n < p; ++n) {
    ...
    o.mass = t * r,
    box2d.ENABLE_ASSERTS && box2d.b2Assert(r > box2d.b2_epsilon),
    e.SelfMul(1 / r),
    box2d.b2Add_V2_V2(e, b, o.center),
    o.I = t * i,
    o.I += o.mass * (box2d.b2Dot_V2_V2(o.center, o.center) - box2d.b2Dot_V2_V2(e, e));
}
,
...
box2d.b2PolygonShape.prototype.ComputeSubmergedArea = function(o, t, e, r) {
    ...
    switch (p) {
    case 0:
        return a ? (o = box2d.b2PolygonShape.prototype.ComputeSubmergedArea.s_md,
        this.ComputeMass(o, 1),
        box2d.b2Mul_X_V2(e, o.center, r),
        o.mass) : 0;
    case 1:
        -1 === s ? s = this.m_count - 1 : t = this.m_count - 1;
    }
    for (o = (s + 1) % this.m_count,
    i = (t + 1) % this.m_count,
    b = (0 - n[s]) / (n[o] - n[s]),
    n = (0 - n[t]) / (n[i] - n[t]),
    s = box2d.b2PolygonShape.prototype.ComputeSubmergedArea.s_intoVec.Set(this.m_vertices[s].x * (1 - b) + this.m_vertices[o].x * b, this.m_vertices[s].y * (1 - b) + this.m_vertices[o].y * b),
    ...
    n = 0,
    b = box2d.b2PolygonShape.prototype.ComputeSubmergedArea.s_center.SetZero(),
    p = this.m_vertices[o],
    a = null; o !== i; )
        a = (o = (o + 1) % this.m_count) === i ? t : this.m_vertices[o],
        n += d = .5 * ((p.x - s.x) * (a.y - s.y) - (p.y - s.y) * (a.x - s.x)),
        b.x += d * (s.x + p.x + a.x) / 3,
        b.y += d * (s.y + p.y + a.y) / 3,
        p = a;
    return b.SelfMul(1 / n),
    box2d.b2Mul_X_V2(e, b, r),
    n;
}
,
...
box2d.b2PolygonShape.ComputeCentroid = function(o, t, e) {
    ...
    for (var r = 0, i = box2d.b2PolygonShape.ComputeCentroid.s_pRef.SetZero(), b = 0; b < t; ++b) {
        ...
        e.x += a * (1 / 3) * (n.x + p.x + s.x),
        e.y += a * (1 / 3) * (n.y + p.y + s.y);
    }
    return box2d.ENABLE_ASSERTS && box2d.b2Assert(r > box2d.b2_epsilon),
    e.SelfMul(1 / r),
    e;
}
,
...
box2d.b2SeparationFunction.prototype.Initialize = function(o, t, e, r, i, b) {
    return this.m_proxyA = t,
    this.m_proxyB = r,
    t = o.count,
    box2d.ENABLE_ASSERTS && box2d.b2Assert(0 < t && 3 > t),
    this.m_sweepA.Copy(e),
    this.m_sweepB.Copy(i),
    e = box2d.b2TimeOfImpact.s_xfA,
    i = box2d.b2TimeOfImpact.s_xfB,
    this.m_sweepA.GetTransform(e, b),
    this.m_sweepB.GetTransform(i, b),
    1 === t ? (this.m_type = box2d.b2SeparationFunctionType.e_points,
    t = this.m_proxyA.GetVertex(o.indexA[0]),
    o = this.m_proxyB.GetVertex(o.indexB[0]),
    e = box2d.b2Mul_X_V2(e, t, box2d.b2TimeOfImpact.s_pointA),
    i = box2d.b2Mul_X_V2(i, o, box2d.b2TimeOfImpact.s_pointB),
    box2d.b2Sub_V2_V2(i, e, this.m_axis),
    o = this.m_axis.Normalize(),
    this.m_localPoint.SetZero()) : (o.indexA[0] === o.indexA[1] ? (this.m_type = box2d.b2SeparationFunctionType.e_faceB,
    t = this.m_proxyB.GetVertex(o.indexB[0]),
    r = this.m_proxyB.GetVertex(o.indexB[1]),
    box2d.b2Cross_V2_S(box2d.b2Sub_V2_V2(r, t, box2d.b2Vec2.s_t0), 1, this.m_axis).SelfNormalize(),
    b = box2d.b2Mul_R_V2(i.q, this.m_axis, box2d.b2TimeOfImpact.s_normal),
    box2d.b2Mid_V2_V2(t, r, this.m_localPoint),
    i = box2d.b2Mul_X_V2(i, this.m_localPoint, box2d.b2TimeOfImpact.s_pointB),
    t = this.m_proxyA.GetVertex(o.indexA[0]),
    e = box2d.b2Mul_X_V2(e, t, box2d.b2TimeOfImpact.s_pointA),
    o = box2d.b2Dot_V2_V2(box2d.b2Sub_V2_V2(e, i, box2d.b2Vec2.s_t0), b)) : (this.m_type = box2d.b2SeparationFunctionType.e_faceA,
    t = this.m_proxyA.GetVertex(o.indexA[0]),
    r = this.m_proxyA.GetVertex(o.indexA[1]),
    box2d.b2Cross_V2_S(box2d.b2Sub_V2_V2(r, t, box2d.b2Vec2.s_t0), 1, this.m_axis).SelfNormalize(),
    b = box2d.b2Mul_R_V2(e.q, this.m_axis, box2d.b2TimeOfImpact.s_normal),
    box2d.b2Mid_V2_V2(t, r, this.m_localPoint),
    e = box2d.b2Mul_X_V2(e, this.m_localPoint, box2d.b2TimeOfImpact.s_pointA),
    o = this.m_proxyB.GetVertex(o.indexB[0]),
    i = box2d.b2Mul_X_V2(i, o, box2d.b2TimeOfImpact.s_pointB),
    o = box2d.b2Dot_V2_V2(box2d.b2Sub_V2_V2(i, e, box2d.b2Vec2.s_t0), b)),
    0 > o && (this.m_axis.SelfNeg(),
    o = -o)),
    o;
}
,
...
box2d.b2SeparationFunction.prototype.FindMinSeparation = function(o, t, e) {
    var r = box2d.b2TimeOfImpact.s_xfA
      , i = box2d.b2TimeOfImpact.s_xfB;
    switch (this.m_sweepA.GetTransform(r, e),
    this.m_sweepB.GetTransform(i, e),
    this.m_type) {
    case box2d.b2SeparationFunctionType.e_points:
        ...
        return o[0] = this.m_proxyA.GetSupport(b),
        t[0] = this.m_proxyB.GetSupport(n),
        o = this.m_proxyA.GetVertex(o[0]),
        t = this.m_proxyB.GetVertex(t[0]),
        r = box2d.b2Mul_X_V2(r, o, box2d.b2TimeOfImpact.s_pointA),
        i = box2d.b2Mul_X_V2(i, t, box2d.b2TimeOfImpact.s_pointB),
        box2d.b2Dot_V2_V2(box2d.b2Sub_V2_V2(i, r, box2d.b2Vec2.s_t0), this.m_axis);
    case box2d.b2SeparationFunctionType.e_faceA:
        return e = box2d.b2Mul_R_V2(r.q, this.m_axis, box2d.b2TimeOfImpact.s_normal),
        r = box2d.b2Mul_X_V2(r, this.m_localPoint, box2d.b2TimeOfImpact.s_pointA),
    ...
    case box2d.b2SeparationFunctionType.e_faceB:
        return e = box2d.b2Mul_R_V2(i.q, this.m_axis, box2d.b2TimeOfImpact.s_normal),
        i = box2d.b2Mul_X_V2(i, this.m_localPoint, box2d.b2TimeOfImpact.s_pointB),
        b = box2d.b2MulT_R_V2(r.q, box2d.b2Vec2.s_t0.Copy(e).SelfNeg(), box2d.b2TimeOfImpact.s_axisA),
        t[0] = -1,
        o[0] = this.m_proxyA.GetSupport(b),
        o = this.m_proxyA.GetVertex(o[0]),
        r = box2d.b2Mul_X_V2(r, o, box2d.b2TimeOfImpact.s_pointA),
...
box2d.b2SeparationFunction.prototype.Evaluate = function(o, t, e) {
    ...
    this.m_type) {
    case box2d.b2SeparationFunctionType.e_points:
        return o = this.m_proxyA.GetVertex(o),
        t = this.m_proxyB.GetVertex(t),
        r = box2d.b2Mul_X_V2(r, o, box2d.b2TimeOfImpact.s_pointA),
        i = box2d.b2Mul_X_V2(i, t, box2d.b2TimeOfImpact.s_pointB),
        box2d.b2Dot_V2_V2(box2d.b2Sub_V2_V2(i, r, box2d.b2Vec2.s_t0), this.m_axis);
    case box2d.b2SeparationFunctionType.e_faceA:
...
box2d.b2TimeOfImpact = function(o, t) {
    ...
    for (y.proxyA = t.proxyA,
    y.proxyB = t.proxyB,
    y.useRadii = !1; ; ) {
        var c = box2d.b2TimeOfImpact.s_xfA
          , _ = box2d.b2TimeOfImpact.s_xfB;
        if (b.GetTransform(c, d),
        n.GetTransform(_, d),
        y.transformA.Copy(c),
        y.transformB.Copy(_),
        c = box2d.b2TimeOfImpact.s_distanceOutput,
        box2d.b2ShapeDistance(c, x, y),
        0 >= c.distance) {
        ...
        for (var m = p, u = 0; ; ) {
            ...
            if (box2d.b2_toiMaxRootIters = box2d.b2Max(box2d.b2_toiMaxRootIters, P),
            ++u === box2d.b2_maxPolygonVertices)
                break;
        }
        if (++l,
        ++box2d.b2_toiIters,
    ...
    box2d.b2_toiMaxIters = box2d.b2Max(box2d.b2_toiMaxIters, l),
    e = e.GetMilliseconds(),
    box2d.b2_toiMaxTime = box2d.b2Max(box2d.b2_toiMaxTime, e),
    box2d.b2_toiTime += e;
}
,
...
box2d.b2Fixture.prototype.CreateProxies = function(o, t) {
    ...
    for (var e = 0; e < this.m_proxyCount; ++e) {
        ...
        this.m_shape.ComputeAABB(r.aabb, t, e),
        r.proxy = o.CreateProxy(r.aabb, r),
        r.fixture = this,
        r.childIndex = e;
    }
}
...
box2d.b2Fixture.prototype.Synchronize = function(o, t, e) {
    if (0 !== this.m_proxyCount)
        for (var r = 0; r < this.m_proxyCount; ++r) {
            ...
            this.m_shape.ComputeAABB(b, t, r),
            this.m_shape.ComputeAABB(n, e, r),
            i.aabb.Combine2(b, n),
    ...
    if (null !== this.m_body) {
        for (var o = this.m_body.GetContactList(); o; ) {
            var t = o.contact
              , e = t.GetFixtureA()
              , r = t.GetFixtureB();
            e !== this && r !== this || t.FlagForFiltering(),
            o = o.next;
        }
        if (null !== (o = this.m_body.GetWorld()))
            for (o = o.m_contactManager.m_broadPhase,
            t = 0; t < this.m_proxyCount; ++t)
                o.TouchProxy(this.m_proxies[t].proxy);
    }
}
,
...
box2d.b2Body = function(o, t) {
    ...
    o.bullet && (this.m_flag_bulletFlag = !0),
    o.fixedRotation && (this.m_flag_fixedRotationFlag = !0),
    o.allowSleep && (this.m_flag_autoSleepFlag = !0),
    o.awake && (this.m_flag_awakeFlag = !0),
    o.active && (this.m_flag_activeFlag = !0),
    this.m_world = t,
    this.m_xf.p.Copy(o.position),
    this.m_xf.q.SetAngle(o.angle),
...
box2d.b2Body.prototype.CreateFixture = function(o, t) {
    if (o instanceof box2d.b2FixtureDef)
        return this.CreateFixture_Def(o);
    if (o instanceof box2d.b2Shape && "number" == typeof t)
        return this.CreateFixture_Shape_Density(o, t);
    throw Error();
}
,
...
box2d.b2Body.prototype.CreateFixture_Def = function(o) {
    ...
    return t.Create(this, o),
    this.m_flag_activeFlag && t.CreateProxies(this.m_world.m_contactManager.m_broadPhase, this.m_xf),
...
box2d.b2Body.prototype.CreateFixture_Shape_Density = function(o, t) {
    ...
    return e.shape = o,
    e.density = "number" == typeof t ? t : 0,
    this.CreateFixture_Def(e);
}
,
...
box2d.b2Body.prototype.DestroyFixture = function(o) {
    ...
    !this.m_world.IsLocked()) {
        ...
        for (box2d.ENABLE_ASSERTS && box2d.b2Assert(r),
        t = this.m_contactList; t; ) {
            e = t.contact,
            t = t.next,
            r = e.GetFixtureA();
            var i = e.GetFixtureB();
...
box2d.b2Body.prototype.SetTransform = function(o, t, e) {
    if (o instanceof box2d.b2Vec2 && "number" == typeof t)
        this.SetTransform_X_Y_A(o.x, o.y, t);
    else if (o instanceof box2d.b2Transform)
        this.SetTransform_X_Y_A(o.p.x, o.p.y, o.GetAngle());
    else {
        if ("number" != typeof o || "number" != typeof t || "number" != typeof e)
            throw Error();
...
box2d.b2Body.prototype.SetTransform_X_Y_A = function(o, t, e) {
    if (box2d.ENABLE_ASSERTS && box2d.b2Assert(!this.m_world.IsLocked()),
    !this.m_world.IsLocked() && (this.m_xf.p.x !== o || this.m_xf.p.y !== t || this.m_xf.q.GetAngle() !== e))
        ...
        t = this.m_fixtureList; t; t = t.m_next)
            t.Synchronize(o, this.m_xf, this.m_xf);
}
,
...
box2d.b2Body.prototype.GetDefinition = function(o) {
    ...
    o.allowSleep = this.m_flag_autoSleepFlag,
    o.angle = this.GetAngle(),
    o.angularDamping = this.m_angularDamping,
    o.gravityScale = this.m_gravityScale,
    o.angularVelocity = this.m_angularVelocity,
    o.fixedRotation = this.m_flag_fixedRotationFlag,
    o.bullet = this.m_flag_bulletFlag,
    o.awake = this.m_flag_awakeFlag,
...
box2d.b2Body.prototype.ApplyForce = function(o, t, e) {
    ...
    this.m_flag_awakeFlag && (this.m_force.x += o.x,
    this.m_force.y += o.y,
...
box2d.b2Body.prototype.ApplyLinearImpulse = function(o, t, e) {
    ...
    this.m_flag_awakeFlag && (this.m_linearVelocity.x += this.m_invMass * o.x,
...
box2d.b2Body.prototype.GetMassData = function(o) {
    ...
    o.I = this.m_I + this.m_mass * box2d.b2Dot_V2_V2(this.m_sweep.localCenter, this.m_sweep.localCenter),
...
box2d.b2Body.prototype.SetMassData = function(o) {
    if (box2d.ENABLE_ASSERTS && box2d.b2Assert(!this.m_world.IsLocked()),
    !this.m_world.IsLocked() && this.m_type === box2d.b2BodyType.b2_dynamicBody) {
        this.m_invI = this.m_I = this.m_invMass = 0,
        this.m_mass = o.mass,
        0 >= this.m_mass && (this.m_mass = 1),
        this.m_invMass = 1 / this.m_mass,
        0 < o.I && !this.m_flag_fixedRotationFlag && (this.m_I = o.I - this.m_mass * box2d.b2Dot_V2_V2(o.center, o.center),
...
box2d.b2Body.prototype.ResetMassData = function() {
    if (this.m_invI = this.m_I = this.m_invMass = this.m_mass = 0,
    this.m_sweep.localCenter.SetZero(),
    this.m_type === box2d.b2BodyType.b2_staticBody || this.m_type === box2d.b2BodyType.b2_kinematicBody)
        ...
        o.x *= this.m_invMass,
        o.y *= this.m_invMass) : this.m_invMass = this.m_mass = 1,
        ...
        t = box2d.b2Body.prototype.ResetMassData.s_oldCenter.Copy(this.m_sweep.c),
...
box2d.b2Body.prototype.SetType = function(o) {
    if (box2d.ENABLE_ASSERTS && box2d.b2Assert(!this.m_world.IsLocked()),
    !this.m_world.IsLocked() && this.m_type !== o) {
        for (this.m_type = o,
        this.ResetMassData(),
        ...
        for (this.m_contactList = null,
        o = this.m_world.m_contactManager.m_broadPhase,
        t = this.m_fixtureList; t; t = t.m_next)
            for (var e = t.m_proxyCount, r = 0; r < e; ++r)
                o.TouchProxy(t.m_proxies[r].proxy);
    }
}
,
...
box2d.b2Body.prototype.SetSleepingAllowed = function(o) {
    o ? this.m_flag_autoSleepFlag = !0 : (this.m_flag_autoSleepFlag = !1,
    this.SetAwake(!0));
}
,
...
box2d.b2Body.prototype.SetAwake = function(o) {
    o ? this.m_flag_awakeFlag || (this.m_flag_awakeFlag = !0,
    ...
    o !== this.IsActive())
        if (o) {
            ...
            for (var t = this.m_fixtureList; t; t = t.m_next)
                t.CreateProxies(o, this.m_xf);
        } else {
            for (this.m_flag_activeFlag = !1,
            o = this.m_world.m_contactManager.m_broadPhase,
            t = this.m_fixtureList; t; t = t.m_next)
                t.DestroyProxies(o);
            for (o = this.m_contactList; o; )
                t = o,
                o = o.next,
                this.m_world.m_contactManager.Destroy(t.contact);
...
box2d.b2Body.prototype.SetFixedRotation = function(o) {
    this.m_flag_fixedRotationFlag !== o && (this.m_flag_fixedRotationFlag = o,
    this.m_angularVelocity = 0,
    this.ResetMassData());
}
,
...
box2d.b2Body.prototype.SynchronizeFixtures = function() {
    ...
    o.q.SetAngle(this.m_sweep.a0),
    box2d.b2Mul_R_V2(o.q, this.m_sweep.localCenter, o.p),
...
box2d.b2Body.prototype.ShouldCollideConnected = function(o) {
    for (var t = this.m_jointList; t; t = t.next)
        if (t.other === o && !t.joint.m_collideConnected)
            return !1;
    return !0;
}
,
...
box2d.b2TimeStep.prototype.Copy = function(o) {
    ...
    this.particleIterations = o.particleIterations,
...
,
box2d.b2DestructionListener.prototype.SayGoodbyeParticle = function(o, t) {}
,
...
box2d.b2ContactFilter.prototype.ShouldCollide = function(o, t) {
    ...
    r = t.GetFilterData(),
    e.groupIndex === r.groupIndex && 0 !== e.groupIndex ? 0 < e.groupIndex : 0 != (e.maskBits & r.categoryBits) && 0 != (e.categoryBits & r.maskBits));
}
,
...
box2d.b2Contact.prototype.Update = function(o) {
    ...
    this.m_flag_enabledFlag = !0;
    var e = !1
      , r = (t = this.m_flag_touchingFlag,
    this.m_fixtureA.IsSensor())
      , i = this.m_fixtureB.IsSensor()
      , b = (r = r || i,
    i = this.m_fixtureA.GetBody(),
    ...
    if (r)
        ...
        e = box2d.b2TestOverlap_Shape(i, this.m_indexA, b, this.m_indexB, e, n),
        this.m_manifold.pointCount = 0;
    else {
        for (this.Evaluate(this.m_manifold, e, n),
        e = 0 < this.m_manifold.pointCount,
        n = 0; n < this.m_manifold.pointCount; ++n) {
    ...
    this.m_flag_touchingFlag = e,
    !t && e && o && o.BeginContact(this),
    t && !e && o && o.EndContact(this),
    !r && e && o && o.PreSolve(this, this.m_oldManifold);
}
,
...
box2d.b2Contact.prototype.ComputeTOI = function(o, t) {
    ...
    return box2d.b2TimeOfImpact(r, e),
    r.t;
}
,
...
box2d.b2ChainAndCircleContact.prototype.Evaluate = function(o, t, e) {
    var r = this.m_fixtureA.GetShape()
      , i = this.m_fixtureB.GetShape();
    box2d.ENABLE_ASSERTS && box2d.b2Assert(r instanceof box2d.b2ChainShape),
    ...
    (r instanceof box2d.b2ChainShape ? r : null).GetChildEdge(b, this.m_indexA),
    box2d.b2CollideEdgeAndCircle(o, b, t, i instanceof box2d.b2CircleShape ? i : null, e);
}
,
...
box2d.b2ChainAndPolygonContact.prototype.Evaluate = function(o, t, e) {
    ...
    (r instanceof box2d.b2ChainShape ? r : null).GetChildEdge(b, this.m_indexA),
    box2d.b2CollideEdgeAndPolygon(o, b, t, i instanceof box2d.b2PolygonShape ? i : null, e);
}
,
...
box2d.b2CircleContact.prototype.Evaluate = function(o, t, e) {
    var r = this.m_fixtureA.GetShape()
      , i = this.m_fixtureB.GetShape();
    box2d.ENABLE_ASSERTS && box2d.b2Assert(r instanceof box2d.b2CircleShape),
    box2d.ENABLE_ASSERTS && box2d.b2Assert(i instanceof box2d.b2CircleShape),
...
box2d.b2ContactFactory.prototype.AddType = function(o, t, e, r) {
    ...
    this.m_registers[e][r].pool = i,
    this.m_registers[e][r].createFcn = t,
    this.m_registers[e][r].destroyFcn = b,
    this.m_registers[e][r].primary = !0,
    e !== r && (this.m_registers[r][e].pool = i,
    this.m_registers[r][e].createFcn = t,
    this.m_registers[r][e].destroyFcn = b,
    this.m_registers[r][e].primary = !1);
}
,
...
box2d.b2ContactManager.prototype.Destroy = function(o) {
    ...
    o.m_nodeA === t.m_contactList && (t.m_contactList = o.m_nodeA.next),
    o.m_nodeB.prev && (o.m_nodeB.prev.next = o.m_nodeB.next),
    o.m_nodeB.next && (o.m_nodeB.next.prev = o.m_nodeB.prev),
    o.m_nodeB === e.m_contactList && (e.m_contactList = o.m_nodeB.next),
...
box2d.b2ContactManager.prototype.Collide = function() {
    for (var o = this.m_contactList; o; ) {
        ...
        b = b.IsAwake() && b.m_type !== box2d.b2BodyType.b2_staticBody,
        n = n.IsAwake() && n.m_type !== box2d.b2BodyType.b2_staticBody,
        b || n ? this.m_broadPhase.TestOverlap(t.m_proxies[r].proxy, e.m_proxies[i].proxy) ? (o.Update(this.m_contactListener),
        o = o.m_next) : (o = (t = o).m_next,
        this.Destroy(t)) : o = o.m_next;
    }
}
,
    ...
    if (n !== p) {
        for (var s = p.GetContactList(); s; ) {
            if (s.other === n) {
                ...
                if (a === e && d === r && l === i && x === b || a === r && d === e && l === b && x === i)
                    return;
            }
            s = s.next;
        }
        ...
        p = r.m_body,
        i.m_prev = null,
        i.m_next = this.m_contactList,
        null !== this.m_contactList && (this.m_contactList.m_prev = i),
        this.m_contactList = i,
        i.m_nodeA.contact = i,
        i.m_nodeA.other = p,
        i.m_nodeA.prev = null,
        i.m_nodeA.next = n.m_contactList,
        null !== n.m_contactList && (n.m_contactList.prev = i.m_nodeA),
        n.m_contactList = i.m_nodeA,
        i.m_nodeB.contact = i,
        i.m_nodeB.other = n,
        i.m_nodeB.prev = null,
        i.m_nodeB.next = p.m_contactList,
        null !== p.m_contactList && (p.m_contactList.prev = i.m_nodeB),
        p.m_contactList = i.m_nodeB,
        e.IsSensor() || r.IsSensor() || (n.SetAwake(!0),
        p.SetAwake(!0)),
        ++this.m_contactCount);
    }
}
...
box2d.b2EdgeAndCircleContact.prototype.Evaluate = function(o, t, e) {
    var r = this.m_fixtureA.GetShape()
      , i = this.m_fixtureB.GetShape();
    box2d.ENABLE_ASSERTS && box2d.b2Assert(r instanceof box2d.b2EdgeShape),
    box2d.ENABLE_ASSERTS && box2d.b2Assert(i instanceof box2d.b2CircleShape),
...
box2d.b2PolygonAndCircleContact.prototype.Evaluate = function(o, t, e) {
    var r = this.m_fixtureA.GetShape()
      , i = this.m_fixtureB.GetShape();
    box2d.ENABLE_ASSERTS && box2d.b2Assert(r instanceof box2d.b2PolygonShape),
    box2d.ENABLE_ASSERTS && box2d.b2Assert(i instanceof box2d.b2CircleShape),
...
box2d.b2ContactSolver.prototype.Initialize = function(o) {
    ...
    if (this.m_velocityConstraints.length < this.m_count)
        ...
        box2d.DEBUG && window.console.log("box2d.b2ContactSolver.m_velocityConstraints: " + t); this.m_velocityConstraints.length < t; )
    ...
    t = this.m_count; o < t; ++o)
        ...
        p = b.GetBody(),
        s = n.GetBody(),
        a = (n = i.GetManifold()).pointCount,
        box2d.ENABLE_ASSERTS && box2d.b2Assert(0 < a),
        (b = this.m_velocityConstraints[o]).friction = i.m_friction,
        b.restitution = i.m_restitution,
        b.tangentSpeed = i.m_tangentSpeed,
        b.indexA = p.m_islandIndex,
        b.indexB = s.m_islandIndex,
        b.invMassA = p.m_invMass,
        b.invMassB = s.m_invMass,
        b.invIA = p.m_invI,
        b.invIB = s.m_invI,
        b.contactIndex = o,
        b.pointCount = a,
        b.K.SetZero(),
        b.normalMass.SetZero(),
        (i = this.m_positionConstraints[o]).indexA = p.m_islandIndex,
        i.indexB = s.m_islandIndex,
        i.invMassA = p.m_invMass,
        i.invMassB = s.m_invMass,
        i.localCenterA.Copy(p.m_sweep.localCenter),
        i.localCenterB.Copy(s.m_sweep.localCenter),
        i.invIA = p.m_invI,
        i.invIB = s.m_invI,
        i.localNormal.Copy(n.localNormal),
        i.localPoint.Copy(n.localPoint),
        i.pointCount = a,
        i.radiusA = e,
        i.radiusB = r,
        i.type = n.type,
        ...
        r = a; e < r; ++e)
            p = n.points[e],
            a = b.points[e],
            this.m_step.warmStarting ? (a.normalImpulse = this.m_step.dtRatio * p.normalImpulse,
            ...
            a.tangentMass = 0,
            a.velocityBias = 0,
            i.localPoints[e].Copy(p.localPoint);
    return this;
}
,
...
box2d.b2ContactSolver.prototype.InitializeVelocityConstraints = function() {
    var o, t, e, r, i, b, n, p, s, a, d, l, x, y, c, _, m, u, h, g, f = box2d.b2ContactSolver.prototype.InitializeVelocityConstraints.s_xfA, S = box2d.b2ContactSolver.prototype.InitializeVelocityConstraints.s_xfB, P = box2d.b2ContactSolver.prototype.InitializeVelocityConstraints.s_worldManifold;
    for (o = 0,
    t = this.m_count; o < t; ++o) {
        for (i = this.m_velocityConstraints[o],
        e = (b = this.m_positionConstraints[o]).radiusA,
        r = b.radiusB,
        n = this.m_contacts[i.contactIndex].GetManifold(),
        p = i.indexA,
        s = i.indexB,
        a = i.invMassA,
        d = i.invMassB,
        ...
        y = b.localCenterA,
        c = b.localCenterB,
        b = this.m_positions[p].c,
        _ = this.m_positions[p].a,
        m = this.m_velocities[p].v,
        p = this.m_velocities[p].w,
        u = this.m_positions[s].c,
        h = this.m_positions[s].a,
        g = this.m_velocities[s].v,
        s = this.m_velocities[s].w,
        box2d.ENABLE_ASSERTS && box2d.b2Assert(0 < n.pointCount),
        f.q.SetAngle(_),
        S.q.SetAngle(h),
        box2d.b2Sub_V2_V2(b, box2d.b2Mul_R_V2(f.q, y, box2d.b2Vec2.s_t0), f.p),
        box2d.b2Sub_V2_V2(u, box2d.b2Mul_R_V2(S.q, c, box2d.b2Vec2.s_t0), S.p),
        P.Initialize(n, f, e, S, r),
        i.normal.Copy(P.normal),
        box2d.b2Cross_V2_S(i.normal, 1, i.tangent),
        r = i.pointCount,
        e = 0; e < r; ++e)
            n = i.points[e],
            box2d.b2Sub_V2_V2(P.points[e], b, n.rA),
            box2d.b2Sub_V2_V2(P.points[e], u, n.rB),
            y = a + d + l * (y = box2d.b2Cross_V2_V2(n.rA, i.normal)) * y + x * (c = box2d.b2Cross_V2_V2(n.rB, i.normal)) * c,
            n.normalMass = 0 < y ? 1 / y : 0,
            c = i.tangent,
            y = a + d + l * (y = box2d.b2Cross_V2_V2(n.rA, c)) * y + x * (c = box2d.b2Cross_V2_V2(n.rB, c)) * c,
            n.tangentMass = 0 < y ? 1 / y : 0,
            n.velocityBias = 0,
            (y = box2d.b2Dot_V2_V2(i.normal, box2d.b2Sub_V2_V2(box2d.b2AddCross_V2_S_V2(g, s, n.rB, box2d.b2Vec2.s_t0), box2d.b2AddCross_V2_S_V2(m, p, n.rA, box2d.b2Vec2.s_t1), box2d.b2Vec2.s_t0))) < -box2d.b2_velocityThreshold && (n.velocityBias += -i.restitution * y);
        2 === i.pointCount && box2d.g_blockSolve && (m = i.points[0],
        u = i.points[1],
        b = box2d.b2Cross_V2_V2(m.rA, i.normal),
        m = box2d.b2Cross_V2_V2(m.rB, i.normal),
        p = box2d.b2Cross_V2_V2(u.rA, i.normal),
        s = box2d.b2Cross_V2_V2(u.rB, i.normal),
        (u = a + d + l * b * b + x * m * m) * u < 1e3 * (u * (g = a + d + l * p * p + x * s * s) - (a = a + d + l * b * p + x * m * s) * a) ? (i.K.ex.Set(u, a),
        i.K.ey.Set(a, g),
...
box2d.b2ContactSolver.prototype.WarmStart = function() {
    ...
    for (o = 0,
    t = this.m_count; o < t; ++o) {
        for (b = (i = this.m_velocityConstraints[o]).indexA,
        n = i.indexB,
        p = i.invMassA,
        s = i.invIA,
        a = i.invMassB,
        d = i.invIB,
        r = i.pointCount,
        l = this.m_velocities[b].v,
        x = this.m_velocities[b].w,
        y = this.m_velocities[n].v,
        c = this.m_velocities[n].w,
        _ = i.normal,
        m = i.tangent,
        e = 0; e < r; ++e)
            u = i.points[e],
            box2d.b2Add_V2_V2(box2d.b2Mul_S_V2(u.normalImpulse, _, box2d.b2Vec2.s_t0), box2d.b2Mul_S_V2(u.tangentImpulse, m, box2d.b2Vec2.s_t1), h),
            x -= s * box2d.b2Cross_V2_V2(u.rA, h),
            l.SelfMulSub(p, h),
            c += d * box2d.b2Cross_V2_V2(u.rB, h),
            y.SelfMulAdd(a, h);
        this.m_velocities[b].w = x,
...
box2d.b2ContactSolver.prototype.SolveVelocityConstraints = function() {
    var o, t, e, r, i, b, n, p, s, a, d, l, x, y, c, _, m, u, h, g, f, S, P = box2d.b2ContactSolver.prototype.SolveVelocityConstraints.s_dv, C = box2d.b2ContactSolver.prototype.SolveVelocityConstraints.s_dv1, A = box2d.b2ContactSolver.prototype.SolveVelocityConstraints.s_dv2, B = box2d.b2ContactSolver.prototype.SolveVelocityConstraints.s_P, v = box2d.b2ContactSolver.prototype.SolveVelocityConstraints.s_a, V = box2d.b2ContactSolver.prototype.SolveVelocityConstraints.s_b, J = box2d.b2ContactSolver.prototype.SolveVelocityConstraints.s_x, M = box2d.b2ContactSolver.prototype.SolveVelocityConstraints.s_d, D = box2d.b2ContactSolver.prototype.SolveVelocityConstraints.s_P1, w = box2d.b2ContactSolver.prototype.SolveVelocityConstraints.s_P2, G = box2d.b2ContactSolver.prototype.SolveVelocityConstraints.s_P1P2;
    for (o = 0,
    t = this.m_count; o < t; ++o) {
        for (b = (i = this.m_velocityConstraints[o]).indexA,
        n = i.indexB,
        ...
        d = i.invIB,
        l = i.pointCount,
        x = this.m_velocities[b].v,
        y = this.m_velocities[b].w,
        c = this.m_velocities[n].v,
        _ = this.m_velocities[n].w,
        m = i.normal,
        u = i.tangent,
        h = i.friction,
        ...
        r = l; e < r; ++e)
            g = i.points[e],
            box2d.b2Sub_V2_V2(box2d.b2AddCross_V2_S_V2(c, _, g.rB, box2d.b2Vec2.s_t0), box2d.b2AddCross_V2_S_V2(x, y, g.rA, box2d.b2Vec2.s_t1), P),
            f = box2d.b2Dot_V2_V2(P, u) - i.tangentSpeed,
            f = g.tangentMass * -f,
            S = h * g.normalImpulse,
            f = (S = box2d.b2Clamp(g.tangentImpulse + f, -S, S)) - g.tangentImpulse,
            g.tangentImpulse = S,
            box2d.b2Mul_S_V2(f, u, B),
            x.SelfMulSub(p, B),
            y -= s * box2d.b2Cross_V2_V2(g.rA, B),
            c.SelfMulAdd(a, B),
            _ += d * box2d.b2Cross_V2_V2(g.rB, B);
        if (1 !== i.pointCount && box2d.g_blockSolve)
            for (l = i.points[0],
            g = i.points[1],
            v.Set(l.normalImpulse, g.normalImpulse),
            box2d.ENABLE_ASSERTS && box2d.b2Assert(0 <= v.x && 0 <= v.y),
            ...
            e = box2d.b2Dot_V2_V2(C, m),
            r = box2d.b2Dot_V2_V2(A, m),
            V.x = e - l.velocityBias,
            V.y = r - g.velocityBias,
            V.SelfSub(box2d.b2Mul_M22_V2(i.K, v, box2d.b2Vec2.s_t0)); ; ) {
                if (box2d.b2Mul_M22_V2(i.normalMass, V, J).SelfNeg(),
                0 <= J.x && 0 <= J.y) {
                    box2d.b2Sub_V2_V2(J, v, M),
                    box2d.b2Mul_S_V2(M.x, m, D),
                    box2d.b2Mul_S_V2(M.y, m, w),
                    box2d.b2Add_V2_V2(D, w, G),
                    x.SelfMulSub(p, G),
                    y -= s * (box2d.b2Cross_V2_V2(l.rA, D) + box2d.b2Cross_V2_V2(g.rA, w)),
                    c.SelfMulAdd(a, G),
                    _ += d * (box2d.b2Cross_V2_V2(l.rB, D) + box2d.b2Cross_V2_V2(g.rB, w)),
                    l.normalImpulse = J.x,
                    g.normalImpulse = J.y;
                    break;
                }
                if (J.x = -l.normalMass * V.x,
                J.y = 0,
                r = i.K.ex.y * J.x + V.y,
                0 <= J.x && 0 <= r) {
                    box2d.b2Sub_V2_V2(J, v, M),
            ...
            for (e = 0; e < l; ++e)
                g = i.points[e],
                box2d.b2Sub_V2_V2(box2d.b2AddCross_V2_S_V2(c, _, g.rB, box2d.b2Vec2.s_t0), box2d.b2AddCross_V2_S_V2(x, y, g.rA, box2d.b2Vec2.s_t1), P),
                r = box2d.b2Dot_V2_V2(P, m),
                f = -g.normalMass * (r - g.velocityBias),
                f = (S = box2d.b2Max(g.normalImpulse + f, 0)) - g.normalImpulse,
                g.normalImpulse = S,
                box2d.b2Mul_S_V2(f, m, B),
                x.SelfMulSub(p, B),
                y -= s * box2d.b2Cross_V2_V2(g.rA, B),
                c.SelfMulAdd(a, B),
                _ += d * box2d.b2Cross_V2_V2(g.rB, B);
        this.m_velocities[b].w = y,
...
box2d.b2ContactSolver.prototype.StoreImpulses = function() {
    ...
    t = this.m_count; o < t; ++o)
        for (i = this.m_velocityConstraints[o],
        b = this.m_contacts[i.contactIndex].GetManifold(),
        e = 0,
        r = i.pointCount; e < r; ++e)
            b.points[e].normalImpulse = i.points[e].normalImpulse,
...
box2d.b2PositionSolverManifold.prototype.Initialize = function(o, t, e, r) {
    ...
    o.type) {
    case box2d.b2ManifoldType.e_circles:
        box2d.b2Mul_X_V2(t, o.localPoint, i),
        box2d.b2Mul_X_V2(e, o.localPoints[0], b),
        box2d.b2Sub_V2_V2(b, i, this.normal).SelfNormalize(),
        box2d.b2Mid_V2_V2(i, b, this.point),
        this.separation = box2d.b2Dot_V2_V2(box2d.b2Sub_V2_V2(b, i, box2d.b2Vec2.s_t0), this.normal) - o.radiusA - o.radiusB;
        break;
    case box2d.b2ManifoldType.e_faceA:
        box2d.b2Mul_R_V2(t.q, o.localNormal, this.normal),
        box2d.b2Mul_X_V2(t, o.localPoint, n),
        box2d.b2Mul_X_V2(e, o.localPoints[r], p),
        this.separation = box2d.b2Dot_V2_V2(box2d.b2Sub_V2_V2(p, n, box2d.b2Vec2.s_t0), this.normal) - o.radiusA - o.radiusB,
        this.point.Copy(p);
        break;
    case box2d.b2ManifoldType.e_faceB:
        box2d.b2Mul_R_V2(e.q, o.localNormal, this.normal),
        box2d.b2Mul_X_V2(e, o.localPoint, n),
        box2d.b2Mul_X_V2(t, o.localPoints[r], p),
        this.separation = box2d.b2Dot_V2_V2(box2d.b2Sub_V2_V2(p, n, box2d.b2Vec2.s_t0), this.normal) - o.radiusA - o.radiusB,
        this.point.Copy(p),
        this.normal.SelfNeg();
    }
...
box2d.b2ContactSolver.prototype.SolvePositionConstraints = function() {
    var o, t, e, r, i, b, n, p, s, a, d, l, x, y, c, _, m, u, h, g, f, S = box2d.b2ContactSolver.prototype.SolvePositionConstraints.s_xfA, P = box2d.b2ContactSolver.prototype.SolvePositionConstraints.s_xfB, C = box2d.b2ContactSolver.prototype.SolvePositionConstraints.s_psm, A = box2d.b2ContactSolver.prototype.SolvePositionConstraints.s_rA, B = box2d.b2ContactSolver.prototype.SolvePositionConstraints.s_rB, v = box2d.b2ContactSolver.prototype.SolvePositionConstraints.s_P, V = 0;
    for (o = 0,
    t = this.m_count; o < t; ++o) {
        for (b = (i = this.m_positionConstraints[o]).indexA,
        n = i.indexB,
        p = i.localCenterA,
        s = i.invMassA,
        a = i.invIA,
        ...
        x = i.invIB,
        r = i.pointCount,
        y = this.m_positions[b].c,
        c = this.m_positions[b].a,
        _ = this.m_positions[n].c,
        m = this.m_positions[n].a,
        e = 0; e < r; ++e)
            S.q.SetAngle(c),
            P.q.SetAngle(m),
            box2d.b2Sub_V2_V2(y, box2d.b2Mul_R_V2(S.q, p, box2d.b2Vec2.s_t0), S.p),
            box2d.b2Sub_V2_V2(_, box2d.b2Mul_R_V2(P.q, d, box2d.b2Vec2.s_t0), P.p),
            C.Initialize(i, S, P, e),
            u = C.normal,
            h = C.point,
            g = C.separation,
            box2d.b2Sub_V2_V2(h, y, A),
            box2d.b2Sub_V2_V2(h, _, B),
            V = box2d.b2Min(V, g),
            h = box2d.b2Clamp(box2d.b2_baumgarte * (g + box2d.b2_linearSlop), -box2d.b2_maxLinearCorrection, 0),
            h = 0 < (g = s + l + a * (g = box2d.b2Cross_V2_V2(A, u)) * g + x * (f = box2d.b2Cross_V2_V2(B, u)) * f) ? -h / g : 0,
            box2d.b2Mul_S_V2(h, u, v),
            y.SelfMulSub(s, v),
            c -= a * box2d.b2Cross_V2_V2(A, v),
            _.SelfMulAdd(l, v),
            m += x * box2d.b2Cross_V2_V2(B, v);
        this.m_positions[b].a = c,
        this.m_positions[n].a = m;
    }
...
box2d.b2ContactSolver.prototype.SolveTOIPositionConstraints = function(o, t) {
    ...
    r = this.m_count; e < r; ++e) {
        ...
        i = 0; i < b; ++i)
            C.q.SetAngle(m),
            A.q.SetAngle(h),
            box2d.b2Sub_V2_V2(_, box2d.b2Mul_R_V2(C.q, a, box2d.b2Vec2.s_t0), C.p),
            box2d.b2Sub_V2_V2(u, box2d.b2Mul_R_V2(A.q, d, box2d.b2Vec2.s_t0), A.p),
            B.Initialize(n, C, A, i),
            g = B.normal,
            f = B.point,
            S = B.separation,
            box2d.b2Sub_V2_V2(f, _, v),
            box2d.b2Sub_V2_V2(f, u, V),
            M = box2d.b2Min(M, S),
            f = box2d.b2Clamp(box2d.b2_toiBaumgarte * (S + box2d.b2_linearSlop), -box2d.b2_maxLinearCorrection, 0),
            f = 0 < (S = l + y + x * (S = box2d.b2Cross_V2_V2(v, g)) * S + c * (P = box2d.b2Cross_V2_V2(V, g)) * P) ? -f / S : 0,
            box2d.b2Mul_S_V2(f, g, J),
            _.SelfMulSub(l, J),
            m -= x * box2d.b2Cross_V2_V2(v, J),
            u.SelfMulAdd(y, J),
            h += c * box2d.b2Cross_V2_V2(V, J);
        this.m_positions[p].a = m,
        this.m_positions[s].a = h;
    }
...
box2d.b2Island.prototype.Initialize = function(o, t, e, r, i) {
    ...
    this.m_allocator = r,
    this.m_listener = i; this.m_bodies.length < o; )
    ...
    if (this.m_positions.length < o)
        ...
        box2d.DEBUG && window.console.log("box2d.b2Island.m_positions: " + t); this.m_positions.length < t; )
    ...
    if (this.m_velocities.length < o)
        ...
        box2d.DEBUG && window.console.log("box2d.b2Island.m_velocities: " + t); this.m_velocities.length < t; )
...
box2d.b2Island.prototype.Solve = function(o, t, e, r) {
    for (var i = box2d.b2Island.s_timer.Reset(), b = t.dt, n = 0; n < this.m_bodyCount; ++n) {
        ...
        p.m_sweep.c0.Copy(p.m_sweep.c),
        p.m_sweep.a0 = p.m_sweep.a,
        p.m_type === box2d.b2BodyType.b2_dynamicBody && (d.x += b * (p.m_gravityScale * e.x + p.m_invMass * p.m_force.x),
        d.y += b * (p.m_gravityScale * e.y + p.m_invMass * p.m_force.y),
        l += b * p.m_invI * p.m_torque,
        d.SelfMul(1 / (1 + b * p.m_linearDamping)),
        l *= 1 / (1 + b * p.m_angularDamping)),
        this.m_positions[n].a = a,
        this.m_velocities[n].w = l;
    }
    for (i.Reset(),
    (p = box2d.b2Island.s_solverData).step.Copy(t),
    p.positions = this.m_positions,
    p.velocities = this.m_velocities,
    (n = box2d.b2Island.s_contactSolverDef).step.Copy(t),
    ...
    (e = box2d.b2Island.s_contactSolver.Initialize(n)).InitializeVelocityConstraints(),
    t.warmStarting && e.WarmStart(),
    n = 0; n < this.m_jointCount; ++n)
        this.m_joints[n].InitVelocityConstraints(p);
    for (o.solveInit = i.GetMilliseconds(),
    i.Reset(),
    n = 0; n < t.velocityIterations; ++n) {
        for (a = 0; a < this.m_jointCount; ++a)
            this.m_joints[a].SolveVelocityConstraints(p);
        e.SolveVelocityConstraints();
    }
    for (e.StoreImpulses(),
    o.solveVelocity = i.GetMilliseconds(),
    n = 0; n < this.m_bodyCount; ++n) {
        s = this.m_positions[n].c,
        a = this.m_positions[n].a,
        d = this.m_velocities[n].v,
        ...
        d.SelfMul(x)),
        (x = b * l) * x > box2d.b2_maxRotationSquared && (l *= x = box2d.b2_maxRotation / box2d.b2Abs(x)),
        s.x += b * d.x,
        s.y += b * d.y,
        a += b * l,
        this.m_positions[n].a = a,
    ...
    for (i.Reset(),
    s = !1,
    n = 0; n < t.positionIterations; ++n) {
        for (d = e.SolvePositionConstraints(),
        l = !0,
        a = 0; a < this.m_jointCount; ++a)
            x = this.m_joints[a].SolvePositionConstraints(p),
            l = l && x;
        if (d && l) {
            s = !0;
            break;
    ...
    for (n = 0; n < this.m_bodyCount; ++n)
        (t = this.m_bodies[n]).m_sweep.c.Copy(this.m_positions[n].c),
        t.m_sweep.a = this.m_positions[n].a,
        t.m_linearVelocity.Copy(this.m_velocities[n].v),
        t.m_angularVelocity = this.m_velocities[n].w,
        t.SynchronizeTransform();
    if (o.solvePosition = i.GetMilliseconds(),
    this.Report(e.m_velocityConstraints),
    r) {
        for (o = box2d.b2_maxFloat,
        r = box2d.b2_linearSleepTolerance * box2d.b2_linearSleepTolerance,
        i = box2d.b2_angularSleepTolerance * box2d.b2_angularSleepTolerance,
        n = 0; n < this.m_bodyCount; ++n)
            (p = this.m_bodies[n]).GetType() !== box2d.b2BodyType.b2_staticBody && (!p.m_flag_autoSleepFlag || p.m_angularVelocity * p.m_angularVelocity > i || box2d.b2Dot_V2_V2(p.m_linearVelocity, p.m_linearVelocity) > r ? o = p.m_sleepTime = 0 : (p.m_sleepTime += b,
            o = box2d.b2Min(o, p.m_sleepTime)));
        if (o >= box2d.b2_timeToSleep && s)
            for (n = 0; n < this.m_bodyCount; ++n)
                (p = this.m_bodies[n]).SetAwake(!1);
    }
}
,
...
box2d.b2Island.prototype.SolveTOI = function(o, t, e) {
    ...
    for (var r = 0; r < this.m_bodyCount; ++r) {
        ...
        this.m_positions[r].c.Copy(i.m_sweep.c),
        this.m_positions[r].a = i.m_sweep.a,
        this.m_velocities[r].v.Copy(i.m_linearVelocity),
        this.m_velocities[r].w = i.m_angularVelocity;
    }
    for ((r = box2d.b2Island.s_contactSolverDef).contacts = this.m_contacts,
    r.count = this.m_contactCount,
    r.allocator = this.m_allocator,
    r.step.Copy(o),
    r.positions = this.m_positions,
    r.velocities = this.m_velocities,
    i = box2d.b2Island.s_contactSolver.Initialize(r),
    r = 0; r < o.positionIterations && !i.SolveTOIPositionConstraints(t, e); ++r)
        ;
    for (this.m_bodies[t].m_sweep.c0.Copy(this.m_positions[t].c),
    ...
    i.InitializeVelocityConstraints(),
    r = 0; r < o.velocityIterations; ++r)
        i.SolveVelocityConstraints();
    for (o = o.dt,
    r = 0; r < this.m_bodyCount; ++r) {
        t = this.m_positions[r].c,
        e = this.m_positions[r].a;
        ...
        b.SelfMul(p)),
        (p = o * n) * p > box2d.b2_maxRotationSquared && (n *= p = box2d.b2_maxRotation / box2d.b2Abs(p)),
        t.SelfMulAdd(o, b),
        e += o * n,
        this.m_positions[r].a = e,
        this.m_velocities[r].w = n,
        (p = this.m_bodies[r]).m_sweep.c.Copy(t),
        p.m_sweep.a = e,
        p.m_linearVelocity.Copy(b),
    ...
    if (null !== this.m_listener)
        for (var t = 0; t < this.m_contactCount; ++t) {
            ...
            if (e) {
                ...
                for (var b = 0; b < r.pointCount; ++b)
                    i.normalImpulses[b] = r.points[b].normalImpulse,
...
box2d.b2AreaJoint = function(o) {
    ...
    for (var e = this.m_targetArea = 0, r = this.m_bodies.length; e < r; ++e) {
        var i = this.m_bodies[e]
          ...
          , n = i.GetWorldCenter()
          , p = b.GetWorldCenter();
        this.m_targetLengths[e] = box2d.b2Distance(n, p),
        this.m_targetArea += box2d.b2Cross_V2_V2(n, p),
        t.Initialize(i, b, n, p),
...
box2d.b2AreaJoint.prototype.InitVelocityConstraints = function(o) {
    ...
    if (o.step.warmStarting)
        for (this.m_impulse *= o.step.dtRatio,
        t = 0,
        e = this.m_bodies.length; t < e; ++t) {
            var i = this.m_bodies[t]
              , b = o.velocities[i.m_islandIndex].v;
            r = this.m_deltas[t];
            b.x += i.m_invMass * r.y * .5 * this.m_impulse,
            b.y += i.m_invMass * -r.x * .5 * this.m_impulse;
        }
    else
        this.m_impulse = 0;
}
...
box2d.b2AreaJoint.prototype.SolveVelocityConstraints = function(o) {
    for (var t = 0, e = 0, r = 0, i = this.m_bodies.length; r < i; ++r) {
        var b = this.m_bodies[r]
          ...
          , p = this.m_deltas[r];
        t = t + p.LengthSquared() / b.GetMass(),
        e = e + box2d.b2Cross_V2_V2(n, p);
    }
    for (t = -2 * e / t,
    this.m_impulse += t,
    r = 0,
    i = this.m_bodies.length; r < i; ++r)
        b = this.m_bodies[r],
        n = o.velocities[b.m_islandIndex].v,
        p = this.m_deltas[r],
        n.x += b.m_invMass * p.y * .5 * t,
...
box2d.b2AreaJoint.prototype.SolvePositionConstraints = function(o) {
    for (var t = 0, e = 0, r = 0, i = this.m_bodies.length; r < i; ++r) {
        var b = this.m_bodies[r]
          , n = (b = o.positions[b.m_islandIndex].c,
        o.positions[this.m_bodies[(r + 1) % i].m_islandIndex].c)
          , p = box2d.b2Sub_V2_V2(n, b, this.m_delta)
          , s = p.Length();
        s < box2d.b2_epsilon && (s = 1),
        this.m_normals[r].x = p.y / s,
        this.m_normals[r].y = -p.x / s,
        t += s,
        e += box2d.b2Cross_V2_V2(b, n);
    }
    for (t = .5 * (this.m_targetArea - .5 * e) / t,
    e = !0,
    r = 0,
    i = this.m_bodies.length; r < i; ++r)
        b = this.m_bodies[r],
        b = o.positions[b.m_islandIndex].c,
        (p = box2d.b2Add_V2_V2(this.m_normals[r], this.m_normals[(r + 1) % i], this.m_delta)).SelfMul(t),
        (n = p.LengthSquared()) > box2d.b2Sq(box2d.b2_maxLinearCorrection) && p.SelfMul(box2d.b2_maxLinearCorrection / box2d.b2Sqrt(n)),
        n > box2d.b2Sq(box2d.b2_linearSlop) && (e = !1),
        b.x += p.x,
        b.y += p.y;
    return e;
}
...
box2d.b2DistanceJointDef.prototype.Initialize = function(o, t, e, r) {
    ...
    this.length = box2d.b2Distance(e, r),
...
box2d.b2DistanceJoint.prototype.InitVelocityConstraints = function(o) {
    ...
    if (box2d.b2Sub_V2_V2(this.m_localAnchorA, this.m_localCenterA, this.m_lalcA),
    box2d.b2Mul_R_V2(s, this.m_lalcA, this.m_rA),
    box2d.b2Sub_V2_V2(this.m_localAnchorB, this.m_localCenterB, this.m_lalcB),
    box2d.b2Mul_R_V2(b, this.m_lalcB, this.m_rB),
    this.m_u.x = i.x + this.m_rB.x - t.x - this.m_rA.x,
    this.m_u.y = i.y + this.m_rB.y - t.y - this.m_rA.y,
    (i = this.m_u.Length()) > box2d.b2_linearSlop ? this.m_u.SelfMul(1 / i) : this.m_u.SetZero(),
    t = box2d.b2Cross_V2_V2(this.m_rA, this.m_u),
    s = box2d.b2Cross_V2_V2(this.m_rB, this.m_u),
    t = this.m_invMassA + this.m_invIA * t * t + this.m_invMassB + this.m_invIB * s * s,
    this.m_mass = 0 !== t ? 1 / t : 0,
    0 < this.m_frequencyHz) {
        i = i - this.m_length,
        s = 2 * box2d.b2_pi * this.m_frequencyHz,
        b = this.m_mass * s * s;
        var a = o.step.dt;
        this.m_gamma = a * (2 * this.m_mass * this.m_dampingRatio * s + a * b),
        this.m_gamma = 0 !== this.m_gamma ? 1 / this.m_gamma : 0,
        this.m_bias = i * a * b * this.m_gamma,
        t += this.m_gamma,
        this.m_mass = 0 !== t ? 1 / t : 0;
    } else
        this.m_bias = this.m_gamma = 0;
    o.step.warmStarting ? (this.m_impulse *= o.step.dtRatio,
    t = box2d.b2Mul_S_V2(this.m_impulse, this.m_u, box2d.b2DistanceJoint.prototype.InitVelocityConstraints.s_P),
    e.SelfMulSub(this.m_invMassA, t),
    r -= this.m_invIA * box2d.b2Cross_V2_V2(this.m_rA, t),
    n.SelfMulAdd(this.m_invMassB, t),
    p += this.m_invIB * box2d.b2Cross_V2_V2(this.m_rB, t)) : this.m_impulse = 0,
...
box2d.b2DistanceJoint.prototype.SolveVelocityConstraints = function(o) {
    ...
    b = -this.m_mass * (b + this.m_bias + this.m_gamma * this.m_impulse);
    this.m_impulse += b,
    b = box2d.b2Mul_S_V2(b, this.m_u, box2d.b2DistanceJoint.prototype.SolveVelocityConstraints.s_P),
    t.SelfMulSub(this.m_invMassA, b),
    e -= this.m_invIA * box2d.b2Cross_V2_V2(this.m_rA, b),
    r.SelfMulAdd(this.m_invMassB, b),
    i += this.m_invIB * box2d.b2Cross_V2_V2(this.m_rB, b),
...
box2d.b2DistanceJoint.prototype.SolvePositionConstraints = function(o) {
    ...
    return t.SelfMulSub(this.m_invMassA, s),
    e -= this.m_invIA * box2d.b2Cross_V2_V2(b, s),
    r.SelfMulAdd(this.m_invMassB, s),
    i += this.m_invIB * box2d.b2Cross_V2_V2(n, s),
    o.positions[this.m_indexA].a = e,
    o.positions[this.m_indexB].a = i,
    box2d.b2Abs(p) < box2d.b2_linearSlop;
}
,
...
box2d.b2FrictionJoint.prototype.InitVelocityConstraints = function(o) {
    ...
    n = box2d.b2Mul_R_V2(n, this.m_lalcA, this.m_rA),
    box2d.b2Sub_V2_V2(this.m_localAnchorB, this.m_localCenterB, this.m_lalcB);
    ...
    this.m_invMassB)
      ...
      , d = this.m_invIB
      , l = this.m_K;
    l.ex.x = r + s + a * n.y * n.y + d * p.y * p.y,
    l.ex.y = -a * n.x * n.y - d * p.x * p.y,
    l.ey.x = l.ex.y,
    l.ey.y = r + s + a * n.x * n.x + d * p.x * p.x,
    l.GetInverse(this.m_linearMass),
    this.m_angularMass = a + d,
    0 < this.m_angularMass && (this.m_angularMass = 1 / this.m_angularMass),
    o.step.warmStarting ? (this.m_linearImpulse.SelfMul(o.step.dtRatio),
    this.m_angularImpulse *= o.step.dtRatio,
    n = this.m_linearImpulse,
    t.SelfMulSub(r, n),
    e -= a * (box2d.b2Cross_V2_V2(this.m_rA, n) + this.m_angularImpulse),
    i.SelfMulAdd(s, n),
    b += d * (box2d.b2Cross_V2_V2(this.m_rB, n) + this.m_angularImpulse)) : (this.m_linearImpulse.SetZero(),
    this.m_angularImpulse = 0),
    o.velocities[this.m_indexA].w = e,
    o.velocities[this.m_indexB].w = b;
}
,
...
box2d.b2FrictionJoint.prototype.SolveVelocityConstraints = function(o) {
    var t, e = o.velocities[this.m_indexA].v, r = o.velocities[this.m_indexA].w, i = o.velocities[this.m_indexB].v, b = o.velocities[this.m_indexB].w, n = this.m_invMassA, p = this.m_invMassB, s = this.m_invIA, a = this.m_invIB, d = o.step.dt, l = -this.m_angularMass * (b - r), x = this.m_angularImpulse;
    t = d * this.m_maxTorque,
    this.m_angularImpulse = box2d.b2Clamp(this.m_angularImpulse + l, -t, t),
    r -= s * (l = this.m_angularImpulse - x),
    b += a * l,
    t = box2d.b2Sub_V2_V2(box2d.b2AddCross_V2_S_V2(i, b, this.m_rB, box2d.b2Vec2.s_t0), box2d.b2AddCross_V2_S_V2(e, r, this.m_rA, box2d.b2Vec2.s_t1), box2d.b2FrictionJoint.prototype.SolveVelocityConstraints.s_Cdot),
    ...
    t = d * this.m_maxForce,
    this.m_linearImpulse.LengthSquared() > t * t && (this.m_linearImpulse.Normalize(),
    this.m_linearImpulse.SelfMul(t)),
    box2d.b2Sub_V2_V2(this.m_linearImpulse, x, l),
    e.SelfMulSub(n, l),
    r -= s * box2d.b2Cross_V2_V2(this.m_rA, l),
    i.SelfMulAdd(p, l),
    b += a * box2d.b2Cross_V2_V2(this.m_rB, l),
    o.velocities[this.m_indexA].w = r,
    o.velocities[this.m_indexB].w = b;
}
,
...
box2d.b2World.prototype.CreateBody = function(o) {
    return box2d.ENABLE_ASSERTS && box2d.b2Assert(!this.IsLocked()),
    this.IsLocked() ? null : ((o = new box2d.b2Body(o,this)).m_prev = null,
    (o.m_next = this.m_bodyList) && (this.m_bodyList.m_prev = o),
    this.m_bodyList = o,
    ++this.m_bodyCount,
    o);
}
...
box2d.b2World.prototype.DestroyBody = function(o) {
    ...
    !this.IsLocked()) {
        ...
        for (o.m_jointList = null,
        t = o.m_controllerList; t; )
            e = t,
            t = t.nextController,
            e.controller.RemoveBody(o);
        for (t = o.m_contactList; t; )
            e = t,
            t = t.next,
            this.m_contactManager.Destroy(e.contact);
        for (o.m_contactList = null,
        t = o.m_fixtureList; t; )
            e = t,
            t = t.m_next,
            this.m_destructionListener && this.m_destructionListener.SayGoodbyeFixture(e),
            e.DestroyProxies(this.m_contactManager.m_broadPhase),
            e.Destroy(),
            o.m_fixtureList = t,
            --o.m_fixtureCount;
...
box2d.b2World.prototype.CreateJoint = function(o) {
    ...
    t.m_prev = null,
    (t.m_next = this.m_jointList) && (this.m_jointList.m_prev = t),
    this.m_jointList = t,
    ++this.m_jointCount,
    t.m_edgeA.joint = t,
    t.m_edgeA.other = t.m_bodyB,
    t.m_edgeA.prev = null,
    (t.m_edgeA.next = t.m_bodyA.m_jointList) && (t.m_bodyA.m_jointList.prev = t.m_edgeA),
    t.m_bodyA.m_jointList = t.m_edgeA,
    t.m_edgeB.joint = t,
    t.m_edgeB.other = t.m_bodyA,
    t.m_edgeB.prev = null,
    (t.m_edgeB.next = t.m_bodyB.m_jointList) && (t.m_bodyB.m_jointList.prev = t.m_edgeB),
    t.m_bodyB.m_jointList = t.m_edgeB;
    var e = o.bodyA
      , r = o.bodyB;
    if (!o.collideConnected)
        for (o = r.GetContactList(); o; )
            o.other === e && o.contact.FlagForFiltering(),
            o = o.next;
    return t;
}
,
...
box2d.b2World.prototype.DestroyJoint = function(o) {
    ...
    !this.IsLocked()) {
        ...
        o.m_edgeB === r.m_jointList && (r.m_jointList = o.m_edgeB.next),
        o.m_edgeB.prev = null,
        o.m_edgeB.next = null,
...
box2d.b2World.prototype.CreateParticleSystem = function(o) {
    return box2d.ENABLE_ASSERTS && box2d.b2Assert(!this.IsLocked()),
    this.IsLocked() ? null : ((o = new box2d.b2ParticleSystem(o,this)).m_prev = null,
...
box2d.b2World.prototype.DestroyParticleSystem = function(o) {
    box2d.ENABLE_ASSERTS && box2d.b2Assert(!this.IsLocked()),
    this.IsLocked() || (o.m_prev && (o.m_prev.m_next = o.m_next),
    o.m_next && (o.m_next.m_prev = o.m_prev),
    o === this.m_particleSystemList && (this.m_particleSystemList = o.m_next));
}
,
...
box2d.b2World.prototype.Solve = function(o) {
    for (var t = this.m_bodyList; t; t = t.m_next)
        t.m_xf0.Copy(t.m_xf);
    for (var e = this.m_controllerList; e; e = e.m_next)
        e.Step(o);
    for (this.m_profile.solveInit = 0,
    ...
    t = this.m_bodyList; t; t = t.m_next)
        t.m_flag_islandFlag = !1;
    for (var r = this.m_contactManager.m_contactList; r; r = r.m_next)
        r.m_flag_islandFlag = !1;
    for (r = this.m_jointList; r; r = r.m_next)
        r.m_islandFlag = !1;
    r = this.m_bodyCount;
    for (var i = this.s_stack, b = this.m_bodyList; b; b = b.m_next)
        if (!b.m_flag_islandFlag && b.IsAwake() && b.IsActive() && b.GetType() !== box2d.b2BodyType.b2_staticBody) {
            ...
            var n = 0;
            for (i[n++] = b,
            b.m_flag_islandFlag = !0; 0 < n; )
                if (t = i[--n],
                box2d.ENABLE_ASSERTS && box2d.b2Assert(t.IsActive()),
                e.AddBody(t),
                t.SetAwake(!0),
                t.GetType() !== box2d.b2BodyType.b2_staticBody) {
                    for (var p = t.m_contactList; p; p = p.next) {
                        var s = p.contact;
                        if (!s.m_flag_islandFlag && s.IsEnabled() && s.IsTouching()) {
                            var a = s.m_fixtureB.m_isSensor;
                            s.m_fixtureA.m_isSensor || a || (e.AddContact(s),
                            s.m_flag_islandFlag = !0,
                            (s = p.other).m_flag_islandFlag || (box2d.ENABLE_ASSERTS && box2d.b2Assert(n < r),
                            i[n++] = s,
                            s.m_flag_islandFlag = !0));
                        }
                    }
                    for (t = t.m_jointList; t; t = t.next)
                        t.joint.m_islandFlag || (s = t.other).IsActive() && (e.AddJoint(t.joint),
                        t.joint.m_islandFlag = !0,
                        s.m_flag_islandFlag || (box2d.ENABLE_ASSERTS && box2d.b2Assert(n < r),
                        i[n++] = s,
                        s.m_flag_islandFlag = !0));
                }
            for (t = new box2d.b2Profile(),
            e.Solve(t, o, this.m_gravity, this.m_allowSleep),
            this.m_profile.solveInit += t.solveInit,
            this.m_profile.solveVelocity += t.solveVelocity,
            this.m_profile.solvePosition += t.solvePosition,
            n = 0; n < e.m_bodyCount; ++n)
                (t = e.m_bodies[n]).GetType() === box2d.b2BodyType.b2_staticBody && (t.m_flag_islandFlag = !1);
        }
    for (n = 0; n < i.length && i[n]; ++n)
        i[n] = null;
    for (o = new box2d.b2Timer(),
    t = this.m_bodyList; t; t = t.m_next)
        t.m_flag_islandFlag && t.GetType() !== box2d.b2BodyType.b2_staticBody && t.SynchronizeFixtures();
    this.m_contactManager.FindNewContacts(),
    this.m_profile.broadphase = o.GetMilliseconds();
}
,
...
box2d.b2World.prototype.SolveTOI = function(o) {
    ...
    this.m_stepComplete) {
        for (var e = this.m_bodyList; e; e = e.m_next)
            e.m_flag_islandFlag = !1,
            e.m_sweep.alpha0 = 0;
        for (var r = this.m_contactManager.m_contactList; r; r = r.m_next)
            r.m_flag_toiFlag = r.m_flag_islandFlag = !1,
            r.m_toiCount = 0,
            r.m_toi = 1;
    }
    for (; ; ) {
        var i = null;
        for (e = 1,
        r = this.m_contactManager.m_contactList; r; r = r.m_next)
            if (r.IsEnabled() && !(r.m_toiCount > box2d.b2_maxSubSteps)) {
                ...
                if (r.m_flag_toiFlag)
                    ...
                    if (!l && !x)
                        continue;
                    if (a = b.IsBullet() || a !== box2d.b2BodyType.b2_dynamicBody,
                    d = s.IsBullet() || d !== box2d.b2BodyType.b2_dynamicBody,
                    !a && !d)
                        continue;
                    d = b.m_sweep.alpha0,
                    b.m_sweep.alpha0 < s.m_sweep.alpha0 ? (d = s.m_sweep.alpha0,
                    b.m_sweep.Advance(d)) : s.m_sweep.alpha0 < b.m_sweep.alpha0 && (d = b.m_sweep.alpha0,
                    s.m_sweep.Advance(d)),
                    box2d.ENABLE_ASSERTS && box2d.b2Assert(1 > d),
                    l = r.GetChildIndexA(),
                    x = r.GetChildIndexB(),
                    (a = box2d.b2World.prototype.SolveTOI.s_toi_input).proxyA.SetShape(n.GetShape(), l),
                    a.proxyB.SetShape(p.GetShape(), x),
                    a.sweepA.Copy(b.m_sweep),
                    a.sweepB.Copy(s.m_sweep),
                    a.tMax = 1,
                    b = box2d.b2World.prototype.SolveTOI.s_toi_output,
                    box2d.b2TimeOfImpact(b, a),
                    s = b.t,
                    b = b.state === box2d.b2TOIOutputState.e_touching ? box2d.b2Min(d + (1 - d) * s, 1) : 1,
                    r.m_toi = b,
                    r.m_flag_toiFlag = !0;
                }
                b < e && (i = r,
        ...
        b = n.GetBody(),
        s = p.GetBody(),
        r = box2d.b2World.prototype.SolveTOI.s_backup1.Copy(b.m_sweep),
        n = box2d.b2World.prototype.SolveTOI.s_backup2.Copy(s.m_sweep),
        b.Advance(e),
        s.Advance(e),
        ...
        i.IsEnabled() && i.IsTouching()) {
            ...
            t.AddBody(s),
            t.AddContact(i),
            b.m_flag_islandFlag = !0,
            s.m_flag_islandFlag = !0,
            i.m_flag_islandFlag = !0,
            i = 0; 2 > i; ++i)
                if ((r = 0 === i ? b : s).m_type === box2d.b2BodyType.b2_dynamicBody)
                    for (n = r.m_contactList; n && t.m_bodyCount !== t.m_bodyCapacity && t.m_contactCount !== t.m_contactCapacity; n = n.next)
                        !(p = n.contact).m_flag_islandFlag && ((d = n.other).m_type !== box2d.b2BodyType.b2_dynamicBody || r.IsBullet() || d.IsBullet()) && (a = p.m_fixtureB.m_isSensor,
                        p.m_fixtureA.m_isSensor || a || (a = box2d.b2World.prototype.SolveTOI.s_backup.Copy(d.m_sweep),
                        d.m_flag_islandFlag || d.Advance(e),
                        p.Update(this.m_contactManager.m_contactListener),
                        p.IsEnabled() && p.IsTouching() ? (p.m_flag_islandFlag = !0,
                        t.AddContact(p),
                        d.m_flag_islandFlag || (d.m_flag_islandFlag = !0,
                        d.m_type !== box2d.b2BodyType.b2_staticBody && d.SetAwake(!0),
                        t.AddBody(d))) : (d.m_sweep.Copy(a),
                        d.SynchronizeTransform())));
            for ((i = box2d.b2World.prototype.SolveTOI.s_subStep).dt = (1 - e) * o.dt,
            i.inv_dt = 1 / i.dt,
            i.dtRatio = 1,
            i.positionIterations = 20,
            i.velocityIterations = o.velocityIterations,
            i.particleIterations = o.particleIterations,
            i.warmStarting = !1,
            t.SolveTOI(i, b.m_islandIndex, s.m_islandIndex),
            i = 0; i < t.m_bodyCount; ++i)
                if ((r = t.m_bodies[i]).m_flag_islandFlag = !1,
                r.m_type === box2d.b2BodyType.b2_dynamicBody)
                    for (r.SynchronizeFixtures(),
                    n = r.m_contactList; n; n = n.next)
                        n.contact.m_flag_toiFlag = n.contact.m_flag_islandFlag = !1;
...
box2d.b2World.prototype.Step = function(o, t, e, r) {
    ...
    if (b.dt = o,
    b.velocityIterations = t,
    b.positionIterations = e,
    b.particleIterations = r,
    b.inv_dt = 0 < o ? 1 / o : 0,
    b.dtRatio = this.m_inv_dt0 * o,
    b.warmStarting = this.m_warmStarting,
    o = new box2d.b2Timer(),
    this.m_contactManager.Collide(),
    this.m_profile.collide = o.GetMilliseconds(),
    this.m_stepComplete && 0 < b.dt) {
        for (o = new box2d.b2Timer(),
        t = this.m_particleSystemList; t; t = t.m_next)
            t.Solve(b);
        this.Solve(b),
        this.m_profile.solve = o.GetMilliseconds();
    }
    this.m_continuousPhysics && 0 < b.dt && (o = new box2d.b2Timer(),
    this.SolveTOI(b),
    this.m_profile.solveTOI = o.GetMilliseconds()),
    0 < b.dt && (this.m_inv_dt0 = b.inv_dt),
...
box2d.b2World.prototype.QueryAABB = function(o, t) {
    ...
    if (e.Query(function(t) {
        return t = e.GetUserData(t),
        box2d.ENABLE_ASSERTS && box2d.b2Assert(t instanceof box2d.b2FixtureProxy),
        t = t.fixture,
        o instanceof box2d.b2QueryCallback ? o.ReportFixture(t) : o(t);
    }, t),
    o instanceof box2d.b2QueryCallback)
        for (var r = this.m_particleSystemList; r; r = r.m_next)
            o.ShouldQueryParticleSystem(r) && r.QueryAABB(o, t);
}
,
...
box2d.b2World.prototype.QueryShape = function(o, t, e, r) {
    ...
    if (t.ComputeAABB(b, e, r || 0),
    i.Query(function(r) {
        return r = i.GetUserData(r),
        box2d.ENABLE_ASSERTS && box2d.b2Assert(r instanceof box2d.b2FixtureProxy),
        r = r.fixture,
        !box2d.b2TestOverlap_Shape(t, 0, r.GetShape(), 0, e, r.GetBody().GetTransform()) || (o instanceof box2d.b2QueryCallback ? o.ReportFixture(r) : o(r));
    }, b),
    o instanceof box2d.b2QueryCallback)
        for (r = this.m_particleSystemList; r; r = r.m_next)
            o.ShouldQueryParticleSystem(r) && r.QueryAABB(o, b);
}
,
...
box2d.b2World.prototype.QueryPoint = function(o, t, e) {
    ...
    if (i.lowerBound.Set(t.x - e, t.y - e),
    i.upperBound.Set(t.x + e, t.y + e),
    r.Query(function(e) {
        return e = r.GetUserData(e),
        box2d.ENABLE_ASSERTS && box2d.b2Assert(e instanceof box2d.b2FixtureProxy),
        !(e = e.fixture).TestPoint(t) || (o instanceof box2d.b2QueryCallback ? o.ReportFixture(e) : o(e));
    }, i),
    o instanceof box2d.b2QueryCallback)
        for (e = this.m_particleSystemList; e; e = e.m_next)
            o.ShouldQueryParticleSystem(e) && e.QueryAABB(o, i);
}
,
...
box2d.b2World.prototype.RayCast = function(o, t, e) {
    ...
    r.RayCast(function(i, b) {
        ...
        if (p.RayCast(s, i, n.childIndex)) {
            ...
            return a.Set((1 - n) * t.x + n * e.x, (1 - n) * t.y + n * e.y),
            o instanceof box2d.b2RayCastCallback ? o.ReportFixture(p, a, s.normal, n) : o(p, a, s.normal, n);
        }
        return i.maxFraction;
    }, i),
    o instanceof box2d.b2RayCastCallback)
        for (i = this.m_particleSystemList; i; i = i.m_next)
            o.ShouldQueryParticleSystem(i) && i.RayCast(o, t, e);
}
,
...
box2d.b2World.prototype.DrawShape = function(o, t) {
    ...
    case box2d.b2ShapeType.e_circleShape:
        e = e instanceof box2d.b2CircleShape ? e : null,
        this.m_debugDraw.DrawSolidCircle(e.m_p, e.m_radius, box2d.b2Vec2.UNITX, t);
        break;
    ...
    case box2d.b2ShapeType.e_chainShape:
        ...
        for (var n = 1; n < i; ++n)
            r = b[n],
            this.m_debugDraw.DrawSegment(e, r, t),
            this.m_debugDraw.DrawCircle(r, .05, t),
            e = r;
        break;
    case box2d.b2ShapeType.e_polygonShape:
        e = (i = e instanceof box2d.b2PolygonShape ? e : null).m_count,
        b = i.m_vertices,
...
box2d.b2World.prototype.DrawJoint = function(o) {
    ...
    t = o.GetAnchorB(box2d.b2World.prototype.DrawJoint.s_p2),
    box2d.b2World.prototype.DrawJoint.s_color.SetRGB(.5, .8, .8));
    switch (o.m_type) {
    case box2d.b2JointType.e_distanceJoint:
    ...
    case box2d.b2JointType.e_pulleyJoint:
        ...
        r = r.GetGroundAnchorB(box2d.b2World.prototype.DrawJoint.s_s2),
        this.m_debugDraw.DrawSegment(o, e, b),
        this.m_debugDraw.DrawSegment(r, t, b),
        this.m_debugDraw.DrawSegment(o, r, b);
        break;
    case box2d.b2JointType.e_mouseJoint:
        this.m_debugDraw.DrawSegment(e, t, b);
        break;
    default:
        this.m_debugDraw.DrawSegment(r, e, b),
        this.m_debugDraw.DrawSegment(e, t, b),
        this.m_debugDraw.DrawSegment(i, t, b);
    }
}
,
...
box2d.b2World.prototype.DrawParticleSystem = function(o) {
    var t = o.GetParticleCount();
    if (t) {
        var e = o.GetRadius()
          , r = o.GetPositionBuffer();
        o.m_colorBuffer.data ? (o = o.GetColorBuffer(),
        this.m_debugDraw.DrawParticles(r, e, o, t)) : this.m_debugDraw.DrawParticles(r, e, null, t);
    }
}
,
    ...
    if (null !== this.m_debugDraw) {
        ...
        if (o & box2d.b2DrawFlags.e_shapeBit)
            for (var e = this.m_bodyList; e; e = e.m_next) {
                ...
                for (var i = e.GetFixtureList(); i; i = i.m_next)
                    e.IsActive() ? e.GetType() === box2d.b2BodyType.b2_staticBody ? t.SetRGB(.5, .9, .5) : e.GetType() === box2d.b2BodyType.b2_kinematicBody ? t.SetRGB(.5, .5, .9) : e.IsAwake() ? t.SetRGB(.9, .7, .7) : t.SetRGB(.6, .6, .6) : t.SetRGB(.5, .5, .3),
                    this.DrawShape(i, t);
                this.m_debugDraw.PopTransform(r);
            }
        if (o & box2d.b2DrawFlags.e_particleBit)
            for (e = this.m_particleSystemList; e; e = e.m_next)
                this.DrawParticleSystem(e);
                ...
                if (e.IsActive())
                    for (i = e.GetFixtureList(); i; i = i.m_next)
                        for (var n = 0; n < i.m_proxyCount; ++n) {
                            ...
                            b[0].Set(p.lowerBound.x, p.lowerBound.y),
                            b[1].Set(p.upperBound.x, p.lowerBound.y),
                            b[2].Set(p.upperBound.x, p.upperBound.y),
                            b[3].Set(p.lowerBound.x, p.upperBound.y),
                            this.m_debugDraw.DrawPolygon(b, 4, t);
                        }
        }
        if (o & box2d.b2DrawFlags.e_centerOfMassBit)
            for (e = this.m_bodyList; e; e = e.m_next)
                (r = box2d.b2World.prototype.DrawDebugData.s_xf).q.Copy(e.m_xf.q),
                r.p.Copy(e.GetWorldCenter()),
                this.m_debugDraw.DrawTransform(r);
        if (o & box2d.b2DrawFlags.e_controllerBit)
            for (o = this.m_controllerList; o; o = o.m_next)
                o.Draw(this.m_debugDraw);
    }
}
,
...
box2d.b2World.prototype.SetBroadPhase = function(o) {
    ...
    for (var e = this.m_bodyList; e; e = e.m_next)
        for (var r = e.m_fixtureList; r; r = r.m_next)
            r.m_proxy = o.CreateProxy(t.GetFatAABB(r.m_proxy), r);
}
,
...
box2d.b2World.prototype.CalculateReasonableParticleIterations = function(o) {
    return null === this.m_particleSystemList ? 1 : box2d.b2CalculateParticleIterations(this.m_gravity.Length(), function(o) {
        ...
        for (o = o.GetParticleSystemList(); null !== o; o = o.m_next)
            t = box2d.b2Min(t, o.GetRadius());
        return t;
    }(this), o);
}
,
...
box2d.b2World.prototype.ShiftOrigin = function(o) {
    ...
    !this.IsLocked()) {
        ...
        for (t = this.m_jointList; t; t = t.m_next)
            t.ShiftOrigin(o);
...
box2d.b2World.prototype.Dump = function() {
    if (box2d.DEBUG && !this.m_flag_locked) {
        ...
        for (var o = 0, t = this.m_bodyList; t; t = t.m_next)
            ...
            ++o;
        for (o = 0,
        t = this.m_jointList; t; t = t.m_next)
            t.m_index = o,
            ++o;
        for (t = this.m_jointList; t; t = t.m_next)
            t.m_type !== box2d.b2JointType.e_gearJoint && (box2d.b2Log("{\n"),
            t.Dump(),
            box2d.b2Log("}\n"));
        for (t = this.m_jointList; t; t = t.m_next)
            t.m_type === box2d.b2JointType.e_gearJoint && (box2d.b2Log("{\n"),
...
box2d.b2MotorJoint.prototype.InitVelocityConstraints = function(o) {
    ...
    this.m_invMassA)
      ...
      , _ = this.m_invIB
      , m = this.m_K;
    m.ex.x = x + y + c * l.y * l.y + _ * d.y * d.y,
    m.ex.y = -c * l.x * l.y - _ * d.x * d.y,
    m.ey.x = m.ex.y,
    m.ey.y = x + y + c * l.x * l.x + _ * d.x * d.x,
    m.GetInverse(this.m_linearMass),
    this.m_angularMass = c + _,
    0 < this.m_angularMass && (this.m_angularMass = 1 / this.m_angularMass),
...
box2d.b2MotorJoint.prototype.SolveVelocityConstraints = function(o) {
    ...
    this.m_linearImpulse.SelfMul(y)),
    box2d.b2Sub_V2_V2(this.m_linearImpulse, x, l),
    t.SelfMulSub(b, l),
    e -= p * box2d.b2Cross_V2_V2(c, l),
    r.SelfMulAdd(n, l),
    i += s * box2d.b2Cross_V2_V2(_, l),
    o.velocities[this.m_indexA].w = e,
    o.velocities[this.m_indexB].w = i;
}
,
...
box2d.b2MouseJoint.prototype.InitVelocityConstraints = function(o) {
    ...
    b = b * n * n,
    n = o.step.dt;
    box2d.ENABLE_ASSERTS && box2d.b2Assert(p + n * b > box2d.b2_epsilon),
    this.m_gamma = n * (p + n * b),
    0 !== this.m_gamma && (this.m_gamma = 1 / this.m_gamma),
    this.m_beta = n * b * this.m_gamma,
    box2d.b2Sub_V2_V2(this.m_localAnchorB, this.m_localCenterB, this.m_lalcB),
    box2d.b2Mul_R_V2(i, this.m_lalcB, this.m_rB),
    (i = this.m_K).ex.x = this.m_invMassB + this.m_invIB * this.m_rB.y * this.m_rB.y + this.m_gamma,
    i.ex.y = -this.m_invIB * this.m_rB.x * this.m_rB.y,
    i.ey.x = i.ex.y,
    i.ey.y = this.m_invMassB + this.m_invIB * this.m_rB.x * this.m_rB.x + this.m_gamma,
    i.GetInverse(this.m_mass),
    ...
    e.x += this.m_invMassB * this.m_impulse.x,
    e.y += this.m_invMassB * this.m_impulse.y,
...
box2d.b2MouseJoint.prototype.SolveVelocityConstraints = function(o) {
    ...
    box2d.b2Sub_V2_V2(this.m_impulse, i, r),
    t.SelfMulAdd(this.m_invMassB, r),
    e += this.m_invIB * box2d.b2Cross_V2_V2(this.m_rB, r),
...
box2d.b2PrismaticJointDef.prototype.Initialize = function(o, t, e, r) {
    ...
    this.bodyA.GetLocalPoint(e, this.localAnchorA),
    this.bodyB.GetLocalPoint(e, this.localAnchorB),
    this.bodyA.GetLocalVector(r, this.localAxisA),
...
box2d.b2PrismaticJoint.prototype.InitVelocityConstraints = function(o) {
    ...
    b = this.m_invIA,
    this.m_invIB);
    box2d.b2Mul_R_V2(s, this.m_localXAxisA, this.m_axis),
    this.m_a1 = box2d.b2Cross_V2_V2(box2d.b2Add_V2_V2(l, a, box2d.b2Vec2.s_t0), this.m_axis),
    this.m_a2 = box2d.b2Cross_V2_V2(d, this.m_axis),
    this.m_motorMass = t + i + b * this.m_a1 * this.m_a1 + x * this.m_a2 * this.m_a2,
    0 < this.m_motorMass && (this.m_motorMass = 1 / this.m_motorMass),
    box2d.b2Mul_R_V2(s, this.m_localYAxisA, this.m_perp),
    this.m_s1 = box2d.b2Cross_V2_V2(box2d.b2Add_V2_V2(l, a, box2d.b2Vec2.s_t0), this.m_perp),
    this.m_s2 = box2d.b2Cross_V2_V2(d, this.m_perp),
    this.m_K.ex.x = t + i + b * this.m_s1 * this.m_s1 + x * this.m_s2 * this.m_s2,
    this.m_K.ex.y = b * this.m_s1 + x * this.m_s2,
    this.m_K.ex.z = b * this.m_s1 * this.m_a1 + x * this.m_s2 * this.m_a2,
    this.m_K.ey.x = this.m_K.ex.y,
    this.m_K.ey.y = b + x,
    0 === this.m_K.ey.y && (this.m_K.ey.y = 1),
    this.m_K.ey.z = b * this.m_a1 + x * this.m_a2,
    this.m_K.ez.x = this.m_K.ex.z,
    this.m_K.ez.y = this.m_K.ey.z,
    this.m_K.ez.z = t + i + b * this.m_a1 * this.m_a1 + x * this.m_a2 * this.m_a2,
    this.m_enableLimit ? (s = box2d.b2Dot_V2_V2(this.m_axis, l),
    ...
    o.step.warmStarting ? (this.m_impulse.SelfMulScalar(o.step.dtRatio),
    this.m_motorImpulse *= o.step.dtRatio,
    s = box2d.b2Add_V2_V2(box2d.b2Mul_S_V2(this.m_impulse.x, this.m_perp, box2d.b2Vec2.s_t0), box2d.b2Mul_S_V2(this.m_motorImpulse + this.m_impulse.z, this.m_axis, box2d.b2Vec2.s_t1), box2d.b2PrismaticJoint.prototype.InitVelocityConstraints.s_P),
...
box2d.b2PrismaticJoint.prototype.SolveVelocityConstraints = function(o) {
    ...
    if (this.m_enableMotor && this.m_limitState !== box2d.b2LimitState.e_equalLimits) {
        ...
        this.m_motorImpulse = box2d.b2Clamp(this.m_motorImpulse + a, -l, l),
        a = this.m_motorImpulse - d,
    ...
    d = box2d.b2Add_V2_V2(box2d.b2Mul_S_V2(a.x, this.m_perp, box2d.b2Vec2.s_t0), box2d.b2Mul_S_V2(a.z, this.m_axis, box2d.b2Vec2.s_t1), box2d.b2PrismaticJoint.prototype.SolveVelocityConstraints.s_P),
    l = a.x * this.m_s1 + a.y + a.z * this.m_a1,
    a = a.x * this.m_s2 + a.y + a.z * this.m_a2) : (a = this.m_K.Solve22(-l, -x, box2d.b2PrismaticJoint.prototype.SolveVelocityConstraints.s_df2),
    this.m_impulse.x += a.x,
    this.m_impulse.y += a.y,
    d = box2d.b2Mul_S_V2(a.x, this.m_perp, box2d.b2PrismaticJoint.prototype.SolveVelocityConstraints.s_P),
    l = a.x * this.m_s1 + a.y,
    a = a.x * this.m_s2 + a.y),
    t.SelfMulSub(b, d),
    e -= p * l,
    r.SelfMulAdd(n, d),
    o.velocities[this.m_indexA].w = e,
    o.velocities[this.m_indexB].w = i + s * a;
}
,
...
box2d.b2PrismaticJoint.prototype.SolvePositionConstraints = function(o) {
    ...
    b = box2d.b2Mul_R_V2(b, this.m_localYAxisA, this.m_perp),
    box2d.b2Cross_V2_V2(box2d.b2Add_V2_V2(y, l, box2d.b2Vec2.s_t0), b))
    ...
    !1)
      , P = 0;
    if (this.m_enableLimit && (y = box2d.b2Dot_V2_V2(c, y),
    box2d.b2Abs(this.m_upperTranslation - this.m_lowerTranslation) < 2 * box2d.b2_linearSlop ? (P = box2d.b2Clamp(y, -box2d.b2_maxLinearCorrection, box2d.b2_maxLinearCorrection),
    l = box2d.b2Max(l, box2d.b2Abs(y)),
    S = !0) : y <= this.m_lowerTranslation ? (P = box2d.b2Clamp(y - this.m_lowerTranslation + box2d.b2_linearSlop, -box2d.b2_maxLinearCorrection, 0),
    l = box2d.b2Max(l, this.m_lowerTranslation - y),
    S = !0) : y >= this.m_upperTranslation && (P = box2d.b2Clamp(y - this.m_upperTranslation - box2d.b2_linearSlop, 0, box2d.b2_maxLinearCorrection),
    l = box2d.b2Max(l, y - this.m_upperTranslation),
    S = !0)),
    S) {
        y = a * m + d * u;
        var C = a * m * _ + d * u * n;
        ...
        y = a * m + d * u,
        0 === (S = a + d) && (S = 1),
        (P = this.m_K2).ex.Set(p + s + a * m * m + d * u * u, y),
        P.ey.Set(y, S),
        g = P.Solve(-g, -f, box2d.b2PrismaticJoint.prototype.SolvePositionConstraints.s_impulse1),
        h.x = g.x,
        h.y = g.y,
        h.z = 0;
    ...
    r.SelfMulAdd(s, c),
    o.positions[this.m_indexA].a = e,
    o.positions[this.m_indexB].a = i + d * n,
...
box2d.b2PulleyJointDef.prototype.Initialize = function(o, t, e, r, i, b, n) {
    ...
    this.groundAnchorB.Copy(r),
    this.bodyA.GetLocalPoint(i, this.localAnchorA),
    this.bodyB.GetLocalPoint(b, this.localAnchorB),
    this.lengthA = box2d.b2Distance(i, e),
    this.lengthB = box2d.b2Distance(b, r),
    this.ratio = n,
...
box2d.b2PulleyJoint.prototype.InitVelocityConstraints = function(o) {
    ...
    this.m_uB.Copy(i).SelfAdd(this.m_rB).SelfSub(this.m_groundAnchorB),
    t = this.m_uA.Length(),
    i = this.m_uB.Length(),
    t > 10 * box2d.b2_linearSlop ? this.m_uA.SelfMul(1 / t) : this.m_uA.SetZero(),
    i > 10 * box2d.b2_linearSlop ? this.m_uB.SelfMul(1 / i) : this.m_uB.SetZero(),
    t = box2d.b2Cross_V2_V2(this.m_rA, this.m_uA),
    i = box2d.b2Cross_V2_V2(this.m_rB, this.m_uB),
    this.m_mass = this.m_invMassA + this.m_invIA * t * t + this.m_ratio * this.m_ratio * (this.m_invMassB + this.m_invIB * i * i),
    ...
    r += this.m_invIA * box2d.b2Cross_V2_V2(this.m_rA, t),
    n.SelfMulAdd(this.m_invMassB, i),
    p += this.m_invIB * box2d.b2Cross_V2_V2(this.m_rB, i)) : this.m_impulse = 0,
    o.velocities[this.m_indexA].w = r,
    o.velocities[this.m_indexB].w = p;
}
,
...
box2d.b2PulleyJoint.prototype.SolveVelocityConstraints = function(o) {
    ...
    n = -this.m_mass * b;
    this.m_impulse += n,
    b = box2d.b2Mul_S_V2(-n, this.m_uA, box2d.b2PulleyJoint.prototype.SolveVelocityConstraints.s_PA),
    n = box2d.b2Mul_S_V2(-this.m_ratio * n, this.m_uB, box2d.b2PulleyJoint.prototype.SolveVelocityConstraints.s_PB),
    t.SelfMulAdd(this.m_invMassA, b),
    e += this.m_invIA * box2d.b2Cross_V2_V2(this.m_rA, b),
    r.SelfMulAdd(this.m_invMassB, n),
    i += this.m_invIB * box2d.b2Cross_V2_V2(this.m_rB, n),
    o.velocities[this.m_indexA].w = e,
    o.velocities[this.m_indexB].w = i;
}
,
...
box2d.b2PulleyJoint.prototype.SolvePositionConstraints = function(o) {
    var t = o.positions[this.m_indexA].c
      ...
      , n = this.m_qB.SetAngle(i);
    box2d.b2Sub_V2_V2(this.m_localAnchorA, this.m_localCenterA, this.m_lalcA),
    b = box2d.b2Mul_R_V2(b, this.m_lalcA, this.m_rA),
    box2d.b2Sub_V2_V2(this.m_localAnchorB, this.m_localCenterB, this.m_lalcB);
    ...
    var p = this.m_uA.Copy(t).SelfAdd(b).SelfSub(this.m_groundAnchorA)
      ...
      , a = p.Length()
      , d = s.Length();
    a > 10 * box2d.b2_linearSlop ? p.SelfMul(1 / a) : p.SetZero(),
    d > 10 * box2d.b2_linearSlop ? s.SelfMul(1 / d) : s.SetZero();
    ...
    d = this.m_constant - a - this.m_ratio * d,
    a = box2d.b2Abs(d),
    d *= -l,
    p = box2d.b2Mul_S_V2(-d, p, box2d.b2PulleyJoint.prototype.SolvePositionConstraints.s_PA),
    s = box2d.b2Mul_S_V2(-this.m_ratio * d, s, box2d.b2PulleyJoint.prototype.SolvePositionConstraints.s_PB),
    t.SelfMulAdd(this.m_invMassA, p),
    e += this.m_invIA * box2d.b2Cross_V2_V2(b, p),
    r.SelfMulAdd(this.m_invMassB, s),
    i += this.m_invIB * box2d.b2Cross_V2_V2(n, s),
    o.positions[this.m_indexA].a = e,
    o.positions[this.m_indexB].a = i,
    a < box2d.b2_linearSlop;
}
,
...
box2d.b2RevoluteJoint.prototype.InitVelocityConstraints = function(o) {
    ...
    box2d.b2Sub_V2_V2(this.m_localAnchorA, this.m_localCenterA, this.m_lalcA),
    box2d.b2Mul_R_V2(p, this.m_lalcA, this.m_rA),
    box2d.b2Sub_V2_V2(this.m_localAnchorB, this.m_localCenterB, this.m_lalcB),
    box2d.b2Mul_R_V2(s, this.m_lalcB, this.m_rB);
    p = this.m_invMassA,
    s = this.m_invMassB;
    var a = this.m_invIA
      , d = this.m_invIB
    ...
    this.m_mass.ez.x = -this.m_rA.y * a - this.m_rB.y * d,
    this.m_mass.ex.y = this.m_mass.ey.x,
    this.m_mass.ey.y = p + s + this.m_rA.x * this.m_rA.x * a + this.m_rB.x * this.m_rB.x * d,
    this.m_mass.ez.y = this.m_rA.x * a + this.m_rB.x * d,
    this.m_mass.ex.z = this.m_mass.ez.x,
    this.m_mass.ey.z = this.m_mass.ez.y,
    this.m_mass.ez.z = a + d,
    this.m_motorMass = a + d,
    0 < this.m_motorMass && (this.m_motorMass = 1 / this.m_motorMass),
    this.m_enableMotor && !l || (this.m_motorImpulse = 0),
    this.m_enableLimit && !l ? (t = i - t - this.m_referenceAngle,
    box2d.b2Abs(this.m_upperAngle - this.m_lowerAngle) < 2 * box2d.b2_angularSlop ? this.m_limitState = box2d.b2LimitState.e_equalLimits : t <= this.m_lowerAngle ? (this.m_limitState !== box2d.b2LimitState.e_atLowerLimit && (this.m_impulse.z = 0),
    ...
    e.SelfMulSub(p, t),
    r -= a * (box2d.b2Cross_V2_V2(this.m_rA, t) + this.m_motorImpulse + this.m_impulse.z),
    b.SelfMulAdd(s, t),
    n += d * (box2d.b2Cross_V2_V2(this.m_rB, t) + this.m_motorImpulse + this.m_impulse.z)) : (this.m_impulse.SetZero(),
    this.m_motorImpulse = 0),
    o.velocities[this.m_indexA].w = r,
...
box2d.b2RevoluteJoint.prototype.SolveVelocityConstraints = function(o) {
    ...
    if (this.m_enableMotor && this.m_limitState !== box2d.b2LimitState.e_equalLimits && !a) {
        var d = i - e - this.m_motorSpeed
          , l = (d = -this.m_motorMass * d,
        this.m_motorImpulse)
          , x = o.step.dt * this.m_maxMotorTorque;
        this.m_motorImpulse = box2d.b2Clamp(this.m_motorImpulse + d, -x, x),
        e -= p * (d = this.m_motorImpulse - l),
        i += s * d;
    }
    ...
    a = -a.y + this.m_impulse.z * this.m_mass.ez.y,
    a = this.m_mass.Solve22(l, a, box2d.b2RevoluteJoint.prototype.SolveVelocityConstraints.s_reduced),
    d.x = a.x,
    d.y = a.y,
    d.z = -this.m_impulse.z,
    this.m_impulse.x += a.x,
    this.m_impulse.y += a.y,
    ...
    this.m_impulse.x += a.x,
    this.m_impulse.y += a.y,
    this.m_impulse.z = 0) : this.m_impulse.SelfAdd(d)),
    a = box2d.b2RevoluteJoint.prototype.SolveVelocityConstraints.s_P.Set(d.x, d.y),
    t.SelfMulSub(b, a),
    e -= p * (box2d.b2Cross_V2_V2(this.m_rA, a) + d.z),
    r.SelfMulAdd(n, a),
    ...
    t.SelfMulSub(b, d),
    e -= p * box2d.b2Cross_V2_V2(this.m_rA, d),
    r.SelfMulAdd(n, d),
    i += s * box2d.b2Cross_V2_V2(this.m_rB, d)),
    o.velocities[this.m_indexA].w = e,
    o.velocities[this.m_indexB].w = i;
}
,
...
box2d.b2RevoluteJoint.prototype.SolvePositionConstraints = function(o) {
    ...
    if (this.m_enableLimit && this.m_limitState !== box2d.b2LimitState.e_inactiveLimit && !s) {
        ...
        s = -this.m_motorMass * a,
        p = box2d.b2Abs(a)) : this.m_limitState === box2d.b2LimitState.e_atLowerLimit ? (p = -(a -= this.m_lowerAngle),
        ...
        a = box2d.b2Clamp(a - box2d.b2_angularSlop, 0, box2d.b2_maxAngularCorrection),
        s = -this.m_motorMass * a),
        e -= this.m_invIA * s,
        i += this.m_invIB * s;
    }
    ...
    box2d.b2Sub_V2_V2(this.m_localAnchorB, this.m_localCenterB, this.m_lalcB);
    n = box2d.b2Mul_R_V2(n, this.m_lalcB, this.m_rB),
    s = (a = box2d.b2Sub_V2_V2(box2d.b2Add_V2_V2(r, n, box2d.b2Vec2.s_t0), box2d.b2Add_V2_V2(t, b, box2d.b2Vec2.s_t1), box2d.b2RevoluteJoint.prototype.SolvePositionConstraints.s_C)).Length();
    var d = this.m_invMassA
      , l = this.m_invMassB
      , x = this.m_invIA
      , y = this.m_invIB
      , c = this.m_K;
    return c.ex.x = d + l + x * b.y * b.y + y * n.y * n.y,
    c.ex.y = -x * b.x * b.y - y * n.x * n.y,
    c.ey.x = c.ex.y,
    c.ey.y = d + l + x * b.x * b.x + y * n.x * n.x,
    a = c.Solve(a.x, a.y, box2d.b2RevoluteJoint.prototype.SolvePositionConstraints.s_impulse).SelfNeg(),
    t.SelfMulSub(d, a),
    e -= x * box2d.b2Cross_V2_V2(b, a),
    r.SelfMulAdd(l, a),
    i += y * box2d.b2Cross_V2_V2(n, a),
    o.positions[this.m_indexA].a = e,
    o.positions[this.m_indexB].a = i,
    s <= box2d.b2_linearSlop && p <= box2d.b2_angularSlop;
}
,
...
box2d.b2GearJoint = function(o) {
    ...
    this.m_typeA === box2d.b2JointType.e_revoluteJoint ? (e = o.joint1,
    ...
    t = r - i - this.m_referenceAngleA) : (i = o.joint1,
    ...
    r = this.m_localAnchorC,
    t = box2d.b2MulT_R_V2(e.q, box2d.b2Add_V2_V2(box2d.b2Mul_R_V2(t.q, this.m_localAnchorA, box2d.b2Vec2.s_t0), box2d.b2Sub_V2_V2(t.p, e.p, box2d.b2Vec2.s_t1), box2d.b2Vec2.s_t0), box2d.b2Vec2.s_t0),
    t = box2d.b2Dot_V2_V2(box2d.b2Sub_V2_V2(t, r, box2d.b2Vec2.s_t0), this.m_localAxisC)),
    this.m_bodyD = this.m_joint2.GetBodyA(),
    this.m_bodyB = this.m_joint2.GetBodyB(),
    e = this.m_bodyB.m_xf;
    i = this.m_bodyB.m_sweep.a,
    r = this.m_bodyD.m_xf;
    var b = this.m_bodyD.m_sweep.a;
    this.m_typeB === box2d.b2JointType.e_revoluteJoint ? (e = o.joint2,
    ...
    e = i - b - this.m_referenceAngleB) : (i = o.joint2,
    ...
    i = this.m_localAnchorD,
    e = box2d.b2MulT_R_V2(r.q, box2d.b2Add_V2_V2(box2d.b2Mul_R_V2(e.q, this.m_localAnchorB, box2d.b2Vec2.s_t0), box2d.b2Sub_V2_V2(e.p, r.p, box2d.b2Vec2.s_t1), box2d.b2Vec2.s_t0), box2d.b2Vec2.s_t0),
...
box2d.b2GearJoint.prototype.InitVelocityConstraints = function(o) {
    ...
    this.m_mass += this.m_iA + this.m_iC) : (a = box2d.b2Mul_R_V2(y, this.m_localAxisC, box2d.b2GearJoint.prototype.InitVelocityConstraints.s_u),
    box2d.b2Sub_V2_V2(this.m_localAnchorC, this.m_lcC, this.m_lalcC),
    y = box2d.b2Mul_R_V2(y, this.m_lalcC, box2d.b2GearJoint.prototype.InitVelocityConstraints.s_rC),
    box2d.b2Sub_V2_V2(this.m_localAnchorA, this.m_lcA, this.m_lalcA),
    x = box2d.b2Mul_R_V2(x, this.m_lalcA, box2d.b2GearJoint.prototype.InitVelocityConstraints.s_rA),
    this.m_JvAC.Copy(a),
    this.m_JwC = box2d.b2Cross_V2_V2(y, a),
    this.m_JwA = box2d.b2Cross_V2_V2(x, a),
    ...
    x = box2d.b2Mul_R_V2(n, this.m_lalcD, box2d.b2GearJoint.prototype.InitVelocityConstraints.s_rD),
    box2d.b2Sub_V2_V2(this.m_localAnchorB, this.m_lcB, this.m_lalcB),
    r = box2d.b2Mul_R_V2(r, this.m_lalcB, box2d.b2GearJoint.prototype.InitVelocityConstraints.s_rB),
    box2d.b2Mul_S_V2(this.m_ratio, a, this.m_JvBD),
    this.m_JwD = this.m_ratio * box2d.b2Cross_V2_V2(x, a),
    this.m_JwB = this.m_ratio * box2d.b2Cross_V2_V2(r, a),
    this.m_mass += this.m_ratio * this.m_ratio * (this.m_mD + this.m_mB) + this.m_iD * this.m_JwD * this.m_JwD + this.m_iB * this.m_JwB * this.m_JwB),
    this.m_mass = 0 < this.m_mass ? 1 / this.m_mass : 0,
    o.step.warmStarting ? (t.SelfMulAdd(this.m_mA * this.m_impulse, this.m_JvAC),
    e += this.m_iA * this.m_impulse * this.m_JwA,
    i.SelfMulAdd(this.m_mB * this.m_impulse, this.m_JvBD),
    b += this.m_iB * this.m_impulse * this.m_JwB,
    p.SelfMulSub(this.m_mC * this.m_impulse, this.m_JvAC),
    s -= this.m_iC * this.m_impulse * this.m_JwC,
    d.SelfMulSub(this.m_mD * this.m_impulse, this.m_JvBD),
    l -= this.m_iD * this.m_impulse * this.m_JwD) : this.m_impulse = 0,
    o.velocities[this.m_indexA].w = e,
    o.velocities[this.m_indexB].w = b,
    o.velocities[this.m_indexC].w = s,
    o.velocities[this.m_indexD].w = l;
}
,
...
box2d.b2GearJoint.prototype.SolveVelocityConstraints = function(o) {
    ...
    a = -this.m_mass * a;
    this.m_impulse += a,
    t.SelfMulAdd(this.m_mA * a, this.m_JvAC),
    e += this.m_iA * a * this.m_JwA,
    r.SelfMulAdd(this.m_mB * a, this.m_JvBD),
    i += this.m_iB * a * this.m_JwB,
    b.SelfMulSub(this.m_mC * a, this.m_JvAC),
    n -= this.m_iC * a * this.m_JwC,
    p.SelfMulSub(this.m_mD * a, this.m_JvBD),
    s -= this.m_iD * a * this.m_JwD,
    o.velocities[this.m_indexA].w = e,
    o.velocities[this.m_indexB].w = i,
    o.velocities[this.m_indexC].w = n,
    o.velocities[this.m_indexD].w = s;
}
,
box2d.b2GearJoint.prototype.SolvePositionConstraints = function(o) {
    var t, e, r = o.positions[this.m_indexA].c, i = o.positions[this.m_indexA].a, b = o.positions[this.m_indexB].c, n = o.positions[this.m_indexB].a, p = o.positions[this.m_indexC].c, s = o.positions[this.m_indexC].a, a = o.positions[this.m_indexD].c, d = o.positions[this.m_indexD].a, l = this.m_qA.SetAngle(i), x = this.m_qB.SetAngle(n), y = this.m_qC.SetAngle(s), c = this.m_qD.SetAngle(d), _ = this.m_JvAC, m = this.m_JvBD, u = 0;
    if (this.m_typeA === box2d.b2JointType.e_revoluteJoint)
        _.SetZero(),
        l = t = 1,
        u += this.m_iA + this.m_iC,
        y = i - s - this.m_referenceAngleA;
    else {
        ...
        _.Copy(e),
        l = box2d.b2Cross_V2_V2(t, e),
        t = box2d.b2Cross_V2_V2(h, e),
        u += this.m_mC + this.m_mA + this.m_iC * l * l + this.m_iA * t * t,
        e = this.m_lalcC,
        y = box2d.b2MulT_R_V2(y, box2d.b2Add_V2_V2(h, box2d.b2Sub_V2_V2(r, p, box2d.b2Vec2.s_t0), box2d.b2Vec2.s_t0), box2d.b2Vec2.s_t0),
    ...
    if (this.m_typeB === box2d.b2JointType.e_revoluteJoint)
        ...
        box2d.b2Mul_S_V2(this.m_ratio, e, m),
        x = this.m_ratio * box2d.b2Cross_V2_V2(g, e),
        e = this.m_ratio * box2d.b2Cross_V2_V2(h, e),
        u += this.m_ratio * this.m_ratio * (this.m_mD + this.m_mB) + this.m_iD * x * x + this.m_iB * e * e,
        g = this.m_lalcD,
        c = box2d.b2MulT_R_V2(c, box2d.b2Add_V2_V2(h, box2d.b2Sub_V2_V2(b, a, box2d.b2Vec2.s_t0), box2d.b2Vec2.s_t0), box2d.b2Vec2.s_t0),
        c = box2d.b2Dot_V2_V2(box2d.b2Sub_V2_V2(c, g, box2d.b2Vec2.s_t0), this.m_localAxisD);
    }
    return c = y + this.m_ratio * c - this.m_constant,
    y = 0,
    0 < u && (y = -c / u),
    r.SelfMulAdd(this.m_mA * y, _),
    i += this.m_iA * y * t,
    b.SelfMulAdd(this.m_mB * y, m),
    n += this.m_iB * y * e,
    p.SelfMulSub(this.m_mC * y, _),
    s -= this.m_iC * y * l,
    a.SelfMulSub(this.m_mD * y, m),
    d -= this.m_iD * y * x,
    o.positions[this.m_indexA].a = i,
    o.positions[this.m_indexB].a = n,
    o.positions[this.m_indexC].a = s,
    o.positions[this.m_indexD].a = d,
...
box2d.b2RopeJoint.prototype.InitVelocityConstraints = function(o) {
    ...
    box2d.b2Sub_V2_V2(this.m_localAnchorB, this.m_localCenterB, this.m_lalcB),
    box2d.b2Mul_R_V2(b, this.m_lalcB, this.m_rB),
    this.m_u.Copy(i).SelfAdd(this.m_rB).SelfSub(t).SelfSub(this.m_rA),
    ...
    t = box2d.b2Cross_V2_V2(this.m_rA, this.m_u),
    i = box2d.b2Cross_V2_V2(this.m_rB, this.m_u),
    t = this.m_invMassA + this.m_invIA * t * t + this.m_invMassB + this.m_invIB * i * i,
    this.m_mass = 0 !== t ? 1 / t : 0,
    o.step.warmStarting ? (this.m_impulse *= o.step.dtRatio,
    ...
    p += this.m_invIB * box2d.b2Cross_V2_V2(this.m_rB, t)) : this.m_impulse = 0,
    o.velocities[this.m_indexA].w = r,
    o.velocities[this.m_indexB].w = p) : (this.m_u.SetZero(),
...
box2d.b2RopeJoint.prototype.SolveVelocityConstraints = function(o) {
    ...
    b = box2d.b2Dot_V2_V2(this.m_u, box2d.b2Sub_V2_V2(n, b, box2d.b2Vec2.s_t0));
    0 > p && (b += o.step.inv_dt * p),
    p = -this.m_mass * b,
    b = this.m_impulse,
    this.m_impulse = box2d.b2Min(0, this.m_impulse + p),
    p = this.m_impulse - b,
    p = box2d.b2Mul_S_V2(p, this.m_u, box2d.b2RopeJoint.prototype.SolveVelocityConstraints.s_P),
    t.SelfMulSub(this.m_invMassA, p),
    e -= this.m_invIA * box2d.b2Cross_V2_V2(this.m_rA, p),
    r.SelfMulAdd(this.m_invMassB, p),
    i += this.m_invIB * box2d.b2Cross_V2_V2(this.m_rB, p),
    o.velocities[this.m_indexA].w = e,
    o.velocities[this.m_indexB].w = i;
}
,
...
box2d.b2RopeJoint.prototype.SolvePositionConstraints = function(o) {
    ...
    return t.SelfMulSub(this.m_invMassA, a),
    e -= this.m_invIA * box2d.b2Cross_V2_V2(b, a),
    r.SelfMulAdd(this.m_invMassB, a),
    i += this.m_invIB * box2d.b2Cross_V2_V2(n, a),
    o.positions[this.m_indexA].a = e,
    o.positions[this.m_indexB].a = i,
    p - this.m_maxLength < box2d.b2_linearSlop;
}
,
...
box2d.b2WeldJoint.prototype.InitVelocityConstraints = function(o) {
    ...
    l.ey.x = -this.m_rA.y * this.m_rA.x * a - this.m_rB.y * this.m_rB.x * d,
    l.ez.x = -this.m_rA.y * a - this.m_rB.y * d,
    l.ex.y = l.ey.x,
    l.ey.y = p + s + this.m_rA.x * this.m_rA.x * a + this.m_rB.x * this.m_rB.x * d,
    l.ez.y = this.m_rA.x * a + this.m_rB.x * d,
    l.ex.z = l.ez.x,
    l.ey.z = l.ez.y,
    l.ez.z = a + d,
    0 < this.m_frequencyHz) {
        l.GetInverse22(this.m_mass);
        var l, x = 0 < (l = a + d) ? 1 / l : 0, y = (t = i - t - this.m_referenceAngle,
        x * (i = 2 * box2d.b2_pi * this.m_frequencyHz) * i), c = o.step.dt;
        this.m_gamma = c * (2 * x * this.m_dampingRatio * i + c * y),
        this.m_gamma = 0 !== this.m_gamma ? 1 / this.m_gamma : 0,
        this.m_bias = t * c * y * this.m_gamma,
        l += this.m_gamma,
        this.m_mass.ez.z = 0 !== l ? 1 / l : 0;
    } else
        0 === l.ez.z ? l.GetInverse22(this.m_mass) : l.GetSymInverse33(this.m_mass),
        this.m_bias = this.m_gamma = 0;
    o.step.warmStarting ? (this.m_impulse.SelfMulScalar(o.step.dtRatio),
    l = box2d.b2WeldJoint.prototype.InitVelocityConstraints.s_P.Set(this.m_impulse.x, this.m_impulse.y),
    e.SelfMulSub(p, l),
    r -= a * (box2d.b2Cross_V2_V2(this.m_rA, l) + this.m_impulse.z),
    b.SelfMulAdd(s, l),
    n += d * (box2d.b2Cross_V2_V2(this.m_rB, l) + this.m_impulse.z)) : this.m_impulse.SetZero(),
    o.velocities[this.m_indexA].w = r,
    o.velocities[this.m_indexB].w = n;
}
,
...
box2d.b2WeldJoint.prototype.SolveVelocityConstraints = function(o) {
    ...
    if (0 < this.m_frequencyHz) {
        ...
        this.m_impulse.y += a.y,
        t.SelfMulSub(b, a),
        e -= p * box2d.b2Cross_V2_V2(this.m_rA, a),
        r.SelfMulAdd(n, a),
        i += s * box2d.b2Cross_V2_V2(this.m_rB, a);
    } else {
        a = box2d.b2Sub_V2_V2(box2d.b2AddCross_V2_S_V2(r, i, this.m_rB, box2d.b2Vec2.s_t0), box2d.b2AddCross_V2_S_V2(t, e, this.m_rA, box2d.b2Vec2.s_t1), box2d.b2WeldJoint.prototype.SolveVelocityConstraints.s_Cdot1);
        ...
        a = box2d.b2WeldJoint.prototype.SolveVelocityConstraints.s_P.Set(d.x, d.y),
        t.SelfMulSub(b, a),
        e -= p * (box2d.b2Cross_V2_V2(this.m_rA, a) + d.z),
        r.SelfMulAdd(n, a),
...
box2d.b2WeldJoint.prototype.SolvePositionConstraints = function(o) {
    ...
    if ((c = this.m_K).ex.x = p + s + l.y * l.y * a + x.y * x.y * d,
    c.ey.x = -l.y * l.x * a - x.y * x.x * d,
    c.ez.x = -l.y * a - x.y * d,
    c.ex.y = c.ey.x,
    c.ey.y = p + s + l.x * l.x * a + x.x * x.x * d,
    c.ez.y = l.x * a + x.x * d,
    c.ex.z = c.ez.x,
    c.ey.z = c.ez.y,
    c.ez.z = a + d,
    0 < this.m_frequencyHz) {
        var y = box2d.b2Sub_V2_V2(box2d.b2Add_V2_V2(r, x, box2d.b2Vec2.s_t0), box2d.b2Add_V2_V2(t, l, box2d.b2Vec2.s_t1), box2d.b2WeldJoint.prototype.SolvePositionConstraints.s_C1)
          , c = (n = y.Length(),
        b = 0,
        c.Solve22(y.x, y.y, box2d.b2WeldJoint.prototype.SolvePositionConstraints.s_P).SelfNeg());
        t.SelfMulSub(p, c),
        e -= a * box2d.b2Cross_V2_V2(l, c),
        r.SelfMulAdd(s, c),
        i += d * box2d.b2Cross_V2_V2(x, c);
    } else
        y = box2d.b2Sub_V2_V2(box2d.b2Add_V2_V2(r, x, box2d.b2Vec2.s_t0), box2d.b2Add_V2_V2(t, l, box2d.b2Vec2.s_t1), box2d.b2WeldJoint.prototype.SolvePositionConstraints.s_C1),
        x = i - e - this.m_referenceAngle,
        n = y.Length(),
        b = box2d.b2Abs(x),
        l = box2d.b2WeldJoint.prototype.SolvePositionConstraints.s_impulse,
        ...
        l.y = c.y,
        l.z = 0),
        c = box2d.b2WeldJoint.prototype.SolvePositionConstraints.s_P.Set(l.x, l.y),
        t.SelfMulSub(p, c),
        e -= a * (box2d.b2Cross_V2_V2(this.m_rA, c) + l.z),
        r.SelfMulAdd(s, c),
        i += d * (box2d.b2Cross_V2_V2(this.m_rB, c) + l.z);
    return o.positions[this.m_indexA].a = e,
    o.positions[this.m_indexB].a = i,
    n <= box2d.b2_linearSlop && b <= box2d.b2_angularSlop;
}
,
...
box2d.b2WheelJoint.prototype.InitVelocityConstraints = function(o) {
    ...
    box2d.b2Sub_V2_V2(this.m_localAnchorA, this.m_localCenterA, this.m_lalcA),
    a = box2d.b2Mul_R_V2(x, this.m_lalcA, this.m_rA),
    box2d.b2Sub_V2_V2(this.m_localAnchorB, this.m_localCenterB, this.m_lalcB),
    y = box2d.b2Mul_R_V2(y, this.m_lalcB, this.m_rB),
    ...
    box2d.b2Mul_R_V2(x, this.m_localYAxisA, this.m_ay),
    this.m_sAy = box2d.b2Cross_V2_V2(box2d.b2Add_V2_V2(b, a, box2d.b2Vec2.s_t0), this.m_ay),
    this.m_sBy = box2d.b2Cross_V2_V2(y, this.m_ay),
    this.m_mass = t + e + r * this.m_sAy * this.m_sAy + i * this.m_sBy * this.m_sBy,
    0 < this.m_mass && (this.m_mass = 1 / this.m_mass),
    this.m_gamma = this.m_bias = this.m_springMass = 0,
    0 < this.m_frequencyHz ? (box2d.b2Mul_R_V2(x, this.m_localXAxisA, this.m_ax),
    this.m_sAx = box2d.b2Cross_V2_V2(box2d.b2Add_V2_V2(b, a, box2d.b2Vec2.s_t0), this.m_ax),
    this.m_sBx = box2d.b2Cross_V2_V2(y, this.m_ax),
    0 < (t = t + e + r * this.m_sAx * this.m_sAx + i * this.m_sBx * this.m_sBx) && (this.m_springMass = 1 / t,
    e = box2d.b2Dot_V2_V2(b, this.m_ax),
    x = 2 * box2d.b2_pi * this.m_frequencyHz,
    b = this.m_springMass * x * x,
    s = o.step.dt,
    this.m_gamma = s * (2 * this.m_springMass * this.m_dampingRatio * x + s * b),
    0 < this.m_gamma && (this.m_gamma = 1 / this.m_gamma),
    this.m_bias = e * s * b * this.m_gamma,
    this.m_springMass = t + this.m_gamma,
    0 < this.m_springMass && (this.m_springMass = 1 / this.m_springMass))) : this.m_springImpulse = 0,
    this.m_enableMotor ? (this.m_motorMass = r + i,
    ...
    this.m_motorImpulse *= o.step.dtRatio,
    r = box2d.b2Add_V2_V2(box2d.b2Mul_S_V2(this.m_impulse, this.m_ay, box2d.b2Vec2.s_t0), box2d.b2Mul_S_V2(this.m_springImpulse, this.m_ax, box2d.b2Vec2.s_t1), box2d.b2WheelJoint.prototype.InitVelocityConstraints.s_P),
    ...
    n.SelfMulSub(this.m_invMassA, r),
    p -= this.m_invIA * i,
    d.SelfMulAdd(this.m_invMassB, r),
    l += this.m_invIB * t) : this.m_motorImpulse = this.m_springImpulse = this.m_impulse = 0,
    o.velocities[this.m_indexA].w = p,
    o.velocities[this.m_indexB].w = l;
}
,
...
box2d.b2WheelJoint.prototype.SolveVelocityConstraints = function(o) {
    ...
    n -= r * l,
    p.SelfMulAdd(e, d),
    a = (s += i * a) - n - this.m_motorSpeed,
    a *= -this.m_motorMass,
    d = this.m_motorImpulse,
    l = o.step.dt * this.m_maxMotorTorque,
    this.m_motorImpulse = box2d.b2Clamp(this.m_motorImpulse + a, -l, l),
    n -= r * (a = this.m_motorImpulse - d),
    s += i * a,
    a = box2d.b2Dot_V2_V2(this.m_ay, box2d.b2Sub_V2_V2(p, b, box2d.b2Vec2.s_t0)) + this.m_sBy * s - this.m_sAy * n,
    a *= -this.m_mass,
    this.m_impulse += a,
    d = box2d.b2Mul_S_V2(a, this.m_ay, box2d.b2WheelJoint.prototype.SolveVelocityConstraints.s_P),
    l = a * this.m_sAy,
    a *= this.m_sBy,
    b.SelfMulSub(t, d),
    n -= r * l,
    ...
    o.velocities[this.m_indexB].w = s + i * a;
}
,
...
box2d.b2WheelJoint.prototype.SolvePositionConstraints = function(o) {
    ...
    p = box2d.b2Cross_V2_V2(box2d.b2Add_V2_V2(s, p, box2d.b2Vec2.s_t0), b),
    n = box2d.b2Cross_V2_V2(n, b),
    s = box2d.b2Dot_V2_V2(s, this.m_ay),
    0 !== (a = this.m_invMassA + this.m_invMassB + this.m_invIA * this.m_sAy * this.m_sAy + this.m_invIB * this.m_sBy * this.m_sBy) ? -s / a : 0);
    b = box2d.b2Mul_S_V2(a, b, box2d.b2WheelJoint.prototype.SolvePositionConstraints.s_P),
    p *= a,
    n *= a;
    return t.SelfMulSub(this.m_invMassA, b),
    e -= this.m_invIA * p,
    r.SelfMulAdd(this.m_invMassB, b),
    i += this.m_invIB * n,
    o.positions[this.m_indexA].a = e,
...
box2d.b2WheelJoint.prototype.GetPrismaticJointTranslation = function() {
    ...
    t = t.GetWorldPoint(this.m_localAnchorB, new box2d.b2Vec2()),
    e = box2d.b2Sub_V2_V2(t, e, new box2d.b2Vec2()),
...
box2d.b2WheelJoint.prototype.GetPrismaticJointSpeed = function() {
    ...
    var r = box2d.b2Mul_R_V2(t.m_xf.q, this.m_lalcB, this.m_rB)
      ...
      , b = box2d.b2Add_V2_V2(t.m_sweep.c, r, box2d.b2Vec2.s_t1)
      , n = (i = box2d.b2Sub_V2_V2(b, i, box2d.b2Vec2.s_t2),
    b = o.GetWorldVector(this.m_localXAxisA, new box2d.b2Vec2()),
    o.m_linearVelocity)
      , p = t.m_linearVelocity;
    o = o.m_angularVelocity,
    t = t.m_angularVelocity;
...
box2d.b2ParticleColor.prototype.SelfMul_0_255 = function(o) {
    return o += 1,
    this.r = this.r * o >> box2d.b2ParticleColor.k_bitsPerComponent,
    this.g = this.g * o >> box2d.b2ParticleColor.k_bitsPerComponent,
    this.b = this.b * o >> box2d.b2ParticleColor.k_bitsPerComponent,
    this.a = this.a * o >> box2d.b2ParticleColor.k_bitsPerComponent,
    this;
}
,
...
box2d.b2ParticleColor.MixColors = function(o, t, e) {
    ...
    e = e * (t.a - o.a) >> box2d.b2ParticleColor.k_bitsPerComponent,
    o.r += r,
    o.g += i,
    o.b += b,
    o.a += e,
...
box2d.b2ParticleGroup.prototype.GetAllParticleFlags = function() {
    for (var o = 0, t = this.m_firstIndex; t < this.m_lastIndex; t++)
        o |= this.m_system.m_flagsBuffer.data[t];
    return o;
}
,
...
box2d.b2ParticleGroup.prototype.GetLinearVelocityFromWorldPoint = function(o, t) {
    ...
    return this.UpdateStatistics(),
    box2d.b2AddCross_V2_S_V2(this.m_linearVelocity, this.m_angularVelocity, box2d.b2Sub_V2_V2(o, this.m_center, e), t);
}
,
...
box2d.b2ParticleGroup.prototype.DestroyParticles = function(o) {
    if (box2d.b2Assert(!1 === this.m_system.m_world.IsLocked()),
    !this.m_system.m_world.IsLocked())
        for (var t = this.m_firstIndex; t < this.m_lastIndex; t++)
            this.m_system.DestroyParticle(t, o);
}
,
...
box2d.b2ParticleGroup.prototype.UpdateStatistics = function() {
    ...
    if (this.m_timestamp != this.m_system.m_timestamp) {
        ...
        this.m_mass = e * (this.m_lastIndex - this.m_firstIndex),
        this.m_center.SetZero(),
        this.m_linearVelocity.SetZero();
        for (var r = this.m_firstIndex; r < this.m_lastIndex; r++)
            this.m_center.SelfMulAdd(e, this.m_system.m_positionBuffer.data[r]),
            this.m_linearVelocity.SelfMulAdd(e, this.m_system.m_velocityBuffer.data[r]);
        for (0 < this.m_mass && (r = 1 / this.m_mass,
        this.m_center.SelfMul(r),
        this.m_linearVelocity.SelfMul(r)),
        this.m_angularVelocity = this.m_inertia = 0,
        r = this.m_firstIndex; r < this.m_lastIndex; r++)
            box2d.b2Sub_V2_V2(this.m_system.m_positionBuffer.data[r], this.m_center, o),
            box2d.b2Sub_V2_V2(this.m_system.m_velocityBuffer.data[r], this.m_linearVelocity, t),
            this.m_inertia += e * box2d.b2Dot_V2_V2(o, o),
            this.m_angularVelocity += e * box2d.b2Cross_V2_V2(o, t);
...
box2d.std_sort = function(o, t, e, r) {
    "number" != typeof t && (t = 0),
    "number" != typeof e && (e = o.length - t),
    "function" != typeof r && (r = function(o, t) {
        return o < t;
    }
    );
    for (var i = [], b = 0; ; ) {
...
box2d.std_remove_if = function(o, t, e) {
    ...
    for (var r = 0, i = 0; i < e; ++i)
        t(o[i]) || (i === r ? ++r : box2d.std_iter_swap(o, r++, i));
    return r;
}
,
...
box2d.std_unique = function(o, t, e, r) {
    if (t === e)
        return e;
    for (var i = t; ++t !== e; )
        r(o[i], o[t]) || box2d.std_iter_swap(o, ++i, t);
    return ++i;
}
,
...
box2d.b2GrowableBuffer.prototype.Reserve = function(o) {
    if (!(this.capacity >= o)) {
        ...
        for (var t = this.capacity; t < o; ++t)
            this.data[t] = this.allocator();
        this.capacity = o;
    }
}
,
box2d.b2GrowableBuffer.prototype.Grow = function() {
    ...
    box2d.b2Assert(o > this.capacity),
    this.Reserve(o);
}
,
...
box2d.b2GrowableBuffer.prototype.SetCount = function(o) {
    box2d.b2Assert(0 <= o && o <= this.capacity),
    this.count = o;
}
,
...
box2d.b2GrowableBuffer.prototype.RemoveIf = function(o) {
    for (var t = 0, e = 0; e < this.count; ++e)
        o(this.data[e]) || t++;
    this.count = box2d.std_remove_if(this.data, o, this.count),
    box2d.b2Assert(t === this.count);
}
,
...
box2d.b2FixtureParticleQueryCallback.prototype.ReportFixture = function(o) {
    ...
    for (var t = o.GetShape().GetChildCount(), e = 0; e < t; e++) {
        var r, i = o.GetAABB(e);
        for (i = this.m_system.GetInsideBoundsEnumerator(i); 0 <= (r = i.GetNext()); )
            this.ReportFixtureAndParticle(o, e, r);
    }
    return !0;
}
,
...
box2d.b2ParticleSystemDef.prototype.Copy = function(o) {
    ...
    this.pressureStrength = o.pressureStrength,
    this.dampingStrength = o.dampingStrength,
    this.elasticStrength = o.elasticStrength,
    this.springStrength = o.springStrength,
    this.viscousStrength = o.viscousStrength,
    this.surfaceTensionPressureStrength = o.surfaceTensionPressureStrength,
    this.surfaceTensionNormalStrength = o.surfaceTensionNormalStrength,
    this.repulsiveStrength = o.repulsiveStrength,
    this.powderStrength = o.powderStrength,
    this.ejectionStrength = o.ejectionStrength,
    this.staticPressureStrength = o.staticPressureStrength,
    this.staticPressureRelaxation = o.staticPressureRelaxation,
    this.staticPressureIterations = o.staticPressureIterations,
    this.colorMixingStrength = o.colorMixingStrength,
    this.destroyByAge = o.destroyByAge,
    this.lifetimeGranularity = o.lifetimeGranularity,
    this;
}
,
...
box2d.b2ParticleSystem.computeTag = function(o, t) {
...
,
box2d.b2ParticleSystem.FixedSetAllocator.prototype.Invalidate = function(o) {}
,
...
,
box2d.b2ParticleSystem.FixtureParticleSet.prototype.Find = function(o) {}
,
box2d.b2ParticleSystem.ParticlePair = function(o, t) {}
,
...
,
box2d.b2ParticleSystem.b2ParticlePairSet.prototype.Find = function(o) {}
,
...
box2d.b2ParticleSystem.prototype._ctor_ = function(o, t) {
    ...
    box2d.b2Assert(null !== o),
    this.SetStrictContactCheck(o.strictContactCheck),
    this.SetDensity(o.density),
    this.SetGravityScale(o.gravityScale),
    this.SetRadius(o.radius),
    this.SetMaxParticleCount(o.maxCount),
    box2d.b2Assert(0 < o.lifetimeGranularity),
    this.m_def = o.Clone(),
    this.m_world = t,
...
box2d.b2ParticleSystem.prototype.CreateParticle = function(o) {
    if (box2d.b2Assert(!1 === this.m_world.IsLocked()),
    this.m_world.IsLocked())
        return 0;
    ...
    var t = this.m_count++;
    this.m_flagsBuffer.data[t] = 0,
    this.m_lastBodyContactStepBuffer.data && (this.m_lastBodyContactStepBuffer.data[t] = 0),
    ...
    this.m_forceBuffer[t] = (this.m_forceBuffer[t] || new box2d.b2Vec2()).SetZero(),
    this.m_staticPressureBuffer && (this.m_staticPressureBuffer[t] = 0),
    this.m_depthBuffer && (this.m_depthBuffer[t] = 0),
    !this.m_colorBuffer.data && o.color.IsZero() || (this.m_colorBuffer.data = this.RequestBuffer(this.m_colorBuffer.data),
    ...
    this.m_userDataBuffer.data[t] = o.userData),
    this.m_handleIndexBuffer.data && (this.m_handleIndexBuffer.data[t] = null);
    ...
    this.m_indexByExpirationTimeBuffer.data[t] = t),
    e.index = t,
    e = o.group,
    (this.m_groupBuffer[t] = e) && (e.m_firstIndex < e.m_lastIndex ? (this.RotateBuffer(e.m_firstIndex, e.m_lastIndex, t),
    box2d.b2Assert(e.m_lastIndex === t)) : e.m_firstIndex = t,
    e.m_lastIndex = t + 1),
    this.SetParticleFlags(t, o.flags),
    t;
}
,
...
box2d.b2ParticleSystem.prototype.GetParticleHandleFromIndex = function(o) {
    ...
    return t || (t = new box2d.b2ParticleHandle(),
    box2d.b2Assert(null !== t),
    t.SetIndex(o),
...
box2d.b2ParticleSystem.prototype.DestroyParticle = function(o, t) {
    ...
    t && (e |= box2d.b2ParticleFlag.b2_destructionListenerParticle),
    this.SetParticleFlags(o, this.m_flagsBuffer.data[o] | e);
}
,
...
box2d.b2ParticleSystem.DestroyParticlesInShapeCallback = function(o, t, e, r) {
    ...
    this.m_shape = t,
    this.m_xf = e,
    this.m_callDestructionListener = r,
    this.m_destroyed = 0;
}
,
...
box2d.b2ParticleSystem.prototype.DestroyParticlesInShape = function(o, t, e) {
    ...
    return box2d.b2Assert(!1 === this.m_world.IsLocked()),
    this.m_world.IsLocked() ? 0 : (e = new box2d.b2ParticleSystem.DestroyParticlesInShapeCallback(this,o,t,e),
    o.ComputeAABB(r, t, 0),
    this.m_world.QueryAABB(e, r),
    e.Destroyed());
}
,
...
box2d.b2ParticleSystem.prototype.CreateParticleGroup = function(o) {
    ...
    var e = this.m_count;
    if (o.shape && this.CreateParticlesWithShapeForGroup(o.shape, o, t),
    o.shapes && this.CreateParticlesWithShapesForGroup(o.shapes, o.shapeCount, o, t),
    o.particleCount) {
        box2d.b2Assert(null !== o.positionData);
        for (var r = 0; r < o.particleCount; r++)
            this.CreateParticleForGroup(o, t, o.positionData[r]);
    }
    var i = this.m_count
    ...
    b.m_firstIndex = e,
    b.m_lastIndex = i,
    b.m_strength = o.strength,
    b.m_userData = o.userData,
    b.m_transform.Copy(t),
    b.m_prev = null,
    (b.m_next = this.m_groupList) && (this.m_groupList.m_prev = b),
    this.m_groupList = b,
    ++this.m_groupCount,
    r = e; r < i; r++)
        this.m_groupBuffer[r] = b;
    return this.SetGroupFlags(b, o.groupFlags),
    t = new box2d.b2ParticleSystem.ConnectionFilter(),
    this.UpdateContacts(!0),
    this.UpdatePairsAndTriads(e, i, t),
    o.group && (this.JoinParticleGroups(o.group, b),
    b = o.group),
    b;
}
,
...
box2d.b2ParticleSystem.JoinParticleGroupsFilter.prototype.ShouldCreatePair = function(o, t) {
...
box2d.b2ParticleSystem.prototype.JoinParticleGroups = function(o, t) {
    ...
    !this.m_world.IsLocked()) {
        box2d.b2Assert(o !== t),
        this.RotateBuffer(t.m_firstIndex, t.m_lastIndex, this.m_count),
        box2d.b2Assert(t.m_lastIndex === this.m_count),
        this.RotateBuffer(o.m_firstIndex, o.m_lastIndex, t.m_firstIndex),
        box2d.b2Assert(o.m_lastIndex === t.m_firstIndex);
        var e = new box2d.b2ParticleSystem.JoinParticleGroupsFilter(t.m_firstIndex);
        for (this.UpdateContacts(!0),
        this.UpdatePairsAndTriads(o.m_firstIndex, t.m_lastIndex, e),
        e = t.m_firstIndex; e < t.m_lastIndex; e++)
            this.m_groupBuffer[e] = o;
        this.SetGroupFlags(o, o.m_groupFlags | t.m_groupFlags),
        o.m_lastIndex = t.m_lastIndex,
        t.m_firstIndex = t.m_lastIndex,
        this.DestroyParticleGroup(t);
    }
}
,
...
box2d.b2ParticleSystem.prototype.SplitParticleGroup = function(o) {
    ...
    box2d.b2ParticleSystem.InitializeParticleLists(o, t),
    this.MergeParticleListsInContact(o, t);
    var e = box2d.b2ParticleSystem.FindLongestParticleList(o, t);
    this.MergeZombieParticleListNodes(o, t, e),
    this.CreateParticleGroupsFromParticleList(o, t, e),
...
box2d.b2ParticleSystem.prototype.SetMaxParticleCount = function(o) {
    box2d.b2Assert(this.m_count <= o),
    this.m_def.maxCount = o;
}
,
...
box2d.b2ParticleSystem.prototype.SetParticleFlags = function(o, t) {
    this.m_flagsBuffer.data[o] & ~t && (this.m_needsUpdateAllParticleFlags = !0),
    ~this.m_allParticleFlags & t && (t & box2d.b2ParticleFlag.b2_tensileParticle && (this.m_accumulation2Buffer = this.RequestBuffer(this.m_accumulation2Buffer)),
    t & box2d.b2ParticleFlag.b2_colorMixingParticle && (this.m_colorBuffer.data = this.RequestBuffer(this.m_colorBuffer.data)),
    this.m_allParticleFlags |= t),
    this.m_flagsBuffer.data[o] = t;
}
,
...
box2d.b2ParticleSystem.prototype.SetStuckThreshold = function(o) {
    this.m_stuckThreshold = o,
    0 < o && (this.m_lastBodyContactStepBuffer.data = this.RequestBuffer(this.m_lastBodyContactStepBuffer.data),
...
box2d.b2ParticleSystem.prototype.SetParticleLifetime = function(o, t) {
    ...
    e) {
        ...
        for (var r = 0; r < e; ++r)
            this.m_indexByExpirationTimeBuffer.data[r] = r;
    }
...
box2d.b2ParticleSystem.prototype.GetParticleLifetime = function(o) {
    return box2d.b2Assert(this.ValidateParticleIndex(o)),
    this.ExpirationTimeToLifetime(this.GetExpirationTimeBuffer()[o]);
}
,
...
box2d.b2ParticleSystem.prototype.SetDestructionByAge = function(o) {
    o && this.GetExpirationTimeBuffer(),
    this.m_def.destroyByAge = o;
}
,
...
box2d.b2ParticleSystem.prototype.ApplyLinearImpulse = function(o, t, e) {
    ...
    for (e = e.Clone().SelfMul(1 / i); o < t; o++)
        r[o].SelfAdd(e);
}
,
...
box2d.b2ParticleSystem.prototype.ApplyForce = function(o, t, e) {
    for (var r = 0, i = o; i < t; i++)
        r |= this.m_flagsBuffer.data[i];
    if (box2d.b2Assert(this.ForceCanBeApplied(r)),
    e = e.Clone().SelfMul(1 / (t - o)),
    ...
    if (0 !== this.m_proxyBuffer.count)
        ...
        this.m_positionBuffer.data); r < e; ++r) {
            var b = this.m_proxyBuffer.data[r].index
              , n = i[b];
            if (t.lowerBound.x < n.x && n.x < t.upperBound.x && t.lowerBound.y < n.y && n.y < t.upperBound.y && !o.ReportParticle(this, b))
                break;
        }
}
,
...
box2d.b2ParticleSystem.prototype.QueryPointAABB = function(o, t, e) {
    var r = box2d.b2ParticleSystem.prototype.QueryPointAABB.s_aabb;
    e = "number" == typeof e ? e : box2d.b2_linearSlop,
    r.lowerBound.Set(t.x - e, t.y - e),
    r.upperBound.Set(t.x + e, t.y + e),
    this.QueryAABB(o, r);
}
,
...
box2d.b2ParticleSystem.prototype.RayCast = function(o, t, e) {
    ...
    if (0 !== this.m_proxyBuffer.count) {
        ...
        box2d.b2Min_V2_V2(t, e, r.lowerBound),
        box2d.b2Max_V2_V2(t, e, r.upperBound);
        var a = 1;
        e = box2d.b2Sub_V2_V2(e, t, b);
        var d;
        for (b = box2d.b2Dot_V2_V2(e, e),
        r = this.GetInsideBoundsEnumerator(r); 0 <= (d = r.GetNext()); ) {
            ...
            if (0 <= (y = x * x - b * ((y = box2d.b2Dot_V2_V2(l, l)) - this.m_squaredDiameter))) {
                ...
                if (!((y = (-x - c) / b) > a)) {
                    if (0 > y && (0 > (y = (-x + c) / b) || y > a))
                        continue;
                    if ((l = box2d.b2AddMul_V2_S_V2(l, y, e, n)).Normalize(),
                    d = o.ReportParticle(this, d, box2d.b2AddMul_V2_S_V2(t, y, e, p), l, y),
                    0 >= (a = box2d.b2Min(a, d)))
                        break;
                }
            }
...
box2d.b2ParticleSystem.prototype.ComputeAABB = function(o) {
    var t = this.GetParticleCount();
    box2d.b2Assert(null !== o),
    o.lowerBound.x = +box2d.b2_maxFloat,
    o.lowerBound.y = +box2d.b2_maxFloat,
    o.upperBound.x = -box2d.b2_maxFloat,
    o.upperBound.y = -box2d.b2_maxFloat;
    for (var e = this.m_positionBuffer.data, r = 0; r < t; r++) {
        var i = e[r];
        box2d.b2Min_V2_V2(o.lowerBound, i, o.lowerBound),
        box2d.b2Max_V2_V2(o.upperBound, i, o.upperBound);
    }
    o.lowerBound.x -= this.m_particleDiameter,
    o.lowerBound.y -= this.m_particleDiameter,
    o.upperBound.x += this.m_particleDiameter,
    o.upperBound.y += this.m_particleDiameter;
}
,
...
box2d.b2ParticleSystem.Proxy.CompareProxyProxy = function(o, t) {
    return o.tag < t.tag;
}
,
...
box2d.b2ParticleSystem.InsideBoundsEnumerator = function(o, t, e, r, i) {
    this.m_system = o,
    this.m_xLower = (t & box2d.b2ParticleSystem.xMask) >>> 0,
    this.m_xUpper = (e & box2d.b2ParticleSystem.xMask) >>> 0,
    this.m_yLower = (t & box2d.b2ParticleSystem.yMask) >>> 0,
    this.m_yUpper = (e & box2d.b2ParticleSystem.yMask) >>> 0,
    this.m_first = r,
    this.m_last = i,
...
box2d.b2ParticleSystem.InsideBoundsEnumerator.prototype.GetNext = function() {
    for (; this.m_first < this.m_last; ) {
        ...
        if (box2d.b2Assert(t >= this.m_yLower),
        box2d.b2Assert(t <= this.m_yUpper),
        o >= this.m_xLower && o <= this.m_xUpper)
...
box2d.b2ParticleSystem.prototype.ReallocateBuffer3 = function(o, t, e) {
    return box2d.b2Assert(e > t),
    (o = o ? o.slice() : []).length = e,
    o;
}
,
box2d.b2ParticleSystem.prototype.ReallocateBuffer5 = function(o, t, e, r, i) {
    return box2d.b2Assert(r > e),
    box2d.b2Assert(!t || r <= t),
    i && !o || t || (o = this.ReallocateBuffer3(o, e, r)),
    o;
}
,
box2d.b2ParticleSystem.prototype.ReallocateBuffer4 = function(o, t, e, r) {
    return box2d.b2Assert(e > t),
    this.ReallocateBuffer5(o.data, o.userSuppliedCapacity, t, e, r);
}
,
box2d.b2ParticleSystem.prototype.RequestBuffer = function(o) {
    ...
    (o = []).length = this.m_internalAllocatedCapacity),
    o;
}
,
box2d.b2ParticleSystem.prototype.ReallocateHandleBuffers = function(o) {
    box2d.b2Assert(o > this.m_internalAllocatedCapacity),
    this.m_handleIndexBuffer.data = this.ReallocateBuffer4(this.m_handleIndexBuffer, this.m_internalAllocatedCapacity, o, !0);
}
,
box2d.b2ParticleSystem.prototype.ReallocateInternalAllocatedBuffers = function(o) {
    ...
    if (o = b(o, this.m_def.maxCount),
    o = b(o, this.m_flagsBuffer.userSuppliedCapacity),
    o = b(o, this.m_positionBuffer.userSuppliedCapacity),
    o = b(o, this.m_velocityBuffer.userSuppliedCapacity),
    o = b(o, this.m_colorBuffer.userSuppliedCapacity),
    o = b(o, this.m_userDataBuffer.userSuppliedCapacity),
    this.m_internalAllocatedCapacity < o) {
        this.ReallocateHandleBuffers(o),
        this.m_flagsBuffer.data = this.ReallocateBuffer4(this.m_flagsBuffer, this.m_internalAllocatedCapacity, o, !1);
...
box2d.b2ParticleSystem.prototype.CreateParticleForGroup = function(o, t, e) {
    ...
    r.flags = o.flags,
    box2d.b2Mul_X_V2(t, e, r.position),
    box2d.b2Add_V2_V2(o.linearVelocity, box2d.b2Cross_S_V2(o.angularVelocity, box2d.b2Sub_V2_V2(r.position, o.position, box2d.b2Vec2.s_t0), box2d.b2Vec2.s_t0), r.velocity),
    r.color.Copy(o.color),
...
box2d.b2ParticleSystem.prototype.CreateParticlesStrokeShapeForGroup = function(o, t, e) {
    ...
    for (var p = 0, s = o.GetChildCount(), a = 0; a < s; a++) {
        ...
        for (var l = box2d.b2Sub_V2_V2(d.m_vertex2, d.m_vertex1, i), x = l.Length(); p < x; ) {
            ...
            this.CreateParticleForGroup(t, e, y),
            p += n;
        }
        p -= x;
    }
...
box2d.b2ParticleSystem.prototype.CreateParticlesFillShapeForGroup = function(o, t, e) {
    ...
    box2d.b2Assert(1 === o.GetChildCount()),
    o.ComputeAABB(r, n, 0);
...
box2d.b2ParticleSystem.CompositeShape.prototype.TestPoint = function(o, t) {
    for (var e = 0; e < this.m_shapeCount; e++)
        if (this.m_shapes[e].TestPoint(o, t))
            return !0;
    return !1;
}
,
...
box2d.b2ParticleSystem.CompositeShape.prototype.ComputeAABB = function(o, t, e) {
    ...
    for (o.lowerBound.x = +box2d.b2_maxFloat,
    o.lowerBound.y = +box2d.b2_maxFloat,
    o.upperBound.x = -box2d.b2_maxFloat,
    o.upperBound.y = -box2d.b2_maxFloat,
    box2d.b2Assert(0 === e),
    e = 0; e < this.m_shapeCount; e++)
        for (var i = this.m_shapes[e].GetChildCount(), b = 0; b < i; b++) {
            var n = r;
            this.m_shapes[e].ComputeAABB(n, t, b),
            o.Combine1(n);
        }
}
,
...
box2d.b2ParticleSystem.prototype.CreateParticlesWithShapesForGroup = function(o, t, e, r) {
    o = new box2d.b2ParticleSystem.CompositeShape(o,t),
    this.CreateParticlesFillShapeForGroup(o, e, r);
}
,
...
box2d.b2ParticleSystem.prototype.CloneParticle = function(o, t) {
    ...
    if (e.flags = this.m_flagsBuffer.data[o],
    e.position.Copy(this.m_positionBuffer.data[o]),
    e.velocity.Copy(this.m_velocityBuffer.data[o]),
    this.m_colorBuffer.data && e.color.Copy(this.m_colorBuffer.data[o]),
    this.m_userDataBuffer.data && (e.userData = this.m_userDataBuffer.data[o]),
    e.group = t,
    e = this.CreateParticle(e),
    this.m_handleIndexBuffer.data) {
        var r = this.m_handleIndexBuffer.data[o];
        r && r.SetIndex(e),
        this.m_handleIndexBuffer.data[e] = r,
    ...
    this.m_hasForce && this.m_forceBuffer[e].Copy(this.m_forceBuffer[o]),
    this.m_staticPressureBuffer && (this.m_staticPressureBuffer[e] = this.m_staticPressureBuffer[o]),
    this.m_depthBuffer && (this.m_depthBuffer[e] = this.m_depthBuffer[o]),
    this.m_expirationTimeBuffer.data && (this.m_expirationTimeBuffer.data[e] = this.m_expirationTimeBuffer.data[o]),
    e;
}
,
...
box2d.b2ParticleSystem.prototype.DestroyParticlesInGroup = function(o, t) {
    for (var e = o.m_firstIndex; e < o.m_lastIndex; e++)
        this.DestroyParticle(e, t);
}
,
...
box2d.b2ParticleSystem.prototype.DestroyParticleGroup = function(o) {
    ...
    box2d.b2Assert(null !== o),
    this.m_world.m_destructionListener && this.m_world.m_destructionListener.SayGoodbyeParticleGroup(o),
    this.SetGroupFlags(o, 0);
    for (var t = o.m_firstIndex; t < o.m_lastIndex; t++)
        this.m_groupBuffer[t] = null;
    o.m_prev && (o.m_prev.m_next = o.m_next),
    o.m_next && (o.m_next.m_prev = o.m_prev),
    o === this.m_groupList && (this.m_groupList = o.m_next),
    --this.m_groupCount;
}
,
...
box2d.b2ParticleSystem.prototype.UpdatePairsAndTriads = function(o, t, e) {
    ...
    box2d.b2Assert(o <= t);
    for (var p = 0, s = o; s < t; s++)
        p |= this.m_flagsBuffer.data[s];
    if (p & box2d.b2ParticleSystem.k_pairFlags)
        for (s = 0; s < this.m_contactBuffer.count; s++) {
            ...
            x.indexB = l,
            x.flags = a.flags,
            x.strength = box2d.b2Min(c ? c.m_strength : 1, _ ? _.m_strength : 1),
            x.distance = box2d.b2Distance(n[d], n[l])),
    ...
    if (p & box2d.b2ParticleSystem.k_triadFlags) {
        for (p = new box2d.b2VoronoiDiagram(t - o),
        a = 0,
        s = o; s < t; s++)
            d = this.m_flagsBuffer.data[s],
            l = this.m_groupBuffer[s],
            d & box2d.b2ParticleFlag.b2_zombieParticle || !box2d.b2ParticleSystem.ParticleCanBeConnected(d, l) || (e.IsNecessary(s) && ++a,
            ...
            if ((s | a | d) & box2d.b2ParticleSystem.k_triadFlags && e.ShouldCreateTriad(o, t, p)) {
                ...
                if (!(box2d.b2Dot_V2_V2(c, c) > h || box2d.b2Dot_V2_V2(_, _) > h || box2d.b2Dot_V2_V2(u, u) > h)) {
                    var g = m.m_groupBuffer[o]
                      , f = m.m_groupBuffer[t]
                      , S = m.m_groupBuffer[p];
                    (h = m.m_triadBuffer.data[m.m_triadBuffer.Append()]).indexA = o,
                    h.indexB = t,
                    h.indexC = p,
                    h.flags = s | a | d,
                    h.strength = box2d.b2Min(box2d.b2Min(g ? g.m_strength : 1, f ? f.m_strength : 1), S ? S.m_strength : 1),
                    o = (l.x + x.x + y.x) / 3,
                    t = (l.y + x.y + y.y) / 3,
                    h.pa.x = l.x - o,
                    h.pa.y = l.y - t,
                    ...
                    h.pc.x = y.x - o,
                    h.pc.y = y.y - t,
                    h.ka = -box2d.b2Dot_V2_V2(u, c),
                    h.kb = -box2d.b2Dot_V2_V2(c, _),
                    h.kc = -box2d.b2Dot_V2_V2(_, u),
                    h.s = box2d.b2Cross_V2_V2(l, x) + box2d.b2Cross_V2_V2(x, y) + box2d.b2Cross_V2_V2(y, l);
                }
            }
        }),
...
box2d.b2ParticleSystem.ReactiveFilter.prototype.IsNecessary = function(o) {
...
box2d.b2ParticleSystem.prototype.UpdatePairsAndTriadsWithReactiveParticles = function() {
    ...
    for (this.UpdatePairsAndTriads(0, this.m_count, o),
    o = 0; o < this.m_count; o++)
        this.m_flagsBuffer.data[o] &= ~box2d.b2ParticleFlag.b2_reactiveParticle;
...
box2d.b2ParticleSystem.prototype.MergeParticleListsInContact = function(o, t) {
    for (var e = o.GetBufferIndex(), r = 0; r < this.m_contactBuffer.count; r++) {
        ...
        if (o.ContainsParticle(i) && o.ContainsParticle(b) && (i = t[i - e].list) !== (b = t[b - e].list)) {
            ...
            box2d.b2Assert(i.count >= b.count),
            box2d.b2ParticleSystem.MergeParticleLists(i, b);
        }
    }
}
,
...
box2d.b2ParticleSystem.MergeParticleListAndNode = function(o, t) {
    box2d.b2Assert(t !== o),
    box2d.b2Assert(t.list === t),
    box2d.b2Assert(1 === t.count),
    t.list = o,
    t.next = o.next,
    o.next = t,
    o.count++,
...
box2d.b2ParticleSystem.prototype.CreateParticleGroupsFromParticleList = function(o, t, e) {
    ...
    for (i.groupFlags = o.GetGroupFlags(),
    i.userData = o.GetUserData(),
    o = 0; o < r; o++) {
        var b = t[o];
        if (b.count && b !== e) {
            ...
            for (var n = this.CreateParticleGroup(i); b; b = b.next) {
                ...
                this.m_flagsBuffer.data[p] |= box2d.b2ParticleFlag.b2_zombieParticle,
                b.index = s;
            }
        }
    }
...
box2d.b2ParticleSystem.prototype.UpdatePairsAndTriadsWithParticleList = function(o, t) {
    for (var e = o.GetBufferIndex(), r = 0; r < this.m_pairBuffer.count; r++) {
        var i = (n = this.m_pairBuffer.data[r]).indexA
          , b = n.indexB;
        o.ContainsParticle(i) && (n.indexA = t[i - e].index),
        o.ContainsParticle(b) && (n.indexB = t[b - e].index);
    }
    for (r = 0; r < this.m_triadBuffer.count; r++) {
        i = (n = this.m_triadBuffer.data[r]).indexA,
        b = n.indexB;
        var n, p = n.indexC;
        o.ContainsParticle(i) && (n.indexA = t[i - e].index),
        o.ContainsParticle(b) && (n.indexB = t[b - e].index),
...
box2d.b2ParticleSystem.prototype.ComputeDepth = function() {
    ...
    for (b = [],
    n = 0,
    e = this.m_groupList; e; e = e.GetNext())
        if (e.m_groupFlags & box2d.b2ParticleGroupFlag.b2_particleGroupNeedsUpdateDepth)
            ...
            i = e.m_firstIndex; i < e.m_lastIndex; i++)
                this.m_accumulationBuffer[i] = 0;
    for (e = 0; e < t; e++) {
        r = (l = o[e]).indexA,
        i = l.indexB;
        var p = l.weight;
        this.m_accumulationBuffer[r] += p,
        this.m_accumulationBuffer[i] += p;
    }
    for (box2d.b2Assert(null !== this.m_depthBuffer),
    i = 0; i < n; i++)
        for (i = (e = b[i]).m_firstIndex; i < e.m_lastIndex; i++)
            p = this.m_accumulationBuffer[i],
    ...
    for (var s = 0; s < p; s++) {
        ...
        for (e = 0; e < t; e++) {
            ...
            var d = 1 - l.weight
              ...
              , y = x + d;
            d = l + d;
            l > y && (this.m_depthBuffer[r] = y,
            a = !0),
            x > d && (this.m_depthBuffer[i] = d,
            a = !0);
        }
        if (!a)
            break;
    ...
    for (i = 0; i < n; i++)
        for (i = (e = b[i]).m_firstIndex; i < e.m_lastIndex; i++)
            this.m_depthBuffer[i] = this.m_depthBuffer[i] < box2d.b2_maxFloat ? this.m_depthBuffer[i] * this.m_particleDiameter : 0;
}
,
box2d.b2ParticleSystem.prototype.GetInsideBoundsEnumerator = function(o) {
    ...
    return box2d.b2Assert(0 <= r),
    box2d.b2Assert(r <= i),
    box2d.b2Assert(i <= e),
    new box2d.b2ParticleSystem.InsideBoundsEnumerator(this,t,o,r,i);
}
,
box2d.b2ParticleSystem.prototype.UpdateAllParticleFlags = function() {
    for (var o = this.m_allParticleFlags = 0; o < this.m_count; o++)
        this.m_allParticleFlags |= this.m_flagsBuffer.data[o];
    this.m_needsUpdateAllParticleFlags = !1;
}
,
box2d.b2ParticleSystem.prototype.UpdateAllGroupFlags = function() {
    this.m_allGroupFlags = 0;
    for (var o = this.m_groupList; o; o = o.GetNext())
        this.m_allGroupFlags |= o.m_groupFlags;
...
box2d.b2ParticleSystem.prototype.AddContact = function(o, t, e) {
    ...
    if (box2d.b2Assert(e === this.m_contactBuffer),
    e = box2d.b2Sub_V2_V2(i[t], i[o], r),
    (r = box2d.b2Dot_V2_V2(e, e)) < this.m_squaredDiameter) {
        ...
        b.indexA = o,
        b.indexB = t,
        b.flags = this.m_flagsBuffer.data[o] | this.m_flagsBuffer.data[t],
        b.weight = 1 - r * i * this.m_inverseDiameter,
        box2d.b2Mul_S_V2(i, e, b.normal);
    }
}
,
box2d.b2ParticleSystem.prototype.AddContact.s_d = new box2d.b2Vec2(),
box2d.b2ParticleSystem.prototype.FindContacts_Reference = function(o) {
    box2d.b2Assert(o === this.m_contactBuffer),
    o = this.m_proxyBuffer.count;
    for (var t = this.m_contactBuffer.count = 0, e = 0; t < o; t++) {
        for (var r = box2d.b2ParticleSystem.computeRelativeTag(this.m_proxyBuffer.data[t].tag, 1, 0), i = t + 1; i < o && !(r < this.m_proxyBuffer.data[i].tag); i++)
            this.AddContact(this.m_proxyBuffer.data[t].index, this.m_proxyBuffer.data[i].index, this.m_contactBuffer);
        ...
        i = e; i < o && !(r < this.m_proxyBuffer.data[i].tag); i++)
            this.AddContact(this.m_proxyBuffer.data[t].index, this.m_proxyBuffer.data[i].index, this.m_contactBuffer);
    }
}
,
...
box2d.b2ParticleSystem.prototype.UpdateProxies_Reference = function(o) {
    box2d.b2Assert(o === this.m_proxyBuffer),
...
box2d.b2ParticleSystem.prototype.NotifyContactListenerPreContact = function(o) {
    if (null !== this.GetParticleContactListener())
        throw o.Initialize(this.m_contactBuffer, this.m_flagsBuffer),
        Error();
}
,
box2d.b2ParticleSystem.prototype.NotifyContactListenerPostContact = function(o) {
    if (null !== (o = this.GetParticleContactListener())) {
        for (var t = 0; t < this.m_contactBuffer.count; ++t)
            o.BeginContactParticleParticle(this, this.m_contactBuffer.data[t]);
        throw Error();
    }
}
,
...
box2d.b2ParticleSystem.prototype.UpdateContacts = function(o) {
    ...
    this.NotifyContactListenerPreContact(t),
    this.FindContacts(this.m_contactBuffer),
    this.FilterContacts(this.m_contactBuffer),
    this.NotifyContactListenerPostContact(t),
...
box2d.b2ParticleSystem.prototype.NotifyBodyContactListenerPreContact = function(o) {
    if (null !== this.GetFixtureContactListener())
        throw o.Initialize(this.m_bodyContactBuffer, this.m_flagsBuffer),
        Error();
}
,
box2d.b2ParticleSystem.prototype.NotifyBodyContactListenerPostContact = function(o) {
    if (null !== (o = this.GetFixtureContactListener())) {
        for (var t = 0; t < this.m_bodyContactBuffer.count; t++) {
            ...
            box2d.b2Assert(null !== e),
            o.BeginContactFixtureParticle(this, e);
        }
        throw Error();
    }
}
...
box2d.b2ParticleSystem.UpdateBodyContactsCallback = function(o, t) {
    box2d.b2FixtureParticleQueryCallback.call(this, o),
    this.m_contactFilter = t;
}
,
...
box2d.b2ParticleSystem.UpdateBodyContactsCallback.prototype.ReportFixtureAndParticle = function(o, t, e) {
    ...
    if ((t = o.ComputeDistance(i, b, t)) < this.m_system.m_particleDiameter && this.ShouldCollideFixtureParticle(o, this.m_system, e)) {
        var n = o.GetBody()
          ...
          , d = (s = 0 < s ? 1 / s : 0,
        a = 0 < a ? 1 / a : 0,
        this.m_system.m_flagsBuffer.data[e] & box2d.b2ParticleFlag.b2_wallParticle ? 0 : this.m_system.GetParticleInvMass());
        r = box2d.b2Sub_V2_V2(i, p, r),
        r = d + s + a * (r = box2d.b2Cross_V2_V2(r, b)) * r;
        (i = this.m_system.m_bodyContactBuffer.data[this.m_system.m_bodyContactBuffer.Append()]).index = e,
        i.body = n,
        i.fixture = o,
        i.weight = 1 - t * this.m_system.m_inverseDiameter,
        i.normal.Copy(b.SelfNeg()),
        i.mass = 0 < r ? 1 / r : 0,
        this.m_system.DetectStuckParticle(e);
    }
}
,
...
box2d.b2ParticleSystem.prototype.UpdateBodyContacts = function() {
    ...
    if (this.NotifyBodyContactListenerPreContact(t),
    0 < this.m_stuckThreshold)
        for (var e = this.GetParticleCount(), r = 0; r < e; r++)
...
box2d.b2ParticleSystem.prototype.Solve = function(o) {
    ...
    !this.m_paused))
        for (this.m_iterationIndex = 0; this.m_iterationIndex < o.particleIterations; this.m_iterationIndex++) {
            ++this.m_timestamp;
            var e = t.Copy(o);
            e.dt /= o.particleIterations,
            e.inv_dt *= o.particleIterations,
            ...
            this.m_hasForce && this.SolveForce(e),
            ...
            this.SolveGravity(e),
            this.m_allParticleFlags & box2d.b2ParticleFlag.b2_staticPressureParticle && this.SolveStaticPressure(e),
            this.SolvePressure(e),
            this.SolveDamping(e),
            ...
            this.SolveCollision(e),
            this.m_allGroupFlags & box2d.b2ParticleGroupFlag.b2_rigidParticleGroup && this.SolveRigid(e),
            this.m_allParticleFlags & box2d.b2ParticleFlag.b2_wallParticle && this.SolveWall();
            for (var r = 0; r < this.m_count; r++)
                this.m_positionBuffer.data[r].SelfMulAdd(e.dt, this.m_velocityBuffer.data[r]);
        }
}
,
...
box2d.b2ParticleSystem.SolveCollisionCallback = function(o, t) {
    box2d.b2FixtureParticleQueryCallback.call(this, o),
    this.m_step = t;
}
,
...
box2d.b2ParticleSystem.SolveCollisionCallback.prototype.ReportFixtureAndParticle = function(o, t, e) {
    ...
    0 === this.m_system.m_iterationIndex ? (r = box2d.b2MulT_X_V2(a.m_xf0, d, r),
    o.GetShape().GetType() === box2d.b2ShapeType.e_circleShape && (r.SelfSub(a.GetLocalCenter()),
    box2d.b2Mul_R_V2(a.m_xf0.q, r, r),
    box2d.b2MulT_R_V2(a.m_xf.q, r, r),
    r.SelfAdd(a.GetLocalCenter())),
    box2d.b2Mul_X_V2(a.m_xf, r, b.p1)) : b.p1.Copy(d),
    box2d.b2AddMul_V2_S_V2(d, this.m_step.dt, l, b.p2),
    b.maxFraction = 1,
    o.RayCast(i, b, t) && (o = i.normal,
    n.x = (1 - i.fraction) * b.p1.x + i.fraction * b.p2.x + box2d.b2_linearSlop * o.x,
    n.y = (1 - i.fraction) * b.p1.y + i.fraction * b.p2.y + box2d.b2_linearSlop * o.y,
    p.x = this.m_step.inv_dt * (n.x - d.x),
    p.y = this.m_step.inv_dt * (n.y - d.y),
    this.m_system.m_velocityBuffer.data[e].Copy(p),
    s.x = this.m_step.inv_dt * this.m_system.GetParticleMass() * (l.x - p.x),
    s.y = this.m_step.inv_dt * this.m_system.GetParticleMass() * (l.y - p.y),
    this.m_system.ParticleApplyForce(e, s));
}
,
...
box2d.b2ParticleSystem.prototype.SolveCollision = function(o) {
    ...
    r.lowerBound.x = +box2d.b2_maxFloat,
    r.lowerBound.y = +box2d.b2_maxFloat,
    r.upperBound.x = -box2d.b2_maxFloat,
    ...
    for (var i = 0; i < this.m_count; i++) {
        var b = e[i]
          ...
          , p = n.x + o.dt * b.x;
        b = n.y + o.dt * b.y;
        r.lowerBound.x = box2d.b2Min(r.lowerBound.x, box2d.b2Min(n.x, p)),
        r.lowerBound.y = box2d.b2Min(r.lowerBound.y, box2d.b2Min(n.y, b)),
        r.upperBound.x = box2d.b2Max(r.upperBound.x, box2d.b2Max(n.x, p)),
        r.upperBound.y = box2d.b2Max(r.upperBound.y, box2d.b2Max(n.y, b));
    }
    o = new box2d.b2ParticleSystem.SolveCollisionCallback(this,o),
...
box2d.b2ParticleSystem.prototype.SolveBarrier = function(o) {
    for (var t = box2d.b2ParticleSystem.prototype.SolveBarrier.s_aabb, e = box2d.b2ParticleSystem.prototype.SolveBarrier.s_va, r = box2d.b2ParticleSystem.prototype.SolveBarrier.s_vb, i = box2d.b2ParticleSystem.prototype.SolveBarrier.s_pba, b = box2d.b2ParticleSystem.prototype.SolveBarrier.s_vba, n = box2d.b2ParticleSystem.prototype.SolveBarrier.s_vc, p = box2d.b2ParticleSystem.prototype.SolveBarrier.s_pca, s = box2d.b2ParticleSystem.prototype.SolveBarrier.s_vca, a = box2d.b2ParticleSystem.prototype.SolveBarrier.s_qba, d = box2d.b2ParticleSystem.prototype.SolveBarrier.s_qca, l = box2d.b2ParticleSystem.prototype.SolveBarrier.s_dv, x = box2d.b2ParticleSystem.prototype.SolveBarrier.s_f, y = this.m_positionBuffer.data, c = this.m_velocityBuffer.data, _ = 0; _ < this.m_count; _++)
        0 != (this.m_flagsBuffer.data[_] & box2d.b2ParticleSystem.k_barrierWallFlags) && c[_].SetZero();
    ...
    for (var m = this.GetParticleMass(), u = 0; u < this.m_pairBuffer.count; u++) {
        if ((f = this.m_pairBuffer.data[u]).flags & box2d.b2ParticleFlag.b2_barrierParticle) {
            var h = f.indexA
              ...
              , S = y[g]
              , P = t;
            box2d.b2Min_V2_V2(f, S, P.lowerBound),
            box2d.b2Max_V2_V2(f, S, P.upperBound);
            var C, A = this.m_groupBuffer[h], B = this.m_groupBuffer[g];
            for (h = this.GetLinearVelocity(A, h, f, e),
            g = this.GetLinearVelocity(B, g, S, r),
            S = box2d.b2Sub_V2_V2(S, f, i),
            g = box2d.b2Sub_V2_V2(g, h, b),
            P = this.GetInsideBoundsEnumerator(P); 0 <= (C = P.GetNext()); ) {
                var v = y[C]
                ...
                if (A !== V && B !== V) {
                    ...
                    if (0 === w) {
                        ...
                        if (!(0 <= (T = -T / G) && T < _))
                            continue;
                        if (box2d.b2AddMul_V2_S_V2(S, T, g, I),
                        box2d.b2AddMul_V2_S_V2(M, T, D, R),
                        !(0 <= (G = box2d.b2Dot_V2_V2(I, R) / box2d.b2Dot_V2_V2(I, I)) && 1 >= G))
                            continue;
                    } else {
                        if (0 > (T = G * G - 4 * T * w))
                            continue;
                        var F = box2d.b2Sqrt(T);
                        if ((T = (-G - F) / (2 * w)) > (w = (-G + F) / (2 * w)) && (G = T,
                        T = w,
                        w = G),
                        box2d.b2AddMul_V2_S_V2(S, T, g, I),
                        box2d.b2AddMul_V2_S_V2(M, T, D, R),
                        G = box2d.b2Dot_V2_V2(I, R) / box2d.b2Dot_V2_V2(I, I),
                        !(0 <= T && T < _ && 0 <= G && 1 >= G)) {
                            if (!(0 <= (T = w) && T < _))
                                continue;
                            if (box2d.b2AddMul_V2_S_V2(S, T, g, I),
                    ...
                    (M = l).x = h.x + G * g.x - J.x,
                    M.y = h.y + G * g.y - J.y,
                    J = box2d.b2Mul_S_V2(m, M, x),
                    this.IsRigidGroup(V) ? (m = V.GetMass(),
                    M = V.GetInertia(),
                    0 < m && V.m_linearVelocity.SelfMulAdd(1 / m, J),
        ...
        for (i = 0; i < this.m_contactBuffer.count; i++) {
            if ((p = this.m_contactBuffer.data[i]).flags & box2d.b2ParticleFlag.b2_staticPressureParticle) {
                var b = p.indexA
                  , n = p.indexB
                  , p = p.weight;
                this.m_accumulationBuffer[b] += p * this.m_staticPressureBuffer[n],
                this.m_accumulationBuffer[n] += p * this.m_staticPressureBuffer[b];
            }
        }
        for (i = 0; i < this.m_count; i++)
            p = this.m_weightBuffer[i],
            this.m_staticPressureBuffer[i] = this.m_flagsBuffer.data[i] & box2d.b2ParticleFlag.b2_staticPressureParticle ? box2d.b2Clamp((this.m_accumulationBuffer[i] + o * (p - box2d.b2_minParticleWeight)) / (p + e), 0, t) : 0;
    }
}
,
box2d.b2ParticleSystem.prototype.ComputeWeight = function() {
    for (var o = 0; o < this.m_count; o++)
        this.m_weightBuffer[o] = 0;
...
box2d.b2ParticleSystem.prototype.SolvePressure = function(o) {
    ...
    if (this.m_allParticleFlags & box2d.b2ParticleSystem.k_noPressureFlags)
        for (p = 0; p < this.m_count; p++)
            this.m_flagsBuffer.data[p] & box2d.b2ParticleSystem.k_noPressureFlags && (this.m_accumulationBuffer[p] = 0);
    if (this.m_allParticleFlags & box2d.b2ParticleFlag.b2_staticPressureParticle)
        ...
        p = 0; p < this.m_count; p++)
            this.m_flagsBuffer.data[p] & box2d.b2ParticleFlag.b2_staticPressureParticle && (this.m_accumulationBuffer[p] += this.m_staticPressureBuffer[p]);
    for (o = o.dt / (this.m_def.density * this.m_particleDiameter),
    ...
    p = 0; p < this.m_bodyContactBuffer.count; p++) {
        ...
        s.mass)
          , x = s.normal
          , y = e[a];
        s = this.m_accumulationBuffer[a] + b * i,
        i = box2d.b2Mul_S_V2(o * i * l * s, x, t);
        r[a].SelfMulSub(n, i),
        d.ApplyLinearImpulse(i, y, !0);
    }
    for (p = 0; p < this.m_contactBuffer.count; p++)
        a = (s = this.m_contactBuffer.data[p]).indexA,
        d = s.indexB,
        i = s.weight,
        x = s.normal,
        s = this.m_accumulationBuffer[a] + this.m_accumulationBuffer[d],
        i = box2d.b2Mul_S_V2(o * i * s, x, t),
        r[a].SelfSub(i),
        r[d].SelfAdd(i);
}
,
box2d.b2ParticleSystem.prototype.SolvePressure.s_f = new box2d.b2Vec2(),
box2d.b2ParticleSystem.prototype.SolveDamping = function(o) {
    ...
    for (var n = this.GetParticleInvMass(), p = 0; p < this.m_bodyContactBuffer.count; p++) {
        ...
        l = box2d.b2Mul_S_V2(d * l * c, x, e),
        i[s].SelfMulAdd(n, l),
        a.ApplyLinearImpulse(l.SelfNeg(), y, !0));
    }
    for (p = 0; p < this.m_contactBuffer.count; p++)
        s = (y = this.m_contactBuffer.data[p]).indexA,
        a = y.indexB,
        d = y.weight,
        x = y.normal,
        c = box2d.b2Sub_V2_V2(i[a], i[s], t),
        0 > (c = box2d.b2Dot_V2_V2(c, x)) && (d = box2d.b2Max(b * d, box2d.b2Min(-o * c, .5)),
        l = box2d.b2Mul_S_V2(d * c, x, e),
        i[s].SelfAdd(l),
        i[a].SelfSub(l));
}
,
...
box2d.b2ParticleSystem.prototype.SolveRigidDamping = function() {
    for (var o = box2d.b2ParticleSystem.prototype.SolveRigidDamping.s_t0, t = box2d.b2ParticleSystem.prototype.SolveRigidDamping.s_t1, e = box2d.b2ParticleSystem.prototype.SolveRigidDamping.s_p, r = box2d.b2ParticleSystem.prototype.SolveRigidDamping.s_v, i = [0], b = [0], n = [0], p = [0], s = [0], a = [0], d = this.m_positionBuffer.data, l = this.m_def.dampingStrength, x = 0; x < this.m_bodyContactBuffer.count; x++) {
        ...
        if (this.IsRigidGroup(c)) {
            ...
            this.ApplyDamping(i[0], b[0], n[0], !0, c, y, u, m),
            _.ApplyLinearImpulse(box2d.b2Mul_S_V2(-u, m, box2d.b2Vec2.s_t0), h, !0));
        }
    }
    for (x = 0; x < this.m_contactBuffer.count; x++) {
        y = (h = this.m_contactBuffer.data[x]).indexA,
        _ = h.indexB,
        m = h.normal,
        u = h.weight,
        c = this.m_groupBuffer[y];
        ...
        c !== f && (S || P) && (h = box2d.b2Mid_V2_V2(d[y], d[_], e),
        g = box2d.b2Sub_V2_V2(this.GetLinearVelocity(f, _, h, o), this.GetLinearVelocity(c, y, h, t), r),
        0 > (g = box2d.b2Dot_V2_V2(g, m)) && (this.InitDampingParameterWithRigidGroupOrParticle(i, b, n, S, c, y, h, m),
        this.InitDampingParameterWithRigidGroupOrParticle(p, s, a, P, f, _, h, m),
        u = l * u * this.ComputeDampingImpulse(i[0], b[0], n[0], p[0], s[0], a[0], g),
        this.ApplyDamping(i[0], b[0], n[0], S, c, y, u, m),
        this.ApplyDamping(p[0], s[0], a[0], P, f, _, -u, m)));
    }
}
,
...
box2d.b2ParticleSystem.prototype.SolveExtraDamping = function() {
    for (var o = box2d.b2ParticleSystem.prototype.SolveExtraDamping.s_v, t = box2d.b2ParticleSystem.prototype.SolveExtraDamping.s_f, e = this.m_velocityBuffer.data, r = this.m_positionBuffer.data, i = this.GetParticleInvMass(), b = 0; b < this.m_bodyContactBuffer.count; b++) {
        ...
        if (this.m_flagsBuffer.data[n] & box2d.b2ParticleSystem.k_extraDampingFlags) {
            ...
            0 > (l = box2d.b2Dot_V2_V2(l, a)) && (s = box2d.b2Mul_S_V2(.5 * s * l, a, t),
            e[n].SelfMulAdd(i, s),
...
box2d.b2ParticleSystem.prototype.SolveWall = function() {
    for (var o = this.m_velocityBuffer.data, t = 0; t < this.m_count; t++)
        this.m_flagsBuffer.data[t] & box2d.b2ParticleFlag.b2_wallParticle && o[t].SetZero();
}
,
    ...
    for (var t = box2d.b2ParticleSystem.prototype.SolveRigid.s_position, e = box2d.b2ParticleSystem.prototype.SolveRigid.s_rotation, r = box2d.b2ParticleSystem.prototype.SolveRigid.s_transform, i = box2d.b2ParticleSystem.prototype.SolveRigid.s_velocityTransform, b = this.m_positionBuffer.data, n = this.m_velocityBuffer.data, p = this.m_groupList; p; p = p.GetNext())
        if (p.m_groupFlags & box2d.b2ParticleGroupFlag.b2_rigidParticleGroup) {
            ...
            var a = box2d.b2Add_V2_V2(p.m_center, box2d.b2Sub_V2_V2(box2d.b2Mul_S_V2(o.dt, p.m_linearVelocity, box2d.b2Vec2.s_t0), box2d.b2Mul_R_V2(s, p.m_center, box2d.b2Vec2.s_t1), box2d.b2Vec2.s_t0), t)
              , d = r;
            for (d.SetPositionRotation(a, s),
            box2d.b2Mul_X_X(d, p.m_transform, p.m_transform),
            (s = i).p.x = o.inv_dt * d.p.x,
            s.p.y = o.inv_dt * d.p.y,
            s.q.s = o.inv_dt * d.q.s,
            s.q.c = o.inv_dt * (d.q.c - 1),
            d = p.m_firstIndex; d < p.m_lastIndex; d++)
                box2d.b2Mul_X_V2(s, b[d], n[d]);
        }
}
,
...
box2d.b2ParticleSystem.prototype.SolveElastic = function(o) {
    for (var t = box2d.b2ParticleSystem.prototype.SolveElastic.s_pa, e = box2d.b2ParticleSystem.prototype.SolveElastic.s_pb, r = box2d.b2ParticleSystem.prototype.SolveElastic.s_pc, i = box2d.b2ParticleSystem.prototype.SolveElastic.s_r, b = box2d.b2ParticleSystem.prototype.SolveElastic.s_t0, n = this.m_positionBuffer.data, p = this.m_velocityBuffer.data, s = o.inv_dt * this.m_def.elasticStrength, a = 0; a < this.m_triadBuffer.count; a++) {
        ...
        if (d.flags & box2d.b2ParticleFlag.b2_elasticParticle) {
            ...
            g.x -= f,
            g.y -= S,
            (f = i).s = box2d.b2Cross_V2_V2(c, u) + box2d.b2Cross_V2_V2(_, h) + box2d.b2Cross_V2_V2(m, g),
            f.c = box2d.b2Dot_V2_V2(c, u) + box2d.b2Dot_V2_V2(_, h) + box2d.b2Dot_V2_V2(m, g),
            S = box2d.b2InvSqrt(f.s * f.s + f.c * f.c),
            isFinite(S) || (S = 198177537e11),
            f.s *= S,
            f.c *= S,
            f.angle = Math.atan2(f.s, f.c),
            d = s * d.strength,
            box2d.b2Mul_R_V2(f, c, b),
            box2d.b2Sub_V2_V2(b, u, b),
            box2d.b2Mul_S_V2(d, b, b),
            l.SelfAdd(b),
            box2d.b2Mul_R_V2(f, _, b),
            box2d.b2Sub_V2_V2(b, h, b),
            box2d.b2Mul_S_V2(d, b, b),
            x.SelfAdd(b),
            box2d.b2Mul_R_V2(f, m, b),
            box2d.b2Sub_V2_V2(b, g, b),
            box2d.b2Mul_S_V2(d, b, b),
            y.SelfAdd(b);
        }
    }
...
box2d.b2ParticleSystem.prototype.SolveSpring = function(o) {
...
box2d.b2ParticleSystem.prototype.SolveTensile = function(o) {
    ...
    for (var b = 0; b < this.m_count; b++)
        this.m_accumulation2Buffer[b] = box2d.b2Vec2_zero.Clone(),
    ...
    for (b = 0; b < this.m_contactBuffer.count; b++) {
        if ((a = this.m_contactBuffer.data[b]).flags & box2d.b2ParticleFlag.b2_tensileParticle) {
            ...
            this.m_accumulation2Buffer[n].SelfSub(s),
            this.m_accumulation2Buffer[p].SelfAdd(s);
        }
    }
    b = this.GetCriticalVelocity(o),
    o = this.m_def.surfaceTensionPressureStrength * b;
    ...
    for (b = 0; b < this.m_contactBuffer.count; b++)
        if ((a = this.m_contactBuffer.data[b]).flags & box2d.b2ParticleFlag.b2_tensileParticle) {
            ...
            s = box2d.b2Min(o * (l - 2) + t * box2d.b2Dot_V2_V2(x, a), d) * s,
            s = box2d.b2Mul_S_V2(s, a, r);
            i[n].SelfSub(s),
            i[p].SelfAdd(s);
        }
}
...
box2d.b2ParticleSystem.prototype.SolveViscous = function() {
    for (var o = box2d.b2ParticleSystem.prototype.SolveViscous.s_v, t = box2d.b2ParticleSystem.prototype.SolveViscous.s_f, e = this.m_positionBuffer.data, r = this.m_velocityBuffer.data, i = this.m_def.viscousStrength, b = this.GetParticleInvMass(), n = 0; n < this.m_bodyContactBuffer.count; n++) {
        ...
        if (this.m_flagsBuffer.data[p] & box2d.b2ParticleFlag.b2_viscousParticle) {
            ...
            r[p].SelfMulAdd(b, a),
            s.ApplyLinearImpulse(a.SelfNeg(), l, !0);
        }
    }
    for (n = 0; n < this.m_contactBuffer.count; n++)
        (l = this.m_contactBuffer.data[n]).flags & box2d.b2ParticleFlag.b2_viscousParticle && (p = l.indexA,
        s = l.indexB,
        a = l.weight,
        x = box2d.b2Sub_V2_V2(r[s], r[p], o),
        a = box2d.b2Mul_S_V2(i * a, x, t),
        r[p].SelfAdd(a),
        r[s].SelfSub(a));
}
,
...
box2d.b2ParticleSystem.prototype.SolvePowder = function(o) {
    ...
    for (var i = 1 - box2d.b2_particleStride, b = this.GetParticleInvMass(), n = 0; n < this.m_bodyContactBuffer.count; n++) {
        ...
        if (this.m_flagsBuffer.data[p] & box2d.b2ParticleFlag.b2_powderParticle) {
            ...
            if (s > i) {
                ...
                r[p].SelfMulSub(b, x),
                a.ApplyLinearImpulse(x, d, !0);
            }
        }
    }
    for (n = 0; n < this.m_contactBuffer.count; n++)
        (x = this.m_contactBuffer.data[n]).flags & box2d.b2ParticleFlag.b2_powderParticle && ((s = x.weight) > i && (p = x.indexA,
        a = x.indexB,
        l = x.normal,
        x = box2d.b2Mul_S_V2(o * (s - i), l, t),
        r[p].SelfSub(x),
        r[a].SelfAdd(x)));
}
,
box2d.b2ParticleSystem.prototype.SolvePowder.s_f = new box2d.b2Vec2(),
box2d.b2ParticleSystem.prototype.SolveSolid = function(o) {
    var t = box2d.b2ParticleSystem.prototype.SolveSolid.s_f
      , e = this.m_velocityBuffer.data;
    this.m_depthBuffer = this.RequestBuffer(this.m_depthBuffer),
    o = o.inv_dt * this.m_def.ejectionStrength;
    for (var r = 0; r < this.m_contactBuffer.count; r++) {
        var i = this.m_contactBuffer.data[r]
          , b = i.indexA
          , n = i.indexB;
...
box2d.b2ParticleSystem.prototype.SolveForce = function(o) {
    var t = this.m_velocityBuffer.data;
    o = o.dt * this.GetParticleInvMass();
    for (var e = 0; e < this.m_count; e++)
        t[e].SelfMulAdd(o, this.m_forceBuffer[e]);
    this.m_hasForce = !1;
}
,
...
box2d.b2ParticleSystem.prototype.SolveZombie = function() {
    for (var o = 0, t = [], e = 0; e < this.m_count; e++)
        t[e] = box2d.b2_invalidParticleIndex;
    ...
    for (e = 0; e < this.m_count; e++) {
        ...
        if (i & box2d.b2ParticleFlag.b2_zombieParticle) {
            ...
            this.m_handleIndexBuffer.data[e] = null),
            t[e] = box2d.b2_invalidParticleIndex;
        } else
            t[e] = o,
            e !== o && (this.m_handleIndexBuffer.data && ((b = this.m_handleIndexBuffer.data[e]) && b.SetIndex(o),
            this.m_handleIndexBuffer.data[o] = b),
            this.m_flagsBuffer.data[o] = this.m_flagsBuffer.data[e],
            ...
            this.m_positionBuffer.data[o].Copy(this.m_positionBuffer.data[e]),
            this.m_velocityBuffer.data[o].Copy(this.m_velocityBuffer.data[e]),
            this.m_groupBuffer[o] = this.m_groupBuffer[e],
            this.m_hasForce && this.m_forceBuffer[o].Copy(this.m_forceBuffer[e]),
            this.m_staticPressureBuffer && (this.m_staticPressureBuffer[o] = this.m_staticPressureBuffer[e]),
            this.m_depthBuffer && (this.m_depthBuffer[o] = this.m_depthBuffer[e]),
            this.m_colorBuffer.data && this.m_colorBuffer.data[o].Copy(this.m_colorBuffer.data[e]),
    ...
    for (e = 0; e < this.m_proxyBuffer.count; e++)
        (i = this.m_proxyBuffer.data[e]).index = t[i.index];
    for (this.m_proxyBuffer.RemoveIf(function(o) {
        return 0 > o.index;
    }),
    e = 0; e < this.m_contactBuffer.count; e++)
        (i = this.m_contactBuffer.data[e]).indexA = t[i.indexA],
        i.indexB = t[i.indexB];
    for (this.m_contactBuffer.RemoveIf(function(o) {
        return 0 > o.indexA || 0 > o.indexB;
    }),
    e = 0; e < this.m_bodyContactBuffer.count; e++)
        (i = this.m_bodyContactBuffer.data[e]).index = t[i.index];
    for (this.m_bodyContactBuffer.RemoveIf(function(o) {
        return 0 > o.index;
    }),
    e = 0; e < this.m_pairBuffer.count; e++)
        (i = this.m_pairBuffer.data[e]).indexA = t[i.indexA],
        i.indexB = t[i.indexB];
    for (this.m_pairBuffer.RemoveIf(function(o) {
        return 0 > o.indexA || 0 > o.indexB;
    }),
    e = 0; e < this.m_triadBuffer.count; e++)
        (i = this.m_triadBuffer.data[e]).indexA = t[i.indexA],
        i.indexB = t[i.indexB],
        i.indexC = t[i.indexC];
    ...
    this.m_indexByExpirationTimeBuffer.data)
        for (i = e = 0; i < this.m_count; i++)
            (b = t[this.m_indexByExpirationTimeBuffer.data[i]]) !== box2d.b2_invalidParticleIndex && (this.m_indexByExpirationTimeBuffer.data[e++] = b);
    for (i = this.m_groupList; i; i = i.GetNext()) {
        ...
        for (e = i.m_firstIndex; e < i.m_lastIndex; e++) {
            var s = t[e];
            0 <= s ? (b = box2d.b2Min(b, s),
            n = box2d.b2Max(n, s + 1)) : p = !0;
        }
        b < n ? (i.m_firstIndex = b,
        i.m_lastIndex = n,
        p && i.m_groupFlags & box2d.b2ParticleGroupFlag.b2_solidParticleGroup && this.SetGroupFlags(i, i.m_groupFlags | box2d.b2ParticleGroupFlag.b2_particleGroupNeedsUpdateDepth)) : (i.m_firstIndex = 0,
        i.m_lastIndex = 0,
        i.m_groupFlags & box2d.b2ParticleGroupFlag.b2_particleGroupCanBeEmpty || this.SetGroupFlags(i, i.m_groupFlags | box2d.b2ParticleGroupFlag.b2_particleGroupWillBeDestroyed));
    }
    for (this.m_count = o,
    this.m_allParticleFlags = r,
    this.m_needsUpdateAllParticleFlags = !1,
    i = this.m_groupList; i; )
        o = i.GetNext(),
        i.m_groupFlags & box2d.b2ParticleGroupFlag.b2_particleGroupWillBeDestroyed && this.DestroyParticleGroup(i),
        i = o;
}
,
box2d.b2ParticleSystem.prototype.SolveLifetimes = function(o) {
    ...
    box2d.b2Assert(null !== this.m_indexByExpirationTimeBuffer.data),
    this.m_timeElapsed = this.LifetimeToExpirationTime(o.dt),
    o = this.GetQuantizedTimeElapsed();
...
box2d.b2ParticleSystem.prototype.RotateBuffer = function(o, t, e) {
    ...
    if (o !== t && t !== e) {
        if (box2d.b2Assert(t >= o && t <= e),
        box2d.std_rotate(this.m_flagsBuffer.data, o, t, e),
        ...
        box2d.std_rotate(this.m_positionBuffer.data, o, t, e),
        box2d.std_rotate(this.m_velocityBuffer.data, o, t, e),
        box2d.std_rotate(this.m_groupBuffer, o, t, e),
        this.m_hasForce && box2d.std_rotate(this.m_forceBuffer, o, t, e),
        this.m_staticPressureBuffer && box2d.std_rotate(this.m_staticPressureBuffer, o, t, e),
        this.m_depthBuffer && box2d.std_rotate(this.m_depthBuffer, o, t, e),
        this.m_colorBuffer.data && box2d.std_rotate(this.m_colorBuffer.data, o, t, e),
        ...
        for (r = 0; r < this.m_proxyBuffer.count; r++)
            (i = this.m_proxyBuffer.data[r]).index = d(i.index);
        for (r = 0; r < this.m_contactBuffer.count; r++)
            (i = this.m_contactBuffer.data[r]).indexA = d(i.indexA),
            i.indexB = d(i.indexB);
        for (r = 0; r < this.m_bodyContactBuffer.count; r++)
            (i = this.m_bodyContactBuffer.data[r]).index = d(i.index);
        for (r = 0; r < this.m_pairBuffer.count; r++)
            (i = this.m_pairBuffer.data[r]).indexA = d(i.indexA),
            i.indexB = d(i.indexB);
        for (r = 0; r < this.m_triadBuffer.count; r++)
            (i = this.m_triadBuffer.data[r]).indexA = d(i.indexA),
            i.indexB = d(i.indexB),
            i.indexC = d(i.indexC);
        for (r = this.m_groupList; r; r = r.GetNext())
            r.m_firstIndex = d(r.m_firstIndex),
...
box2d.b2ParticleSystem.prototype.SetUserOverridableBuffer = function(o, t, e) {
    box2d.b2Assert(null !== t && 0 < e || null === t && 0 === e),
    o.data = t,
    o.userSuppliedCapacity = e;
}
,
box2d.b2ParticleSystem.prototype.SetGroupFlags = function(o, t) {
    ...
    e & ~t && (this.m_needsUpdateAllGroupFlags = !0),
    ~this.m_allGroupFlags & t && (t & box2d.b2ParticleGroupFlag.b2_solidParticleGroup && (this.m_depthBuffer = this.RequestBuffer(this.m_depthBuffer)),
    this.m_allGroupFlags |= t),
    o.m_groupFlags = t;
}
,
box2d.b2ParticleSystem.prototype.RemoveSpuriousBodyContacts = function() {
    ...
    this.m_bodyContactBuffer.count = box2d.std_remove_if(this.m_bodyContactBuffer.data, function(n) {
        ...
        if (p.SelfMul(r.m_particleDiameter * (1 - n.weight)),
        p = box2d.b2Add_V2_V2(r.m_positionBuffer.data[n.index], p, t),
        !n.fixture.TestPoint(p)) {
            for (var s = n.fixture.GetShape().GetChildCount(), a = 0; a < s; a++)
                if (n.fixture.ComputeDistance(p, e, a) < box2d.b2_linearSlop)
                    return !1;
            return 0,
            !0;
        }
...
box2d.b2ParticleSystem.prototype.DetectStuckParticle = function(o) {
    0 >= this.m_stuckThreshold || (++this.m_bodyContactCountBuffer.data[o],
    2 === this.m_bodyContactCountBuffer.data[o] && (++this.m_consecutiveContactStepsBuffer.data[o],
...
box2d.b2ParticleSystem.prototype.InitDampingParameter = function(o, t, e, r, i, b, n, p) {
    o[0] = 0 < r ? 1 / r : 0,
    t[0] = 0 < i ? 1 / i : 0,
    e[0] = box2d.b2Cross_V2_V2(box2d.b2Sub_V2_V2(n, b, box2d.b2Vec2.s_t0), p);
}
,
...
box2d.b2ParticleSystem.prototype.ApplyDamping = function(o, t, e, r, i, b, n, p) {
    r ? (i.m_linearVelocity.SelfMulAdd(n * o, p),
    i.m_angularVelocity += n * e * t) : this.m_velocityBuffer.data[b].SelfMulAdd(n * o, p);
}
,
box2d.b2StackQueue = function(o) {
    this.m_buffer = box2d.b2MakeArray(o),
    this.m_end = o;
}
,
...
box2d.b2StackQueue.prototype.Push = function(o) {
    if (this.m_back >= this.m_capacity) {
        for (var t = this.m_front; t < this.m_back; t++)
...
box2d.b2StackQueue.prototype.Empty = function() {
    return box2d.b2Assert(this.m_front <= this.m_back),
...
box2d.b2VoronoiDiagram.prototype.Generate = function(o, t) {
    ...
    for (var e = 1 / o, r = new box2d.b2Vec2(+box2d.b2_maxFloat,+box2d.b2_maxFloat), i = new box2d.b2Vec2(-box2d.b2_maxFloat,-box2d.b2_maxFloat), b = 0, n = 0; n < this.m_generatorCount; n++) {
        ...
        box2d.b2Max_V2_V2(i, s.center, i),
        ++b);
    }
    if (0 === b)
        ...
        for (; !i.Empty(); )
            ...
            s = n.m_generator,
            i.Pop(),
            this.m_diagram[e] || (this.m_diagram[e] = s,
            0 < b && i.Push(new box2d.b2VoronoiDiagram.b2VoronoiDiagramTask(b - 1,p,e - 1,s)),
        ...
        for (; !i.Empty(); )
            ...
            n = n.m_generator,
            i.Pop(),
            (r = this.m_diagram[e]) !== n) {
                var s = r.center.x - b
                  , a = (r = r.center.y - p,
                n.center.x - b)
                  , d = n.center.y - p;
                s * s + r * r > a * a + d * d && (this.m_diagram[e] = n,
                0 < b && i.Push(new box2d.b2VoronoiDiagram.b2VoronoiDiagramTask(b - 1,p,e - 1,n)),
...
box2d.b2Rope.prototype.Initialize = function(o) {
    ...
    e = this.m_count - 2;
    for (this.m_Ls = box2d.b2MakeNumberArray(r),
    ...
    for (t = 0; t < e; ++t)
        ...
        b = this.m_ps[t + 1],
        r = this.m_ps[t + 2],
        i = box2d.b2Sub_V2_V2(b, i, box2d.b2Vec2.s_t0),
        r = box2d.b2Sub_V2_V2(r, b, box2d.b2Vec2.s_t1),
        b = box2d.b2Cross_V2_V2(i, r),
        i = box2d.b2Dot_V2_V2(i, r),
        this.m_as[t] = box2d.b2Atan2(b, i);
...
box2d.b2Rope.prototype.Step = function(o, t) {
    if (0 !== o) {
        for (var e = Math.exp(-o * this.m_damping), r = 0; r < this.m_count; ++r)
            this.m_p0s[r].Copy(this.m_ps[r]),
            0 < this.m_ims[r] && this.m_vs[r].SelfMulAdd(o, this.m_gravity),
            this.m_vs[r].SelfMul(e),
        ...
        for (e = 1 / o,
        r = 0; r < this.m_count; ++r)
            box2d.b2Mul_S_V2(e, box2d.b2Sub_V2_V2(this.m_ps[r], this.m_p0s[r], box2d.b2Vec2.s_t0), this.m_vs[r]);
    }
}
,
...
box2d.b2Rope.prototype.SolveC2 = function() {
    for (var o = this.m_count - 1, t = 0; t < o; ++t) {
        ...
        if (0 !== n + p) {
            var s = p / (n + p);
            e.SelfMulSub(n / (n + p) * this.m_k2 * (this.m_Ls[t] - b), i),
            r.SelfMulAdd(this.m_k2 * s * (this.m_Ls[t] - b), i);
        }
    }
}
,
...
box2d.b2Rope.prototype.SetAngle = function(o) {
...
box2d.b2Rope.prototype.SolveC3 = function() {
    for (var o = this.m_count - 2, t = 0; t < o; ++t) {
        ...
        if (0 != (x = s.LengthSquared()) * (y = a.LengthSquared())) {
            ...
            s = box2d.b2Mul_S_V2(-1 / x, s.SelfSkew(), box2d.b2Rope.s_Jd1),
            box2d.b2Mul_S_V2(1 / y, a.SelfSkew(), box2d.b2Rope.s_Jd2))
            ...
            if (0 !== (x = b * box2d.b2Dot_V2_V2(a, a) + n * box2d.b2Dot_V2_V2(y, y) + p * box2d.b2Dot_V2_V2(s, s))) {
                for (x = 1 / x,
                l = d - this.m_as[t]; l > box2d.b2_pi; )
                    l = (d -= 2 * box2d.b2_pi) - this.m_as[t];
                for (; l < -box2d.b2_pi; )
                    l = (d += 2 * box2d.b2_pi) - this.m_as[t];
                d = -this.m_k3 * x * l,
                e.SelfMulAdd(b * d, a),
    ...
    if (this.m_bodyList)
        ...
        o = this.m_bodyList; o; o = o.nextBody) {
            ...
            if (t.IsAwake()) {
                ...
                r.x /= b,
                r.y /= b,
                i < box2d.b2_epsilon || ((b = this.gravity.Clone().SelfNeg()).SelfMul(this.density * i),
                t.ApplyForce(b, r),
                (r = t.GetLinearVelocityFromWorldPoint(e, new box2d.b2Vec2())).SelfSub(this.velocity),
                r.SelfMul(-this.linearDrag * i),
                t.ApplyForce(r, e),
                t.ApplyTorque(-t.GetInertia() / t.GetMass() * i * t.GetAngularVelocity() * this.angularDrag));
            }
        }
}
,
    ...
    if (this.invSqr)
        for (o = this.m_bodyList; o; o = o.nextBody)
            for (var t = o.body, e = t.GetWorldCenter(), r = t.GetMass(), i = this.m_bodyList; i !== o; i = i.nextBody) {
                ...
                t.IsAwake() && t.ApplyForce(s, e),
                b.IsAwake() && b.ApplyForce(s.SelfMul(-1), n));
            }
    else
        for (o = this.m_bodyList; o; o = o.nextBody)
            for (e = (t = o.body).GetWorldCenter(),
            r = t.GetMass(),
            i = this.m_bodyList; i !== o; i = i.nextBody)
                n = (b = i.body).GetWorldCenter(),
                p = b.GetMass(),
                (d = (s = n.x - e.x) * s + (a = n.y - e.y) * a) < box2d.b2_epsilon || ((s = box2d.b2GravityController.prototype.Step.s_f.Set(s, a)).SelfMul(this.G / d * r * p),
                t.IsAwake() && t.ApplyForce(s, e),
                b.IsAwake() && b.ApplyForce(s.SelfMul(-1), n));
}
,
...
function(o, t) {
    ...
    class r extends t.Component {
        ...
        set isSensor(o) {
            this._isSensor = o,
            this._def && (this._def.isSensor = o,
            this.refresh());
        }
        get density() {
        ...
        set friction(o) {
            this._friction = o,
            this._def && (this._def.friction = o,
            this.refresh());
        }
        get restitution() {
        ...
        set restitution(o) {
            this._restitution = o,
            this._def && (this._def.restitution = o,
            this.refresh());
        }
        refresh() {
            if (this.enabled && this.rigidBody) {
                ...
                this.fixture = null);
                var t = this.getDef();
                t.filter.groupIndex = this.rigidBody.group,
                t.filter.categoryBits = this.rigidBody.category,
                t.filter.maskBits = this.rigidBody.mask,
                this.fixture = o.CreateFixture(t),
    ...
    t.ClassUtils.regClass("laya.physics.ColliderBase", r),
    t.ClassUtils.regClass("Laya.ColliderBase", r);
    class i extends t.Component {
        ...
        _createBody() {
            if (!this._body && this.owner) {
                ...
                i.position.Set(b.x / e.Physics.PIXEL_RATIO, b.y / e.Physics.PIXEL_RATIO),
                i.angle = t.Utils.toRadian(o.rotation),
                i.allowSleep = this._allowSleep,
                i.angularDamping = this._angularDamping,
                i.angularVelocity = this._angularVelocity,
                i.bullet = this._bullet,
                i.fixedRotation = !this._allowRotation,
                i.gravityScale = this._gravityScale,
                i.linearDamping = this._linearDamping;
                var n = this._linearVelocity;
                (n && 0 != n.x || 0 != n.y) && (i.linearVelocity = new r.b2Vec2(n.x,n.y)),
                i.type = r.b2BodyType["b2_" + this._type + "Body"],
                this._body = e.Physics.I._createBody(i),
        ...
        _onEnable() {
            var o = this;
            this._createBody(),
            t.Laya.physicsTimer.frameLoop(1, this, this._sysPhysicToNode);
            var e = this.owner;
            if (this.accessGetSetFunc(e, "x", "set") && !e._changeByRigidBody) {
                e._changeByRigidBody = !0,
                this._overSet(e, "x", function(t) {
                    o.accessGetSetFunc(e, "x", "set")(t),
                    o._sysPosToPhysic();
                }),
                this._overSet(e, "y", function(t) {
                    o.accessGetSetFunc(e, "y", "set")(t),
                    o._sysPosToPhysic();
                }),
                this._overSet(e, "rotation", function(t) {
                    o.accessGetSetFunc(e, "rotation", "set")(t),
                    o._sysNodeToPhysic();
                }),
                this._overSet(e, "scaleX", function(t) {
                    o.accessGetSetFunc(e, "scaleX", "set")(t),
                    o.resetCollider(!0);
                }),
                this._overSet(e, "scaleY", function(t) {
                    o.accessGetSetFunc(e, "scaleY", "set")(t),
                    o.resetCollider(!0);
                });
            }
        }
        ...
        _sysPhysicToNode() {
            if ("static" != this.type && this._body.IsAwake()) {
                ...
                0 == r) {
                    ...
                    this.accessGetSetFunc(i, "x", "set")(b.x),
                    this.accessGetSetFunc(i, "y", "set")(b.y);
                } else
                    (b = i.globalToLocal(t.Point.TEMP.setTo(o.x * e.Physics.PIXEL_RATIO, o.y * e.Physics.PIXEL_RATIO), !1, e.Physics.I.worldRoot)).x += i.pivotX,
                    b.y += i.pivotY,
                    b = i.toParentPoint(b),
                    this.accessGetSetFunc(i, "x", "set")(b.x),
                    this.accessGetSetFunc(i, "y", "set")(b.y);
        ...
        _onDisable() {
            t.Laya.physicsTimer.clear(this, this._sysPhysicToNode),
            e.Physics.I._removeBody(this._body),
            this._body = null;
            var o = this.owner;
            o._changeByRigidBody && (this._overSet(o, "x", this.accessGetSetFunc(o, "x", "set")),
            this._overSet(o, "y", this.accessGetSetFunc(o, "y", "set")),
            this._overSet(o, "rotation", this.accessGetSetFunc(o, "rotation", "set")),
            this._overSet(o, "scaleX", this.accessGetSetFunc(o, "scaleX", "set")),
            this._overSet(o, "scaleY", this.accessGetSetFunc(o, "scaleY", "set")),
        ...
        applyForce(o, t) {
            ...
            this._body.ApplyForce(t, o);
        }
        applyForceToCenter(o) {
            this._body || this._onAwake(),
            this._body.ApplyForceToCenter(o);
        }
        applyLinearImpulse(o, t) {
            this._body || this._onAwake(),
            this._body.ApplyLinearImpulse(t, o);
        }
        applyLinearImpulseToCenter(o) {
            this._body || this._onAwake(),
            this._body.ApplyLinearImpulseToCenter(o);
        }
        applyTorque(o) {
            this._body || this._onAwake(),
            this._body.ApplyTorque(o);
        }
        setVelocity(o) {
            this._body || this._onAwake(),
            this._body.SetLinearVelocity(o);
        }
        setAngle(o) {
            this._body || this._onAwake(),
            this._body.SetAngle(o),
        ...
        getCenter() {
            ...
            return o.x = o.x * e.Physics.PIXEL_RATIO,
            o.y = o.y * e.Physics.PIXEL_RATIO,
            o;
        }
        getWorldCenter() {
            this._body || this._onAwake();
        ...
        set gravityScale(o) {
            this._gravityScale = o,
            this._body && this._body.SetGravityScale(o);
        }
        get allowRotation() {
            return this._allowRotation;
        }
        set allowRotation(o) {
            this._allowRotation = o,
            this._body && this._body.SetFixedRotation(!o);
        }
        get allowSleep() {
        ...
        set allowSleep(o) {
            this._allowSleep = o,
            this._body && this._body.SetSleepingAllowed(o);
        }
        get angularDamping() {
            return this._angularDamping;
        }
        set angularDamping(o) {
            this._angularDamping = o,
            this._body && this._body.SetAngularDamping(o);
        }
        get angularVelocity() {
            return this._body ? this._body.GetAngularVelocity() : this._angularVelocity;
        }
        set angularVelocity(o) {
            this._angularVelocity = o,
            this._body && this._body.SetAngularVelocity(o);
        }
        get linearDamping() {
            return this._linearDamping;
        }
        set linearDamping(o) {
            this._linearDamping = o,
            this._body && this._body.SetLinearDamping(o);
        }
        get linearVelocity() {
            if (this._body) {
        ...
        set linearVelocity(o) {
            ...
            this._linearVelocity = o,
            this._body && this._body.SetLinearVelocity(new window.box2d.b2Vec2(o.x,o.y)));
        }
        get bullet() {
            return this._bullet;
        }
        set bullet(o) {
            this._bullet = o,
            this._body && this._body.SetBullet(o);
        }
    }
    t.ClassUtils.regClass("laya.physics.RigidBody", i),
    t.ClassUtils.regClass("Laya.RigidBody", i);
    class b {
        SayGoodbyeJoint(o) {
            o.m_userData && (o.m_userData.isDestroy = !0);
        }
        SayGoodbyeFixture(o) {}
        SayGoodbyeParticleGroup(o) {}
        SayGoodbyeParticle(o) {}
    }
    class n extends t.EventDispatcher {
        ...
        start(o=null) {
            if (!this._enabled) {
                ...
                var r = new e.b2Vec2(0,o.gravity || 500 / n.PIXEL_RATIO);
                this.world = new e.b2World(r),
                this.world.SetDestructionListener(new b()),
                this.world.SetContactListener(new p()),
                this.allowSleeping = null == o.allowSleeping || o.allowSleeping,
                o.customUpdate || t.Laya.physicsTimer.frameLoop(1, this, this._update),
        ...
        _update() {
            ...
            if (o > 0) {
                for (var t = 0; t < o; t += 2)
                    this._sendEvent(this._eventList[t], this._eventList[t + 1]);
        ...
        _sendEvent(o, e) {
            ...
            b) {
                var s = [i, r, e];
                0 === o ? (b.event(t.Event.TRIGGER_ENTER, s),
                b._triggered ? b.event(t.Event.TRIGGER_STAY, s) : b._triggered = !0) : (b._triggered = !1,
                b.event(t.Event.TRIGGER_EXIT, s));
            }
            p && (s = [r, i, e],
            0 === o ? (p.event(t.Event.TRIGGER_ENTER, s),
            p._triggered ? p.event(t.Event.TRIGGER_STAY, s) : p._triggered = !0) : (p._triggered = !1,
            p.event(t.Event.TRIGGER_EXIT, s)));
        }
        _createBody(o) {
            return this.world ? this.world.CreateBody(o) : (console.error('The physical engine should be initialized first.use "Physics.enable()"'),
            null);
        }
        _removeBody(o) {
        ...
        _createJoint(o) {
            if (this.world) {
                let t = this.world.CreateJoint(o);
                return t.m_userData = {},
                t.m_userData.isDestroy = !1,
                t;
            }
    ...
    n.PIXEL_RATIO = 50,
    t.ClassUtils.regClass("laya.physics.Physics", n),
    t.ClassUtils.regClass("Laya.Physics", n);
    class p {
        BeginContact(o) {
    ...
    class s extends r {
        ...
        _setShape(o=!0) {
            ...
            this._shape.SetAsBox(this._width / 2 / n.PIXEL_RATIO * t, this._height / 2 / n.PIXEL_RATIO * e, new window.box2d.b2Vec2((this._width / 2 + this._x) / n.PIXEL_RATIO * t,(this._height / 2 + this._y) / n.PIXEL_RATIO * e)),
            o && this.refresh();
        }
        get x() {
            return this._x;
    ...
    t.ClassUtils.regClass("laya.physics.BoxCollider", s),
    t.ClassUtils.regClass("Laya.BoxCollider", s);
    class a extends r {
        constructor() {
            super(...arguments),
            this._x = 0,
        ...
        _setShape(o=!0) {
            ...
            for (var r = [], i = 0, b = e; i < b; i += 2)
                r.push(new window.box2d.b2Vec2((this._x + parseInt(t[i])) / n.PIXEL_RATIO,(this._y + parseInt(t[i + 1])) / n.PIXEL_RATIO));
    ...
    t.ClassUtils.regClass("laya.physics.ChainCollider", a),
    t.ClassUtils.regClass("Laya.ChainCollider", a);
    class d extends r {
        constructor() {
            super(...arguments),
            this._x = 0,
        ...
        _setShape(o=!0) {
            var t = this.owner.scaleX || 1;
            this._shape.m_radius = this._radius / n.PIXEL_RATIO * t,
            this._shape.m_p.Set((this._radius + this._x) / n.PIXEL_RATIO * t, (this._radius + this._y) / n.PIXEL_RATIO * t),
            o && this.refresh();
        }
        get x() {
            return this._x;
    ...
    t.ClassUtils.regClass("laya.physics.CircleCollider", d),
    t.ClassUtils.regClass("Laya.CircleCollider", d);
    class l extends t.Sprite {
        constructor() {
            super(),
            this.m_drawFlags = 99,
            ...
            l.init()),
            this._camera = {},
            this._camera.m_center = new l.box2d.b2Vec2(0,0),
            this._camera.m_extent = 25,
            this._camera.m_zoom = 1,
            this._camera.m_width = 1280,
            this._camera.m_height = 800,
            this._mG = new t.Graphics(),
            this.graphics = this._mG,
            this._textSp = new t.Sprite(),
            this._textG = this._textSp.graphics,
            this.addChild(this._textSp);
        }
        static init() {
            l.box2d = t.Browser.window.box2d,
            l.DrawString_s_color = new l.box2d.b2Color(.9,.6,.6),
            l.DrawStringWorld_s_p = new l.box2d.b2Vec2(),
            l.DrawStringWorld_s_cc = new l.box2d.b2Vec2(),
            l.DrawStringWorld_s_color = new l.box2d.b2Color(.5,.9,.5);
        }
        render(o, t, e) {
        ...
        _renderToGraphic() {
            ...
            this._mG.clear(),
            this._mG.save(),
            this._mG.scale(n.PIXEL_RATIO, n.PIXEL_RATIO),
        ...
        PushTransform(o) {
            this._mG.save(),
            this._mG.translate(o.p.x, o.p.y),
            this._mG.rotate(o.q.GetAngle());
        }
        PopTransform(o) {
            this._mG.restore();
        }
        ...
        DrawParticles(o, t, e, r) {
            if (null !== e)
                ...
                for (i = 0; i < r; ++i)
                    b = o[i],
                    this._mG.drawCircle(b.x, b.y, t, "#ffff00", null, this.lineWidth);
        }
        DrawSegment(o, t, e) {
        ...
        DrawTransform(o) {
            ...
            this._mG.drawLine(0, 0, 1, 0, l.box2d.b2Color.RED.MakeStyleString(1), this.lineWidth),
            this._mG.drawLine(0, 0, 0, 1, l.box2d.b2Color.GREEN.MakeStyleString(1), this.lineWidth),
            this.PopTransform(o);
        }
        DrawPoint(o, t, e) {
        ...
        DrawString(o, t, e) {
            this._textG.fillText(e, o, t, "15px DroidSans", l.DrawString_s_color.MakeStyleString(), "left");
        }
        ...
        static enable(o=99) {
            if (!l.I) {
                var e = new l();
                e.world = n.I.world,
                e.world.SetDebugDraw(e),
                e.zOrder = 1e3,
                e.m_drawFlags = o,
                t.Laya.stage.addChild(e),
                l.I = e;
            }
            return e;
        }
    ...
    l._inited = !1,
    t.ClassUtils.regClass("laya.physics.PhysicsDebugDraw", l),
    t.ClassUtils.regClass("Laya.PhysicsDebugDraw", l);
    class x extends r {
        constructor() {
            super(...arguments),
            this._x = 0,
    ...
    t.ClassUtils.regClass("laya.physics.PolygonCollider", x),
    t.ClassUtils.regClass("Laya.PolygonCollider", x);
    class y extends t.Component {
        ...
        _createJoint() {}
        _onDisable() {
            this._joint && this._joint.m_userData && !this._joint.m_userData.isDestroy && n.I._removeJoint(this._joint),
            this._joint = null;
        }
    }
    t.ClassUtils.regClass("laya.physics.joint.JointBase", y),
    t.ClassUtils.regClass("Laya.JointBase", y);
    class c extends y {
        constructor() {
            super(...arguments),
            this.selfAnchor = [0, 0],
        ...
        _createJoint() {
            if (!this._joint) {
                if (this.selfBody = this.selfBody || this.owner.getComponent(i),
                !this.selfBody)
                    throw "selfBody can not be empty";
                var o = window.box2d
                  , t = c._temp || (c._temp = new o.b2DistanceJointDef());
                t.bodyA = this.otherBody ? this.otherBody.getBody() : n.I._emptyBody,
                t.bodyB = this.selfBody.getBody(),
                t.localAnchorA.Set(this.otherAnchor[0] / n.PIXEL_RATIO, this.otherAnchor[1] / n.PIXEL_RATIO),
                t.localAnchorB.Set(this.selfAnchor[0] / n.PIXEL_RATIO, this.selfAnchor[1] / n.PIXEL_RATIO),
                t.frequencyHz = this._frequency,
                t.dampingRatio = this._damping,
                ...
                t.length = this._length / n.PIXEL_RATIO || o.b2Vec2.SubVV(r, e, new o.b2Vec2()).Length(),
                this._joint = n.I._createJoint(t);
            }
        }
        get length() {
            return this._length;
        ...
        set length(o) {
            this._length = o,
            this._joint && this._joint.SetLength(o / n.PIXEL_RATIO);
        }
        get frequency() {
        ...
        set frequency(o) {
            this._frequency = o,
            this._joint && this._joint.SetFrequency(o);
        }
        get damping() {
        ...
        set damping(o) {
            this._damping = o,
            this._joint && this._joint.SetDampingRatio(o);
        }
    }
    t.ClassUtils.regClass("laya.physics.joint.DistanceJoint", c),
    t.ClassUtils.regClass("Laya.DistanceJoint", c);
    class _ extends y {
        constructor() {
            super(...arguments),
            this.collideConnected = !1,
        ...
        _createJoint() {
            if (!this._joint) {
                ...
                var o = window.box2d
                  , t = _._temp || (_._temp = new o.b2GearJointDef());
                t.bodyA = this.joint1.owner.getComponent(i).getBody(),
                t.bodyB = this.joint2.owner.getComponent(i).getBody(),
                t.joint1 = this.joint1.joint,
                t.joint2 = this.joint2.joint,
                t.ratio = this._ratio,
                t.collideConnected = this.collideConnected,
                this._joint = n.I._createJoint(t);
            }
        ...
        set ratio(o) {
            this._ratio = o,
            this._joint && this._joint.SetRatio(o);
        }
    }
    t.ClassUtils.regClass("laya.physics.joint.GearJoint", _),
    t.ClassUtils.regClass("Laya.GearJoint", _);
    class m extends y {
        constructor() {
            super(...arguments),
            this.collideConnected = !1,
        ...
        _createJoint() {
            if (!this._joint) {
                ...
                !this.selfBody)
                    throw "selfBody can not be empty";
                var o = window.box2d
                  , t = m._temp || (m._temp = new o.b2MotorJointDef());
                t.Initialize(this.otherBody.getBody(), this.selfBody.getBody()),
                t.linearOffset = new o.b2Vec2(this._linearOffset[0] / n.PIXEL_RATIO,this._linearOffset[1] / n.PIXEL_RATIO),
                t.angularOffset = this._angularOffset,
                t.maxForce = this._maxForce,
                t.maxTorque = this._maxTorque,
                t.correctionFactor = this._correctionFactor,
                t.collideConnected = this.collideConnected,
                this._joint = n.I._createJoint(t);
            }
        }
        ...
        set linearOffset(o) {
            this._linearOffset = o,
            this._joint && this._joint.SetLinearOffset(new window.box2d.b2Vec2(o[0] / n.PIXEL_RATIO,o[1] / n.PIXEL_RATIO));
        }
        get angularOffset() {
            return this._angularOffset;
        }
        set angularOffset(o) {
            this._angularOffset = o,
            this._joint && this._joint.SetAngularOffset(o);
        }
        get maxForce() {
        ...
        set maxForce(o) {
            this._maxForce = o,
            this._joint && this._joint.SetMaxForce(o);
        }
        get maxTorque() {
        ...
        set maxTorque(o) {
            this._maxTorque = o,
            this._joint && this._joint.SetMaxTorque(o);
        }
        ...
        set correctionFactor(o) {
            this._correctionFactor = o,
            this._joint && this._joint.SetCorrectionFactor(o);
        }
    }
    t.ClassUtils.regClass("laya.physics.joint.MotorJoint", m),
    t.ClassUtils.regClass("Laya.MotorJoint", m);
    class u extends y {
        constructor() {
            super(...arguments),
            this._maxForce = 1e4,
        ...
        onMouseDown() {
            this._createJoint(),
            t.Laya.stage.on(t.Event.MOUSE_MOVE, this, this.onMouseMove),
        ...
        _createJoint() {
            if (!this._joint) {
                ...
                !this.selfBody)
                    throw "selfBody can not be empty";
                var o = window.box2d
                  , e = u._temp || (u._temp = new o.b2MouseJointDef());
                if (this.anchor)
                    var r = this.selfBody.owner.localToGlobal(t.Point.TEMP.setTo(this.anchor[0], this.anchor[1]), !1, n.I.worldRoot);
                else
                    r = n.I.worldRoot.globalToLocal(t.Point.TEMP.setTo(t.Laya.stage.mouseX, t.Laya.stage.mouseY));
                var b = new o.b2Vec2(r.x / n.PIXEL_RATIO,r.y / n.PIXEL_RATIO);
                e.bodyA = n.I._emptyBody,
                e.bodyB = this.selfBody.getBody(),
                e.target = b,
                e.frequencyHz = this._frequency,
                e.damping = this._damping,
                e.maxForce = this._maxForce,
                this._joint = n.I._createJoint(e);
            }
        }
        onStageMouseUp() {
            t.Laya.stage.off(t.Event.MOUSE_MOVE, this, this.onMouseMove),
            super._onDisable();
        }
        onMouseMove() {
        ...
        _onDisable() {
            this.owner.off(t.Event.MOUSE_DOWN, this, this.onMouseDown),
            super._onDisable();
        }
        get maxForce() {
            return this._maxForce;
    ...
    t.ClassUtils.regClass("laya.physics.joint.MouseJoint", u),
    t.ClassUtils.regClass("Laya.MouseJoint", u);
    class h extends y {
        constructor() {
            super(...arguments),
            this.anchor = [0, 0],
        ...
        _createJoint() {
            if (!this._joint) {
                ...
                !this.selfBody)
                    throw "selfBody can not be empty";
                var o = window.box2d
                  , e = h._temp || (h._temp = new o.b2PrismaticJointDef())
                ...
                e.Initialize(this.otherBody ? this.otherBody.getBody() : n.I._emptyBody, this.selfBody.getBody(), b, new o.b2Vec2(this.axis[0],this.axis[1])),
                e.enableMotor = this._enableMotor,
                e.motorSpeed = this._motorSpeed,
                e.maxMotorForce = this._maxMotorForce,
                e.enableLimit = this._enableLimit,
        ...
        set enableMotor(o) {
            this._enableMotor = o,
            this._joint && this._joint.EnableMotor(o);
        }
        get motorSpeed() {
        ...
        set motorSpeed(o) {
            this._motorSpeed = o,
            this._joint && this._joint.SetMotorSpeed(o);
        }
        get maxMotorForce() {
            return this._maxMotorForce;
        }
        set maxMotorForce(o) {
            this._maxMotorForce = o,
            this._joint && this._joint.SetMaxMotorForce(o);
        }
        get enableLimit() {
        ...
        set enableLimit(o) {
            this._enableLimit = o,
            this._joint && this._joint.EnableLimit(o);
        }
        get lowerTranslation() {
            return this._lowerTranslation;
        }
        set lowerTranslation(o) {
            this._lowerTranslation = o,
            this._joint && this._joint.SetLimits(o, this._upperTranslation);
        }
        get upperTranslation() {
            return this._upperTranslation;
        }
        set upperTranslation(o) {
            this._upperTranslation = o,
            this._joint && this._joint.SetLimits(this._lowerTranslation, o);
        }
    }
    t.ClassUtils.regClass("laya.physics.joint.PrismaticJoint", h),
    t.ClassUtils.regClass("Laya.PrismaticJoint", h);
    class g extends y {
        constructor() {
            super(...arguments),
            this.selfAnchor = [0, 0],
        ...
        _createJoint() {
            if (!this._joint) {
                ...
                !this.selfBody)
                    throw "selfBody can not be empty";
                var o = window.box2d
                  , e = g._temp || (g._temp = new o.b2PulleyJointDef())
                ...
                e.Initialize(this.otherBody.getBody(), this.selfBody.getBody(), d, x, b, s, this.ratio),
                e.collideConnected = this.collideConnected,
                this._joint = n.I._createJoint(e);
            }
        }
    }
    t.ClassUtils.regClass("laya.physics.joint.PulleyJoint", g),
    t.ClassUtils.regClass("Laya.PulleyJoint", g);
    class f extends y {
        constructor() {
            super(...arguments),
            this.anchor = [0, 0],
        ...
        _createJoint() {
            if (!this._joint) {
                ...
                !this.selfBody)
                    throw "selfBody can not be empty";
                var o = window.box2d
                  , e = f._temp || (f._temp = new o.b2RevoluteJointDef())
                  , r = this.selfBody.owner.localToGlobal(t.Point.TEMP.setTo(this.anchor[0], this.anchor[1]), !1, n.I.worldRoot)
                  , b = new o.b2Vec2(r.x / n.PIXEL_RATIO,r.y / n.PIXEL_RATIO);
                e.Initialize(this.otherBody ? this.otherBody.getBody() : n.I._emptyBody, this.selfBody.getBody(), b),
                e.enableMotor = this._enableMotor,
                e.motorSpeed = this._motorSpeed,
                e.maxMotorTorque = this._maxMotorTorque,
                e.enableLimit = this._enableLimit,
                e.lowerAngle = this._lowerAngle,
                e.upperAngle = this._upperAngle,
                e.collideConnected = this.collideConnected,
                this._joint = n.I._createJoint(e);
            }
        }
        ...
        set maxMotorTorque(o) {
            this._maxMotorTorque = o,
            this._joint && this._joint.SetMaxMotorTorque(o);
        }
        get enableLimit() {
            return this._enableLimit;
        }
        ...
        set lowerAngle(o) {
            this._lowerAngle = o,
            this._joint && this._joint.SetLimits(o, this._upperAngle);
        }
        get upperAngle() {
        ...
        set upperAngle(o) {
            this._upperAngle = o,
            this._joint && this._joint.SetLimits(this._lowerAngle, o);
        }
    }
    t.ClassUtils.regClass("laya.physics.joint.RevoluteJoint", f),
    t.ClassUtils.regClass("Laya.RevoluteJoint", f);
    class S extends y {
        constructor() {
            super(...arguments),
            this.selfAnchor = [0, 0],
        ...
        _createJoint() {
            if (!this._joint) {
                ...
                !this.selfBody)
                    throw "selfBody can not be empty";
                var o = window.box2d
                  , t = S._temp || (S._temp = new o.b2RopeJointDef());
                t.bodyA = this.otherBody ? this.otherBody.getBody() : n.I._emptyBody,
                t.bodyB = this.selfBody.getBody(),
                t.localAnchorA.Set(this.otherAnchor[0] / n.PIXEL_RATIO, this.otherAnchor[1] / n.PIXEL_RATIO),
                t.localAnchorB.Set(this.selfAnchor[0] / n.PIXEL_RATIO, this.selfAnchor[1] / n.PIXEL_RATIO),
        ...
        set maxLength(o) {
            this._maxLength = o,
            this._joint && this._joint.SetMaxLength(o / n.PIXEL_RATIO);
        }
    }
    t.ClassUtils.regClass("laya.physics.joint.RopeJoint", S),
    t.ClassUtils.regClass("Laya.RopeJoint", S);
    class P extends y {
        constructor() {
            super(...arguments),
            this.anchor = [0, 0],
        ...
        _createJoint() {
            if (!this._joint) {
                ...
                !this.selfBody)
                    throw "selfBody can not be empty";
                var o = window.box2d
                  , e = P._temp || (P._temp = new o.b2WeldJointDef())
                  , r = this.selfBody.owner.localToGlobal(t.Point.TEMP.setTo(this.anchor[0], this.anchor[1]), !1, n.I.worldRoot)
                  , b = new o.b2Vec2(r.x / n.PIXEL_RATIO,r.y / n.PIXEL_RATIO);
                e.Initialize(this.otherBody.getBody(), this.selfBody.getBody(), b),
                e.frequencyHz = this._frequency,
                e.dampingRatio = this._damping,
                e.collideConnected = this.collideConnected,
                this._joint = n.I._createJoint(e);
            }
        }
    ...
    t.ClassUtils.regClass("laya.physics.joint.WeldJoint", P),
    t.ClassUtils.regClass("Laya.WeldJoint", P);
    class C extends y {
        constructor() {
            super(...arguments),
            this.anchor = [0, 0],
        ...
        _createJoint() {
            if (!this._joint) {
                ...
                !this.selfBody)
                    throw "selfBody can not be empty";
                var o = window.box2d
                  , e = C._temp || (C._temp = new o.b2WheelJointDef())
                  , r = this.selfBody.owner.localToGlobal(t.Point.TEMP.setTo(this.anchor[0], this.anchor[1]), !1, n.I.worldRoot)
                  , b = new o.b2Vec2(r.x / n.PIXEL_RATIO,r.y / n.PIXEL_RATIO);
                e.Initialize(this.otherBody.getBody(), this.selfBody.getBody(), b, new o.b2Vec2(this.axis[0],this.axis[1])),
                e.enableMotor = this._enableMotor,
                e.motorSpeed = this._motorSpeed,
                e.maxMotorTorque = this._maxMotorTorque,
                e.frequencyHz = this._frequency,
        ...
        set frequency(o) {
            this._frequency = o,
            this._joint && this._joint.SetSpringFrequencyHz(o);
        }
        get damping() {
            return this._damping;
        }
        set damping(o) {
            this._damping = o,
            this._joint && this._joint.SetSpringDampingRatio(o);
        }
        get enableMotor() {
            return this._enableMotor;
        }
    ...
    t.ClassUtils.regClass("laya.physics.joint.WheelJoint", C),
    t.ClassUtils.regClass("Laya.WheelJoint", C),
    o.BoxCollider = s,
    o.ChainCollider = a,
    o.CircleCollider = d,
    o.ColliderBase = r,
    o.DestructionListener = b,
    o.DistanceJoint = c,
    o.GearJoint = _,
    o.IPhysics = e,
    o.JointBase = y,
