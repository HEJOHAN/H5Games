...
function _classCallCheck(t, e) {
    ...
    var a = function AnimationContent() {
        ...
        n = function() {
            ...
            return _createClass(AnimationParser01, null, [{
                key: "parse",
                value: function(t, n) {
                    var h, l, o, u, c, _, p, d = n.__getBuffer(),
                        f = n.readUTFString();
                    t._aniClassName = f;
                    ...
                    v > 0 && (y = d.slice(v, x));
                    var D = new e.Byte(y);
                    for (x > 0 && (t._publicExtData = d.slice(x, d.byteLength)), t._useParent = !!n.getUint8(), t._anis.length = g, h = 0; h < g; h++) {
                        ...
                        for (M.totalKeyframeDatasLength = 0, l = 0; l < A; l++) {
                            ...
                            I.childs = [];
                            var C = n.getInt16();
                            C >= 0 && (I.name = m[C], M.bone3DMap[I.name] = l), I.keyFrame = [], I.parentIndex = n.getInt16(), -1 == I.parentIndex ? I.parent = null : I.parent = M.nodes[I.parentIndex], I.lerpType = n.getUint8();
                            var S = n.getUint32();
                            D.pos = S;
                            var T = I.keyframeWidth = D.getUint16();
                            if (M.totalKeyframeDatasLength += T, 0 === I.lerpType || 1 === I.lerpType)
                                for (I.interpolationMethod = [], I.interpolationMethod.length = T, o = 0; o < T; o++) I.interpolationMethod[o] = i.AnimationTemplet.interpolation[D.getUint8()];
                            ...
                            for (o = 0, u = P; o < u; o++) {
                                ...
                                for (F.data = new Float32Array(T), F.dData = new Float32Array(T), F.nextData = new Float32Array(T), c = 0; c < T; c++) F.data[c] = n.getFloat32(), F.data[c] > -1e-8 && F.data[c] < 1e-8 && (F.data[c] = 0);
                                w += F.duration;
                            }
        ...
        h = function() {
            ...
            return _createClass(AnimationParser02, null, [{
                ...
                key: "READ_BLOCK",
                value: function() {
                    for (var t = AnimationParser02._BLOCK.count = AnimationParser02._reader.getUint16(), e = AnimationParser02._BLOCK.blockStarts = [], i = AnimationParser02._BLOCK.blockLengths = [], a = 0; a < t; a++) e.push(AnimationParser02._reader.getUint32()), i.push(AnimationParser02._reader.getUint32());
                }
            }, {
                key: "READ_STRINGS",
                value: function() {
                    var t = AnimationParser02._reader.getUint32(),
                        e = AnimationParser02._reader.getUint16(),
                        i = AnimationParser02._reader.pos;
                ...
                value: function(t, e) {
                    ...
                    for (var i = 0, a = AnimationParser02._BLOCK.count; i < a; i++) {
                        var r = e.getUint16(),
                            s = AnimationParser02._strings[r],
                            n = AnimationParser02["READ_" + s];
                ...
                key: "READ_ANIMATIONS",
                value: function() {
                    var t, e, n, h, l = AnimationParser02._reader,
                        o = l.__getBuffer(),
                        u = l.getUint16(),
                        c = [];
                    ...
                    for (AnimationParser02._templet._anis.length = _, t = 0; t < _; t++) {
                        ...
                        for (p.totalKeyframeDatasLength = 0, e = 0; e < f; e++) {
                            ...
                            var m = l.getUint16();
                            m >= 0 && (y.name = AnimationParser02._strings[m], p.bone3DMap[y.name] = e), y.keyFrame = [], y.parentIndex = l.getInt16(), -1 == y.parentIndex ? y.parent = null : y.parent = p.nodes[y.parentIndex], p.totalKeyframeDatasLength += u, y.interpolationMethod = c, null != y.parent && y.parent.childs.push(y);
                            var g = l.getUint16();
                            y.keyFrame.length = g;
                            var v = null,
                                x = null;
                            for (n = 0, h = g; n < h; n++) {
                                (v = y.keyFrame[n] = new s()).startTime = l.getFloat32(), x && (x.duration = v.startTime - x.startTime), v.dData = new Float32Array(u), v.nextData = new Float32Array(u);
                                var D = AnimationParser02._DATA.offset,
                                    M = l.getUint32(),
                                    k = 4 * u,
                                    A = o.slice(D + M, D + M + k);
    ...
    var o = function(t) {
            function AnimationPlayer() {
                var t;
                return _classCallCheck(this, AnimationPlayer), (t = _possibleConstructorReturn(this, _getPrototypeOf(AnimationPlayer).call(this))).isCache = !0, t.playbackRate = 1, t._destroyed = !1, t._currentAnimationClipIndex = -1, t._currentKeyframeIndex = -1, t._currentTime = 0, t._overallDuration = Number.MAX_VALUE, t._stopWhenCircleFinish = !1, t._elapsedPlaybackTime = 0, t._startUpdateLoopCount = -1, t._cachePlayRate = 1, t.cacheFrameRate = 60, t.returnToZeroStopped = !1, t;
            }
            return _inherits(AnimationPlayer, e.EventDispatcher), _createClass(AnimationPlayer, [{
                ...
                value: function() {
                    var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : 0,
                        ...
                        a = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : 2147483647,
                ...
                value: function() {
                    var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : 0,
                        ...
                        i = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : 2147483647,
                        a = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : 0,
                        r = arguments.length > 4 && void 0 !== arguments[4] ? arguments[4] : 0,
                        s = 1e3 / (arguments.length > 5 && void 0 !== arguments[5] ? arguments[5] : 30);
                    this.play(t, e, i, a * s, r * s);
                }
            }, {
                key: "stop",
                value: function() {
                    !(arguments.length > 0 && void 0 !== arguments[0]) || arguments[0] ? (this._currentTime = this._currentFrameTime = this._currentKeyframeIndex = 0, this._currentAnimationClipIndex = -1, this.event(e.Event.STOPPED)) : this._stopWhenCircleFinish = !0;
                }
            }, {
                key: "destroy",
                value: function() {}
        ...
        u = function() {
            ...
            return _createClass(BezierLerp, null, [{
                ...
                value: function(t, e, i, a, r) {
                    var s = BezierLerp._getBezierParamKey(e, i, a, r),
                        n = 100 * s + t;
                    ...
                    for (l = o.length, h = 0; h < l; h += 2)
                        if (t <= o[h]) return BezierLerp._bezierResultCache[n] = o[h + 1], o[h + 1];
                ...
                value: function(t, i, a, r, s) {
                    return BezierLerp._bezierPointsCache[s] ? BezierLerp._bezierPointsCache[s] : (n = [0, 0, t, i, a, r, 1, 1], h = new e.Bezier().getBezierPoints(n, 100, 3), BezierLerp._bezierPointsCache[s] = h, h);
                    var n, h;
                }
            }]), BezierLerp;
        }();
    ...
    var c = function(t) {
        function AnimationTemplet() {
            var t;
            return _classCallCheck(this, AnimationTemplet), (t = _possibleConstructorReturn(this, _getPrototypeOf(AnimationTemplet).call(this)))._anis = [], t._aniMap = {}, t.unfixedLastAniIndex = -1, t._fullFrames = null, t._boneCurKeyFrm = [], t;
        }
        return _inherits(AnimationTemplet, e.Resource), _createClass(AnimationTemplet, [{
            ...
            value: function(t, e, i, a, r, s, n, h, l) {
                var o = arguments.length > 9 && void 0 !== arguments[9] ? arguments[9] : null,
                    c = arguments.length > 10 && void 0 !== arguments[10] ? arguments[10] : 0;
                return i[a] = r[e] + (l[e] - r[e]) * u.getBezierRate(s / h, o[c], o[c + 1], o[c + 2], o[c + 3]), 5;
            }
        }, {
            ...
            value: function(t, e, i, a, r, s, n, h, l) {
                var o = arguments.length > 9 && void 0 !== arguments[9] ? arguments[9] : null,
                    c = arguments.length > 10 && void 0 !== arguments[10] ? arguments[10] : 0;
                return i[a] = o[c + 4] + o[c + 5] * u.getBezierRate((.001 * s + o[c + 6]) / o[c + 7], o[c], o[c + 1], o[c + 2], o[c + 3]), 9;
            }
        }]), AnimationTemplet;
    }();
    c.interpolation = [c._LinearInterpolation_0, c._QuaternionInterpolation_1, c._AngleInterpolation_2, c._RadiansInterpolation_3, c._Matrix4x4Interpolation_4, c._NoInterpolation_5, c._BezierInterpolation_6, c._BezierInterpolation_7], i.AnimationTemplet = c;
    var _ = function(t) {
    ...
    var p = function() {
            function Transform() {
                _classCallCheck(this, Transform), this.skX = 0, this.skY = 0, this.scX = 1, this.scY = 1, this.x = 0, this.y = 0, this.skewX = 0, this.skewY = 0;
            }
        ...
        d = function() {
            function Bone() {
                _classCallCheck(this, Bone), this.length = 10, this.resultTransform = new p(), this.resultMatrix = new e.Matrix(), this.inheritScale = !0, this.inheritRotation = !0, this.d = -1, this._children = [];
            }
            return _createClass(Bone, [{
                ...
                value: function() {
                    ...
                    if (this.rotation = this.transform.skX, i) t = this.resultTransform.getMatrix(), e.Matrix.mul(t, i, this.resultMatrix), this.resultRotation = this.rotation;
                    else if (this.resultRotation = this.rotation + this.parentBone.resultRotation, this.parentBone)
                        if (this.inheritRotation && this.inheritScale) t = this.resultTransform.getMatrix(), e.Matrix.mul(t, this.parentBone.resultMatrix, this.resultMatrix);
                        else {
                ...
                key: "updateDraw",
                value: function(t, i) {
                    Bone.ShowBones && !Bone.ShowBones[this.name] || (this._sprite ? (this._sprite.x = t + this.resultMatrix.tx, this._sprite.y = i + this.resultMatrix.ty) : (this._sprite = new e.Sprite(), this._sprite.graphics.drawCircle(0, 0, 5, "#ff0000"), this._sprite.graphics.drawLine(0, 0, this.length, 0, "#00ff00"), this._sprite.graphics.fillText(this.name, 0, 0, "20px Arial", "#00ff00", "center"), e.ILaya.stage.addChild(this._sprite), this._sprite.x = t + this.resultMatrix.tx, this._sprite.y = i + this.resultMatrix.ty));
                    var a, r = 0;
    ...
    var f = function() {
            ...
            return _createClass(UVTools, null, [{
                key: "getRelativeUV",
                value: function(t, e) {
                    var i, a, r = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : null,
                        s = t[0],
                        n = t[2] - t[0],
                        h = t[1],
                        l = t[5] - t[1];
        ...
        y = function() {
            function MeshData() {
                _classCallCheck(this, MeshData), this.uvs = new Float32Array([0, 0, 1, 0, 1, 1, 0, 1]), this.vertices = new Float32Array([0, 0, 100, 0, 100, 100, 0, 100]), this.indexes = new Uint16Array([0, 1, 3, 3, 1, 2]), this.useUvTransform = !1, this.canvasPadding = 1;
            }
        ...
        g = function() {
            function BoneSlot() {
                _classCallCheck(this, BoneSlot), this.srcDisplayIndex = -1, this.type = "src", this.displayIndex = -1, this.originalIndex = -1, this._replaceDic = {};
            }
            return _createClass(BoneSlot, [{
                ...
                key: "getSaveVerticle",
                value: function(t) {
                    return BoneSlot.useSameMatrixAndVerticle && this._preGraphicVerticle && BoneSlot.isSameArr(t, this._preGraphicVerticle) ? t = this._preGraphicVerticle : (t = e.ILaya.Utils.copyArray([], t), this._preGraphicVerticle = t), t;
                }
            }, {
                key: "getSaveMatrix",
                value: function(t) {
                    if (BoneSlot.useSameMatrixAndVerticle && this._preGraphicMatrix && BoneSlot.isSameMatrix(t, this._preGraphicMatrix)) t = this._preGraphicMatrix;
                    else {
                        var e = t.clone();
                            ...
                            case 0:
                                if (t) {
                                    ...
                                    if (this._parentMatrix) {
                                        ...
                                        if (h) {
                                            var o;
                                            if (e.Matrix.mul(h, this._parentMatrix, e.Matrix.TEMP), a ? (null == this._resultMatrix && (this._resultMatrix = new e.Matrix()), o = this._resultMatrix) : o = BoneSlot._tempResultMatrix, this._diyTexture && this.currDisplayData.uvs) {
                                ...
                                break;
                            case 1:
                                if (a ? (null == this._skinSprite && (this._skinSprite = BoneSlot.createSkinMesh()), s = this._skinSprite) : s = BoneSlot.createSkinMesh(), null == s) return;
                                var c;
                                if (null == this.currDisplayData.bones) {
                                    var _, p = this.currDisplayData.weights;
                                    this.deformData && (p = this.deformData), this._diyTexture ? (this._curDiyUV || (this._curDiyUV = []), 0 == this._curDiyUV.length && (this._curDiyUV = f.getRelativeUV(this.currTexture.uv, this.currDisplayData.uvs, this._curDiyUV), this._curDiyUV = f.getAbsoluteUV(this._diyTexture.uv, this._curDiyUV, this._curDiyUV)), _ = this._curDiyUV) : _ = this.currDisplayData.uvs, this._mVerticleArr = p;
                                    this.currDisplayData.triangles.length;
                                    c = this.currDisplayData.triangles, this.deformData && (a || (this._mVerticleArr = this.getSaveVerticle(this._mVerticleArr))), s.init2(n, c, this._mVerticleArr, _);
                                    var d, y = this.getDisplayMatrix();
                                    if (this._parentMatrix)
                                        if (y) e.Matrix.mul(y, this._parentMatrix, e.Matrix.TEMP), a ? (null == this._resultMatrix && (this._resultMatrix = new e.Matrix()), d = this._resultMatrix) : d = BoneSlot._tempResultMatrix, e.Matrix.TEMP.copyTo(d), a || (d = this.getSaveMatrix(d)), s.transform = d;
                ...
                value: function(t, e) {
                    ...
                    this._diyTexture ? (a = this._diyTexture, this._curDiyUV || (this._curDiyUV = []), 0 == this._curDiyUV.length && (this._curDiyUV = f.getRelativeUV(this.currTexture.uv, this.currDisplayData.uvs, this._curDiyUV), this._curDiyUV = f.getAbsoluteUV(this._diyTexture.uv, this._curDiyUV, this._curDiyUV)), i = this._curDiyUV) : i = this.currDisplayData.uvs;
                    ...
                    if (BoneSlot._tempVerticleArr.length = 0, o = BoneSlot._tempVerticleArr, this.deformData && this.deformData.length > 0) {
                        ...
                        for (g = 0, v = r.length; g < v;) {
                            for (d = r[g++] + g, _ = 0, p = 0; g < d; g++) n = t[r[g]], h = u[y] + this.deformData[x++], l = u[y + 1] + this.deformData[x++], m = u[y + 2], _ += (h * n.a + l * n.c + n.tx) * m, p += (h * n.b + l * n.d + n.ty) * m, y += 3;
                            o.push(_, p);
                        }
                    } else
                        for (g = 0, v = r.length; g < v;) {
                            for (d = r[g++] + g, _ = 0, p = 0; g < d; g++) n = t[r[g]], h = u[y], l = u[y + 1], m = u[y + 2], _ += (h * n.a + l * n.c + n.tx) * m, p += (h * n.b + l * n.d + n.ty) * m, y += 3;
                            o.push(_, p);
                        }
                    this._mVerticleArr = o, s = c, this._mVerticleArr = this.getSaveVerticle(this._mVerticleArr), e.init2(a, s, this._mVerticleArr, i);
                }
            }, {
                key: "drawBonePoint",
                value: function(t) {
    ...
    var v = function DeformAniData() {
        ...
        D = function() {
            function DeformSlotDisplayData() {
                _classCallCheck(this, DeformSlotDisplayData), this.slotIndex = -1, this.timeList = [], this.vectices = [], this.tweenKeyList = [], this.frameIndex = 0;
            }
                    ...
                    if (t += .05, !(this.timeList.length <= 0)) {
                        ...
                        if (!(t < this.timeList[0])) {
                            ...
                            if (this.frameIndex = n, t >= this.timeList[this.timeList.length - 1]) {
                                ...
                                for (i = this.tweenKeyList[n - 1] ? (t - c) / (_ - c) : 0, a = 0; a < r; a++) l = o[a], s[a] = l + (u[a] - l) * i;
                                this.deformData = s;
                            }
                        }
                    }
        ...
        A = function() {
            function IkConstraint(t, e) {
                _classCallCheck(this, IkConstraint), this.isSpine = !0, this.isDebug = !1, this._targetBone = e[t.targetBoneIndex], this.isSpine = t.isSpine, null == this._bones && (this._bones = []), this._bones.length = 0;
            ...
            return _createClass(IkConstraint, [{
                ...
                value: function(t, e, i, a) {
                    var r = t.parentBone,
                        ...
                        u = Math.atan2(o, l) * IkConstraint.radDeg - 0 - t.transform.skX;
                ...
                value: function(t, i, a, r, s, n) {
                    if (0 != n) {
                        var h, l, o, u = t.resultTransform.x,
                            c = t.resultTransform.y,
                            _ = t.transform.scX,
                            p = t.transform.scY,
                            d = i.transform.scX;
                        _ < 0 ? (_ = -_, h = 180, o = -1) : (h = 0, o = 1), p < 0 && (p = -p, o = -o), d < 0 ? (d = -d, l = 180) : l = 0;
                        var f, y, m, g = i.resultTransform.x,
                            v = t.resultMatrix.a,
                            x = t.resultMatrix.c,
                            D = t.resultMatrix.b,
                            M = t.resultMatrix.d,
                            k = Math.abs(_ - p) <= 1e-4;
                        k ? (y = v * g + x * (f = i.resultTransform.y) + t.resultMatrix.tx, m = D * g + M * f + t.resultMatrix.ty) : (f = 0, y = v * g + t.resultMatrix.tx, m = D * g + t.resultMatrix.ty), this.isDebug && (this._sp || (this._sp = new e.Sprite(), e.ILaya.stage.addChild(this._sp)), this._sp.graphics.clear(), this._sp.graphics.drawCircle(a, r, 15, "#ffff00"), this._sp.graphics.drawCircle(y, m, 15, "#ff00ff")), t.setRotation(Math.atan2(m - t.resultMatrix.ty, y - t.resultMatrix.tx));
                        var A = t.parentBone;
                        v = A.resultMatrix.a, x = A.resultMatrix.c, D = A.resultMatrix.b;
                        var I, C, S = 1 / (v * (M = A.resultMatrix.d) - x * D),
                            T = a - A.resultMatrix.tx,
                            b = r - A.resultMatrix.ty,
                            P = (T * M - b * x) * S - u,
                            F = (b * v - T * D) * S - c,
                            w = ((T = y - A.resultMatrix.tx) * M - (b = m - A.resultMatrix.ty) * x) * S - u,
                            B = (b * v - T * D) * S - c,
                            L = Math.sqrt(w * w + B * B),
                            U = i.length * d;
                        if (k) {
                            var E = (P * P + F * F - L * L - (U *= _) * U) / (2 * L * U);
                            E < -1 ? E = -1 : E > 1 && (E = 1), C = Math.acos(E) * s, v = L + U * E, x = U * Math.sin(C), I = Math.atan2(F * v - P * x, P * v + F * x);
                        } else {
                            var R = (v = _ * U) * v,
                                O = (x = p * U) * x,
                                N = P * P + F * F,
                            ...
                            var q = 0,
                                ...
                                $ = 0,
                                tt = 0;
                            (M = (T = L + v) * T) > J && (Z = 0, J = M, $ = T), (M = (T = L - v) * T) < H && (q = Math.PI, H = M, j = T);
                            var et = Math.acos(-v * L / (R - O));
                            (M = (T = v * Math.cos(et) + L) * T + (b = x * Math.sin(et)) * b) < H && (q = et, H = M, j = T, Q = b), M > J && (Z = et, J = M, $ = T, tt = b), N <= (H + J) / 2 ? (I = V - Math.atan2(Q * s, j), C = q * s) : (I = V - Math.atan2(tt * s, $), C = Z * s);
                        }
                        var it = Math.atan2(f, g) * o,
                            at = t.resultTransform.skX;
                        (I = (I - it) * IkConstraint.radDeg + h - at) > 180 ? I -= 360 : I < -180 && (I += 360), t.resultTransform.x = u, t.resultTransform.y = c, t.resultTransform.skX = t.resultTransform.skY = at + I * n, at = i.resultTransform.skX, at %= 360, (C = ((C + it) * IkConstraint.radDeg - 0) * o + l - at) > 180 ? C -= 360 : C < -180 && (C += 360), i.resultTransform.x = g, i.resultTransform.y = f, i.resultTransform.skX = i.resultTransform.skY = i.resultTransform.skY + C * n, t.update();
                    }
                }
            }, {
                key: "_applyIk3",
                value: function(t, i, a, r, s, n) {
                    if (0 != n) {
                        var h, l, o, u, c, _, p = i.resultMatrix.a * i.length,
                            d = i.resultMatrix.b * i.length,
                            f = p * p + d * d,
                            y = Math.sqrt(f),
                            m = t.resultMatrix.tx,
                            g = t.resultMatrix.ty,
                            ...
                            k = D * D + M * M,
                            A = Math.sqrt(k),
                            I = (D = a - t.resultMatrix.tx) * D + (M = r - t.resultMatrix.ty) * M,
                            C = Math.sqrt(I);
                        ...
                        h = v, l = x, this.isDebug && (this._sp || (this._sp = new e.Sprite(), e.ILaya.stage.addChild(this._sp)), this._sp.graphics.clear(), this._sp.graphics.drawCircle(m, g, 15, "#ff00ff"), this._sp.graphics.drawCircle(a, r, 15, "#ffff00"), this._sp.graphics.drawCircle(h, l, 15, "#ff00ff")), o = Math.atan2(l - t.resultMatrix.ty, h - t.resultMatrix.tx), t.setRotation(o), (u = IkConstraint._tempMatrix).identity(), u.rotate(o), u.scale(t.resultMatrix.getScaleX(), t.resultMatrix.getScaleY()), u.translate(t.resultMatrix.tx, t.resultMatrix.ty), u.copyTo(t.resultMatrix), t.updateChild(), c = Math.atan2(r - l, a - h), i.setRotation(c), (_ = IkConstraint._tempMatrix).identity(), _.rotate(c), _.scale(i.resultMatrix.getScaleX(), i.resultMatrix.getScaleY()), _.translate(h, l), u.copyTo(i.resultMatrix), i.updateChild();
                    }
                }
            }]), IkConstraint;
        }();
    ...
    var I = function IkConstraintData() {
            _classCallCheck(this, IkConstraintData), this.boneNames = [], this.bendDirection = 1, this.mix = 1, this.isSpine = !0, this.targetBoneIndex = -1, this.boneIndexs = [];
        },
        C = function() {
            function PathConstraint(t, e) {
                _classCallCheck(this, PathConstraint), this._debugKey = !1, this._segments = [], this._curves = [], this.data = t, this.position = t.position, this.spacing = t.spacing, this.rotateMix = t.rotateMix, this.translateMix = t.translateMix, this.bones = [];
            ...
            return _createClass(PathConstraint, [{
                ...
                value: function(t, e) {
                    if (this.target) {
                        ...
                        for (f = 0, k = 3; f < c; f++, k += 3) {
                            ...
                            if (A = v, I = x, r) {
                                var F, w, B, L = m.resultMatrix.a,
                                    U = m.resultMatrix.c,
                                    E = m.resultMatrix.b,
                                    R = m.resultMatrix.d;
                                F = l ? D[k - 1] : 0 == p[f + 1] ? D[k + 2] : Math.atan2(b, T), F -= Math.atan2(E, L) - C / 180 * Math.PI, S && (w = Math.cos(F), B = Math.sin(F), A += ((g = m.length) * (w * L - B * E) - T) * a, I += (g * (B * L + w * E) - b) * a), F > Math.PI ? F -= 2 * Math.PI : F < -Math.PI && (F += 2 * Math.PI), F *= a, w = Math.cos(F), B = Math.sin(F), m.resultMatrix.a = w * L - B * E, m.resultMatrix.c = w * U - B * R, m.resultMatrix.b = B * L + w * E, m.resultMatrix.d = B * U + w * R;
                            }
                        }
                    }
                }
                ...
                value: function(t, e, i, a, r, s) {
                    ...
                    if (null != o) {
                        ...
                        var A, I;
                        if (c || (c = u), t.deformData && (c = t.deformData), A = t.parent, e)
                        ...
                        var C = I.tx,
                            ...
                            P = I.c,
                            F = I.d;
                        for (h && (F *= h.d), p = i, y = s; y < a; p += 2, y += 2) x = c[p], D = c[p + 1], r[y] = x * T + D * b + C, r[y + 1] = -(x * P + D * F + S);
                    }
                }
            }, {
                ...
                value: function(t, e, i, a, r, s, n) {
                    ...
                    var h, l, o, u, c, _, p, d, f = [],
                        ...
                        D = m / 6,
                        M = -1;
                    if (D--, m -= 4, this.computeWorldVertices2(t, e, 2, m, f, 0), this._debugKey)
                        for (y = 0; y < f.length;) i.drawCircle(f[y++], f[y++], 10, "#ff0000");
                    h = f, this._curves.length = D;
                    var k = this._curves;
                    l = 0;
                    var A, I, C, S, T, b, P, F, w, B = h[0],
                        L = h[1],
                        U = 0,
                        E = 0,
                        R = 0,
                        ...
                        N = 0,
                        V = 0;
                    for (y = 0, w = 2; y < D; y++, w += 6) T = 2 * (A = .1875 * (B - 2 * (U = h[w]) + (R = h[w + 2]))) + (C = .09375 * (3 * (U - R) - B + (N = h[w + 4]))), b = 2 * (I = .1875 * (L - 2 * (E = h[w + 1]) + (O = h[w + 3]))) + (S = .09375 * (3 * (E - O) - L + (V = h[w + 5]))), P = .75 * (U - B) + A + .16666667 * C, F = .75 * (E - L) + I + .16666667 * S, l += Math.sqrt(P * P + F * F), P += T, F += b, T += C, b += S, l += Math.sqrt(P * P + F * F), P += T, F += b, l += Math.sqrt(P * P + F * F), P += T + C, F += b + S, l += Math.sqrt(P * P + F * F), k[y] = l, B = N, L = V;
                    if (s && (g *= l), n)
                        for (y = 0; y < a; y++) v[y] *= l;
                    var Y, K = this._segments,
                        X = 0;
                    for (y = 0, o = 0, u = 0, Y = 0; y < a; y++, o += 3)
                        if ((c = g += _ = v[y]) < 0) this.addBeforePosition(c, h, 0, x, o);
                        ...
                        if (u != M) {
                            M = u;
                            var z = 6 * u;
                            for (T = 2 * (A = .03 * ((B = h[z]) - 2 * (U = h[z + 2]) + (R = h[z + 4]))) + (C = .006 * (3 * (U - R) - B + (N = h[z + 6]))), b = 2 * (I = .03 * ((L = h[z + 1]) - 2 * (E = h[z + 3]) + (O = h[z + 5]))) + (S = .006 * (3 * (E - O) - L + (V = h[z + 7]))), P = .3 * (U - B) + A + .16666667 * C, F = .3 * (E - L) + I + .16666667 * S, X = Math.sqrt(P * P + F * F), K[0] = X, z = 1; z < 8; z++) P += T, F += b, T += C, b += S, X += Math.sqrt(P * P + F * F), K[z] = X;
                            P += T, F += b, X += Math.sqrt(P * P + F * F), K[8] = X, P += T + C, F += b + S, X += Math.sqrt(P * P + F * F), K[9] = X, Y = 0;
                        }
                        for (c *= X;; Y++)
                            if (!(c > (d = K[Y]))) {
    ...
    var S = function PathConstraintData() {
        ...
        T = function() {
            function TfConstraint(t, e) {
                var i, a;
                for (_classCallCheck(this, TfConstraint), this._temp = [], this._data = t, null == this._bones && (this._bones = []), this.target = e[t.targetIndex], i = 0, a = t.boneIndexs.length; i < a; i++) this._bones.push(e[t.boneIndexs[i]]);
                    ...
                    for (var t, e = this.target.resultMatrix.a, i = this.target.resultMatrix.b, a = this.target.resultMatrix.c, r = this.target.resultMatrix.d, s = 0, n = this._bones.length; s < n; s++) {
                        ...
                        if (this.translateMix && (this._temp[0] = this._data.offsetX, this._temp[1] = this._data.offsetY, this.target.localToWorld(this._temp), t.resultMatrix.tx += (this._temp[0] - t.resultMatrix.tx) * this.translateMix, t.resultMatrix.ty += (this._temp[1] - t.resultMatrix.ty) * this.translateMix, t.updateChild()), this.scaleMix > 0) {
                            var d = Math.sqrt(t.resultMatrix.a * t.resultMatrix.a + t.resultMatrix.c * t.resultMatrix.c),
                                f = Math.sqrt(e * e + a * a),
                                y = d > 1e-5 ? (d + (f - d + this._data.offsetScaleX) * this.scaleMix) / d : 0;
                            t.resultMatrix.a *= y, t.resultMatrix.c *= y, d = Math.sqrt(t.resultMatrix.b * t.resultMatrix.b + t.resultMatrix.d * t.resultMatrix.d), f = Math.sqrt(i * i + r * r), y = d > 1e-5 ? (d + (f - d + this._data.offsetScaleY) * this.scaleMix) / d : 0, t.resultMatrix.b *= y, t.resultMatrix.d *= y;
                        }
                        if (this.shearMix > 0) {
                            l = t.resultMatrix.b, u = t.resultMatrix.d;
                            var m = Math.atan2(u, l);
                            (c = Math.atan2(r, i) - Math.atan2(a, e) - (m - Math.atan2(t.resultMatrix.c, t.resultMatrix.a))) > Math.PI ? c -= 2 * Math.PI : c < -Math.PI && (c += 2 * Math.PI), c = m + (c + this._data.offsetShearY * Math.PI / 180) * this.shearMix, y = Math.sqrt(l * l + u * u), t.resultMatrix.b = Math.cos(c) * y, t.resultMatrix.d = Math.sin(c) * y;
                        }
                    }
                }
            }]), TfConstraint;
        ...
        b = function(t) {
            function Skeleton() {
                ...
                return _classCallCheck(this, Skeleton), (t = _possibleConstructorReturn(this, _getPrototypeOf(Skeleton).call(this)))._boneMatrixArray = [], t._lastTime = 0, t._currAniIndex = -1, t._pause = !0, t._aniClipIndex = -1, t._clipIndex = -1, t._skinIndex = 0, t._skinName = "default", t._aniMode = 0, t._index = -1, t._total = -1, t._indexControl = !1, t._eventIndex = 0, t._drawOrderIndex = 0, t._drawOrder = null, t._lastAniClipIndex = -1, t._lastUpdateAniClipIndex = -1, t._playAudio = !0, t._soundChannelArr = [], e && t.init(e, i), t;
            }
            return _inherits(Skeleton, e.Sprite), _createClass(Skeleton, [{
                key: "init",
                value: function(t) {
                    var i, a, r, s, n = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : 0,
                        h = 0;
                    if (1 == n)
                        for (this._graphicsCache = [], h = 0, i = t.getAnimationCount(); h < i; h++) this._graphicsCache.push([]);
                    if (this._yReverseMatrix = t.yReverseMatrix, this._aniMode = n, this._templet = t, this._templet._addReference(1), this._player = new o(), this._player.cacheFrameRate = t.rate, this._player.templet = t, this._player.play(), this._parseSrcBoneMatrix(), this._boneList = t.mBoneArr, this._rootBone = t.mRootBone, this._aniSectionDic = t.aniSectionDic, t.ikArr.length > 0)
                        for (this._ikArr = [], h = 0, i = t.ikArr.length; h < i; h++) this._ikArr.push(new A(t.ikArr[h], this._boneList));
                    if (t.pathArr.length > 0)
                        for (null == this._pathDic && (this._pathDic = {}), h = 0, i = t.pathArr.length; h < i; h++) a = t.pathArr[h], r = new C(a, this._boneList), (s = this._boneSlotDic[a.name]) && ((r = new C(a, this._boneList)).target = s), this._pathDic[a.name] = r;
                    if (t.tfArr.length > 0)
                        for (this._tfArr = [], h = 0, i = t.tfArr.length; h < i; h++) this._tfArr.push(new T(t.tfArr[h], this._boneList));
                ...
                value: function(t, i) {
                    var a = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : 0,
                        r = this._templet.eventAniArr[this._player.currentAnimationClipIndex];
                    if (r) {
                        var s, n, h = 0;
                ...
                key: "_createGraphics",
                value: function() {
                    var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : -1; - 1 == t && (t = this._clipIndex);
                    ...
                    for (f = 0, g = p[0]; f < v; f++) {
                        ...
                        u = this._templet.srcBoneMatrixArr[f], D.scX = u.scX * x[d++], D.skX = u.skX + x[d++], D.skY = u.skY + x[d++], D.scY = u.scY * x[d++], D.x = u.x + x[d++], D.y = u.y + x[d++], 8 === this._templet.tMatrixDataLen && (D.skewX = u.skewX + x[d++], D.skewY = u.skewY + x[d++]);
                    }
                    var M, k = {},
                        A = {};
                    ...
                    if (this._rootBone.update(this._yReverseMatrix || e.Matrix.TEMP.identity()), this._ikArr)
                        for (f = 0, g = this._ikArr.length; f < g; f++)(C = this._ikArr[f]).name in S && (C.bendDirection = S[C.name]), C.name in T && (C.mix = T[C.name]), C.apply();
                    if (this._pathDic)
                        for (var b in this._pathDic)(I = this._pathDic[b]).apply(this._boneList, s);
                    if (this._tfArr)
                        for (f = 0, m = this._tfArr.length; f < m; f++) this._tfArr[f].apply();
                    for (f = 0, m = this._boneList.length; f < m; f++)
                        if (c = this._boneList[f], o = this._bindBoneBoneSlotDic[c.name], c.resultMatrix.copyTo(this._boneMatrixArray[f]), o)
                            for (y = 0, g = o.length; y < g; y++)(l = o[y]) && l.setParentMatrix(c.resultMatrix);
                    var P, F, w, B, L = {},
                        U = this._templet.deformAniArr;
                    if (U && U.length > 0) {
                        if (this._lastAniClipIndex != this._aniClipIndex)
                            for (this._lastAniClipIndex = this._aniClipIndex, f = 0, g = this._boneSlotArray.length; f < g; f++)(l = this._boneSlotArray[f]).deformData = null;
                        var E, R = U[this._aniClipIndex];
                        for (E in P = R.default, this._setDeform(P, L, this._boneSlotArray, a), R) "default" != E && E != this._skinName && (P = R[E], this._setDeform(P, L, this._boneSlotArray, a));
                        P = R[this._skinName], this._setDeform(P, L, this._boneSlotArray, a);
                    }
                    if (this._drawOrder)
                        for (f = 0, g = this._drawOrder.length; f < g; f++) F = k[(l = this._boneSlotArray[this._drawOrder[f]]).name], w = A[l.name], isNaN(F) || -2 == F || (this._templet.attachmentNames ? l.showDisplayByName(this._templet.attachmentNames[F]) : l.showDisplayByIndex(F)), L[this._drawOrder[f]] ? (B = L[this._drawOrder[f]], l.currDisplayData && B[l.currDisplayData.attachmentName] ? l.deformData = B[l.currDisplayData.attachmentName] : l.deformData = null) : l.deformData = null, isNaN(w) ? l.draw(s, this._boneMatrixArray, 2 == this._aniMode) : l.draw(s, this._boneMatrixArray, 2 == this._aniMode, w);
                    else
                        for (f = 0, g = this._boneSlotArray.length; f < g; f++) F = k[(l = this._boneSlotArray[f]).name], w = A[l.name], isNaN(F) || -2 == F || (this._templet.attachmentNames ? l.showDisplayByName(this._templet.attachmentNames[F]) : l.showDisplayByIndex(F)), L[f] ? (B = L[f], l.currDisplayData && B[l.currDisplayData.attachmentName] ? l.deformData = B[l.currDisplayData.attachmentName] : l.deformData = null) : l.deformData = null, isNaN(w) ? l.draw(s, this._boneMatrixArray, 2 == this._aniMode) : l.draw(s, this._boneMatrixArray, 2 == this._aniMode, w);
                ...
                value: function() {
                    var t = !(arguments.length > 0 && void 0 !== arguments[0]) || arguments[0];
                    _get(_getPrototypeOf(Skeleton.prototype), "destroy", this).call(this, t), this._templet._removeReference(1), this._templet = null, this._player && this._player.offAll(), this._player = null, this._curOriginalData = null, this._boneMatrixArray.length = 0, this._lastTime = 0, this.timer.clear(this, this._update), this._soundChannelArr.length > 0 && this._onAniSoundStoped(!0);
                }
            }, {
                key: "url",
                get: function() {
    ...
    b.useSimpleMeshInCanvas = !1, i.Skeleton = b, e.ILaya.regClass(b), e.ClassUtils.regClass("laya.ani.bone.Skeleton", b), e.ClassUtils.regClass("Laya.Skeleton", b);
    var P = function SkinData() {
        ...
        L = function(t) {
            function Templet() {
                var t;
                return _classCallCheck(this, Templet), (t = _possibleConstructorReturn(this, _getPrototypeOf(Templet).apply(this, arguments)))._graphicsCache = [], t.srcBoneMatrixArr = [], t.ikArr = [], t.tfArr = [], t.pathArr = [], t.boneSlotDic = {}, t.bindBoneBoneSlotDic = {}, t.boneSlotArray = [], t.skinDataArray = [], t.skinDic = {}, t.subTextureDic = {}, t.isParseFail = !1, t.drawOrderAniArr = [], t.eventAniArr = [], t.attachmentNames = null, t.deformAniArr = [], t.skinSlotDisplayDataArr = [], t._isParseAudio = !1, t._isDestroyed = !1, t._rate = 30, t.isParserComplete = !1, t.aniSectionDic = {}, t._textureDic = {}, t.mBoneArr = [], t;
            }
            return _inherits(Templet, c), _createClass(Templet, [{
                ...
                value: function() {
                    ...
                    if (this._isDestroyed) this.destroy();
                        ...
                        t ? (this._path = this._skBufferUrl.slice(0, this._skBufferUrl.lastIndexOf("/")) + "/", this.parseData(null, t)) : this.event(e.Event.ERROR, "load failed:" + this._skBufferUrl);
                    }
                }
            }, {
                key: "parseData",
                ...
                value: function() {
                    ...
                    var h, l, o = new e.Byte(this.getPublicExtData()),
                        ...
                        U = L.split("\n");
                    for (i = 0; i < b; i++) {
                        if (h = this._mainTexture, l = this._path + U[2 * i], L = U[2 * i + 1], null == this._mainTexture && (h = this._textureDic[l]), !h) return this.event(e.Event.ERROR, this), void(this.isParseFail = !0);
                        u = o.getFloat32(), c = o.getFloat32(), _ = o.getFloat32(), f = o.getFloat32(), T = o.getFloat32(), y = isNaN(T) ? 0 : T, T = o.getFloat32(), m = isNaN(T) ? 0 : T, T = o.getFloat32(), A = isNaN(T) ? _ : T, T = o.getFloat32(), C = isNaN(T) ? f : T, this.subTextureDic[L] = e.Texture.create(h, u, c, _, f, -y, -m, A, C);
                    }
                    this._mainTexture = h;
                    ...
                    var K, X = o.getInt16(),
                        z = {};
                    for (i = 0; i < X; i++) R = new d(), 0 == i ? K = R : R.root = K, R.d = t ? -1 : 1, N = o.readUTFString(), V = o.readUTFString(), R.length = o.getFloat32(), 1 == o.getByte() && (R.inheritRotation = !1), 1 == o.getByte() && (R.inheritScale = !1), R.name = N, V && ((O = z[V]) ? O.addChild(R) : this.mRootBone = R), z[N] = R, this.mBoneArr.push(R);
                    this.tMatrixDataLen = o.getUint16();
                    var G, W, q = o.getUint16(),
                        H = Math.floor(q / this.tMatrixDataLen),
                        j = this.srcBoneMatrixArr;
                    for (i = 0; i < H; i++)(G = new p()).scX = o.getFloat32(), G.skX = o.getFloat32(), G.skY = o.getFloat32(), G.scY = o.getFloat32(), G.x = o.getFloat32(), G.y = o.getFloat32(), 8 === this.tMatrixDataLen && (G.skewX = o.getFloat32(), G.skewY = o.getFloat32()), j.push(G), (R = this.mBoneArr[i]).transform = G;
                    var Q, Z, J = o.getUint16();
                    for (i = 0; i < J; i++) {
                        for (W = new I(), Q = o.getUint16(), a = 0; a < Q; a++) W.boneNames.push(o.readUTFString()), W.boneIndexs.push(o.getInt16());
                        W.name = o.readUTFString(), W.targetBoneName = o.readUTFString(), W.targetBoneIndex = o.getInt16(), W.bendDirection = o.getFloat32(), W.mix = o.getFloat32(), W.isSpine = t, this.ikArr.push(W);
                    }
                    var $, tt, et = o.getUint16();
                    for (i = 0; i < et; i++) {
                        for (Z = new B(), $ = o.getUint16(), a = 0; a < $; a++) Z.boneIndexs.push(o.getInt16());
                        Z.name = o.getUTFString(), Z.targetIndex = o.getInt16(), Z.rotateMix = o.getFloat32(), Z.translateMix = o.getFloat32(), Z.scaleMix = o.getFloat32(), Z.shearMix = o.getFloat32(), Z.offsetRotation = o.getFloat32(), Z.offsetX = o.getFloat32(), Z.offsetY = o.getFloat32(), Z.offsetScaleX = o.getFloat32(), Z.offsetScaleY = o.getFloat32(), Z.offsetShearY = o.getFloat32(), this.tfArr.push(Z);
                    }
                    ...
                    for (i = 0; i < dt; i++) {
                        ...
                        for (var mt = 0; mt < ft; mt++)
                            for ((lt = new v()).skinName = o.getUTFString(), yt[lt.skinName] = lt, at = o.getInt16(), a = 0; a < at; a++)
                                for (ot = new x(), lt.deformSlotDataList.push(ot), rt = o.getInt16(), r = 0; r < rt; r++)
                                    for (ut = new D(), ot.deformSlotDisplayList.push(ut), ut.slotIndex = o.getInt16(), ut.attachment = o.getUTFString(), st = o.getInt16(), s = 0; s < st; s++)
                                        for (1 == o.getByte() ? ut.tweenKeyList.push(!0) : ut.tweenKeyList.push(!1), nt = o.getFloat32(), ut.timeList.push(nt), ct = [], ut.vectices.push(ct), ht = o.getInt16(), n = 0; n < ht; n++) ct.push(o.getFloat32());
                    }
                    ...
                    for (i = 0; i < It; i++) {
                        for (kt = o.getInt16(), Dt = [], a = 0; a < kt; a++)(At = new k()).name = o.getUTFString(), this._isParseAudio && (At.audioValue = o.getUTFString()), At.intValue = o.getInt32(), At.floatValue = o.getFloat32(), At.stringValue = o.getUTFString(), At.time = o.getFloat32(), Dt.push(At);
                        this.eventAniArr.push(Dt);
                    }
                    var Ct = o.getInt16();
                    if (Ct > 0)
                        for (this.attachmentNames = [], i = 0; i < Ct; i++) this.attachmentNames.push(o.getUTFString());
                    var St, Tt, bt = o.getInt16();
                    for (i = 0; i < bt; i++)(St = new g()).name = o.readUTFString(), St.parent = o.readUTFString(), St.attachmentName = o.readUTFString(), St.srcDisplayIndex = St.displayIndex = o.getInt16(), St.templet = this, this.boneSlotDic[St.name] = St, null == (Tt = this.bindBoneBoneSlotDic[St.parent]) && (this.bindBoneBoneSlotDic[St.parent] = Tt = []), Tt.push(St), this.boneSlotArray.push(St);
                    var Pt, Ft, wt, Bt, Lt, Ut, Et, Rt, Ot, Nt, Vt = o.readUTFString().split("\n"),
                        Yt = 0,
                        Kt = o.getUint8();
                    for (i = 0; i < Kt; i++) {
                        for ((Pt = new P()).name = Vt[Yt++], Bt = o.getUint8(), a = 0; a < Bt; a++) {
                            for ((Ft = new w()).name = Vt[Yt++], St = this.boneSlotDic[Ft.name], Lt = o.getUint8(), r = 0; r < Lt; r++) {
                                if (wt = new F(), this.skinSlotDisplayDataArr.push(wt), wt.name = Vt[Yt++], wt.attachmentName = Vt[Yt++], wt.transform = new p(), wt.transform.scX = o.getFloat32(), wt.transform.skX = o.getFloat32(), wt.transform.skY = o.getFloat32(), wt.transform.scY = o.getFloat32(), wt.transform.x = o.getFloat32(), wt.transform.y = o.getFloat32(), Ft.displayArr.push(wt), wt.width = o.getFloat32(), wt.height = o.getFloat32(), wt.type = o.getUint8(), wt.verLen = o.getUint16(), (X = o.getUint16()) > 0)
                                    for (wt.bones = [], s = 0; s < X; s++) {
                                        var Xt = o.getUint16();
                                        wt.bones.push(Xt);
                                    }
                                if ((Ut = o.getUint16()) > 0)
                                    for (wt.uvs = [], s = 0; s < Ut; s++) wt.uvs.push(o.getFloat32());
                                if ((Et = o.getUint16()) > 0)
                                    for (wt.weights = [], s = 0; s < Et; s++) wt.weights.push(o.getFloat32());
                                if ((Rt = o.getUint16()) > 0)
                                    for (wt.triangles = [], s = 0; s < Rt; s++) wt.triangles.push(o.getUint16());
                                if ((Ot = o.getUint16()) > 0)
                                    for (wt.vertices = [], s = 0; s < Ot; s++) wt.vertices.push(o.getFloat32());
                                if ((Nt = o.getUint16()) > 0)
                                    for (wt.lengths = [], s = 0; s < Nt; s++) wt.lengths.push(o.getFloat32());
                            }
                            Pt.slotArr.push(Ft);
                        }
                ...
                value: function(t, e) {
                    ...
                    if (h) {
                        for (i = 0, a = h.slotArr.length; i < a; i++)(s = h.slotArr[i]) && (r = t[s.name]) && (r.showSlotData(s, n), n && "undefined" != r.attachmentName && "null" != r.attachmentName ? r.showDisplayByName(r.attachmentName) : r.showDisplayByIndex(r.displayIndex));
                        return !0;
                    }
                    return !1;
                }
                ...
                value: function() {
                    ...
                    this.skinSlotDisplayDataArr.length = 0, this._relativeUrl && delete Templet.TEMPLET_DICTIONARY[this._relativeUrl], _get(_getPrototypeOf(Templet.prototype), "destroy", this).call(this), e.ILaya.loader.clearRes(this._skBufferUrl);
                }
            }, {
                key: "getAniNameByIndex",
                value: function(t) {
    ...
    L.LAYA_ANIMATION_160_VISION = "LAYAANIMATION:1.6.0", L.LAYA_ANIMATION_VISION = "LAYAANIMATION:1.7.0", i.Templet = L;
    var U = function(t) {
        function MovieClip() {
            var t, i = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : null;
            return _classCallCheck(this, MovieClip), (t = _possibleConstructorReturn(this, _getPrototypeOf(MovieClip).call(this)))._start = 0, t._Pos = 0, t._ended = !0, t._loadedImage = {}, t._endFrame = -1, t.interval = 30, t._ids = {}, t._idOfSprite = [], t._reset(), t._playing = !1, t._parentMovieClip = i, i ? (t._isRoot = !1, t._movieClipList = i._movieClipList, t._movieClipList.push(_assertThisInitialized(t))) : (t._movieClipList = [_assertThisInitialized(t)], t._isRoot = !0, t._setBitUp(e.Const.DISPLAY)), t;
        }
        return _inherits(MovieClip, e.Sprite), _createClass(MovieClip, [{
            ...
            key: "_displayFrame",
            value: function() {
                var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : -1; - 1 != t && (this._curIndex > t && this._reset(), this._parseFrame(t));
            }
        }, {
            key: "_reset",
            value: function() {
                (!(arguments.length > 0 && void 0 !== arguments[0]) || arguments[0]) && 1 != this._curIndex && this.removeChildren(), this._preIndex = this._curIndex = -1, this._Pos = this._start;
            }
        }, {
            key: "_parseFrame",
            value: function(t) {
                    ...
                    case 12:
                        if (r = u.getUint16(), s = this._ids[u.getUint16()], this._Pos = u.pos, u.pos = s, 0 == (n = u.getUint8())) {
                            ...
                            if (!(a = o[r])) {
                                a = o[r] = new e.Sprite();
                                var _ = new e.Sprite();
                                _.loadImage(this.basePath + c + ".png"), this._loadedImage[this.basePath + c + ".png"] = !0, a.addChild(_), _.size(u.getFloat32(), u.getFloat32());
                                var p = u._getMatrix();
                                _.transform = p;
                            }
                            a.alpha = 1;
                        } else 1 == n && ((i = o[r]) || (o[r] = i = new MovieClip(this), i.interval = this.interval, i._ids = this._ids, i.basePath = this.basePath, i._setData(u, s), i._initState(), i.play(0)), i.alpha = 1);
                        u.pos = this._Pos;
                        break;
                    case 3:
                        var d = o[u.getUint16()];
            ...
            value: function(t) {
                ...
                this._url = t, a && (this._atlasPath = r || t.split(".swf")[0] + ".json"), this.stop(), this._clear(), this._movieClipList = [this], i = [{
                    url: t,
                    type: e.ILaya.Loader.BUFFER
    ...
    U._ValueList = ["x", "y", "width", "height", "scaleX", "scaleY", "rotation", "alpha"], t.AnimationContent = a, t.AnimationNodeContent = r, t.AnimationParser01 = n, t.AnimationParser02 = h, t.AnimationPlayer = o, t.AnimationState = l, t.AnimationTemplet = c, t.BezierLerp = u, t.Bone = d, t.BoneSlot = g, t.DeformAniData = v, t.DeformSlotData = x, t.DeformSlotDisplayData = D, t.DrawOrderData = M, t.EventData = k, t.GraphicsAni = _, t.IAniLib = i, t.IkConstraint = A, t.IkConstraintData = I, t.KeyFramesContent = s, t.MeshData = y, t.MovieClip = U, t.PathConstraint = C, t.PathConstraintData = S, t.Skeleton = b, t.SkinData = P, t.SkinMeshForGraphic = m, t.SkinSlotDisplayData = F, t.SlotData = w, t.Templet = L, t.TfConstraint = T, t.TfConstraintData = B, t.Transform = p, t.UVTools = f;
