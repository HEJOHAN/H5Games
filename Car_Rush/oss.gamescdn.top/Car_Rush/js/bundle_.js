...
! function() {
    ...
    1: [function(t, e, i) {
        ...
        var a = t("./scripts/views/GameOver"),
            n = t("./scripts/uiComp/OverAdListLoop"),
            o = t("./scripts/uiComp/AdListLoop"),
            s = t("./scripts/views/CollectView"),
            r = t("./scripts/uiComp/ConvergeAd"),
            h = t("./scripts/views/SkinTrail"),
            l = t("./scripts/views/GameView"),
            d = t("./scripts/views/HomeView"),
            c = t("./scripts/uiComp/PromotionAnimation"),
            u = t("./scripts/views/LoginView"),
            p = t("./scripts/views/Resurgence"),
            f = t("./scripts/views/RankView"),
            m = function() {
                function t() {}
                return t.init = function() {
                    var t = Laya.ClassUtils.regClass;
                    t("scripts/views/GameOver.ts", a["default"]), t("scripts/uiComp/OverAdListLoop.ts", n["default"]), t("scripts/uiComp/AdListLoop.ts", o["default"]), t("scripts/views/CollectView.ts", s["default"]), t("scripts/uiComp/ConvergeAd.ts", r["default"]), t("scripts/views/SkinTrail.ts", h["default"]), t("scripts/views/GameView.ts", l["default"]), t("scripts/views/HomeView.ts", d["default"]), t("scripts/uiComp/PromotionAnimation.ts", c["default"]), t("scripts/views/LoginView.ts", u["default"]), t("scripts/views/Resurgence.ts", p["default"]), t("scripts/views/RankView.ts", f["default"]);
                }, t.width = 750, t.height = 1334, t.scaleMode = "fixedauto", t.screenMode = "none", t.alignV = "middle", t.alignH = "center", t.startScene = "views/login.scene", t.sceneRoot = "", t.debug = !1, t.stat = !1, t.physicsDebug = !1, t.exportSceneToJson = !0, t;
            }();
        i["default"] = m, m.init();
    }, {
            ...
            o = function() {
                function t() {
                    var t = Laya.Browser.height / Laya.Browser.width,
                        e = Laya.Browser.onMobile ? t * a["default"].width : a["default"].height;
                    n["default"].screen.realPxRatio = e / Laya.Browser.clientHeight, n["default"].screen.allScreen = t > 17 / 9 ? !0 : !1, n["default"].screen.offsetTop = (e - a["default"].height) / 2, window.Laya3D ? Laya3D.init(a["default"].width, e) : Laya.init(a["default"].width, a["default"].height, Laya.WebGL), Laya.Physics && Laya.Physics.enable(), Laya.DebugPanel && Laya.DebugPanel.enable(), Laya.stage.scaleMode = a["default"].scaleMode, Laya.stage.alignV = a["default"].alignV, Laya.stage.alignH = a["default"].alignH;
                    ...
                    Laya.stage.useRetinalCanvas = !0, Laya.URL.exportSceneToJson = a["default"].exportSceneToJson, (a["default"].debug || "true" == Laya.Utils.getQueryString("debug")) && Laya.enableDebugPanel(), a["default"].physicsDebug && Laya.PhysicsDebugDraw && Laya.PhysicsDebugDraw.enable(), a["default"].stat && Laya.Stat.show(), Laya.alertGlobalError = !0, Laya.ResourceVersion.enable("version.json", Laya.Handler.create(this, this.onVersionLoaded), Laya.ResourceVersion.FILENAME_VERSION);
                }
    ...
    3: [function(t, e, i) {
        ...
        var a = t("./manager/StorageMgr"),
            n = t("./manager/SoundMgr"),
            o = t("./manager/NetMgr"),
            s = t("./platforms/wx/WxAd"),
            r = t("./manager/GameMgr"),
            h = t("./comp/CreateModel"),
            l = t("./platforms/wx/WxAPI"),
            d = t("./other/ConfigData"),
            c = function() {
                function t() {}
                return Object.defineProperty(t, "gameMgr", {
                    ...
                    get: function() {
                        return void 0 === this._modelCreator && (this._modelCreator = new h["default"]()), this._modelCreator;
                    },
                    enumerable: !0,
                    configurable: !0
                }), t._eventListener = new Laya.EventDispatcher(), t._gameMgr = new r["default"](), t._netMgr = new o["default"](), t._commonData = new d["default"](), t.screen = {
                    realPxRatio: 0,
                    offsetTop: 0,
                    allScreen: !1
                }, t;
                    ...
                    if (!a["default"].gameMgr.isOver)
                        for (var t = 0; t < this.targets.length; t++) {
                            ...
                            if (e && e.getBike.transform.position.y < 3) {
                                ...
                                i.z > o.z && i.z < o.z + this.distance ? (this.isTouchs[t] = i.x > o.x - this.width && i.x < o.x + this.width, this.isTouchs[t] && this.canChecks[t] && (this.canChecks[t] = !1, e.speedUp())) : -1 != e.owner.name.indexOf("Role") && i.z > o.z + 1e3 && (Laya.Pool.recover("arrow", this.owner), this.owner.parent.removeChild(this.owner));
                            }
                        }
                }, e;
            }(Laya.Script3D);
    ...
    5: [function(t, e, i) {
        ...
        var a = t("../LayaSample"),
            n = t("../other/ConfigData"),
            o = function(t) {
                function e() {
                    var e = null !== t && t.apply(this, arguments) || this;
                    return e.originMaxSpeed = .55, e.maxSpeed = .55, e.factor_speed = 1.28, e.factor_jump = .1, e.G = -.25, e.Acc = .02, e.acceTimer = 0, e.deceTimer = 1, e.speedToZ = 0, e.speedToY = 0, e.carWidth = .54, e.currentHeight = .689, e.turnoverHeight = 0, e.rotateUnit = new Laya.Vector3(1, 0, 0), e.rotateTimer = 0, e.rotateAngle = 0, e.rotateStatus = 0, e.originAngle = 0, e.isSpeedUp = !1, e.speedLevel = 0, e;
                }
                return __extends(e, t), e.prototype.init = function() {
                    Laya.timer.clearAll(this), this.speedToZ = 0, this.speedToY = 0, this.acceTimer = 0, this.deceTimer = 1, this.setParticleFxExplsion(!1), this.particleAccePlay(), this.changeData(), this.isJump = !1, this.isSpeedUp = !1, this.isRotate = !1, this.anim && (this.anim.speed = 1, this.anim.play("idle")), this.bike.transform.position = this.originPos.clone(), this.bike.transform.rotationEuler = new Laya.Vector3(), this.trail.active = !0, this.trail1.active = !0, this.fxExplsion.transform.localRotationEuler = new Laya.Vector3(0, 0, 0), this.isHit = !1;
                    ...
                    this.trail = t.getChildByName("FX_BikeTrails"), this.trail1 = t.getChildByName("FX_BikeTrails (1)"), this.fxExplsion = t.getChildByName("FX_Explsion"), this.setParticleFxExplsion(!1), this.particleAcce = t.getChildByName("FX_jiasu"), this.particleAcce1 = t.getChildByName("FX_jiasu_a"), this.particleAcce2 = t.getChildByName("FX_jiasu_b"), this.particleAcce3 = t.getChildByName("FX_jiasu_c"), this.setParticleAcce(0, !1), this.anim = this.owner.getChildByName("Role").getComponent(Laya.Animator), this.wheels = [];
                    ...
                    0 != this.deceTimer && (this.deceTimer = 0, this.anim && (this.anim.play("start"), this.anim.crossFade("run", 1)), this.particleAccePlay()), this.acceTimer += Laya.timer.delta, this.speedToZ += this.Acc * (this.acceTimer / 1e3), this.speedToZ > this.maxSpeed && (this.speedToZ = this.maxSpeed), this.move.setValue(0, this.speedToY, this.speedToZ), this.bike.transform.translate(this.move, !1);
                }, e.prototype.setParticleFxExplsion = function(t) {
                    var e = this.fxExplsion.getChildAt(0),
                        i = e.particleSystem;
                    ...
                    if (a["default"].gameMgr.isPressed && this.isJump && this.canRotate) {
                        Laya.timer.clear(this, this.rotateSlowDown), this.rotateTimer += Laya.timer.delta, this.isRotate = !0;
                        var t = this.bike.transform.rotationEuler;
                        t.x -= 6, this.bike.transform.rotationEuler = t, this.anim && (this.anim.speed = 1), this.rotateAngle += 6, this.checkAngle();
                    } else this.isRotate && (this.isRotate = !1, this.rotateSlow());
                }, e.prototype.rotateSlow = function() {
                    this.rotateSlowTimer = 0, this.rotateTimer > 1e3 && (this.rotateTimer = 1e3), this.rotateTimer *= .5, Laya.timer.frameLoop(1, this, this.rotateSlowDown);
                    ...
                    i.x -= e, this.rotateAngle += e, this.checkAngle(), this.bike.transform.rotationEuler = i, t > 1 && (Laya.timer.clear(this, this.rotateSlowDown), this.rotateTimer = 0);
                }, e.prototype.checkAngle = function() {
                    this.rotateAngle > 300 && this.rotateAngle < 660 && 0 == this.rotateStatus ? (this.anim && this.anim.play("turn02"), this.rotateStatus = 1) : this.rotateAngle > 660 && this.rotateAngle < 1020 && 1 == this.rotateStatus ? (this.anim && this.anim.play("turn03"), this.rotateStatus = 2) : this.rotateAngle > 1020 && 2 == this.rotateStatus && (this.rotateStatus = 3);
                }, e.prototype.jump = function(t, e) {
                    void 0 === e && (e = !0), Laya.timer.clear(this, this.fallDown), this.rotateStatus = 0, this.changeData(), this.canRotate = e || this.speedLevel > 0, this.anim && this.anim.play("turn01"), this.trail.active = !1, this.trail1.active = !1, this.isJump = !0, this.originAngle = this.bike.transform.rotationEuler.x, this.speedToZ < .1 && (this.speedToZ = .1), this.speedToY = t * (this.speedToZ / this.maxSpeed) + this.speedLevel * this.factor_jump, this.slowTimer = 0, Laya.timer.frameLoop(1, this, this.slowDown);
                }, e.prototype.slowDown = function() {
                    this.slowTimer += Laya.timer.delta, this.speedToY -= this.Acc * (this.slowTimer / 1e3), this.speedToY < 0 && (this.speedToY = 0, Laya.timer.clear(this, this.slowDown), this.fall());
                    ...
                    if (this.declineTimer += Laya.timer.delta, this.speedToY = this.G * this.declineTimer / 1e3, this.bike.transform.position.y < this.currentHeight) {
                        this.changeData(), Laya.timer.clear(this, this.rotateSlowDown), this.isJump = !1, this.anim && (this.anim.speed = 1, this.anim.crossFade("hit_the_ground", .5)), this.trail.active = !0, this.trail1.active = !0, this.speedToY = 0;
                        var t = this.bike.transform.position;
                        if (t.y = this.currentHeight, this.bike.transform.position = t, Laya.timer.clear(this, this.fallDown), this.currentAngle = Math.abs(this.bike.transform.rotationEuler.x) % 360, this.currentAngle > 60 && this.currentAngle <= 300) return void this.crash(2, 1);
                        if (this.rotateStatus > 0)
                            for (var e = 0; e < this.rotateStatus; e++) this.speedUp();
                        else this.anim && this.anim.crossFade("run", .5);
                        this.fixAngle();
                    }
                    ...
                    function t() {
                        e += Laya.timer.delta;
                        var s = e / (200 * i);
                        a.x = n + (o - n) * s, this.owner.transform.rotationEuler = a, s > 1 && (Laya.timer.clear(this, t), this.owner.transform.rotationEuler = new Laya.Vector3(), this.isFixing = !1);
                    }
                    ...
                    Laya.timer.clearAll(this), this.speedToZ = 0, this.speedToY = 0, this.acceTimer = 0, this.deceTimer = 1, this.setParticleFxExplsion(!1), this.particleAcceStop(), this.changeData(), this.isJump = !1, this.isSpeedUp = !1, this.isRotate = !1, this.anim && (this.anim.speed = 1, this.anim.play("idle"));
                    var e = this.bike.transform.position;
                    e.x = Math.floor(100 * Math.random() % 5) - 2, e.y = this.currentHeight, e.z = t, this.bike.transform.position = e, this.bike.transform.rotationEuler = new Laya.Vector3(), this.trail.active = !0, this.trail1.active = !0, this.isHit = !1;
                    ...
                    if (!this.isHit) {
                        ...
                        1 == t && (a["default"].glEvent.event(n.EventType.HIT_CAR_EVENT), a["default"].glEvent.event(n.EventType.CIRCLE_COUNT_EVENT, {
                            circleNum: -1
                        })), 1 == e ? (this.fxExplsion.transform.localRotationEuler = new Laya.Vector3(180, 0, 0), this.bike.transform.rotationEuler = new Laya.Vector3(200 - 40 * Math.random(), 0, 0)) : this.bike.transform.rotationEuler = new Laya.Vector3();
                        var o = this.bike.transform.position;
                        1 == e ? o.y = this.turnoverHeight : o.y = this.currentHeight, this.bike.transform.position = o, a["default"].wxMgr.playVibrateShort(), this.anim && (i > -240 && -30 > i ? this.anim.play("die02") : this.anim.play("die01")), this.setParticleFxExplsion(!0), this.particleAcceStop(), Laya.timer.clearAll(this), this.changeData(), this.isHit = !0;
                    }
                }, e.prototype.speedUp = function() {
                    this.speedLevel >= 3 ? this.speedLevel = 3 : (this.speedLevel++, this.acceTimer = 0, this.isSpeedUp = !0, this.maxSpeed *= this.factor_speed, this.speedUpTotalTime = 1e3);
                    var t = Math.ceil(100 * Math.random() % 3);
                    this.anim && this.anim.crossFade("accelerate0" + t, .5), this.speedUpTimer = 0, Laya.timer.clear(this, this.speedProgress), Laya.timer.frameLoop(1, this, this.speedProgress);
                }, e.prototype.speedProgress = function() {
                    this.speedUpTimer += Laya.timer.delta;
                    var t = this.speedUpTimer / this.speedUpTotalTime;
                    t > 1 && (this.isJump || this.anim && this.anim.crossFade("run", .5), this.speedLevel = 0, Laya.Tween.to(this, {
    ...
    6: [function(t, e, i) {
        ...
        var a = t("../LayaSample"),
            n = function(t) {
                ...
                return __extends(e, t), e.prototype.init = function() {
                    this.camera.transform.position = new Laya.Vector3(-2.2, 3, -4.3), this.camera.transform.rotationEuler = new Laya.Vector3(-18, -158.5, 0), this.moveRot = this.camera.transform.rotationEuler.clone(), this.offset.setValue(-2.2, 2.311, -5.3), this.setParticleSuDuXian(!1), this.camera.fieldOfView = 60;
                }, e.prototype.onAwake = function() {
                    this.camera = this.owner, this.camera.transform.position = new Laya.Vector3(-2.2, 3, -4.3), this.camera.transform.rotationEuler = new Laya.Vector3(-18, -158.5, 0), this.offset = new Laya.Vector3(), this.movePos = new Laya.Vector3(0, 0, .1), this.moveRot = this.camera.transform.rotationEuler.clone();
                    var t = Laya.stage.getChildAt(0);
                    this.target = t.getChildByName("Role"), this.suDuXian = this.owner.getChildByName("eff_suduxian"), this.suDuXian.transform.localPosition = new Laya.Vector3(0, .2, -4.5), this.suDuXian.transform.localRotationEuler = new Laya.Vector3(-3, 180, 0), this.setParticleSuDuXian(!1), Laya.Vector3.subtract(this.camera.transform.position, this.target.transform.position, this.offset);
                    ...
                    Laya.Vector3.add(this.offset, this.target.transform.position, this.movePos), Laya.Vector3.lerp(this.camera.transform.position, this.movePos, .23, this.movePos), this.camera.transform.position = this.movePos;
                    ...
                    a["default"].gameMgr.isPlay || (this.camera.transform.position = new Laya.Vector3(-2.2, 3, -4.3), this.camera.transform.rotationEuler = new Laya.Vector3(-18, -158.5, 0)), this.offset = new Laya.Vector3(), this.movePos = new Laya.Vector3(0, 0, .1), this.moveRot = this.camera.transform.rotationEuler.clone(), this.target = t, Laya.Vector3.subtract(this.camera.transform.position, this.target.transform.position, this.offset);
                }, e.prototype.setParticleSuDuXian = function(t) {
                    var e = this.suDuXian.getChildAt(0),
                        i = e.particleSystem;
                    i && (t ? i.play() : i.stop());
                    for (var a = e.numChildren, n = 0; a > n; n++) {
                        var o = e.getChildAt(n).particleSystem;
        ...
        var a = t("../LayaSample"),
            ...
            l = function(t) {
                function e() {
                    ...
                    return e.jumpPlatforms = [], e.barriers = [], e.arrows = [], e.roads = [], e.bikeComps = [], e.offset = 0, e.constructsArray = [], e.loadEasyModels(), e.loadModels(), e.loadConstruct(), e;
                }
                return __extends(e, t), e.getUnitRoadLength = function() {
                    return 26.999;
                }, e.prototype.init = function(t) {
                    this.scene = t, this.bikeComp = t.getChildByName("Role").getComponent(r["default"]), this.bikeComps.push(this.bikeComp), this.bikeComps.push(t.getChildByName("AI").getComponent(n["default"])), this.bikeComps.push(t.getChildByName("AI_2").getComponent(n["default"])), a["default"].commonData.bikeComps = this.bikeComps;
                    var e = Laya.loader.getRes(a["default"].commonData.models);
                    this.model = e.getChildByName("Model"), this.slope_h = this.model.getChildByName("Ramp_Hig"), this.slope_m = this.model.getChildByName("Ramp_Mid"), this.slope_l = this.model.getChildByName("Ramp_Low"), this.slope_h_acce = this.model.getChildByName("Ramp_Hig_Acce"), this.slope_m_acce = this.model.getChildByName("Ramp_Mid_Acce"), this.slope_l_acce = this.model.getChildByName("Ramp_Low_Acce"), this.rail = this.model.getChildByName("Barrier"), this.railMat = this.model.getChildByName("Barrier"), this.arrow = this.model.getChildByName("AcceArrow"), this.setSkins();
                }, e.prototype.changeModelLight = function(t) {
                    for (var e = this.model.numChildren, i = 0; e > i; i++) {
                        var a = this.model.getChildAt(i),
                            n = a.meshRenderer.material;
                        n.albedoIntensity = t;
                    }
                    ...
                    var e = this,
                        i = Laya.Pool.getItemByCreateFun("barrier", function() {
                    ...
                    var e = this;
                    this.offset = t;
                    var i = Math.floor(100 * Math.random() % this.constructions.length),
                        a = this.constructions[i];
                    a.models.forEach(function(t) {
                        e.createConstruct(t);
                    });
                    ...
                    if (!(0 > t || t > 6)) {
                        var e = this.skins.getChildByName("RoleMatList"),
                            i = this.skins.getChildByName("Model"),
                            a = null,
                            n = null;
                        if (0 == t || 1 == t || 2 == t) {
                    ...
                    if (!(0 > t || t > 6)) {
                        ...
                        if (1 == t || 2 == t) var i = e.getChildAt(0).clone();
                        else var i = e.getChildAt(1).clone();
                        var a = this.getCarModel(t);
                        return i.addChild(a.r), i.addChild(a.e), a.r.transform.localPosition = new Laya.Vector3(0, -.689, 0), a.e.transform.localPosition = new Laya.Vector3(0, 0, 0), i.transform.scale = new Laya.Vector3(.8, .8, .8), i;
                    }
                }, e.prototype.changeCar = function(t) {
                    this.bikeComps.length > 2 && this.bikeComps.splice(this.bikeComps.indexOf(this.bikeComp), 1), this.bikeComp = t, this.bikeComps.push(t);
                }, e;
            }(Laya.Script3D);
        i["default"] = l;
        (function() {
    ...
    8: [function(t, e, i) {
        ...
        var a = t("../LayaSample"),
            n = t("../manager/SoundMgr"),
            o = t("../other/ConfigData"),
            s = function(t) {
                function e() {
                    var e = null !== t && t.apply(this, arguments) || this;
                    return e.originMaxSpeed = .7, e.maxSpeed = .7, e.factor_speed = 1.3, e.factor_jump = .1, e.G = -.25, e.Acc = .02, e.acceTimer = 0, e.deceTimer = 1, e.speedToZ = 0, e.speedToY = 0, e.carWidth = .54, e.currentHeight = .689, e.turnoverHeight = .3, e.rotateUnit = new Laya.Vector3(1, 0, 0), e.isDie = !1, e.isPlay = !1, e.rotateTimer = 0, e.rotateAngle = 0, e.rotateStatus = 0, e.cheerCount = 0, e.originAngle = 0, e.isSpeedUp = !1, e.speedLevel = 0, e;
                }
                return __extends(e, t), e.prototype.init = function() {
                    Laya.timer.clearAll(this), this.speedToZ = 0, this.speedToY = 0, this.acceTimer = 0, this.deceTimer = 1, this.maxSpeed = .7, this.isDie = !1, this.isPlay = !1, this.setParticleFxExplsion(!1), this.particleAccePlay(), this.changeData(), this.isJump = !1, this.isSpeedUp = !1, this.isRotate = !1, this.anim && (this.anim.speed = 1, this.anim.play("idle")), this.bike.transform.position = this.originPos.clone(), this.bike.transform.rotationEuler = new Laya.Vector3(), this.trail.active = !0, this.trail1.active = !0, this.fxExplsion.transform.localRotationEuler = new Laya.Vector3(0, 0, 0);
                }, e.prototype.onAwake = function() {
                    this.bike = this.owner, this.originPos = this.bike.transform.position.clone(), this.move = new Laya.Vector3();
                    var t = this.owner.getChildByName("Effect");
                    this.trail = t.getChildByName("FX_BikeTrails"), this.trail1 = t.getChildByName("FX_BikeTrails (1)"), this.fxExplsion = t.getChildByName("FX_Explsion"), this.setParticleFxExplsion(!1), this.particleAcce = t.getChildByName("FX_jiasu"), this.particleAcce1 = t.getChildByName("FX_jiasu_a"), this.particleAcce2 = t.getChildByName("FX_jiasu_b"), this.particleAcce3 = t.getChildByName("FX_jiasu_c"), this.setParticleAcce(0, !1), this.anim = this.owner.getChildByName("Role").getComponent(Laya.Animator), this.wheels = [];
                    ...
                    Laya.timer.clearAll(this), this.speedToZ = 0, this.speedToY = 0, this.acceTimer = 0, this.deceTimer = 1, this.isDie = !1, this.isPlay = !1, this.setParticleFxExplsion(!1), this.particleAcceStop(), this.changeData(), this.isJump = !1, this.isSpeedUp = !1, this.isRotate = !1, this.anim && (this.anim.speed = 1, this.anim.play("idle"));
                    var t = this.bike.transform.position;
                    t.x = 0, t.y = 1, this.bike.transform.position = t, this.bike.transform.rotationEuler = new Laya.Vector3(), this.trail.active = !0, this.trail1.active = !0;
                }, e.prototype.wheelsRolling = function() {
                    var t = this;
                    a["default"].gameMgr.isMove && this.wheels.forEach(function(e) {
                        e.transform.rotate(t.rotateUnit);
                    ...
                    a["default"].gameMgr.isPressed ? this.isPlay || (this.particleAccePlay(), this.isPlay = !0) : this.isPlay && (this.particleAcceStop(), this.isPlay = !1);
                }, e.prototype.onUpdate = function() {
                    !a["default"].gameMgr.isOver && a["default"].gameMgr.isPlay && (this.moveUpdate(), this.rotate(), this.otherCar(), this.wheelsRolling(), this.particleAcceEffect());
                }, e.prototype.moveUpdate = function() {
                    a["default"].gameMgr.isPressed || this.isSpeedUp ? (0 != this.deceTimer && (this.deceTimer = 0, this.anim && (this.anim.play("start"), this.anim.crossFade("run", 1)), a["default"].soundMgr.play(n.SoundType.RIDE)), this.acceTimer += Laya.timer.delta, this.speedToZ += this.Acc * (this.acceTimer / 1e3), this.speedToZ > this.maxSpeed && (this.speedToZ = this.maxSpeed)) : this.speedToZ > 0 && !this.isJump && (0 != this.acceTimer && (this.acceTimer = 0), this.deceTimer += Laya.timer.delta, this.speedToZ -= this.Acc * (this.deceTimer / 1e3), this.speedToZ < 0 && (this.speedToZ = 0, this.setParticleAcce(this.speedLevel, !1), this.anim && this.anim.play("end"), a["default"].soundMgr.stop(n.SoundType.RIDE))), a["default"].glEvent.event(o.EventType.UPDATE_SPEED_EVENT, {
                        speed: this.speedToZ,
                    ...
                    if (a["default"].gameMgr.isPressed && this.isJump && this.canRotate) {
                        Laya.timer.clear(this, this.rotateSlowDown), this.rotateTimer += Laya.timer.delta, this.isRotate = !0;
                        var t = this.bike.transform.rotationEuler;
                        t.x -= 6, this.bike.transform.rotationEuler = t, this.anim && (this.anim.speed = 1), this.rotateAngle += 6, this.checkPlayerAngle();
                    ...
                    this.anim && (this.anim.speed = .9 * (1 - t) + .1);
                    var i = this.bike.transform.rotationEuler;
                    i.x -= e, this.rotateAngle += e, this.checkPlayerAngle(), this.bike.transform.rotationEuler = i, t > 1 && (Laya.timer.clear(this, this.rotateSlowDown), this.rotateTimer = 0);
                }, e.prototype.checkPlayerAngle = function() {
                    this.rotateAngle > 300 && this.rotateAngle < 660 && 0 == this.rotateStatus ? (this.anim && this.anim.play("turn02"), this.rotateStatus = 1, a["default"].glEvent.event(o.EventType.CIRCLE_COUNT_EVENT, {
                        circleNum: this.rotateStatus
                    }), a["default"].commonData.needShowGuide && (this.canRotate = !1), this.playSound()) : this.rotateAngle > 660 && this.rotateAngle < 1020 && 1 == this.rotateStatus ? (this.rotateStatus = 2, a["default"].glEvent.event(o.EventType.CIRCLE_COUNT_EVENT, {
                        circleNum: this.rotateStatus
                    }), this.playSound()) : this.rotateAngle > 1020 && this.rotateAngle < 1380 && 2 == this.rotateStatus ? (this.rotateStatus = 3, a["default"].glEvent.event(o.EventType.CIRCLE_COUNT_EVENT, {
                        circleNum: this.rotateStatus
                    }), this.playSound()) : this.rotateAngle > 1380 && 3 == this.rotateStatus && (this.rotateStatus = 4, a["default"].glEvent.event(o.EventType.CIRCLE_COUNT_EVENT, {
                        circleNum: this.rotateStatus
                    }), this.playSound());
                    ...
                    this.cheerCount++, this.cheerCount > 5 && (this.cheerCount = 5), a["default"].soundMgr.play(n.SoundType.CHEER), Laya.timer.clear(this, t);
                    var e = 0;
                    Laya.timer.frameLoop(1, this, t);
                }, e.prototype.jump = function(t, e) {
                    void 0 === e && (e = !0), a["default"].soundMgr.stop(n.SoundType.RIDE), a["default"].soundMgr.play(n.SoundType.JUMP), Laya.timer.clear(this, this.fallDown), this.rotateStatus = 0, this.changeData(), this.canRotate = e || this.speedLevel > 0, this.anim && this.anim.play("turn01"), this.setParticleAcce(this.speedLevel, !1), this.trail.active = !1, this.trail1.active = !1, this.isJump = !0, this.originAngle = this.bike.transform.rotationEuler.x, this.speedToZ < .1 && (this.speedToZ = .1), this.speedToY = t * (this.speedToZ / this.maxSpeed) + this.speedLevel * this.factor_jump, this.slowTimer = 0, Laya.timer.frameLoop(1, this, this.slowDown);
                }, e.prototype.slowDown = function() {
                    this.slowTimer += Laya.timer.delta, this.speedToY -= this.Acc * (this.slowTimer / 1e3), this.speedToY < 0 && (this.speedToY = 0, Laya.timer.clear(this, this.slowDown), this.fall());
                }, e.prototype.fall = function() {
                    this.declineTimer = 0, Laya.timer.clear(this, this.fallDown), Laya.timer.frameLoop(1, this, this.fallDown);
                    ...
                    if (this.declineTimer += Laya.timer.delta, this.speedToY = this.G * this.declineTimer / 1e3, this.bike.transform.position.y < this.currentHeight) {
                        a["default"].soundMgr.play(n.SoundType.GROUND), a["default"].soundMgr.play(n.SoundType.RIDE), a["default"].wxMgr.playVibrateShort(), a["default"].glEvent.event(o.EventType.CIRCLE_COUNT_EVENT, {
                            circleNum: 0
                        }), this.changeData(), Laya.timer.clear(this, this.rotateSlowDown), this.isJump = !1, this.anim && (this.anim.speed = 1, this.anim.crossFade("hit_the_ground", .5)), this.trail.active = !0, this.trail1.active = !0, this.speedToY = 0;
                        var t = this.bike.transform.position;
                        if (t.y = this.currentHeight, this.bike.transform.position = t, Laya.timer.clear(this, this.fallDown), this.currentAngle = Math.abs(this.bike.transform.rotationEuler.x) % 360, this.currentAngle > 70 && this.currentAngle <= 300) return this.currentAngle < 90 || this.currentAngle > 270 ? void this.crash() : void this.crash(1);
                        if (this.rotateStatus > 0)
                            for (var e = 0; e < this.rotateStatus; e++) this.speedUp();
                        else this.anim && this.anim.crossFade("run", .5);
                        this.changeAngle();
                    ...
                    a["default"].soundMgr.stop(n.SoundType.RIDE), a["default"].soundMgr.play(n.SoundType.HIT), a["default"].wxMgr.playVibrateLong();
                    var e = this.bike.transform.rotationEuler.x % 360;
                    1 == t ? (this.fxExplsion.transform.localRotationEuler = new Laya.Vector3(180, 0, 0), this.bike.transform.rotationEuler = new Laya.Vector3(200 - 40 * Math.random(), 0, 0)) : this.bike.transform.rotationEuler = new Laya.Vector3();
                    var i = this.bike.transform.position;
                    1 == t ? i.y = this.turnoverHeight : i.y = this.currentHeight, this.bike.transform.position = i, this.anim && (e > -240 && -30 > e ? this.anim.play("die02") : this.anim.play("die01")), this.setParticleAcce(0, !1), a["default"].glEvent.event("cameraEffect", !1), a["default"].glEvent.event(o.EventType.CIRCLE_COUNT_EVENT, {
                        circleNum: 0
                    }), this.setParticleFxExplsion(!0), this.isDie = !0, this.isPlay = !1, this.particleAcceStop(), Laya.timer.clearAll(this), this.changeData(), a["default"].glEvent.event(o.EventType.OVER_GAME_EVENT);
                }, e.prototype.speedUp = function() {
                    a["default"].wxMgr.playVibrateShort(), this.speedLevel >= 3 ? this.speedLevel = 3 : (this.speedLevel++, this.acceTimer = 0, this.isSpeedUp = !0, this.maxSpeed *= this.factor_speed, this.speedUpTotalTime = 1e3);
                    var t = Math.ceil(100 * Math.random() % 3);
                    this.anim && this.anim.crossFade("accelerate0" + t, .5), this.speedUpTimer = 0, Laya.timer.clear(this, this.speedProgress), Laya.timer.frameLoop(1, this, this.speedProgress), this.setParticleAcce(0, !1), this.setParticleAcce(this.speedLevel, !0), a["default"].wxMgr.playVibrateShort(), a["default"].glEvent.event("cameraEffect", !0);
                    ...
                    a["default"].glEvent.event(o.EventType.SPEED_UP_EVENT, {
                        progress: t,
                        level: this.speedLevel
                    }), t > 1 && (this.isJump || this.anim && this.anim.crossFade("run", .5), this.setParticleAcce(0, !1), a["default"].glEvent.event("cameraEffect", !1), a["default"].glEvent.event(o.EventType.SPEED_UP_EVENT, {
                        progress: 1,
                        level: 0
    ...
    9: [function(t, e, i) {
        ...
        var a = t("../LayaSample"),
            n = function(t) {
                ...
                return __extends(e, t), e.prototype.init = function(t) {
                    this.width = .75, this.height = .7, this.distance = .7, this.width_limit = this.width + .2, this.distance += 1.5, this.targets = t, this.checkOnce = [], this.isHits = [], this.toLeft = [];
                    for (var e = 0; e < this.targets.length; e++) this.checkOnce.push(!0), this.isHits.push(!1), this.toLeft.push(!1);
                }, e.prototype.onUpdate = function() {
                    if (!a["default"].gameMgr.isOver)
                        for (var t = 0; t < this.targets.length; t++) {
                            var e = this.targets[t],
                                ...
                                n = e.carWidth,
                                o = this.owner,
                                s = o.transform.position;
                            e && e.getBike.transform.position.y < this.height + .7 && i.z < s.z + this.distance ? i.z > s.z && (this.checkOnce[t] && (this.checkOnce[t] = !1, this.isHits[t] = i.x - n / 2 > s.x - this.width && i.x - n / 2 < s.x + this.width || i.x + n / 2 < s.x + this.width && i.x + n / 2 > s.x - this.width || i.x + n / 2 > s.x + this.width && i.x - n / 2 < s.x - this.width || i.x + n / 2 < s.x + this.width && i.x - n / 2 > s.x - this.width, i.x + n / 2 < s.x + this.width, this.toLeft[t] = i.x < s.x - this.width, this.isHits[t] && e.crash()), -1 != e.owner.name.indexOf("Role") && i.z > s.z + 1e3 && (Laya.Pool.recover("barrier", this.owner), this.owner.parent.removeChild(this.owner))) : this.checkOnce[t] || (this.checkOnce[t] = !0, this.isHits[t] = !1, this.toLeft[t] = !1);
                        }
                }, e;
            }(Laya.Script3D);
        i["default"] = n;
    ...
    10: [function(t, e, i) {
        ...
        var a = t("../LayaSample"),
            ...
            o = function(t) {
                function e() {
                    var e = null !== t && t.apply(this, arguments) || this;
                    return e.width = 1, e.firstChecks = [], e.jumping = [], e.toLeft = [], e.jumped = [], e;
                }
                return __extends(e, t), e.prototype.init = function(t, e) {
                    switch (this.canRotate = !0, this.type = t, t) {
                        case "jp_low":
                            this.height = .8, this.distance = 3, this.angle_max = -15, this.canRotate = !1, this.jump_strength = .03;
                            break;
                        case "jp_mid":
                        ...
                        case "jp_low_acce":
                            ...
                            break;
                        case "jp_mid_acce":
                            this.height = 1.3, this.distance = 2.8, this.angle_max = -25, this.canAcce = !0, this.jump_strength = .25;
                            break;
                        case "jp_hig_acce":
                            this.height = 1.7, this.distance = 2.5, this.angle_max = -35, this.canAcce = !0, this.jump_strength = .7;
                    }
                    this.targets = e, this.firstChecks = [], this.jumping = [], this.jumped = [], this.toLeft = [];
                    for (var i = 0; i < this.targets.length; i++) this.firstChecks.push(!0), this.jumping.push(!1), this.jumped.push(!1), this.toLeft.push(!1);
                        ...
                        for (var t = 0; t < this.targets.length; t++) {
                            ...
                            if (e && (this.jumping[t] && !e.isJump || e.getBike.transform.position.y < this.height + 1.9) && i.z < s.z + this.distance + 1) {
                                if (i.z > s.z) {
                                    ...
                                    if (this.firstChecks[t]) this.firstChecks[t] = !1, this.jumping[t] = i.x - r / 2 > s.x - this.width && i.x - r / 2 < s.x + this.width || i.x + r / 2 < s.x + this.width && i.x + r / 2 > s.x - this.width || i.x + r / 2 > s.x + this.width && i.x - r / 2 < s.x - this.width || i.x + r / 2 < s.x + this.width && i.x - r / 2 > s.x - this.width, this.toLeft[t] = i.x < s.x - this.width, this.jumping[t] && this.canAcce && e.speedUp();
                                    else if (this.jumping[t] && i.z < s.z + this.distance - 1) {
                                        var h = e.getBike.transform.position.clone();
                                        h.y = .69 * (i.z - s.z);
                                        var l = e.getBike.transform.rotationEuler.clone();
                                        l.x = -7.14 * (i.z - s.z), l.x < this.angle_max && (l.x = this.angle_max), e.getBike.transform.position = h, e.getBike.transform.rotationEuler = l;
                                    } else !this.jumping[t] && i.z < s.z + this.distance || this.jumping[t] && !this.jumped[t] && i.z < s.z + this.distance + 1 && (this.jumped[t] = !0, e.jump(this.jump_strength, this.canRotate), "Role" == e.owner.name && a["default"].soundMgr.play(n.SoundType.RUSH)); - 1 != e.owner.name.indexOf("Role") && i.z > s.z + 1e3 && (Laya.Pool.recover(this.type, this.owner), this.owner.parent.removeChild(this.owner));
                                }
                            } else this.firstChecks[t] || (this.firstChecks[t] = !0, this.jumping[t] = !1, this.toLeft[t] = !1, this.jumped[t] = !1);
                        }
                }, e;
            }(Laya.Script3D);
        i["default"] = o;
    ...
    11: [function(t, e, i) {
        ...
        var n;
        ! function(t) {
            t.Login = "views/login.scene", t.Game = "views/game.scene", t.Home = "views/home.scene", t.Over = "views/over.scene", t.Clearing = "views/clearing.scene", t.Rank = "views/rank.scene", t.Collect = "views/collect.scene", t.Skin = "views/freeSkin.scene", t.Converge = "views/ConvergeAd.scene";
    ...
    12: [function(t, e, i) {
        ...
        var a = t("../LayaSample"),
            ...
            o = function() {
                ...
                return t.prototype.request = function(e, i, a) {}, t.prototype.urlEncode = function(t) {
                    if (null == t) return "";
                    var e = "",
                        i = new Array();
                    for (var a in t) i.push(a);
                    i = i.sort();
                    for (var n = 0, o = i.length; o > n; ++n) e += i[n] + "=" + encodeURIComponent(t[i[n]]), n != o - 1 && (e += "&");
                    return e;
                    ...
                    var t = this;
                    t._connectCount += 1, t._connectCount < 3 ? (console.error("net error，try to connect " + t._connectCount + " time"), setTimeout(function(t) {
                        a["default"].wxMgr.login();
                    }, 1e3 * t._connectCount)) : t._connectCount = 0;
                }, t.prototype.requestStatistics = function(e) {}, t.prototype.navigateToMiniProgram = function(t) {
                    t && t.to_appid && Laya.Browser.onMiniGame && (n["default"].instance.navigateToMiniProgramStatistics(t), window.wx.navigateToMiniProgram({
                        appId: t.to_appid,
                        path: t.toLinks,
                        extraData: {
                            foo: "bar"
                        ...
                        success: function(e) {
                            n["default"].instance.navigateToMiniProgramBackStatistics(t), t.callback && t.callback("success"), t.callback = null;
                        }
                    }));
                }, t.deviceType = "wxapp", t.apiLogin = "userLogin.action", t.apiAd = "", t.host = "", t.statisticsUrl = "", t.apiKey = "", t.apiSecret = "", t.version = 127, t.encryptDESKey1 = "qire1", t.encryptDESKey2 = "qire2", t.encryptDESKey3 = "qire3", t.encryptDES = !0, t.sessionId = "", t.ctrlInfo = {}, t.bannerAdIds = [""], t.rewardedAdIds = [""], t.innerADIds = [""], t.wudian_level = [1, 1, 1, 1], t.systemInfo = {}, t.aladingStatus = 1, t.code = "", t.isNew = !1, t.openId = "", t.allAdsControl = [], t;
            }();
        i["default"] = o;
    }, {
        "../LayaSample": 3,
    ...
    13: [function(t, e, i) {
        ...
        var a = t("../LayaSample"),
            n = function() {
                function t() {
                    this.isPlayingBGM = !1, this.isPlayingRide = !1, this._pathRoot = "res/sound/", this._soundCtx = {}, this._soundFile = [];
                    for (var t in o) {
                        var e = o[t];
                ...
                return t.prototype.init = function() {
                    for (var t = this._pathRoot, e = "", i = this._soundFile, a = this._soundFile.length, n = 0; a > n; ++n) {
                        ...
                        o.url = t + e + ".mp3", ("ride" == e || "bgm" == e) && (o.loops = 0), Laya.SoundManager.addChannel(o), this._soundCtx[e] = !0;
                    }
                    ...
                    if (void 0 === e && (e = 0), this._soundCtx[t] && a["default"].storageMgr.isPlaySound()) {
                        ...
                        Laya.Browser.onMiniGame ? (this.bgm || (this.bgm = wx.createInnerAudioContext(), this.bgm.src = i, this.bgm.loop = !0), this.bgm.play()) : Laya.SoundManager.playMusic(i, e);
                    }
        ...
        var o;
        ! function(t) {
            t.BGM = "bgm", t.RIDE = "ride", t.OVER = "over", t.CHEER = "cheer", t.HIT = "hit", t.CLICK = "click", t.JUMP = "jump", t.GROUND = "ground", t.DJS = "djs", t.RUSH = "rush", t.SPEED_UP_1 = "speed_up_2_3", t.SPEED_UP_2 = "speed_up_2_3", t.SPEED_UP_3 = "speed_up_2_3";
    ...
    14: [function(t, e, i) {
        ...
        var a, n = t("./NetMgr"),
            o = t("../LayaSample");
        ! function(t) {
            t[t.NORMAL = 0] = "NORMAL", t[t.RESURGENCE = 1] = "RESURGENCE", t[t.PROP = 2] = "PROP", t[t.LOTTERY = 3] = "LOTTERY", t[t.START_GAME = 4] = "START_GAME", t[t.TRY_SKIN = 5] = "TRY_SKIN", t[t.OFFLINE = 6] = "OFFLINE", t[t.SETTLE = 7] = "SETTLE", t[t.EGG = 8] = "EGG", t[t.SKILL = 9] = "SKILL";
    ...
    16: [function(t, e, i) {
        ...
        var a = function() {
            function t() {
                this.scenes = "res/scenes/Conventional/ModelScene.ls", this.models = "res/res3d/models/Conventional/ModelScene.lh", this.skinList = "res/res3d/skinList_V1/Conventional/ModelScene.lh", this.newScore = 1, this.goonCount = 0, this.isSleep = !1, this.watchVideo = !1, this.watchInter = !1, this.useTime = 1e3, this.needWxAuthorize = !1, this.userInfo = {}, this.existInterAd = !1, this.existVideoAd = !1, this.existBannerAd = !1, this.isAdDelay = !1, this.adTime = 13e3, this.myAppid = "wx329acc38987d8151", this.curSkinIndex = 0, this.shareInfo = {}, this.launchOptions = {}, this.wxsysInfo = {}, this.construction = 2, this.isCheckSignin = !1, this.lateWay = 0, this.needShowGuide = !1, this.bikeComps = [], this.gameCount = 0, this.isShowSkin = !1, this.skinIncome = 0, this.skinScore = 0;
            }
            return t;
        }();
        i["default"] = a;
        var n;
        ! function(t) {
            t.AD_LOAD_EVENT = "ad_load_event", t.CHANGE_SKIN = "change_skin_event", t.CIRCLE_COUNT_EVENT = "circle_count_event", t.OVER_GAME_EVENT = "over_game_event", t.UPDATE_SPEED_EVENT = "update_speed_event", t.SPEED_UP_EVENT = "speed_up_event", t.AI_HIT_EVENT = "ai_hit_event", t.INIT_GAME_EVENT = "init_game_event", t.PLAY_GAME_EVENT = "play_game_event", t.GOON_GAME_EVENT = "goon_game_event", t.SHOW_APPLITE_EVENT = "show_applite_event", t.LOGIN_EVENT = "login_success_event", t.DRAW_WORLD_RANK_EVENT = "draw_world_rank_event", t.AD_SHOW_EVENT = "ad_show_event", t.AD_VIDEO_CLOSE_EVENT = "ad_video_close_event", t.WX_WAKE_EVENT = "wx_wake_event", t.WX_SLEEP_EVENT = "wx_sleep_event", t.SHARE_BACK_EVENT = "share_back_event", t.LOAD_FINISH_EVENT = "load_finish_event", t.HIT_CAR_EVENT = "hit_car_event";
            ...
            n = function() {
                ...
                return t.isNull = function(t) {
                    ...
                    if (Laya.Browser.onMiniGame) {
                        var e = a["default"].systemInfo,
                            i = 20;
                        20 == e.statusBarHeight || (44 == e.statusBarHeight || 27 == e.statusBarHeight || 30 == e.statusBarHeight ? i += 70 : 24 == e.statusBarHeight && (i += 16)), t.forEach(function(t) {
                            t.y = i + t.height / 2;
                        });
                    }
                    ...
                    for (var i = [], s = 0; e > s; s++) {
                        var r = this.random(0, n.length - 1),
                            h = n[r];
    ...
    18: [function(t, e, i) {
        ...
        var a = function() {
            ...
            return t.prototype.init = function() {}, t.prototype.getBannerCount = function() {
                return 0;
            }, t.prototype.getBannerItem = function() {}, t.prototype.setBannerItem = function() {}, t.prototype.showBannerAd = function() {}, t.prototype.getInterstitialAd = function() {}, t.prototype.hideBannerAd = function() {}, t.prototype.setBannerAdWidth = function(t) {}, t.prototype.setBannerAdTop = function(t) {}, t.prototype.getBannerAd = function() {}, t.prototype.showVideoAd = function(t) {}, t.prototype.getVideoAd = function() {}, t.prototype.loadVideoAd = function() {}, t.prototype.showInterstitialAd = function() {}, t;
        }();
        i["default"] = a;
    }, {}],
    19: [function(t, e, i) {
        ...
        var a = t("./WxAdManager"),
            n = t("../../manager/NetMgr"),
            o = t("../../LayaSample"),
            s = t("../../manager/SoundMgr"),
            r = t("../../other/ConfigData"),
            h = t("../../manager/StatisticsMgr"),
            l = function() {
                function t() {}
                return t.prototype.init = function() {
                    if (this.preTime = 0, this.buttonAuthorize1 = null, this._shareStartTime = new Date().getTime() + 86e3, this._isCreateWxInfoBtn = !1, Laya.Browser.onMiniGame) {
                        var t = window.wx.getSystemInfoSync();
                        n["default"].systemInfo = t, o["default"].commonData.wxsysInfo = t, this._regisiterWXCallback(), this.getLaunchOption(), this.showShareMenuWithTicket(!0);
                    }
                    ...
                    var e = o["default"].wxMgr,
                        i = o["default"].commonData.wxsysInfo,
                        a = i.screenWidth,
                        n = i.screenHeight,
                        s = (i.screenWidth - a) / 2,
                        r = (i.screenHeight - n) / 2,
                        l = {
                            left: s,
                            top: r,
                            width: a,
                    ...
                    e.buttonAuthorize1 = window.wx.createUserInfoButton({
                        ...
                        var a = new Date().getTime(),
                            n = Math.floor((a - e.preTime) / 1e3);
                        if (e.preTime = a, !(1 > n)) {
                            if (i.userInfo) {
                                console.log("用户授权登录");
                                var s = {};
                                h["default"].instance.authorStatistics(), s.nickname = i.userInfo.nickName, s.gender = i.userInfo.gender, s.avatarUrl = i.userInfo.avatarUrl, o["default"].commonData.userInfo.nickname = s.nickname, o["default"].commonData.userInfo.avatarUrl = s.avatarUrl, t.updateUserInfo(s);
                    ...
                    o["default"].netMgr.request("getSystemParamList.action", t, function(t) {
                        if (0 == t.code) {
                            ...
                            if (n["default"].ctrlInfo = {
                                ...
                                }, t.bannerAdIds && (n["default"].bannerAdIds = t.bannerAdIds.split(",")), t.rewardedAdIds && (n["default"].ctrlInfo.isVideo = !0, n["default"].rewardedAdIds = t.rewardedAdIds.split(",")), t.innerADIds && (n["default"].innerADIds = t.innerADIds.split(",")), t.wudianLevel) {}
                            if (t.lateDelay) {}
                            if (t.btuMove) {}
                            if (t.btuAppear) {}
                        }
                    });
                }, t.prototype.setUserInfo = function(t) {}, t.prototype.getAllAdsControl = function() {
                    var t = this,
                        e = {};
                    e.nowVersion = n["default"].version, e.timeout = t.getAllAdsControl, o["default"].netMgr.request("getAllAdsControl.action", e, function(t) {
                        console.log("getAllAdsControl.action:", t), 0 == t.code && t.allAdsControl && (n["default"].allAdsControl = JSON.parse(t.allAdsControl), a["default"].Instance.init());
                    });
                }, t.prototype.showAuthorizeBtn = function(t) {
                    this.buttonAuthorize1 && (t ? (this.buttonAuthorize1.show(), console.log("show")) : (this.buttonAuthorize1.hide(), console.log("hide")));
                    ...
                    var e = o["default"].storageMgr.getGameStatus(),
                        i = o["default"].wxMgr;
                    if (e.maxScore < t) {
                    ...
                    Laya.Browser.onMiniGame && (window.wx.offShow(this.onShowEvent), window.wx.onShow(this.onShowEvent), window.wx.offHide(this.onHideEvent), window.wx.onHide(this.onHideEvent));
                }, t.prototype.onShowEvent = function(t) {
                    var e = o["default"].wxMgr;
                    if (o["default"].commonData.isSleep = !1, console.log(o["default"].soundMgr.isPlayingBGM), console.log(o["default"].storageMgr.isPlaySound()), o["default"].soundMgr.isPlayingBGM || o["default"].soundMgr.playMusic(s.SoundType.BGM), o["default"].glEvent.event(r.EventType.WX_WAKE_EVENT, {}), e._statuShareGame) {
                        console.log("渠道1"), e._statuShareGame = !1;
                        var i = new Date().getTime(),
                            a = i - e._shareStartTime,
                            n = 2500 > a ? !1 : !0;
                    ...
                    if (Laya.Browser.onMiniGame) {
                        var n, s = o["default"].wxMgr,
                            r = s.getShareContent(t);
                        e && (s._shareStartTime = new Date().getTime(), s._statuShareGame = !0, s._shareId = r.share_id), n = {
                            title: r.share_title,
                    ...
                    if (n["default"].ctrlInfo.shareInfo) {
                        ...
                        var e = o["default"].commonData.shareInfo,
                            i = {};
                        if (e) {
    ...
    20: [function(t, e, i) {
        ...
        var a = t("../../LayaSample"),
            ...
            r = function(t) {
                ...
                return __extends(e, t), e.prototype.init = function() {
                    if (this._videoAd = null, this._interAd = null, this._videoCate = -1, this._isCreateInter = !1, Laya.Browser.onMiniGame) {
                        var t = a["default"].commonData.wxsysInfo.SDKVersion;
                        this._isCreateInter = o["default"].Instance.compareVersion(t, "2.6.0") >= 0, this.getVideoAd(), this.getInterstitialAd();
                    }
                    ...
                    var e = this._videoAd;
                    Laya.Browser.onMiniGame && e && (this._videoCate = t, a["default"].wxMgr.upViewVideoInfo(0, t), e.show().then(function() {
                    ...
                    if (Laya.Browser.onMiniGame) {
                        ...
                        var t = this._videoAd;
                        t && (t.offLoad(this._onLoadVideo), t.offError(this._onErrorVideo), t.offClose(this._onCloseVideo)), t = wx.createRewardedVideoAd({
                            adUnitId: s["default"].rewardedAdIds
                        }), t.onLoad(this._onLoadVideo), t.onError(this._onErrorVideo), t.onClose(this._onCloseVideo), this._videoAd = t;
                    }
                    ...
                    if (this._isCreateInter && wx.createInterstitialAd) {
                        ...
                        }), t.onLoad(this._onLoadInterstitial), t.onError(this._onErrorInterstitial), t.onClose(this._onCloseInterstitial), this._interAd = t;
                    }
                    ...
                    console.error("Interstitial 加载错误", t), a["default"].commonData.existInterAd = !1, a["default"].glEvent.event("ad_load_event", {
                        adtype: "inter",
                        isLoad: !1
                    });
                }, e;
        ...
        var a = t("../../manager/NetMgr"),
            ...
            s = function() {
                ...
                return Object.defineProperty(t, "Instance", {
                    ...
                    Laya.Browser.onMiniGame && !this.isInited && (a["default"].systemInfo.SDKVersion && this.compareVersion(a["default"].systemInfo.SDKVersion, "2.0.4") >= 0 && (this.isInited = !0, this.showBannerAd_fuhuo(!0), this.showBannerAd_jiesuanjiemian(!0), this.showBannerAd_jiesuanjinbi(!0), this.showBannerAd_shiyongpifu(!0), this.showBannerAd_zhujiemian(!0), this.showBannerAd_zhujiemianlingqujinbi(!0), this.LoadRewardedVideoAdList()), a["default"].systemInfo.SDKVersion && this.compareVersion(a["default"].systemInfo.SDKVersion, "2.6.0") >= 0);
                    ...
                    var n = a["default"].systemInfo.windowWidth,
                        o = Laya.stage.width / 2 - 140,
                        s = a["default"].systemInfo.windowHeight;
                    return this.bannerAd_zhujiemian || (this.bannerAd_zhujiemian = window.wx.createBannerAd({
                        ...
                        i && (i.style.left = (n - i.style.realWidth) / 2, i.style.top = s - i.style.realHeight, s / n > 2 && (i.style.top = i.style.top - 10));
                    }), this.bannerAd_zhujiemian.onError(function(e) {
                        console.log("广告加载错误:", e), t.Instance.destroyBannerAd_zhujiemian();
                    }), this.bannerAd_zhujiemian.onLoad(function() {})), e ? (console.log("预加载广告"), void 0 != this.bannerAd_zhujiemian && this.bannerAd_zhujiemian.hide(), !0) : (this.bannerAd_zhujiemian && this.bannerAd_zhujiemian.show(), !0);
                    ...
                    return this.bannerAd_zhujiemianlingqujinbi || (this.bannerAd_zhujiemianlingqujinbi = window.wx.createBannerAd({
                        ...
                        i && (i.style.left = (n - i.style.realWidth) / 2, i.style.top = s - i.style.realHeight, s / n > 2 && (i.style.top = i.style.top - 25));
                    ...
                    }), this.bannerAd_zhujiemianlingqujinbi.onLoad(function() {})), e ? (console.log("预加载广告"), void 0 != this.bannerAd_zhujiemianlingqujinbi && this.bannerAd_zhujiemianlingqujinbi.hide(), !0) : (void 0 != this.bannerAd_zhujiemianlingqujinbi && (0 != a["default"].wudian_level[4] && 1 == a["default"].ctrlInfo.isWudian ? (console.log("show_zhujiemianlingqujinbi NetMgr.ctrlInfo.lateDelay[4] = ", a["default"].ctrlInfo.lateDelay[4]), Laya.timer.clear(this, this.show_zhujiemianlingqujinbi), Laya.timer.once(a["default"].ctrlInfo.lateDelay[4], this, this.show_zhujiemianlingqujinbi)) : (Laya.timer.clear(this, this.show_zhujiemianlingqujinbi), Laya.timer.once(700, this, this.show_zhujiemianlingqujinbi))), !0);
                    ...
                    return this.bannerAd_shiyongpifu || (this.bannerAd_shiyongpifu = window.wx.createBannerAd({
                        ...
                        console.log("广告加载错误:", e), t.Instance.destroyBannerAd_zhujiemianlingqujinbi();
                    }), this.bannerAd_shiyongpifu.onLoad(function() {})), e ? (console.log("预加载广告"), void 0 != this.bannerAd_shiyongpifu && this.bannerAd_shiyongpifu.hide(), !0) : (void 0 != this.bannerAd_shiyongpifu && (0 != a["default"].wudian_level[0] && 1 == a["default"].ctrlInfo.isWudian ? (Laya.timer.clear(this, this.show_shiyongpifu), console.log("shiyongpifu NetMgr.ctrlInfo.lateDelay[0] =" + a["default"].ctrlInfo.lateDelay[0]), Laya.timer.once(a["default"].ctrlInfo.lateDelay[0], this, this.show_shiyongpifu)) : (Laya.timer.clear(this, this.show_shiyongpifu), Laya.timer.once(700, this, this.show_shiyongpifu))), !0);
                    ...
                    return this.bannerAd_fuhuo || (this.bannerAd_fuhuo = window.wx.createBannerAd({
                        ...
                        console.log("广告加载错误:", e), t.Instance.destroyBannerAd_zhujiemianlingqujinbi();
                    }), this.bannerAd_fuhuo.onLoad(function() {})), e ? (console.log("预加载广告"), void 0 != this.bannerAd_fuhuo && this.bannerAd_fuhuo.hide(), !0) : (void 0 != this.bannerAd_fuhuo && (0 != a["default"].wudian_level[1] && 1 == a["default"].ctrlInfo.isWudian ? (Laya.timer.clear(this, this.show_fuhuo), Laya.timer.once(a["default"].ctrlInfo.lateDelay[1], this, this.show_fuhuo), console.log("shiyongpifu NetMgr.ctrlInfo.lateDelay[1] =" + a["default"].ctrlInfo.lateDelay[1])) : (Laya.timer.clear(this, this.show_fuhuo), Laya.timer.once(700, this, this.show_fuhuo))), !0);
                    ...
                    return this.bannerAd_jiesuanjinbi || (this.bannerAd_jiesuanjinbi = window.wx.createBannerAd({
                        ...
                        console.log("广告加载错误:", e), t.Instance.destroyBannerAd_zhujiemianlingqujinbi();
                    }), this.bannerAd_jiesuanjinbi.onLoad(function() {})), e ? (console.log("预加载广告"), void 0 != this.bannerAd_jiesuanjinbi && this.bannerAd_jiesuanjinbi.hide(), !0) : (void 0 != this.bannerAd_jiesuanjinbi && (0 != a["default"].wudian_level[2] && 1 == a["default"].ctrlInfo.isWudian ? (console.log("show_jiesuanjinbi NetMgr.ctrlInfo.lateDelay[2] = ", a["default"].ctrlInfo.lateDelay[2]), Laya.timer.clear(this, this.show_jiesuanjinbi), Laya.timer.once(a["default"].ctrlInfo.lateDelay[2], this, this.show_jiesuanjinbi)) : (Laya.timer.clear(this, this.show_jiesuanjinbi), Laya.timer.once(700, this, this.show_jiesuanjinbi))), !0);
                    ...
                    return this.bannerAd_jiesuanjiemian || (this.bannerAd_jiesuanjiemian = window.wx.createBannerAd({
                        ...
                        console.log("广告加载错误:", e), t.Instance.destroyBannerAd_zhujiemianlingqujinbi();
                    }), this.bannerAd_jiesuanjiemian.onLoad(function() {})), e ? (console.log("预加载广告"), void 0 != this.bannerAd_jiesuanjiemian && this.bannerAd_jiesuanjiemian.hide(), !0) : (void 0 != this.bannerAd_jiesuanjiemian && (0 != a["default"].wudian_level[3] && 1 == a["default"].ctrlInfo.isWudian ? (Laya.timer.clear(this, this.show_jiesuanjiemian), Laya.timer.once(a["default"].ctrlInfo.lateDelay[3], this, this.show_jiesuanjiemian), console.log("show_jiesuanjiemian NetMgr.ctrlInfo.lateDelay[3] = ", a["default"].ctrlInfo.lateDelay[3])) : (Laya.timer.clear(this, this.show_jiesuanjiemian), Laya.timer.once(700, this, this.show_jiesuanjiemian))), !0);
                    ...
                    Laya.timer.clear(this, this.show_zhujiemianlingqujinbi), Laya.timer.clear(this, this.show_shiyongpifu), Laya.timer.clear(this, this.show_fuhuo), Laya.timer.clear(this, this.show_jiesuanjinbi), Laya.timer.clear(this, this.show_jiesuanjiemian), this.hideBannerAd_fuhuo(), this.hideBannerAd_jiesuanjiemian(), this.hideBannerAd_jiesuanjinbi(), this.hideBannerAd_shiyongpifu(), this.hideBannerAd_zhujiemian(), this.hideBannerAd_zhujiemianlingqujinbi();
                    ...
                    this.isInited && (this.caller_shuangbeikaiju = i, this.callBackSuc_shuangbeikaiju = a, this.callBackFail_shuangbeikaiju = n, this.callBackErro_shuangbeikaiju = o, this.hasAd_shuangbeikaiju ? (this.hasAd_shuangbeikaiju = !1, this.rewardedVideoAd_shuangbeikaiju.show()) : this.rewardedVideoAd_shuangbeikaiju.load().then(function() {
                    ...
                    this.isInited && (this.caller_zhujiemianduobeijinbi = i, this.callBackSuc_zhujiemianduobeijinbi = a, this.callBackFail_zhujiemianduobeijinbi = n, this.callBackErro_zhujiemianduobeijinbi = o, this.hasAd_zhujiemianduobeijinbi ? (this.hasAd_zhujiemianduobeijinbi = !1, this.rewardedVideoAd_zhujiemianduobeijinbi.show()) : this.rewardedVideoAd_zhujiemianduobeijinbi.load().then(function() {
                    ...
                    Laya.Browser.onMiniGame && this.isInited && (this.rewardedVideoAd_shiyongpifu = window.wx.createRewardedVideoAd({
                        ...
                        n["default"].soundMgr.playMusic(o.SoundType.BGM), e && e.isEnded || void 0 === e ? (t.Instance.videoPlayedTimes += 1, null != t.Instance.callBackSuc_shiyongpifu && t.Instance.callBackSuc_shiyongpifu(t.Instance.caller_shiyongpifu)) : null != t.Instance.callBackFail_shiyongpifu && t.Instance.callBackFail_shiyongpifu(t.Instance.caller_shiyongpifu);
                    })));
                }, t.prototype.showVideo_shiyongpifu = function(e, i, a, n, o) {
                    this.isInited && (this.caller_shiyongpifu = i, this.callBackSuc_shiyongpifu = a, this.callBackFail_shiyongpifu = n, this.callBackErro_shiyongpifu = o, this.hasAd_shiyongpifu ? (this.hasAd_shiyongpifu = !1, this.rewardedVideoAd_shiyongpifu.show()) : this.rewardedVideoAd_shiyongpifu.load().then(function() {
                    ...
                    this.isInited && (this.caller_fuhuo = i, this.callBackSuc_fuhuo = a, this.callBackFail_fuhuo = n, this.callBackErro_fuhuo = o, this.hasAd_fuhuo ? (this.hasAd_fuhuo = !1, this.rewardedVideoAd_fuhuo.show()) : this.rewardedVideoAd_fuhuo.load().then(function() {
                    ...
                    this.isInited && (this.caller_jiesuanjinbi = i, this.callBackSuc_jiesuanjinbi = a, this.callBackFail_jiesuanjinbi = n, this.callBackErro_jiesuanjinbi = o, this.hasAd_jiesuanjinbi ? (this.hasAd_jiesuanjinbi = !1, this.rewardedVideoAd_jiesuanjinbi.show()) : this.rewardedVideoAd_jiesuanjinbi.load().then(function() {
                    ...
                    this.isInited && (this.caller_shangcheng = i, this.callBackSuc_shangcheng = a, this.callBackFail_shangcheng = n, this.callBackErro_shangcheng = o, this.hasAd_shangcheng ? (this.hasAd_shangcheng = !1, this.rewardedVideoAd_shangcheng.show()) : this.rewardedVideoAd_shangcheng.load().then(function() {
    ...
    22: [function(t, e, i) {
        ...
        var s = function(t) {
            ...
            return __extends(e, t), e.prototype.init = function(t) {
                this._cellWidth = t._cellWidth || 108, this._spaceX = t._spaceX || 31, this.speedTime = t.speedTime || 500, this._cellHeight = t._cellHeight || 108;
                ...
                if (!n["default"].isNull(t)) {
                    ...
                    for (var r, h = function() {
                            ...
                            l.owner.addChild(a);
                            var h = new Laya.Text();
                            a.addChild(h), a.addChild(n), s ? a.pos((d - 1) * (l._cellWidth + l._spaceX), l.posY) : a.pos(d * (l._cellWidth + l._spaceX), l.posY), n.skin = r.param, n.width = l._cellWidth, n.height = l._cellHeight, a.width = l._cellWidth, a.height = 140, h.y = 118, h.width = l._cellWidth, h.height = 24, h.fontSize = 24, h.color = "#4A4A4A", h.align = "center", h.valign = "middle", h.zOrder = 10;
                            var c = d;
    ...
    23: [function(t, e, i) {
        ...
        var a = t("../other/MyUtils"),
            n = t("../LayaSample"),
            o = t("../platforms/wx/WxAdManager"),
            s = t("../other/ConfigData"),
            r = t("../manager/GameMgr"),
            h = function(t) {
                function e() {
                    var e = null !== t && t.apply(this, arguments) || this;
                ...
                return __extends(e, t), e.prototype.onAwake = function() {
                    t.prototype.onAwake.call(this), this.homeBtn = this.owner.getChildByName("homeBtn"), a["default"].autoScreenSize([this.homeBtn]), this.view = this.owner, this.adList = this.owner.getChildByName("list"), this.adList.vScrollBarSkin = "", this.adList.selectEnable = !0, this.adList.y = 20, this.adList.renderHandler = new Laya.Handler(this, this.onRender), this.adList.mouseHandler = new Laya.Handler(this, this.onClickItem), Laya.stage.height > 1334 && (this.adList.y = 20 + (Laya.stage.height - 1334) / 2), o["default"].Instance.hideBannerAd(), this.okBtn = this.owner.getChildByName("okBtn"), this.okBtn.bottom = 0, this.homeBtn = this.owner.getChildByName("homeBtn");
                }, e.prototype.onEnable = function() {
                    ...
                    var e = [];
                    null == this.adList.array && (e = a["default"].getAdData(1004), this.adList.array = e), this.adList.refresh(), this.adList.scrollTo(0), Laya.timer.once(1e3, this, function() {
    ...
    24: [function(t, e, i) {
        ...
        var s = function(t) {
            function e() {
                var e = t.call(this) || this;
                return e.moveSpeed = .5, e._itemHeight = 244, e._itemWidth = 184, e._spaceX = 14, e._spaceY = 14, e._repeatX = 3, e._repeatY = 3, e.speedTime = 500, e.viewHeight = 503, e;
            }
            return __extends(e, t), e.prototype.start = function(t) {
                if (!n["default"].isNull(t)) {
                    ...
                    for (var e = 0, i = new r(), o = this, s = function() {
                            ...
                            a.pos(e * (h._itemWidth + h._spaceX), n), a.skin = t.param, a.width = h._itemWidth, a.height = h._itemHeight, a.on(Laya.Event.MOUSE_DOWN, h, function() {
                                o.startTime = Laya.timer.currTimer;
                ...
                this.moveDirection == a.DOWN && this._cells[0].getPosY() > this.fristPosY && this.setDirtion(a.UP), this.moveDirection == a.UP && this._cells[this._cells.length - 1].getPosY() < this.endPosY && this.setDirtion(a.DOWN);
    ...
    25: [function(t, e, i) {
        ...
        var a = t("../other/MyUtils"),
            ...
            o = function(t) {
                function e() {
                    var e = t.call(this) || this;
                    return e.isClick = !1, e.toLinks = "", e.toAppId = "", e.thePosition = 1, e.nowidx = 0, e.maxdix = 0, e.isAnim = !0, e.isChange = !1, e.lastRand = 0, e;
                }
                return __extends(e, t), e.prototype.onAwake = function() {
                    ...
                    return !n || n.length <= 0 ? void(this.owner.visible = !1) : (this.owner.visible = !0, this.owner.rotation = 0, this.owner.scale(1, 1), this.isAnim = t, this.isChange = e, this.thePosition = i, this.nowidx = 0, this.maxdix = n.length - 1, this.randomAD(), this.isAnim && this.adAnim(), Laya.timer.clearAll(this), void this.startAnim());
                }, e.prototype.startAnim = function() {
                    var t = this,
                        e = a["default"].getAdData(this.thePosition);
                    ...
                    if (t) {
                        ...
                        this.lastRand == e && (e += 1, e > this.maxdix && (e = 0)), this.lastRand = e, this.nowidx = e, this.toAppId = t[this.nowidx].appid, this.toLinks = t[this.nowidx].toLinks, this.adImg ? this.adImg.skin = t[this.nowidx].param : this.owner.skin = t[this.nowidx].param;
                    }
                ...
                }, e.prototype.jumpOtherGame = function() {}, e;
            }(Laya.Script);
        i["default"] = o;
    }, {
        "../LayaSample": 3,
    ...
    26: [function(t, e, i) {
        ...
        var a = function(t) {
            ...
            return __extends(e, t), e.prototype.initUI = function() {
                ...
                var a = 28,
                    n = t.index;
                0 == t.index && (a = 24, n = "未上榜"), this.lblRank.fontSize = a, this.lblRank.text = n, this.lblScore.text = t.score;
                var o = "";
    ...
    27: [function(t, e, i) {
        ...
        var a = function(t) {
            ...
            return __extends(e, t), e.prototype.onDisable = function() {}, e.prototype.initItem = function() {
                ...
                this.icon = t.getChildByName("skinIcon"), this.getTypeTag = t.getChildByName("maskBg"), t.size(e.itemWidth, e.itemHeight), this.addChild(t);
            }, e.prototype.setItemInfo = function(t) {
                null != t && (this.icon.skin = t.iconPath);
            }, e.itemWidth = 128, e.itemHeight = 128, e.itemPrefab = null, e.iconWidth = 155, e.iconHeight = 99, e.iconOffset = Laya.Vector2.ZERO, e;
        }(Laya.Box);
        i["default"] = a;
    }, {}],
    28: [function(t, e, i) {
        ...
        var a = t("../LayaSample"),
            n = function(t) {
                ...
                return __extends(e, t), e.prototype.onAwake = function() {
                    if (window.HUHU_AD && (this.url == "views/over.scene" || this.url == "views/clearing.scene")) {
    ...
    30: [function(t, e, i) {
        ...
        var a = t("./BaseView"),
            n = t("../LayaSample"),
            o = t("../uiComp/AdListLoop"),
            s = t("../uiComp/OverAdListLoop"),
            r = t("../other/MyUtils"),
            h = t("../manager/NetMgr"),
            l = t("../platforms/wx/WxAdManager"),
            d = t("../other/ConfigData"),
            c = t("../manager/GameMgr"),
            u = function(t) {
                function e() {
                ...
                return __extends(e, t), e.prototype.initData = function() {
                    ...
                    this.bottom = this.getChild("bottom"), this.btnBack = this.getChild("btnBack", this.bottom), this.btnPlay = this.getChild("btnPlay", this.bottom), this.btnShare = this.getChild("btnShare", this.bottom);
                    var t = this.getChild("content");
                    var a = this.getChild("score");
                    this.fontScore = this.getChild("fontScore", a), this.fontScore.value = n["default"].commonData.newScore.toString();
                    ...
                    this.btnPlay.on(Laya.Event.CLICK, this, this.clickPlay), this.btnBack.on(Laya.Event.CLICK, this, this.clickBack);
                }, e.prototype.showADPanel = function() {}, e.prototype.hideADPanel = function() {}, e.prototype.ShowBanner = function() {}, e.prototype.onOpened = function() {
                    this.bottom.visible = !0;
                }, e.prototype.onClosed = function() {
                    t.prototype.onClosed.call(this), l["default"].Instance.hideBannerAd();
                }, e.prototype.clickShare = function() {}, e.prototype.clickPlay = function() {
                    platform.getInstance().showInterstitial(() => {
                        this.close(), n["default"].commonData.construction = Math.floor(3 * Math.random()), n["default"].glEvent.event(d.EventType.INIT_GAME_EVENT, {
                            isPlay: !1
                        }), n["default"].glEvent.event(d.EventType.PLAY_GAME_EVENT);
                    })
                }, e.prototype.clickBack = function() {
                    this.close(), n["default"].commonData.construction = Math.floor(3 * Math.random()), 1 == h["default"].ctrlInfo.backHomeControl ? Laya.Scene.open(c.SceneType.Converge, !1) : (Laya.Scene.open(c.SceneType.Home, !1), n["default"].glEvent.event(d.EventType.INIT_GAME_EVENT, {
                        isPlay: !1
                    }));
                }, e;
            }(a["default"]);
    ...
    31: [function(t, e, i) {
        ...
        var a = t("./BaseView"),
            ...
            r = t("../comp/Player"),
            h = t("../other/MyUtils"),
            l = t("../comp/CreateModel"),
            d = t("../manager/SoundMgr"),
            c = t("../other/ConfigData"),
            u = t("../manager/GameMgr"),
            p = function(t) {
                function e() {
                    var e = null !== t && t.apply(this, arguments) || this;
                    return e.speedFactor = .1, e.constructionArray = ["Construction", "Construction_2", "Construction_3", "Construction_4", "Construction_5", "Construction_6", "Construction_7", "Construction_8", "Construction_9"], e.skyM = [], e.maxDis = 0, e.circleScore = 0, e.carHitTime = 0, e.carHitScore = 0, e.guideProcess = 0, e;
                }
                return __extends(e, t), e.prototype.initData = function() {
                    n["default"].commonData.gameCount = 0, n["default"].commonData.isShowSkin = !0, this.targetPos = new Laya.Vector3(), this.targetRot = new Laya.Vector3(), this.lerpPos = new Laya.Vector3(), this.lerpRot = new Laya.Vector3(), this.loadScene(), this.setFog();
                }, e.prototype.initUI = function() {
                    var t = this.getChild("topPanel");
                    this.barSpeed = this.getChild("barSpeed", t), this.barSpeed.value = 0, this.barSpeed.bar.height = 21, this.barSpeed.visible = !1, this.fontScore = this.getChild("fontScore", t), this.fontScore.value = "0", this.fontScore.visible = !1, this.circle = this.getChild("circle"), this.circle.alpha = 0, this.fontCircleNum = this.getChild("fontCircleNum", this.circle), this.fontAddScore = this.getChild("fontAddScore", this.circle), this.imgCircle = this.getChild("imgCircle", this.circle), this.guidePanel = this.getChild("guidePanel"), this.sprGuide = this.getChild("sprGuide", this.guidePanel), h["default"].toPosition(this.sprGuide, {
                        x: 539,
                        y: 1075
                    }, 1e3, !0), this.imgGuide = this.getChild("imgGuide", this.guidePanel), this.imgGuideRotate = this.getChild("imgGuideRotate"), this.imgGuideRotate.visible = !1, this.visible = !1;
                }, e.prototype.initEvent = function() {
                    Laya.stage.on(Laya.Event.MOUSE_UP, this, this.onMouseUpEvent), Laya.stage.on(Laya.Event.MOUSE_DOWN, this, this.onMouseDownEvent), Laya.stage.on(Laya.Event.MOUSE_MOVE, this, this.onMouseMoveEvent), n["default"].glEvent.on(c.EventType.UPDATE_SPEED_EVENT, this, this.updateScore), n["default"].glEvent.on(c.EventType.INIT_GAME_EVENT, this, this.initGame), n["default"].glEvent.on(c.EventType.OVER_GAME_EVENT, this, this.overGameEvent), n["default"].glEvent.on(c.EventType.PLAY_GAME_EVENT, this, this.onPlayGameEvent), n["default"].glEvent.on(c.EventType.GOON_GAME_EVENT, this, this.onGoonGameEvent), n["default"].glEvent.on(c.EventType.SPEED_UP_EVENT, this, this.updateSpeedBarEvent), n["default"].glEvent.on(c.EventType.CIRCLE_COUNT_EVENT, this, this.circleCountEvent), n["default"].glEvent.on(c.EventType.CHANGE_SKIN, this, this.changeSkin), n["default"].glEvent.on(c.EventType.HIT_CAR_EVENT, this, this.addPlayerScore);
                }, e.prototype.loadScene = function() {
                    var t = Laya.loader.getRes(n["default"].commonData.scenes);
                    Laya.stage.addChild(t), Laya.stage.setChildIndex(t, 0), this.mainScene = t, n["default"].modelCreator.setSkins(), this.bike = t.getChildByName("Role"), this.bike.transform.scale = new Laya.Vector3(.8, .8, .8);
                    var e = this.getRoleMat(),
                        i = n["default"].modelCreator.getCarModel(e);
                    n["default"].commonData.curSkinIndex = e, this.bike.addChild(i.r), this.bike.addChild(i.e), i.r.transform.localPosition = new Laya.Vector3(0, -.889, 0), i.e.transform.localPosition = new Laya.Vector3(0, -.2, 0), this.targetPos = this.bike.transform.position.clone(), this.bikeComp = this.bike.addComponent(r["default"]), this.enermy = t.getChildByName("AI"), this.enermy.transform.scale = new Laya.Vector3(.8, .8, .8), i = n["default"].modelCreator.getCarModel(3), this.enermy.addChild(i.r), this.enermy.addChild(i.e), i.r.transform.localPosition = new Laya.Vector3(0, -.889, 0), i.e.transform.localPosition = new Laya.Vector3(0, -.2, 0), this.enermyComp = this.enermy.addComponent(s["default"]), this.enermy2 = t.getChildByName("AI_2"), this.enermy2.transform.scale = new Laya.Vector3(.8, .8, .8), i = n["default"].modelCreator.getCarModel(1), this.enermy2.addChild(i.r), this.enermy2.addChild(i.e), i.r.transform.localPosition = new Laya.Vector3(0, -.889, 0), i.e.transform.localPosition = new Laya.Vector3(0, -.2, 0), this.enermy2Comp = this.enermy2.addComponent(s["default"]), this.mainCamera = this.mainScene.getChildByName("Main Camera"), this.cameraComp = this.mainCamera.addComponent(o["default"]), this.light = this.mainScene.getChildByName("Directional Light"), this.skyMaterails = this.mainScene.getChildByName("skyBoxMaterials"), n["default"].modelCreator.init(t), this.getMaterails(this.skyMaterails, this.skyM), this.loadConstruction(), this.constructionNum = 0, this.roadNum = 1;
                    var a = l["default"].getUnitRoadLength(),
                        h = 3;
                    n["default"].commonData.needShowGuide && (n["default"].modelCreator.createModels(a), this.enermy.active = !1, this.enermy2.active = !1, Laya.timer.frameLoop(1, this, this.newPlayGuide));
                    var d = 4;
                    Laya.timer.frameLoop(1, this, function() {
                        var t = Math.floor(this.roadNum / d);
                        if (this.bike.transform.position.z > a * (t * d) && this.constructionNum != t)
                            if (console.log("dividend " + t + "    this.roadNum " + this.roadNum + "   this.bike.transform.position.z " + this.bike.transform.position.z), this.constructionNum = t, t % 2 == 0) {
                                var e = this.construction1.transform.position.clone();
                                this.construction1.transform.position = new Laya.Vector3(e.x, e.y, this.startConstruction1PosZ + t * a * d), console.log("_2  ", this.construction1.transform.position);
                            } else {
                                var e = this.construction.transform.position.clone();
                                this.construction.transform.position = new Laya.Vector3(e.x, e.y, this.startConstructionPosZ + (t + 1) * a * d), console.log("_  ", this.construction.transform.position);
                            }
                    ...
                    var t = 0;
                    t = n["default"].commonData.construction, this.construction = this.mainScene.getChildByName(this.constructionArray[0 + 3 * t]), this.construction1 = this.mainScene.getChildByName(this.constructionArray[1 + 3 * t]), this.construction2 = this.mainScene.getChildByName(this.constructionArray[2 + 3 * t]), this.startConstructionPosZ = this.construction.transform.position.z, this.startConstruction1PosZ = this.construction1.transform.position.z, this.startconstruction2Pos = this.construction2.transform.position.clone(), this.construction.active = !0, this.construction1.active = !0, this.construction2.active = !0, this.light.intensity = .8, this.mainScene.skyRenderer.material = this.skyM[0], this.mainScene.ambientColor = h["default"].getRGB("#7C8390"), n["default"].modelCreator.changeModelLight(1), 0 == t ? (this.mainScene.fogColor = h["default"].getRGB("#E1D8A4"), this.light.color = h["default"].getRGB("#98885D"), this.light.intensity = 1.1) : 1 == t ? (this.mainScene.fogColor = h["default"].getRGB("#BDDEE3"), this.light.color = h["default"].getRGB("#DFD7C2")) : 2 == t ? (this.mainScene.fogColor = h["default"].getRGB("#DADCE1"), this.mainScene.ambientColor = h["default"].getRGB("#525358"), this.light.color = h["default"].getRGB("#B2BFD6"), this.mainScene.skyRenderer.material = this.skyM[1], n["default"].modelCreator.changeModelLight(1.2)) : (this.mainScene.fogColor = h["default"].getRGB("#DADCE1"), this.mainScene.ambientColor = h["default"].getRGB("#525358"), this.light.color = h["default"].getRGB("#B2BFD6"), this.mainScene.skyRenderer.material = this.skyM[1], n["default"].modelCreator.changeModelLight(1.2));
                    for (var e = 0; e < this.constructionArray.length; e++)(3 * t > e || e >= 3 * (t + 1)) && (this.constructionOther = this.mainScene.getChildByName(this.constructionArray[e]), this.constructionOther.active = !1);
                }, e.prototype.getMaterails = function(t, e) {
                    for (var i = t.numChildren, a = 0; i > a; a++) {
                        var n = t.getChildAt(a);
                        e.push(n.meshRenderer.sharedMaterial);
                    ...
                    n["default"].gameMgr.isPlay && !n["default"].gameMgr.isOver && (this.guidePanel.visible && 0 == this.guideProcess && this.showGuide(!1), n["default"].gameMgr.isMove = !1, Laya.timer.clear(this, this.updatePlayer), Laya.timer.frameLoop(1, this, this.updatePlayer), this.fontScore.visible = !0, n["default"].gameMgr.isPressed = !0, this.originPosX = t.stageX);
                }, e.prototype.onMouseUpEvent = function() {
                    n["default"].commonData.needShowGuide && this.guideProcess > 0 && (n["default"].gameMgr.isPlay = !0, this.imgGuideRotate.visible && (this.imgGuideRotate.visible = !1)), n["default"].gameMgr.isPressed = !1;
                    ...
                    if (n["default"].gameMgr.isPressed) {
                        ...
                        if (t.stageX != this.originPosX) {
                            ...
                            (o > 0 && this.maxDis < 0 || 0 > o && this.maxDis > 0) && (this.maxDis = 0), Math.abs(o) > Math.abs(this.maxDis) && (this.maxDis = o), i.x -= .1 * this.maxDis * this.speedFactor, a.z += o / 20, i.x > e ? i.x = e : i.x < -e && (i.x = -e), this.targetPos = i, this.originPosX = t.stageX;
                        }
                    }
                }, e.prototype.updatePlayer = function() {
                    n["default"].gameMgr.isMove = !0, this.targetPos.setValue(this.targetPos.x, this.bike.transform.position.y, this.bike.transform.position.z), Laya.Vector3.lerp(this.bike.transform.position, this.targetPos, .05, this.lerpPos), this.bike.transform.position = this.lerpPos, this.construction2.transform.position = new Laya.Vector3(this.startconstruction2Pos.x, this.startconstruction2Pos.y, this.startconstruction2Pos.z + this.lerpPos.z - 1), this.targetRot.setValue(this.bike.transform.rotationEuler.x, this.targetRot.y, this.targetRot.z), Laya.Vector3.lerp(this.bike.transform.rotationEuler, this.targetRot, .05, this.lerpRot), this.bike.transform.rotationEuler = this.lerpRot, !n["default"].gameMgr.isPressed && Math.abs(this.lerpRot.z) < .01 && (n["default"].gameMgr.isMove = !1), Math.abs(this.lerpPos.x - this.targetPos.x) < .01 && (this.maxDis = 0);
                    ...
                    n["default"].commonData.needShowGuide ? (this.enermy.active = !1, this.enermy2.active = !1, this.guidePanel.y = 0, this.guideProcess = 0, this.imgGuide.skin = "ui/common/font_guide.png", Laya.timer.clear(this, this.newPlayGuide), Laya.timer.frameLoop(1, this, this.newPlayGuide), this.sprGuide.x = 108, h["default"].toPosition(this.sprGuide, {
                        x: 539,
                        y: 1075
                    }, 1e3, !0)) : (this.enermy.active = !0, this.enermy2.active = !0, n["default"].commonData.isShowSkin = !0);
                    var e = this.construction1.transform.position.clone();
                    this.construction1.transform.position = new Laya.Vector3(e.x, e.y, this.startConstruction1PosZ), e = this.construction.transform.position.clone(), this.construction.transform.position = new Laya.Vector3(e.x, e.y, this.startConstructionPosZ), e = this.startconstruction2Pos.clone(), this.construction2.transform.position = e, this.constructionNum = 0, this.roadNum = 1, this.changeSkin({
                        isPlay: !1
                    }), this.loadConstruction(), this.bikeComp.init(), this.enermyComp.init(), this.enermy2Comp.init(), this.fontScore.value = "0", this.circleScore = 0, this.carHitTime = 0, this.carHitScore = 0, this.visible = t.isPlay, this.showGuide(t.isPlay), n["default"].gameMgr.isPlay = t.isPlay, n["default"].gameMgr.isOver = !1, this.targetPos = new Laya.Vector3(), this.targetRot = new Laya.Vector3(), this.lerpPos = new Laya.Vector3(), this.lerpRot = new Laya.Vector3(), Laya.timer.once(800, this, function() {
                    ...
                    return n["default"].commonData.isShowSkin ? void Laya.Scene.open(u.SceneType.Skin, !1, {
                        isPlay: !0
                    }) : n["default"].commonData.isShowSkin && n["default"].storageMgr.isSkinTips() && n["default"].commonData.existVideoAd && n["default"].commonData.gameCount % 3 == 0 ? void Laya.Scene.open(u.SceneType.Skin, !1) : void(n["default"].gameMgr.isPlay || (n["default"].commonData.gameCount++, n["default"].commonData.isShowSkin = !0, this.cameraComp.startAnim(), n["default"].gameMgr.isPlay = !0, this.visible = !0, this.showGuide(!0), this.fontScore.visible = !1, this.mainCamera));
                }, e.prototype.showGuide = function(t) {
                    this.guidePanel.visible = t;
                }, e.prototype.onGoonGameEvent = function() {
                    n["default"].commonData.goonCount++, n["default"].gameMgr.isPlay || (n["default"].gameMgr.isPlay = !0, n["default"].gameMgr.isOver = !1, this.visible = !0, this.showGuide(!1)), this.targetPos = new Laya.Vector3(), this.targetRot = new Laya.Vector3(), this.lerpPos = new Laya.Vector3(), this.lerpRot = new Laya.Vector3(), this.bikeComp["continue"](), n["default"].modelCreator.recoverAllModels();
                }, e.prototype.overGameEvent = function() {
                    this.barSpeed.visible = !1, n["default"].gameMgr.isOver = !0, n["default"].gameMgr.isPlay = !1, n["default"].gameMgr.isPressed = !1, this.visible = !1, n["default"].commonData.newScore = Number(this.fontScore.value), Laya.timer.clear(this, this.updatePlayer), Laya.timer.once(800, this, function() {
                        n["default"].soundMgr.play(d.SoundType.OVER), Laya.timer.once(1e3, this, function() {
                            n["default"].commonData.goonCount > 0 ? (n["default"].commonData.goonCount = 0, Laya.Scene.open(u.SceneType.Clearing, !1)) : Laya.Scene.open(u.SceneType.Over, !1);
                        });
                    });
                    ...
                    var e = 200,
                        i = this.circle;
                    if (this.imgCircle.visible = !0, this.fontCircleNum.visible = !0, -1 == t.circleNum && (this.imgCircle.visible = !1, this.fontCircleNum.visible = !1), 0 == t.circleNum && 0 != i.alpha) return h["default"].fromScale(i, 1, e), void h["default"].toAlpha(i, 0, e, !1);
                    if (0 != t.circleNum) {
                        n["default"].commonData.needShowGuide && (console.log("指引松开手"), this.imgGuideRotate.visible = !0, n["default"].gameMgr.isPlay = !1), i.alpha = 0, i.scaleX = 1, i.scaleY = 1, this.fontCircleNum.value = t.circleNum, h["default"].toAlpha(i, 1, e), h["default"].toScale(i, 1.3, e, !1), this.fontAddScore.y = -50, this.fontAddScore.alpha = 1;
                        var a = 100 * Math.pow(2, t.circleNum - 1);
                        this.circleScore += a, -1 == t.circleNum ? this.fontAddScore.value = "+50" : this.fontAddScore.value = "+" + a;
                        var o = 120;
                        h["default"].toScale(this.fontAddScore, .8, o, !1), h["default"].toPosition(this.fontAddScore, new Laya.Vector2(this.fontAddScore.x, this.fontAddScore.y - 80), o), Laya.timer.once(o + 200, this, function() {
                            h["default"].toPosition(this.fontAddScore, new Laya.Vector2(this.fontAddScore.x, this.fontAddScore.y - 70), o), h["default"].toScale(this.fontAddScore, .6, o, !1), h["default"].toAlpha(this.fontAddScore, 0, o);
                        });
                    }
                    ...
                    0 == this.guideProcess && t > 5 ? (console.log("指引右滑"), this.imgGuide.skin = "ui/common/font_guide_right.png", this.guidePanel.y = -650, this.showGuide(!0), this.guideProcess = 1, this.sprGuide.x = 108, h["default"].toPosition(this.sprGuide, {
                        x: 539,
                        y: 1075
                    }, 1e3, !0, 1)) : 1 == this.guideProcess && t > 40 ? (console.log("指引左滑"), this.imgGuide.skin = "ui/common/font_guide_left.png", this.showGuide(!0), this.guideProcess = 2, this.sprGuide.x = 569, h["default"].toPosition(this.sprGuide, {
                        x: 108,
                        y: 1075
                    }, 1e3, !0, 1)) : t > 90 && 100 > t ? this.showGuide(!1) : 2 == this.guideProcess && t > 300 && (Laya.timer.clear(this, this.newPlayGuide), n["default"].commonData.needShowGuide = !1, this.guideProcess = 0, this.guidePanel.y = 0, this.imgGuide.skin = "ui/common/font_guide.png", this.sprGuide.x = 108, h["default"].toPosition(this.sprGuide, {
                        x: 539,
                        y: 1075
                    }, 1e3, !0));
                }, e.prototype.changeSkin = function(t) {
                    var e = this.getRoleMat();
                    if (t.index || (t.index = e), n["default"].commonData.curSkinIndex == t.index) t.isPlay && this.onPlayGameEvent();
                    else {
                        n["default"].commonData.curSkinIndex = t.index;
                        var i = n["default"].modelCreator.getSkinByIndex(t.index);
                        if (i) {
                            this.bike && (this.bike.destroy(!0), this.mainScene.removeChild(this.bike)), this.bike = i, this.mainScene.addChild(this.bike);
                            var a = i.getComponent(r["default"]);
                            a || (a = i.addComponent(r["default"])), this.bikeComp = a, this.bikeComp.init(), this.cameraComp.changeRole(i), n["default"].modelCreator.changeCar(this.bikeComp), t.isPlay ? this.onPlayGameEvent() : (n["default"].commonData.skinIncome = 0, n["default"].commonData.skinScore = 0);
                        }
                    }
                }, e;
            }(a["default"]);
    ...
    32: [function(t, e, i) {
        ...
        var a = t("./BaseView"),
            n = t("../LayaSample"),
            o = t("../manager/NetMgr"),
            s = t("../uiComp/PromotionAnimation"),
            r = t("../uiComp/AdListLoop"),
            h = t("../other/MyUtils"),
            l = t("../platforms/wx/WxAdManager"),
            d = t("../manager/SoundMgr"),
            c = t("../other/ConfigData"),
            u = t("../manager/GameMgr"),
            p = t("../manager/StatisticsMgr"),
            f = function(t) {
                function e() {
                    var e = null !== t && t.apply(this, arguments) || this;
                ...
                return __extends(e, t), e.prototype.onAwake = function() {
                    ...
                    this.setting = this.getChild("setting", t), this.settingS = this.getChild("settingS", this.setting), this.img_settings = this.getChild("img_settings", this.settingS), this.btnSound = this.getChild("btnSound", this.img_settings), this.setSound(n["default"].storageMgr.isPlaySound()), this.btnVibrate = this.getChild("btnVibrate", this.img_settings), this.setVibrate(n["default"].storageMgr.isPlayVibrate()), this.btnStart = this.getChild("btnStart"), this.btnPlay = this.getChild("btnPlay", e), this.btnRank = this.getChild("btnRank", e), this.btnShare = this.getChild("btnShare", e), this.btnService = this.getChild("btnSvrvice", e), this.btnCollect = this.getChild("btnCollect", e), this.adPlane = this.getChild("ADPanel");
                }, e.prototype.initEvent = function() {
                    platform.getInstance().canNavigate = true;
                    console.log("zhenzhenzhe")
                    this.btnSound.on(Laya.Event.CLICK, this, this.clickSound), this.btnStart.on(Laya.Event.CLICK, this, this.clickStart), this.btnPlay.on(Laya.Event.CLICK, this, this.clickStart), this.setting.on(Laya.Event.CLICK, this, this.onClickSetting);
                }, e.prototype.onOpened = function() {}, e.prototype.setSound = function(t) {
                    var e = t ? "on.png" : "off.png";
                    this.btnSound.skin = this.soundSkin + e, laya.media.SoundManager.muted = !t, n["default"].storageMgr.setPlaySound(t), t ? n["default"].soundMgr.playMusic(d.SoundType.BGM) : n["default"].soundMgr.stopMusic(d.SoundType.BGM);
                }, e.prototype.setVibrate = function(t) {}, e.prototype.onClickSetting = function() {
                    ...
                    platform.getInstance().showInterstitial(() => {
                        ...
                        this.close(), p["default"].instance.startGameStatistics(), n["default"].glEvent.event(c.EventType.PLAY_GAME_EVENT);
                    })
                }, e.prototype.clickRank = function() {}, e.prototype.showADPanel = function() {}, e.prototype.hideADPanel = function() {}, e.prototype.ShowBanner = function() {}, e.prototype.clickService = function() {
    ...
    33: [function(t, e, i) {
        ...
        var a = t("./BaseView"),
            ...
            r = function(t) {
                ...
                return __extends(e, t), e.prototype.onAwake = function() {
                    t.prototype.onAwake.call(this), this.loadRes();
                }, e.prototype.initSize = function() {
                    this.x = 0;
                    this.width = Laya.stage.width;
                    this.height = Laya.stage.height;
                }, e.prototype.loadSub = function() {}, e.prototype.onOpened = function() {
    ...
    34: [function(t, e, i) {
        ...
        var a = t("../uiComp/RankItem"),
            ...
            h = function(t) {
                function e() {
                    var e = t.call(this) || this;
                    return e.rankBgList = ["rank/W_pab_d3.png", "rank/W_pab_d3.png", "rank/W_pab_d3.png"], e.worldList = null, e.rankMe = null, e.btnBack = null, e.tabRank = null, e.friendList = null, e.existWorldRank = !0, e.worldLoading = 0, e;
                }
                return __extends(e, t), e.prototype.onAwake = function() {
                    this.initUI(), this.initSize(this), this.initEvent(), this.onRankFriend(), this.pageWorldRank = 1, this.isLoadedWorldRank = !1, o["default"].wxMgr.worldRank(1), Laya.loader.load("prefab/rankItem.json", Laya.Handler.create(this, this.initList), null, Laya.Loader.PREFAB);
                }, e.prototype.initUI = function() {
                    var t = this.getChild("topPanel"),
                        e = this.getChild("node");
                    this.btnBack = this.getChild("btnBack", t), this.tabRank = this.getChild("tabRank", e), this.world = this.getChild("world", e), this.worldList = this.getChild("list", this.world), this.rankMe = this.getChild("rankMe", this.world), this.friend = this.getChild("friend", e), this.friendList = this.getChild("list", this.friend), this.touchArea = this.getChild("touchArea", this.friend), this.touchArea.alpha = 0;
                }, e.prototype.initEvent = function() {
                    this.btnBack.on(Laya.Event.CLICK, this, this.clickClose), this.tabRank.selectHandler = new Laya.Handler(this, this.onRankClick), o["default"].glEvent.on(s.EventType.DRAW_WORLD_RANK_EVENT, this, this.onDrawWorldrankEvent);
                }, e.prototype.onClosed = function() {
                    t.prototype.onClosed.call(this), Laya.loader.clearRes("prefab/rankItem.json"), o["default"].wxMgr.showFriendRank(!1), this.touchArea.offAllCaller(this), this.worldList.array = [], this.worldList.destroy();
                    ...
                    Laya.Browser.onMiniGame && (this.touchArea.on(Laya.Event.MOUSE_DOWN, this, function(t) {
                        t.stopPropagation(), a = 0, i = t.nativeEvent.timeStamp, e = t.nativeEvent.changedTouches[0].clientY, o["default"].wxMgr.onFrientMouseEvent({
                            cmd: "touch_start"
                        });
                    ...
                    t.itemRender = a["default"], t.cacheContent = !1, t.vScrollBarSkin = "", t.selectEnable = !1, t.renderHandler = new Laya.Handler(this, this.updateItem), this.worldLoading++;
                    ...
                    if (this.userRank = n, t.myIndex && t.myIndex > 0 && t.myIndex <= a.length && (this.userRank = t.data[t.myIndex - 1]), i.data = {
                            list: a,
                            page: e
    ...
    35: [function(t, e, i) {
        ...
        var a = t("./BaseView"),
            ...
            s = t("../other/MyUtils"),
            r = t("../manager/NetMgr"),
            h = t("../platforms/wx/WxAdManager"),
            l = t("../manager/SoundMgr"),
            d = t("../other/ConfigData"),
            c = t("../manager/GameMgr"),
            u = t("../manager/StatisticsMgr"),
            p = function(t) {
                function e() {
                    var e = null !== t && t.apply(this, arguments) || this;
                ...
                return __extends(e, t), e.prototype.onAwake = function() {
                    t.prototype.onAwake.call(this);
                }, e.prototype.onOpened = function() {}, e.prototype.onWxWakeEvent = function() {
                    this.isStartTimer = !0;
                }, e.prototype.onWxSleepEvent = function() {
                    this.isStartTimer = !1;
                }, e.prototype.initData = function() {
                    n["default"].adMgr.getBannerCount() < 2 && n["default"].adMgr.getBannerAd(), n["default"].commonData.existVideoAd || n["default"].adMgr.loadVideoAd(), n["default"].commonData.existInterAd || n["default"].adMgr.getInterstitialAd();
                }, e.prototype.initUI = function() {
                    window.HUHU_AD = false;
                    ...
                    this.btnVideo.on(Laya.Event.CLICK, this, this.onVideoClick), this.btnSkip.on(Laya.Event.CLICK, this, this.onSkipClick), n["default"].glEvent.on(d.EventType.WX_SLEEP_EVENT, this, this.onWxSleepEvent), n["default"].glEvent.on(d.EventType.WX_WAKE_EVENT, this, this.onWxWakeEvent), n["default"].glEvent.on(d.EventType.SHARE_BACK_EVENT, this, this.onShareBackEvent), n["default"].glEvent.on(d.EventType.AD_VIDEO_CLOSE_EVENT, this, this.onVideoCloseEvent), n["default"].glEvent.on("changeIsStartTimer", this, this.changeTimer);
                ...
                }, e.prototype.showADPanel = function() {}, e.prototype.hideADPanel = function() {}, e.prototype.ShowBanner = function() {}, e.prototype.onShareBackEvent = function(t) {
                    t.isShare ? (h["default"].Instance.hideBannerAd(), this.close(), this.goonGame()) : (n["default"].wxMgr.showToast("分享失败", 2e3), this.isStartTimer = !0);
                }, e.prototype.onVideoCloseEvent = function(t) {
                    t.isEnded ? (this.close(), this.goonGame()) : (n["default"].wxMgr.showToast("看完视频才能复活", 2e3), this.isStartTimer = !0);
                }, e.prototype.goonGame = function() {
                    n["default"].glEvent.event(d.EventType.GOON_GAME_EVENT);
                }, e.prototype.countDown = function() {
                    return !this.isStartTimer || Laya.timer.delta > 800 ? void 0 : (this.drawPie(), this.overTime > 0 ? void(this.isStartTimer && (this.overTime -= 1, this.lbTimer.text = this.overTime.toString(), n["default"].soundMgr.play(l.SoundType.DJS))) : void this.onSkipClick());
    ...
    36: [function(t, e, i) {
        ...
        var a = t("../uiComp/skinItem"),
            n = t("../LayaSample"),
            o = t("./BaseView"),
            s = t("../uiComp/AdListLoop"),
            r = t("../other/MyUtils"),
            h = t("../platforms/wx/WxAdManager"),
            l = t("../manager/NetMgr"),
            d = t("../other/ConfigData"),
            c = t("../manager/StatisticsMgr"),
            u = function(t) {
                function e() {
                    var e = t.call(this) || this;
                ...
                return __extends(e, t), e.prototype.onAwake = function() {
                    ...
                    var e = this;
                    if (t && t.isPlay && (this.isPlay = t.isPlay, n["default"].gameMgr.isPlay = !1), this.ShowBanner(), l["default"].ctrlInfo.isWudian && 1 == l["default"].wudian_level[0]) {
                    ...
                    var t = this.getChild("content");
                    this.skinList = this.getChild("skinList", t), this.bottomPanel = this.getChild("bottom"), this.btnVideo = this.getChild("btnVideo", this.bottomPanel), this.btnVideo.visible = true;
                    this.btnBack = this.getChild("btnBack", this.bottomPanel);
                }, e.prototype.initEvent = function() {
                    this.btnVideo.on(Laya.Event.CLICK, this, this.clickVideo), this.btnBack.on(Laya.Event.CLICK, this, this.clickSkip), n["default"].glEvent.on(d.EventType.AD_VIDEO_CLOSE_EVENT, this, this.videoCallBack);
                }, e.prototype.onClosed = function() {
                    ...
                    a["default"].itemWidth = 200, a["default"].itemHeight = 270, a["default"].iconWidth = 142, a["default"].iconHeight = 195, a["default"].iconOffset = new Laya.Vector2(29, 8), a["default"].itemPrefab = Laya.loader.getRes(this.skinItemPath);
                    var t = this.skinList;
                    t.itemRender = a["default"], t.selectEnable = !0, t.selectHandler = new Laya.Handler(this, this.onSelect), t.renderHandler = new Laya.Handler(this, this.updateItem), t.array = this.skinData;
                }, e.prototype.updateItem = function(t, e) {
                ...
                }, e.prototype.showADPanel = function() {}, e.prototype.hideADPanel = function() {}, e.prototype.ShowBanner = function() {}, e.prototype.clickVideo = function() {
                    this.itemIndex = Math.floor(4 * Math.random()) + 3;
                    platform.getInstance().showReward(() => {
                        this.changeSkin();
                    });
                }, e.prototype.showVideo = function() {}, e.prototype.clickSkip = function() {
