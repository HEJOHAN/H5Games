! function(t, i, e) {
    var s = (e.un, e.uns, e["static"]),
        ...
        y = laya.maths.Matrix,
        C = (laya.display.Node, laya.maths.Point),
    ...
    e["interface"]("laya.ui.IBox"), e["interface"]("laya.ui.IItem"), e["interface"]("laya.ui.ISelect"), e["interface"]("laya.ui.IRender");
    var T = function() {
            function t() {}
        ...
        P = (function(t) {
            ...
            return n(i, "laya.ui.UIEvent", t), i.SHOW_TIP = "showtip", i.HIDE_TIP = "hidetip", i;
        }(_), function(t) {
            function i() {
            ...
            return s.destroy = function() {
                ...
                if (t && t.bitmap) {
                    ...
                    if (!n || h === e && o === s) this.clear(), this.drawTexture(t, this._offset ? this._offset[0] : 0, this._offset ? this._offset[1] : 0, e, s);
                        ...
                        c && r && this.drawImage(i.getTexture(t, 0, 0, c, r), 0, 0, c, r), a && r && this.drawImage(i.getTexture(t, h - a, 0, a, r), e - a, 0, a, r), c && l && this.drawImage(i.getTexture(t, 0, o - l, c, l), 0, s - l, c, l), a && l && this.drawImage(i.getTexture(t, h - a, o - l, a, l), e - a, s - l, a, l), r && this.drawBitmap(u, i.getTexture(t, c, 0, h - c - a, r), c, 0, e - c - a, r), l && this.drawBitmap(u, i.getTexture(t, c, o - l, h - c - a, l), c, s - l, e - c - a, l), c && this.drawBitmap(u, i.getTexture(t, 0, r, c, o - r - l), 0, r, c, s - r - l), a && this.drawBitmap(u, i.getTexture(t, h - a, r, a, o - r - l), e - a, r, a, s - r - l), this.drawBitmap(u, i.getTexture(t, c, r, h - c - a, o - r - l), c, r, e - c - a, s - r - l), _ && this.restore();
                    }
                    this._repaint();
                }
        ...
        Y = function(t) {
            function i() {
                this._dataSource = null, this._toolTip = null, this._tag = null, this._disabled = !1, this._gray = !1, i.__super.call(this), this._anchorX = NaN, this._anchorY = NaN, this._widget = O.EMPTY, this.preinitialize(), this.createChildren(), this.initialize();
            }
            n(i, "laya.ui.UIComponent", t);
            var s = i.prototype;
            return s.destroy = function(i) {
                void 0 === i && (i = !0), t.prototype.destroy.call(this, i), this._dataSource = null, this._tag = null, this._toolTip = null;
        ...
        A = function(t) {
            function i() {
                ...
                }, i.__super.call(this), this.maskLayer = new x(), this.popupEffectHandler = new f(this, this.popupEffect), this.closeEffectHandler = new f(this, this.closeEffect), this.mouseEnabled = this.maskLayer.mouseEnabled = !0, this.zOrder = 1e3, e.stage.addChild(this), e.stage.on("resize", this, this._onResize), T.closeDialogOnSide && this.maskLayer.on("click", this, this._closeOnSide), this._onResize(null);
            }
            ...
            return s._closeOnSide = function() {
                ...
                this.lockLayer || (this.lockLayer = new X(), this.lockLayer.mouseEnabled = !0, this.lockLayer.size(e.stage.width, e.stage.height)), this.lockLayer.removeChildren(), t && (t.centerX = t.centerY = 0, this.lockLayer.addChild(t));
            }, s._onResize = function(t) {
                var i = this.maskLayer.width = e.stage.width,
                    s = this.maskLayer.height = e.stage.height;
                this.lockLayer && this.lockLayer.size(i, s), this.maskLayer.graphics.clear(!0), this.maskLayer.graphics.drawRect(0, 0, i, s, T.popupBgColor), this.maskLayer.alpha = T.popupBgAlpha;
                ...
                void 0 === i && (i = !1), void 0 === s && (s = !1), i && this._closeAll(), this._clearDialogEffect(t), t.isPopupCenter && this._centerDialog(t), this.addChild(t), (t.isModal || this._getBit(32)) && e.timer.callLater(this, this._checkMask), s && null != t.popupEffect ? t.popupEffect.runWith(t) : this.doOpen(t), this.event("open");
        ...
        N = function(t) {
            function i() {
                this._watchMap = {}, this._widget = null, this._dataSource = null, this._anchorX = NaN, this._anchorY = NaN, this._widget = O.EMPTY, i.__super.call(this);
            }
            n(i, "laya.ui.View", t);
            var s = i.prototype;
            return s.destroy = function(i) {
        ...
        X = (function(i) {
            ...
            return o.onEnable = function() {
                ...
                e.superSet(Y, this, "height", i), t.sharedCanvas && (t.sharedCanvas.height = i), this.callLater(this._postMsg);
            ...
            return e.imps(s, {
                ...
                this._bgColor = t, t ? (this._onResize(null), this.on("resize", this, this._onResize)) : (this.graphics.clear(), this.off("resize", this, this._onResize));
            }), i;
        }(Y)),
        E = function(t) {
            function i(t, e) {
                this.toggle = !1, this._bitmap = null, this._text = null, this._strokeColors = null, this._state = 0, this._selected = !1, this._skin = null, this._autoSize = !0, this._sources = null, this._clickHandler = null, this._stateChanged = !1, i.__super.call(this), this._labelColors = D.buttonLabelColors, this._stateNum = D.buttonStateNum, void 0 === e && (e = ""), this.skin = t, this.label = e;
            }
            ...
            return e.imps(o, {
                ...
                return this.toggle === !1 && this._selected ? void 0 : "click" === t.type ? (this.toggle && (this.selected = !this._selected), void(this._clickHandler && this._clickHandler.run())) : void(!this._selected && (this.state = i.stateMap[t.type]));
                ...
                "string" == typeof t && (t = parseInt(t)), this._stateNum != t && (this._stateNum = 1 > t ? 1 : t > 3 ? 3 : t, this.callLater(this.changeClips));
        ...
        W = function(t) {
            function i(t, e) {
                this._visibleNum = 6, this._button = null, this._list = null, this._isOpen = !1, this._itemSize = 12, this._labels = [], this._selectedIndex = -1, this._selectHandler = null, this._itemHeight = NaN, this._listHeight = NaN, this._listChanged = !1, this._itemChanged = !1, this._scrollBarSkin = null, this._isCustomList = !1, this.itemRender = null, i.__super.call(this), this._itemColors = D.comboBoxItemColors, this.skin = t, this.labels = e;
            }
            ...
            return s.destroy = function(i) {
                ...
                if ("mouseover" === e || "mouseout" === e) {
                    ...
                    n && ("mouseover" === e ? (n.bgColor = this._itemColors[0], n.color = this._itemColors[1]) : (n.bgColor = null, n.color = this._itemColors[2]));
                ...
                this._selectedIndex != t && (this._selectedIndex = t, this._labels.length > 0 ? this.changeSelected() : this.callLater(this.changeSelected), this.event("change", [_.EMPTY.setTo("change", this, this)]), this._selectHandler && this._selectHandler.runWith(this._selectedIndex));
            }), h(0, s, "skin", function() {
                ...
                e.superSet(Y, this, "width", t), this._button.width = this._width, this._itemChanged = !0, this._listChanged = !0;
        ...
        V = (function(t) {
            ...
            return s._onStageHideTip = function(t) {
                ...
                var n = t.getBounds();
                t.x = e.stage.mouseX + i, t.y = e.stage.mouseY + s, t._x + n.width > e.stage.width && (t.x -= n.width + i), t._y + n.height > e.stage.height && (t.y -= n.height + s);
            }, s.closeAll = function() {
                ...
                s.clear(!0), s.drawRect(0, 0, this._tipText.width + 10, this._tipText.height + 10, i.tipBackColor), this.addChild(this._tipBox), this._showToStage(this), e._currentStage.addChild(this);
            }, h(0, s, "defaultTipHandler", function() {
                return this._defaultTipHandler;
            }, function(t) {
                this._defaultTipHandler = t;
            }), i.offsetX = 10, i.offsetY = 15, i.tipTextColor = "#ffffff", i.tipBackColor = "#111111", i.tipDelay = 200, i;
        }(Y), function(t) {
            function i(t, e, s) {
        ...
        U = function(t) {
            ...
            return s.destroy = function(i) {
                ...
                this.addChild(this._colorButton = new E()), this._colorPanel = new X(), this._colorPanel.size(230, 166), this._colorPanel.addChild(this._colorTiles = new x()), this._colorPanel.addChild(this._colorBlock = new x()), this._colorPanel.addChild(this._colorInput = new p());
                ...
                t.clear(!0), t.drawRect(0, 0, 230, 166, this._bgColor, this._borderColor), this.drawBlock(this._selectedColor), this._colorInput.borderColor = this._borderColor, this._colorInput.bgColor = this._inputBgColor, this._colorInput.color = this._inputColor, t = this._colorTiles.graphics, t.clear(!0);
                ...
                this._selectedColor != t && (this._selectedColor = this._colorInput.text = t, this.drawBlock(t), this.changeColor(), this.changeHandler && this.changeHandler.runWith(this._selectedColor), this.event("change", _.EMPTY.setTo("change", this, this)));
            }), h(0, s, "skin", function() {
        ...
        $ = function(t) {
            ...
            return s.destroy = function(i) {
                ...
                this._value != t && (t = t > 1 ? 1 : 0 > t ? 0 : t, this._value = t, this.callLater(this.changeValue), this.event("change"), this.changeHandler && this.changeHandler.runWith(t));
            }), h(0, s, "bg", function() {
                return this._bg;
            }), h(0, s, "sizeGrid", function() {
        ...
        F = function(t) {
            ...
            return s.destroy = function(i) {
                ...
                this.slide(i), e.timer.once(D.scrollBarDelayTime, this, this.startLoop, [i]), e.stage.once("mouseup", this, this.onStageMouseUp);
                ...
                (!this.isLockedFun || this.isLockedFun(t)) && (this.event("end"), this._clickOnly = !0, this._lastOffset = 0, this._checkElastic = !1, this._lastPoint || (this._lastPoint = new C()), this._lastPoint.setTo(e.stage.mouseX, e.stage.mouseY), e.timer.clear(this, this.tweenMove), L.clearTween(this), e.stage.once("mouseup", this, this.onStageMouseUp2), e.stage.once("mouseout", this, this.onStageMouseUp2), e.timer.frameLoop(1, this, this.loop));
            }, s.startDragForce = function() {
                this._clickOnly = !0, this._lastOffset = 0, this._checkElastic = !1, this._lastPoint || (this._lastPoint = new C()), this._lastPoint.setTo(e.stage.mouseX, e.stage.mouseY), e.timer.clear(this, this.tweenMove), L.clearTween(this), e.stage.once("mouseup", this, this.onStageMouseUp2), e.stage.once("mouseout", this, this.onStageMouseUp2), e.timer.frameLoop(1, this, this.loop);
            }, s.cancelDragOp = function() {
                e.stage.off("mouseup", this, this.onStageMouseUp2), e.stage.off("mouseout", this, this.onStageMouseUp2), e.timer.clear(this, this.tweenMove), e.timer.clear(this, this.loop), this._target.mouseEnabled = !0;
            }, s.checkTriggers = function(t) {
                return void 0 === t && (t = !1), this.value >= 0 && this.value - this._lastOffset <= 0 && this.triggerDownDragLimit && this.triggerDownDragLimit(t) ? (this.cancelDragOp(), this.value = 0, !0) : this.value <= this.max && this.value - this._lastOffset >= this.max && this.triggerUpDragLimit && this.triggerUpDragLimit(t) ? (this.cancelDragOp(), this.value = this.max, !0) : !1;
                ...
                this.runCallLater(this.changeScrollBar), this.runCallLater(this._sizeChanged), t = t >= 1 ? .99 : t, this._thumbPercent = t, this.scaleBar && (this.slider.isVertical ? this.slider.bar.height = Math.max(this.slider.height * t, D.scrollBarMinNum) : this.slider.bar.width = Math.max(this.slider.width * t, D.scrollBarMinNum));
            }), h(0, s, "dataSource", t.prototype._$get_dataSource, function(t) {
                this._dataSource = t, "number" == typeof t || "string" == typeof t ? this.value = Number(t) : e.superSet(Y, this, "dataSource", t);
            }), h(0, s, "skin", function() {
                return this._skin;
        ...
        j = function(t) {
            ...
            return o.destroy = function(i) {
                ...
                m.getRes(t) && (this._progress || (this.addChild(this._progress = new G()), this._progress.sizeGrid = this._bar.sizeGrid, this.setChildIndex(this._progress, 1)), this._progress.skin = t), this.setBarPoint(), this.callLater(this.changeValue), this._sizeChanged(), this.event("loaded");
        ...
        J = function(t) {
            ...
            return l.getLocalDateString = function(t) {
                ...
                var n = Date.now(),
                    o = new Date(n + 0);
                s.date = o.toLocaleString(), s.etype = t, "error" != t && "statistics" != t && (t = "statistics"), s.version = "V0.0.1", s.gameId = 10100, s.dinfo = this.dinfo, s.channel = -1e3, s.msg = e, s["@timestamp"] = o.toISOString(), s.user = this.getUserId(), s.openid = this.getOpenId();
                var r = h.getDay(o);
                s.rdate = r, s.day = o.getDate() + "", s.hour = o.getHours() + "", s.minute = o.getMinutes() + "", s.gameurl = i.baseURI, s.regTime = 0, "error" == t ? this.sendLog(s, this.tongjiType + "error-" + r.substring(0, 6) + "/" + t + "/", t) : this.sendLog(s, this.tongjiType + "-" + r.substring(0, 6) + "/" + t + "/", t);
            }, l.getUserId = function() {
                var t = parseInt(v.getItem("layauserid") + "") || -1;
                return -1 == t && (t = this.randRange(0, 1e9), v.setItem("layauserid", t + "")), t;
                ...
                this.removeEvent(), this.gameStopHD = !0, h._moreGameData = null, this._iconImageObj = null, this.clickCallBack = null, this.closeCallBack = null, this.iconImgTl && (this.iconImgTl.offAll("complete"), this.iconImgTl = null), this._moreBox && (this._moreBox.removeChildren(), this._moreBox = null), this._gameBox && (this._gameBox.removeChildren(), this._gameBox = null), this._iconImage && (this._iconImage.removeSelf(), this._iconImage = null);
                ...
                t != i ? (v.setItem("currentTime", i), this.reportError(h._moreGameData.statid1)) : this.reportError(h._moreGameData.statid2), this.onResLoaded();
            }, l.onResLoaded = function() {
                if (this._moreBox) this._moreBox.visible = !0;
                else {
                    this._moreBox = new X(), e.stage.addChild(this._moreBox), this._moreBox.zOrder = 99999, this._moreBox.left = this._moreBox.right = this._moreBox.top = this._moreBox.bottom = 0;
                    ...
                    var n = new st();
                    this._moreBox.addChild(n), n.itemRender = o, n.selectEnable = !0, n.vScrollBarSkin = "", n.scrollBar.autoHide = !0, n.scrollBar.elasticDistance = 250, n.renderHandler = new f(this, this.onGameListRender);
                    ...
                    try {
                        ...
                        h._moreGameData.marvellousGame.gameList = [], h._moreGameData.marvellousGame.gameList = a, n.array = h._moreGameData.marvellousGame.gameList;
                    } catch (d) {
                        n.array = h._moreGameData.marvellousGame.gameList;
                    }
                    this.screenType && (n.spaceY = 10, n.width = 690, this.isQMP() ? n.height = e.stage.height + 130 : n.height = 1139, n.y = 139, n.centerX = 0), this.onStageResize();
                }
                ...
                return !r.onMiniGame && !r.onBDMiniGame || r.onAndroid || !n && !h || (t = !0), t;
                ...
                this.visible = !1, i && (this.dinfo = JSON.stringify(laya.bd.mini.BMiniAdapter.systemInfo), this.onGetAdvsListData());
                ...
                h._http.open("get", e, !0), h._http.setRequestHeader("Content-Type", "application/x-www-form-urlencoded"), h._http.responseType = "text", h._http.onerror = function(i) {
                    t._onError(i);
                ...
                o = function(t) {
                    ...
                    return e.init = function(t, i, e) {
                        if (this.titleLabel ? this.titleLabel.text = t.title : (this.titleLabel = this.onCreateLabel(t.title, this, 32, "#3d3939"), this.titleLabel.pos(8, 0), this.titleLabel.size(162, 50)), this.gameListBox)
                            for (o = 0, r = this.gameListBox._children.length; r > o; o++) l = this.gameListBox._children[o], l.init(t.gameList[o], i, e);
                        else {
                    ...
                    return e.MoveGameItem = function() {}, e.initEvent = function() {
                        ...
                        if (this.itemData = t, this.callBackHandler = e, this.kuangImg ? this.kuangImg.skin = h.onGetAtlasDanImgUrl("dayuan") : this.kuangImg = this.onCreateImage(h.onGetAtlasDanImgUrl("dayuan"), this), this.iconImg) this.iconImg.skin = h.onGetIconImgSkinUrl(t.icon);
                        else {
                        ...
                        this.iconNameLabel ? this.iconNameLabel.text = t.name : (this.iconNameLabel = this.onCreateLabel(t.name, this, 28, "#3d3939"), this.iconNameLabel.pos(7, 165)), this.playImg ? this.playImg.skin = h.onGetAtlasDanImgUrl("img_play") : (this.playImg = this.onCreateImage(h.onGetAtlasDanImgUrl("img_play"), this), this.playImg.pos(12, 210)), this.size(165, 270), this.initEvent();
                    }, e.onCreateLabel = function(t, i, e, s, n) {
        ...
        q = function(t) {
            function i() {
                this.closeHandler = null, this.popupEffect = null, this.closeEffect = null, this.group = null, this.isModal = !1, this.isShowEffect = !0, this.isPopupCenter = !0, this.closeType = null, this._dragArea = null, this._param = null, this._effectTween = null, i.__super.call(this), this.popupEffect = i.manager.popupEffectHandler, this.closeEffect = i.manager.closeEffectHandler, this._dealDragArea(), this.on("click", this, this._onClick);
            }
            ...
            return s._dealDragArea = function() {
                ...
                void 0 === t && (t = !0), this._dealDragArea(), this._param = e, i.manager.open(this, t, this.isShowEffect), i.manager.lock(!1);
            }, s.close = function(t) {
                this.closeType = t, i.manager.close(this);
            }, s.destroy = function(i) {
                void 0 === i && (i = !0), this.closeHandler = null, this.popupEffect = null, this.closeEffect = null, this._dragArea = null, t.prototype.destroy.call(this, i);
            }, s.show = function(t, i) {
            ...
            }, i.CLOSE = "close", i.CANCEL = "cancel", i.SURE = "sure", i.NO = "no", i.YES = "yes", i.OK = "ok", i._manager = null, i;
        }(N),
        Q = function(t) {
            function i() {
        ...
        it = function(t) {
            ...
            return e.imps(s, {
                ...
                this.addChild(this._list = new st()), this._list.renderHandler = f.create(this, this.renderItem, null, !1), this._list.repeatX = 1, this._list.on("change", this, this.onListChange);
                ...
                var s;
                for (var n in t) s = t[n], !s.isDirectory && String(s.label).toLowerCase().indexOf(e) > -1 && (s.x = 0, i.push(s)), s.child && s.child.length > 0 && this.getFilterSource(s.child, i, e);
        ...
        et = function(t) {
            ...
            return s.destroy = function(t) {
                ...
                var e = this._content;
                e.width = t, e.height = i, e._style.scrollRect || (e.scrollRect = b.create()), e._style.scrollRect.setTo(0, 0, t, i), e.scrollRect = e.scrollRect;
                ...
                this._usedCache || (this._usedCache = e.superGet(X, this, "cacheAs")), e.superSet(X, this, "cacheAs", "none"), this._hScrollBar && this._hScrollBar.once("end", this, this.onScrollEnd), this._vScrollBar && this._vScrollBar.once("end", this, this.onScrollEnd);
                ...
                e.superSet(X, this, "cacheAs", t), this._usedCache = null, "none" !== t ? (this._hScrollBar && this._hScrollBar.on("start", this, this.onScrollStart), this._vScrollBar && this._vScrollBar.on("start", this, this.onScrollStart)) : (this._hScrollBar && this._hScrollBar.off("start", this, this.onScrollStart), this._vScrollBar && this._vScrollBar.off("start", this, this.onScrollStart));
        ...
        st = function(t) {
            ...
            return e.imps(s, {
                ...
                this._usedCache || (this._usedCache = e.superGet(X, this, "cacheAs")), e.superSet(X, this, "cacheAs", "none"), this._scrollBar.once("end", this, this.onScrollEnd);
            }, s.onScrollEnd = function() {
                e.superSet(X, this, "cacheAs", this._usedCache);
                ...
                for (var u = t; e > u; u++)
                    for (var _ = 0; i > _; _++) n = a && a.length ? a.pop() : this.createItem(), n.x = (this._isVertical ? _ : u) * h - s._x, n.y = (this._isVertical ? u : _) * o - s._y, n.name = "item" + (u * i + _), s.addChild(n), this.addCell(n);
                ...
                this._content.width = t, this._content.height = i, (this._scrollBar || 0 != this._offset.x || 0 != this._offset.y) && (this._content._style.scrollRect || (this._content.scrollRect = b.create()), this._content._style.scrollRect.setTo(-this._offset.x, -this._offset.y, t, i), this._content.scrollRect = this._content.scrollRect), this.event("resize");
            }, s.onCellMouse = function(t) {
                "mousedown" === t.type && (this._isMoved = !1);
                var i = t.currentTarget,
                    e = this._startIndex + this._cells.indexOf(i);
                0 > e || ("click" === t.type || "rightclick" === t.type ? this.selectEnable && !this._isMoved ? this.selectedIndex = e : this.changeCellState(i, !0, 0) : "mouseover" !== t.type && "mouseout" !== t.type || this._selectedIndex === e || this.changeCellState(i, "mouseover" === t.type, 0), this.mouseHandler && this.mouseHandler.runWith([t, e]));
                ...
                this._array = t;
                var i = 0;
                if (this._array && (i = this._preLen - this._startIndex, i >= 0 && this.renderItems(i), this._preLen = this._array.length), this._scrollBar) {
                    var e = t.length,
                ...
                if (this.totalPage = Math.ceil(i / (this.repeatX * this.repeatY)), this._selectedIndex = this._selectedIndex < i ? this._selectedIndex : i - 1, this.startIndex = this._startIndex, this._scrollBar) {
                    ...
                    h > 1 && n >= s ? (this._scrollBar.scrollSize = this._cellSize, this._scrollBar.thumbPercent = s / n, this._scrollBar.setScroll(0, (n - s) * this._cellSize + this._cellOffset, this._scrollBar.value), this._scrollBar.target = this._content) : (this._scrollBar.setScroll(0, 0, 0), this._scrollBar.target = this._content);
                }
            }), h(0, s, "dataSource", t.prototype._$get_dataSource, function(t) {
        ...
        nt = function(t) {
            ...
            return s.preinitialize = function() {
                ...
                this.addChild(this._tf = new p()), this._tf.padding = D.inputLabelPadding, this._tf.on("input", this, this._onInput), this._tf.on("enter", this, this._onEnter), this._tf.on("blur", this, this._onBlur), this._tf.on("focus", this, this._onFocus);
            }, s._onFocus = function() {
                ...
                this._bg || (this.graphics = this._bg = new P()), this._bg.source = m.getRes(this._skin), this._width && (this._bg.width = this._width), this._height && (this._bg.height = this._height), this._sizeChanged(), this.event("loaded");
            }, s.select = function() {
                this._tf.select();
        ...
        ht = function(t) {
            ...
            return s.onEnable = function() {
                ...
                if (this.width > 0 && this.height > 0) {
                    ...
                    e.superSet(X, this, "width", e.stage.width), e.superSet(X, this, "height", e.stage.height), this.scale(t, t);
                }
            }, h(0, s, "width", t.prototype._$get_width, function(t) {
        ...
        at = (function(t) {
            function i(t) {
                this.advsListArr = [], this.resUrl = "https://unioncdn.layabox.com/config/iconlist.json", this._data = [], this._resquestTime = 36e4, this._appid = null, this._playIndex = 0, this._lunboTime = 5e3, i.__super.call(this), this._http = new r.window.XMLHttpRequest(), this.skin = t, this.setLoadUrl(), this.init(), this.size(120, 120);
            }
            ...
            return s.setLoadUrl = function() {
                ...
                this.isSupportJump() ? ((r.onMiniGame || r.onBDMiniGame) && e.timer.loop(this._resquestTime, this, this.onGetAdvsListData), this.onGetAdvsListData(), this.initEvent()) : this.visible = !1;
                ...
                if (this.advsListArr[this._playIndex])
                    if (this.visible = !0, r.onLimixiu) {
                        ...
                        i && (r.onLimixiu && GameStatusInfo.gameId == i.gameid ? this.onLunbo() : (this.skin = t + i.iconUrl, this.size(103, 126)));
                ...
                var t = this,
                    ...
                    s = this.resUrl + "?" + e;
                this._http.open("get", s, !0), this._http.setRequestHeader("Content-Type", "application/x-www-form-urlencoded"), this._http.responseType = "text", this._http.onerror = function(i) {
                    t._onError(i);
                ...
                void 0 === i && (i = !0), e.timer.clear(this, this.onLunbo), t.prototype.destroy.call(this, !0), this.clear(), e.timer.clear(this, this.onGetAdvsListData);
        ...
        _t = function(t) {
            ...
            return s.sortItem = function(t) {
                ...
                this.sortItem(t);
                var h = 0;
                for (e = 0, s = t.length; s > e; e++) n = t[e], n.x = h, h += n.width * n.scaleX + this._space, "top" == this._align ? n.y = 0 : "middle" == this._align ? n.y = .5 * (i - n.height * n.scaleY) : "bottom" == this._align && (n.y = i - n.height * n.scaleY);
                this._sizeChanged();
            }, h(0, s, "height", t.prototype._$get_height, function(t) {
        ...
        ft = function(t) {
            ...
            return s.changeItems = function() {
                ...
                this.sortItem(t);
                var h = 0;
                for (e = 0, s = t.length; s > e; e++) n = t[e], n.y = h, h += n.height * n.scaleY + this._space, "left" == this._align ? n.x = 0 : "center" == this._align ? n.x = .5 * (i - n.width * n.scaleX) : "right" == this._align && (n.x = i - n.width * n.scaleX);
                this._sizeChanged();
            }, h(0, s, "width", t.prototype._$get_width, function(t) {
        ...
        gt = function(t) {
            function i(t) {
                this._vScrollBar = null, this._hScrollBar = null, void 0 === t && (t = ""), i.__super.call(this, t), this.on("change", this, this._onTextChange);
            }
