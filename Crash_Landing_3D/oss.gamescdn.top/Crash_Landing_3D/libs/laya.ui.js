!function(t, e) {
    ...
    class h extends e.Graphics {
        ...
        changeSource() {
            ...
            if (t && t.bitmap) {
                ...
                if (i && (h !== e || a !== s))
                    return this.clear(),
                    this.draw9Grid(t, 0, 0, e, s, i),
                    void this._repaint();
                this.clear(),
                this.drawTexture(t, this._offset ? this._offset[0] : 0, this._offset ? this._offset[1] : 0, e, s, null, 1, null, null, this.uv),
                this._repaint();
            }
        }
    ...
    v.label = null,
    e.ILaya.regClass(v),
    e.ClassUtils.regClass("laya.ui.Slider", v),
        ...
        onStageMouseUp2(t) {
            ...
            !(this._clickOnly && this._value >= this.min && this._value <= this.max))
                ...
                this._isElastic)
                    ...
                    if (this._lastOffset = s / i,
                    (s = Math.abs(this._lastOffset)) < 2)
    ...
    e.ILaya.regClass(m),
    e.ClassUtils.regClass("laya.ui.ScrollBar", m),
    e.ClassUtils.regClass("Laya.ScrollBar", m);
    class f extends m {
    }
    e.ILaya.regClass(f),
        ...
        onScrollBarChange(t=null) {
            ...
            if (this.cacheContent)
                ...
                if (a > this._startIndex) {
                    ...
                    a < this._startIndex && (r = this._startIndex - a,
                    l = !1,
                ...
                for (var o = 0; o < r; o++) {
                    if (l) {
                        ...
                        _ = this._cells.pop(),
                        this._cells.unshift(_),
                        c = n - o;
                    var d = Math.floor(c / s) * this._cellSize;
                    this._isVertical ? _.y = d : _.x = d,
                    this.renderItem(_, c);
                }
                this._startIndex = a,
            ...
            this._isVertical ? (u.y = e - this._offset.y,
            u.x = -this._offset.x) : (u.y = -this._offset.y,
            u.x = e - this._offset.x),
            this._content.scrollRect = u;
        }
        posCell(t, e) {
            if (this._scrollBar) {
        ...
        updateArray(t) {
            ...
            this._scrollBar) {
                var s = t.length
                  ...
                  , a = Math.ceil(s / i);
                a >= h && (this._scrollBar.thumbPercent = h / a,
                this._scrollBar.slider._max = (a - h) * this._cellSize + this._cellOffset);
            }
        }
        get page() {
            return this._page;
        ...
        set isOpen(t) {
            if (this._isOpen != t)
                ...
                this._isOpen) {
                    ...
                    i = i + this._listHeight <= e.ILaya.stage.height ? i : s.y - this._listHeight,
    ...
    class M extends k {
        ...
        changeScroll() {
            ...
            this._vScrollBar.thumbPercent = h / Math.max(this._tf.textHeight, h),
            ...
            this._hScrollBar.scrollSize = Math.max(.033 * s, 1),
            this._hScrollBar.thumbPercent = s / Math.max(this._tf.textWidth, s),
    ...
    e.ILaya.regClass(D),
    e.ClassUtils.regClass("laya.ui.Tree", D),
    e.ClassUtils.regClass("Laya.Tree", D);
    class A extends c {
        constructor() {
            super(...arguments),
            this._space = 0,
    ...
    e.ILaya.regClass(A),
    e.ClassUtils.regClass("laya.ui.LayoutBox", A),
    e.ClassUtils.regClass("Laya.LayoutBox", A);
    class H extends A {
        sortItem(t) {
            t && t.sort(function(t, e) {
                return t.x - e.x;
        ...
        changeItems() {
            ...
            for (var t = [], e = 0, s = 0, i = this.numChildren; s < i; s++) {
                ...
                h && (t.push(h),
                e = this._height ? this._height : Math.max(e, h.height * h.scaleY));
            }
            this.sortItem(t);
            var a = 0;
            for (s = 0,
            i = t.length; s < i; s++)
                (h = t[s]).x = a,
                a += h.width * h.scaleX + this._space,
    ...
    H.BOTTOM = "bottom",
    e.ILaya.regClass(H),
    e.ClassUtils.regClass("laya.ui.HBox", H),
    e.ClassUtils.regClass("Laya.HBox", H);
    class N extends A {
        set width(t) {
        ...
        changeItems() {
            ...
            for (var t = [], e = 0, s = 0, i = this.numChildren; s < i; s++) {
                var h = this.getChildAt(s);
                h && (t.push(h),
                e = this._width ? this._width : Math.max(e, h.width * h.scaleX));
            }
            this.sortItem(t);
            var a = 0;
            for (s = 0,
            i = t.length; s < i; s++)
                (h = t[s]).y = a,
                a += h.height * h.scaleY + this._space,
    ...
    e.ClassUtils.regClass("laya.ui.DialogManager", X),
    e.ClassUtils.regClass("Laya.DialogManager", X);
    class G extends Y {
        constructor() {
            super(),
            this.isShowEffect = !0,
