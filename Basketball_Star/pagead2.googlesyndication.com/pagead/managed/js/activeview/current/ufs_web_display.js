(function() {
    ...
    */
    ...
    var hs;
    hs = ["2024032701"].slice(-1)[0].substring(0, 8);
            ...
            this.Dd = (c ? $c : d.g(P(function(g) {
                ...
                g.element.g(zf(1)).subscribe(function(k) {
                    ...
                    r = {
                        ...
                        waitForVideoPlaybackToAccumulateState: null != (A = null == m ? void 0 : Ys(m, Ls)) ? A : !0,
                        considerOmidBufferingEvents: null != (W = null == m ? void 0 : Ys(m, As)) ? W : !0,
    ...
    var ut = Rg(null !== "m202403270101".match(/^m\d{10}$/g) ? "m202403270101" : "current"),
        vt;
    a: {
        try {
            var wt = new uh;
