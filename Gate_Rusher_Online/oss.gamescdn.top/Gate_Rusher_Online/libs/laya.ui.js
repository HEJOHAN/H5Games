! function(t, i, e) {
    var s = (e.un, e.uns, e["static"]),
        ...
        p = laya.net.Loader,
        m = laya.net.LocalStorage,
        v = laya.maths.Matrix,
        y = (laya.display.Node, laya.maths.Point),
        C = laya.maths.Rectangle,
        b = (laya.renders.Render, laya.display.Scene),
        S = laya.utils.SceneUtils,
    ...
    e["interface"]("laya.ui.IBox"), e["interface"]("laya.ui.IItem"), e["interface"]("laya.ui.IRender"), e["interface"]("laya.ui.ISelect");
    var M = function() {
            function t() {}
            return h(t, "laya.ui.UIUtils"), t.fillArray = function(t, i, e) {
                var s = t.concat();
                if (i)
                    for (var h = i.split(","), n = 0, o = Math.min(s.length, h.length); o > n; n++) {
                        var r = h[n];
                        s[n] = "true" == r ? !0 : "false" == r ? !1 : r, null != e && (s[n] = e(r));
                    }
                return s;
            ...
            return s.destroy = function() {
                ...
                if (t && t.bitmap) {
                    var e = this.width,
                        ...
                        n = t.sourceWidth,
                        o = t.sourceHeight;
                    if (!h || n === e && o === s) this.clear(), this.drawTexture(t, this._offset ? this._offset[0] : 0, this._offset ? this._offset[1] : 0, e, s);
                    else {
                        this.clear();
                        var r = h[0],
                            l = h[1],
                        ...
                        c && r && this.drawImage(i.getTexture(t, 0, 0, c, r), 0, 0, c, r), l && r && this.drawImage(i.getTexture(t, n - l, 0, l, r), e - l, 0, l, r), c && a && this.drawImage(i.getTexture(t, 0, o - a, c, a), 0, s - a, c, a), l && a && this.drawImage(i.getTexture(t, n - l, o - a, l, a), e - l, s - a, l, a), r && this.drawBitmap(u, i.getTexture(t, c, 0, n - c - l, r), c, 0, e - c - l, r), a && this.drawBitmap(u, i.getTexture(t, c, o - a, n - c - l, a), c, s - a, e - c - l, a), c && this.drawBitmap(u, i.getTexture(t, 0, r, c, o - r - a), 0, r, c, s - r - a), l && this.drawBitmap(u, i.getTexture(t, n - l, r, l, o - r - a), e - l, r, l, s - r - a), this.drawBitmap(u, i.getTexture(t, c, r, n - c - l, o - r - a), c, r, e - c - l, s - r - a), _ && this.restore();
                    }
                    this._repaint();
                }
                ...
                0 >= s && (s = 1), 0 >= h && (h = 1), t.$_GID || (t.$_GID = I.getGID());
                var n;
        ...
        O = function(t) {
            function i() {
                this._dataSource = null, this._toolTip = null, this._tag = null, this._disabled = !1, this._gray = !1, i.__super.call(this), this._anchorX = NaN, this._anchorY = NaN, this._widget = Y.EMPTY, this.preinitialize(), this.createChildren(), this.initialize();
            }
            ...
            return s.destroy = function(i) {
                ...
                isNaN(this._anchorX) || (this.pivotX = this.anchorX * this.width), isNaN(this._anchorY) || (this.pivotY = this.anchorY * this.height), this.event("resize"), this._widget !== Y.EMPTY && this._widget.resetLayout();
        ...
        H = function(t) {
            function i() {
                ...
                }, i.__super.call(this), this.maskLayer = new w(), this.popupEffectHandler = new f(this, this.popupEffect), this.closeEffectHandler = new f(this, this.closeEffect), this.mouseEnabled = this.maskLayer.mouseEnabled = !0, this.zOrder = 1e3, e.stage.addChild(this), e.stage.on("resize", this, this._onResize), T.closeDialogOnSide && this.maskLayer.on("click", this, this._closeOnSide), this._onResize(null);
            }
        ...
        A = function(t) {
            function i() {
                this._watchMap = {}, this._widget = null, this._dataSource = null, this._anchorX = NaN, this._anchorY = NaN, this._widget = Y.EMPTY, i.__super.call(this);
            }
            h(i, "laya.ui.View", t);
            var s = i.prototype;
            return s.destroy = function(i) {
        ...
        N = function(t) {
            ...
            return s.destroy = function(i) {
                ...
                this.slide(i), e.timer.once(z.scrollBarDelayTime, this, this.startLoop, [i]), e.stage.once("mouseup", this, this.onStageMouseUp);
                ...
                (!this.isLockedFun || this.isLockedFun(t)) && (this.event("end"), this._clickOnly = !0, this._lastOffset = 0, this._checkElastic = !1, this._lastPoint || (this._lastPoint = new y()), this._lastPoint.setTo(e.stage.mouseX, e.stage.mouseY), e.timer.clear(this, this.tweenMove), k.clearTween(this), e.stage.once("mouseup", this, this.onStageMouseUp2), e.stage.once("mouseout", this, this.onStageMouseUp2), e.timer.frameLoop(1, this, this.loop));
            }, s.startDragForce = function() {
                this._clickOnly = !0, this._lastOffset = 0, this._checkElastic = !1, this._lastPoint || (this._lastPoint = new y()), this._lastPoint.setTo(e.stage.mouseX, e.stage.mouseY), e.timer.clear(this, this.tweenMove), k.clearTween(this), e.stage.once("mouseup", this, this.onStageMouseUp2), e.stage.once("mouseout", this, this.onStageMouseUp2), e.timer.frameLoop(1, this, this.loop);
                ...
                if (e.stage.off("mouseup", this, this.onStageMouseUp2), e.stage.off("mouseout", this, this.onStageMouseUp2), e.timer.clear(this, this.loop), !(this._clickOnly && this._value >= this.min && this._value <= this.max))
                    if (this._target.mouseEnabled = !0, this._isElastic) this._value < this.min ? k.to(this, {
                        value: this.min
                        ...
                        for (var i = 0, s = Math.min(this._offsets.length, 3), h = 0; s > h; h++) i += this._offsets[this._offsets.length - 1 - h];
                ...
                this.runCallLater(this.changeScrollBar), this.runCallLater(this._sizeChanged), t = t >= 1 ? .99 : t, this._thumbPercent = t, this.scaleBar && (this.slider.isVertical ? this.slider.bar.height = Math.max(this.slider.height * t, z.scrollBarMinNum) : this.slider.bar.width = Math.max(this.slider.width * t, z.scrollBarMinNum));
        ...
        D = function(t) {
            ...
            return o.destroy = function(i) {
                ...
                p.getRes(t) && (this._progress || (this.addChild(this._progress = new E()), this._progress.sizeGrid = this._bar.sizeGrid, this.setChildIndex(this._progress, 1)), this._progress.skin = t), this.setBarPoint(), this.callLater(this.changeValue), this._sizeChanged(), this.event("loaded");
        ...
        R = function(t) {
            ...
            return s.destroy = function(i) {
                ...
                this._tf.text != t && (t && (t = M.adptString(t + "")), this._tf.text = t, this.event("change"), this._width && this._height || this.onCompResize());
        ...
        G = function(t) {
            ...
            return s.destroy = function(i) {
                ...
                this.addChild(this._colorButton = new V()), this._colorPanel = new X(), this._colorPanel.size(230, 166), this._colorPanel.addChild(this._colorTiles = new w()), this._colorPanel.addChild(this._colorBlock = new w()), this._colorPanel.addChild(this._colorInput = new g());
            }, s.initialize = function() {
        ...
        V = function(t) {
            ...
            return e.imps(o, {
                ...
                this._text || (this._text = new x(), this._text.overflow = "hidden", this._text.align = "center", this._text.valign = "middle", this._text.width = this._width, this._text.height = this._height);
            }, o.initialize = function() {
                ...
                var s = t.$_GID + "-" + this._stateNum,
                    h = L.I.get(s);
                if (I.isOkTextureList(h) || (h = null), h) this._sources = h;
                else {
                    if (this._sources = [], 1 === this._stateNum) this._sources.push(t);
                    else
                        for (var n = 0; n < this._stateNum; n++) this._sources.push(B.createFromTexture(t, 0, e * n, i, e));
                ...
                t ? this._bitmap._offset = M.fillArray([1, 1], t, Number) : this._bitmap._offset = [];
        ...
        $ = (function(t) {
            ...
            return s._onStageHideTip = function(t) {
                ...
                var h = t.getBounds();
                t.x = e.stage.mouseX + i, t.y = e.stage.mouseY + s, t._x + h.width > e.stage.width && (t.x -= h.width + i), t._y + h.height > e.stage.height && (t.y -= h.height + s);
            }, s.closeAll = function() {
            ...
            function i(t, e) {
                this._visibleNum = 6, this._button = null, this._list = null, this._isOpen = !1, this._itemSize = 12, this._labels = [], this._selectedIndex = -1, this._selectHandler = null, this._itemHeight = NaN, this._listHeight = NaN, this._listChanged = !1, this._itemChanged = !1, this._scrollBarSkin = null, this._isCustomList = !1, this.itemRender = null, i.__super.call(this), this._itemColors = z.comboBoxItemColors, this.skin = t, this.labels = e;
            }
            ...
            return s.destroy = function(i) {
                ...
                this.addChild(this._button = new V()), this._button.text.align = "left", this._button.labelPadding = "0,0,0,5", this._button.on("mousedown", this, this.onButtonMouseDown);
                ...
                e.superSet(O, this, "width", t), this._button.width = this._width, this._itemChanged = !0, this._listChanged = !0;
                ...
                if (this._isOpen != t)
                    if (this._isOpen = t, this._button.selected = this._isOpen, this._isOpen) {
                        ...
                        var i = this.localToGlobal(y.TEMP.setTo(0, 0)),
        ...
        U = (function(i) {
            ...
            return o.onEnable = function() {
                ...
                e.superSet(O, this, "height", i), t.sharedCanvas && (t.sharedCanvas.height = i), this.callLater(this._postMsg);
            ...
            return s.destroy = function(i) {
                ...
                if (t === this._skin && i) {
                    var e = this._clipWidth || Math.ceil(i.sourceWidth / this._clipX),
                        ...
                        h = this._skin + e + s,
                        n = L.I.get(h);
                    if (I.isOkTextureList(n) || (n = null), n) this._sources = n;
                    else {
                        this._sources = [];
                        for (var o = 0; o < this._clipY; o++)
                            for (var r = 0; r < this._clipX; r++) this._sources.push(B.createFromTexture(i, e * r, s * o, e, s));
        ...
        Q = (function(t) {
            ...
            return s.destroy = function(t) {
                ...
                var e = this._content;
                e.width = t, e.height = i, e._style.scrollRect || (e.scrollRect = C.create()), e._style.scrollRect.setTo(0, 0, t, i), e.scrollRect = e.scrollRect;
                ...
                null == this._vScrollBar && (laya.display.Node.prototype.addChild.call(this, this._vScrollBar = new j()), this._vScrollBar.on("change", this, this.onScrollBarChange, [this._vScrollBar]), this._vScrollBar.target = this._content, this._vScrollBar.elasticDistance = this._elasticEnabled ? 200 : 0, this._setScrollChanged()), this._vScrollBar.skin = t;
        ...
        Z = function(t) {
            ...
            return s.preinitialize = function() {
                ...
                this.addChild(this._tf = new g()), this._tf.padding = z.inputLabelPadding, this._tf.on("input", this, this._onInput), this._tf.on("enter", this, this._onEnter), this._tf.on("blur", this, this._onBlur), this._tf.on("focus", this, this._onFocus);
            }, s._onFocus = function() {
                ...
                this._bg || (this.graphics = this._bg = new P()), this._bg.source = p.getRes(this._skin), this._width && (this._bg.width = this._width), this._height && (this._bg.height = this._height), this._sizeChanged(), this.event("loaded");
            }, s.select = function() {
                this._tf.select();
        ...
        et = function(t) {
            ...
            return e.imps(s, {
                ...
                var s;
                for (var h in t) s = t[h], !s.isDirectory && String(s.label).toLowerCase().indexOf(e) > -1 && (s.x = 0, i.push(s)), s.child && s.child.length > 0 && this.getFilterSource(s.child, i, e);
        ...
        st = function(t) {
            ...
            return e.imps(s, {
                ...
                if (this._cellChanged = !1, this._itemRender) {
                    ...
                    this._cellSize = this._isVertical ? e : i, this._cellOffset = this._isVertical ? e * Math.max(this._repeatY2, this._repeatY) - h - this._spaceY : i * Math.max(this._repeatX2, this._repeatX) - s - this._spaceX, this._isVertical && this.vScrollBarSkin ? this._scrollBar.height = h : !this._isVertical && this.hScrollBarSkin && (this._scrollBar.width = s), this.setContentSize(s, h);
                ...
                if (this.cacheContent) {
                    var r = new X();
                    r.cacheAs = "normal", r.pos((this._isVertical ? 0 : t) * n, (this._isVertical ? t : 0) * o), this._content.addChild(r), s = r;
                } else {
                ...
                for (var u = t; e > u; u++)
                    for (var _ = 0; i > _; _++) h = l && l.length ? l.pop() : this.createItem(), h.x = (this._isVertical ? _ : u) * n - s._x, h.y = (this._isVertical ? u : _) * o - s._y, h.name = "item" + (u * i + _), s.addChild(h), this.addCell(h);
            }, s.createItem = function() {
                var t = [];
                if ("function" == typeof this._itemRender) var i = new this._itemRender();
                else i = S.createComp(this._itemRender, null, null, t);
                ...
                this._content.width = t, this._content.height = i, (this._scrollBar || 0 != this._offset.x || 0 != this._offset.y) && (this._content._style.scrollRect || (this._content.scrollRect = C.create()), this._content._style.scrollRect.setTo(-this._offset.x, -this._offset.y, t, i), this._content.scrollRect = this._content.scrollRect), this.event("resize");
                ...
                if (this.totalPage = Math.ceil(i / (this.repeatX * this.repeatY)), this._selectedIndex = this._selectedIndex < i ? this._selectedIndex : i - 1, this.startIndex = this._startIndex, this._scrollBar) {
                    ...
                    var e = this._isVertical ? this.repeatX : this.repeatY,
                        s = this._isVertical ? this.repeatY : this.repeatX,
                        h = Math.ceil(i / e),
                        n = this._cellOffset > 0 ? this.totalPage + 1 : this.totalPage;
                    n > 1 && h >= s ? (this._scrollBar.scrollSize = this._cellSize, this._scrollBar.thumbPercent = s / h, this._scrollBar.setScroll(0, (h - s) * this._cellSize + this._cellOffset, this._scrollBar.value), this._scrollBar.target = this._content) : (this._scrollBar.setScroll(0, 0, 0), this._scrollBar.target = this._content);
                }
            }), n(0, s, "dataSource", t.prototype._$get_dataSource, function(t) {
        ...
        lt = function(t) {
            ...
            return s.createChildren = function() {
                ...
                for (var e = 0; e < this._clipY; e++)
                    for (var s = i[e].split(""), h = 0, n = s.length; n > h; h++) this._indexMap[s[h]] = e * this._clipX + h;
            }), n(0, s, "height", t.prototype._$get_height, function(t) {
        ...
        ut = function(t) {
            ...
            return s.sortItem = function(t) {
                ...
                this.sortItem(t);
                var n = 0;
                for (e = 0, s = t.length; s > e; e++) h = t[e], h.x = n, n += h.width * h.scaleX + this._space, "top" == this._align ? h.y = 0 : "middle" == this._align ? h.y = .5 * (i - h.height * h.scaleY) : "bottom" == this._align && (h.y = i - h.height * h.scaleY);
                this._sizeChanged();
            }, n(0, s, "height", t.prototype._$get_height, function(t) {
        ...
        _t = function(t) {
            ...
            return s._onTextChange = function() {
                ...
                var t = this._vScrollBar && this._tf.maxScrollY > 0,
                    ...
                    h = this._tf.padding || z.labelPadding;
                ...
                null == this._vScrollBar && (this.addChild(this._vScrollBar = new j()), this._vScrollBar.on("change", this, this.onVBarChanged), this._vScrollBar.target = this._tf, this.callLater(this.changeScroll)), this._vScrollBar.skin = t;
            }), n(0, s, "hScrollBarSkin", function() {
                return this._hScrollBar ? this._hScrollBar.skin : null;
            }, function(t) {
        ...
        dt = function(t) {
            ...
            return s.changeItems = function() {
                ...
                this.sortItem(t);
                var n = 0;
                for (e = 0, s = t.length; s > e; e++) h = t[e], h.y = n, n += h.height * h.scaleY + this._space, "left" == this._align ? h.x = 0 : "center" == this._align ? h.x = .5 * (i - h.width * h.scaleX) : "right" == this._align && (h.x = i - h.width * h.scaleX);
                this._sizeChanged();
            }, n(0, s, "width", t.prototype._$get_width, function(t) {
