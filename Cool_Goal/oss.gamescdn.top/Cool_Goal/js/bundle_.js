...
! function() {
        ...
        var n = t("./script/UiViews/ButtonAnim"),
            ...
            w = function() {
                ...
                return t.init = function() {
                    ...
                    t("script/UiViews/ButtonAnim.ts", n["default"]), t("script/UiViews/ConvergeAd.ts", a["default"]), t("script/GameMgr3d/GameInputCtrl.ts", o["default"]), t("script/UiViews/GameFighting.ts", s["default"]), t("script/UiViews/PromotionAnimation.ts", r["default"]), t("script/UiViews/OverAdListLoop.ts", l["default"]), t("script/UiViews/GameOverLevel.ts", h["default"]), t("script/UiViews/AdListLoop.ts", c["default"]), t("script/UiViews/GetPropesView.ts", u["default"]), t("script/UiViews/GoldenEggView.ts", d["default"]), t("script/BuildPlatform/wx/WXLaunch.ts", f["default"]), t("script/UiViews/MainViewVertical.ts", p["default"]), t("script/UiViews/rank/RankItem.ts", m["default"]), t("script/UiViews/rank/WXRankView.ts", y["default"]), t("script/UiViews/Resurgence.ts", g["default"]), t("script/UiViews/SettleCoin.ts", _["default"]), t("script/UiViews/SkinStore.ts", v["default"]), t("script/UiViews/TipView.ts", b["default"]);
                }, t.width = 750, t.height = 1334, t.scaleMode = "fixedwidth", t.screenMode = "vertical", t.alignV = "middle", t.alignH = "center", t.startScene = "Launch.scene", t.sceneRoot = "", t.debug = !1, t.stat = !1, t.physicsDebug = !1, t.exportSceneToJson = !0, t;
            }();
        i["default"] = w, w.init();
    }, {
    ...
    2: [function(t, e, i) {
        ...
        var n = t("./GameConfig"),
            ...
            o = function() {
                function t() {
                    Laya.isWXPosMsg = !0, Laya.isWXOpenDataContext = !1, Laya.Text.CharacterCache = !1, window.Laya3D ? Laya3D.init(n["default"].width, n["default"].height) : Laya.init(n["default"].width, n["default"].height, Laya.WebGL), Laya.Physics && Laya.Physics.enable(), Laya.DebugPanel && Laya.DebugPanel.enable(), Laya.stage.scaleMode = Laya.Stage.SCALE_SHOWALL, Laya.stage.alignH = "center";
                    ...
                    Laya.URL.exportSceneToJson = n["default"].exportSceneToJson, (n["default"].debug || "true" == Laya.Utils.getQueryString("debug")) && Laya.enableDebugPanel(), n["default"].physicsDebug && Laya.PhysicsDebugDraw && Laya.PhysicsDebugDraw.enable(), n["default"].stat && Laya.Stat.show(), Laya.alertGlobalError = !0, a["default"].init(), this.onVersionLoaded();
                }
    ...
    3: [function(t, e, i) {
        ...
        var n = t("../../Common/EventMgr"),
            ...
            p = function() {
                function t() {
                    var t = this;
                    this._launch = {}, this.btns = [], this.stime = 0, this.shareBackArgs = {}, this.bannerHomeIsHide = !0, this.bannerOtherIsHide = !0, this.bannerClassicEndIsHide = !0, this.isInited = !1, this.hasAd = !1, this.videoPlayedTimes = 0, this._launch = window.wx.getLaunchOptionsSync(), n["default"].instance.onOnceEvent("getSystemParamListBack", this, function() {
                        t.showShareMenu();
                        ...
                        if (void 0 != i && r.avatarUrlGroup && r.nickNameGroup);
                            ...
                            Laya.Browser.now() - t.stime > 2e3 ? (h.success = !0, t.shareBack && t.myCaller && t.shareBack.call(t.myCaller, h), t.shareBack = null) : (h.success = !1, t.shareBack && t.myCaller && t.shareBack.call(t.myCaller, h), t.shareBack = null);
                        }
                        ...
                        t.shareBackArgs && (c = t.shareBackArgs.notShowAd), Laya.timer.frameOnce(1, t, function() {
                            ...
                            var _ = !1;
                            s["default"].game_back_tolist && 1 == s["default"].game_back_tolist[u] && (_ = !0), l["default"].isShare || !_ || t ? n["default"].instance.emit(f.GameEvent.ADBACK) : n["default"].instance.emit("openConvergeAd", {
                ...
                return t.prototype.init = function() {
                    Laya.Browser.onMiniGame && (s["default"].systemInfo.SDKVersion && r["default"].compareVersion(s["default"].systemInfo.SDKVersion, "2.0.4") >= 0 && (this.isInited = !0), this.preBannerTimeHome = Laya.timer.currTimer, this.preBannerTimeOther = Laya.timer.currTimer, this.preBannerTimeClassicEnd = Laya.timer.currTimer);
                    ...
                    Laya.Browser.onMiniGame && window.wx.login({
                        success: function(i) {
                            ...
                            var n = e.getLaunchData(),
                                a = {};
                            a.code = i.code, n.query && (a.inviteId = n.query.invite_uid || "", a.channelId = n.query.channel || "", l["default"].fromImgid = n.query.cur_share_id || ""), n.referrerInfo && (l["default"].fromAppid = n.referrerInfo.appId), a.success = t.success, a.fail = t.fail, h["default"].instance.login(a);
                        },
                        fail: function(t) {}
                    });
                    ...
                    if (e) {
                        ...
                        return h += "&cur_share_id=" + i[n].id, h += "&channel=" + (l["default"].channelId ? l["default"].channelId : ""), t && (t.id && (h += "&scene=" + t.id), t.itemId && (h += "&itemId=" + t.itemId), t.type && (h += "&type=" + t.type), t.share_title && (a = t.share_title), t.share_img && (o = t.share_img)), {
                            title: a,
                            imageUrl: o,
                            query: h
                        };
                    ...
                    if (t && t.to_appid && Laya.Browser.onMiniGame) {
                        ...
                        s["default"].ad_cancel_tolist && 1 == s["default"].ad_cancel_tolist[e] && n["default"].instance.emit(f.GameEvent.ADJUMP), window.wx.navigateToMiniProgram({
                            appId: t.to_appid,
                            path: t.toLinks,
                            extraData: {
                                foo: "bar"
                            ...
                            success: function(e) {
                                s["default"].mainViewJumpToOtherGame = !1, c["default"].instance.navigateToMiniProgramBackStatistics(t), t.callback && t.callback("success"), t.callback = null;
                            }
                        });
                    }
                            ...
                            success: function(i) {
                                if (i.authSetting && i.authSetting["scope.userInfo"]) console.log("已经授权");
                                    ...
                                    e.btns && e.btns.push({
                                        ...
                                        t && t.userInfo ? (l["default"].nickName = t.userInfo.nickName, l["default"].gender = t.userInfo.gender, l["default"].avatarUrl = t.userInfo.avatarUrl, c["default"].instance.authorStatistics(), h["default"].instance.updateUserInfo(), e.btns && e.btns.forEach(function(t) {
                                            t && t.button.destroy();
                    ...
                    s["default"].repeatAuthorization ? this.setAuthorizationCheck(!1) : (s["default"].isCreateAuthorization = !0, this.btns && this.btns.forEach(function(t) {
                        t && t.button.destroy();
                    }));
                    ...
                    if (this.isInited) {
                        ...
                        this.rewardedVideoAd.onLoad(function() {
                            ...
                            return e.hasAd = !1, t.callBackErro ? void t.callBackErro() : (null != e.callBackSuc && e.callBackSuc(), void t.cleanVideoCall());
                        }), this.rewardedVideoAd.onClose(function(i) {
                            a["default"].instance.playBGM(), h["default"].instance.videoCallback(), i && i.isEnded || void 0 === i ? (c["default"].instance.videoPlayOverAdStatistics(t._type), e.videoPlayedTimes += 1, null != e.callBackSuc && e.callBackSuc()) : null != e.callBackFail && e.callBackFail(), t.cleanVideoCall();
                        });
                    }
                }, t.prototype.showVideo = function(t) {
                    if (!this.isInited) return void n["default"].instance.emit("openTip", "今日观看视频次数已用尽");
                    var e = this;
                    this._type = t._type || 0, this.myCaller = t.caller, this.callBackSuc = t.callBackSuc, this.callBackFail = t.callBackFail, this.callBackErro = t.callBackErro, c["default"].instance.clickVideoStatistics(this._type), this.hasAd ? (this.hasAd = !1, this.rewardedVideoAd.show()) : this.rewardedVideoAd.load().then(function() {
                    ...
                    if (Laya.Browser.onMiniGame && this.isInited) {
                        ...
                        if (this.bannerHomeIsHide = !1, Laya.timer.currTimer - this.preBannerTimeHome > 3e4 && this.bannerHome && (this.bannerHome.destroy(), this.bannerHome = null), !this.bannerHome) {
                            ...
                            console.log("广告id:", o), this.bannerHome = window.wx.createBannerAd({
                                ...
                                e.bannerHome.style.left = (i - e.bannerHome.style.realWidth) / 2, e.bannerHome.style.top = a - e.bannerHome.style.realHeight, a / i > 2 && (e.bannerHome.style.top = e.bannerHome.style.top - 10);
                    ...
                    if (Laya.Browser.onMiniGame && this.isInited) {
                        ...
                        var i = s["default"].systemInfo.windowWidth,
                            n = i,
                            a = s["default"].systemInfo.windowHeight;
                        this.bannerOtherIsHide = !1, Laya.timer.currTimer - this.preBannerTimeOther > 3e4 && this.bannerOther && (this.bannerOther.destroy(), this.bannerOther = null), this.bannerOther || (this.destroyBannerAdOther(), this.bannerOther = window.wx.createBannerAd({
                            ...
                            e.bannerOther.style.left = (i - e.bannerOther.style.realWidth) / 2, e.bannerOther.style.top = a - e.bannerOther.style.realHeight - 10, a / i > 2 && (e.bannerOther.style.top = e.bannerOther.style.top - 25);
                    ...
                    if (Laya.Browser.onMiniGame && this.isInited) {
                        ...
                        var i = s["default"].systemInfo.windowWidth,
                            n = i,
                            a = s["default"].systemInfo.windowHeight;
                        this.bannerClassicEndIsHide = !1, Laya.timer.currTimer - this.preBannerTimeOther > 3e4 && this.bannerClassicEnd && (this.bannerClassicEnd.destroy(), this.bannerClassicEnd = null), this.bannerClassicEnd || (this.destroyBannerAdClassicEnd(), this.bannerClassicEnd = window.wx.createBannerAd({
                            adUnitId: s["default"].bannerAdIds[r["default"].random(0, s["default"].bannerAdIds.length - 1)],
                            style: {
                                left: 0,
                                top: a - 100,
                            ...
                            e.bannerClassicEnd.style.left = (i - e.bannerClassicEnd.style.realWidth) / 2, e.bannerClassicEnd.style.top = a - e.bannerClassicEnd.style.realHeight - 10, a / i > 2 && (e.bannerClassicEnd.style.top = e.bannerClassicEnd.style.top - 25);
                    ...
                    this.bannerHomeIsHide = !0, this.bannerHome && (this.preBannerTimeHome = 0, 1 == s["default"].ctrlInfo.is_banner ? (this.bannerHome.destroy(), this.bannerHome = null) : this.bannerHome.hide());
                }, t.prototype.destroyBannerAdOther = function() {
                    this.bannerOtherIsHide = !0, this.bannerOther && (this.preBannerTimeOther = 0, 1 == s["default"].ctrlInfo.is_banner ? (this.bannerOther.destroy(), this.bannerOther = null) : this.bannerOther.hide());
                }, t.prototype.destroyBannerAdClassicEnd = function() {
                    this.bannerClassicEndIsHide = !0, this.bannerClassicEnd && (this.preBannerTimeClassicEnd = 0, 1 == s["default"].ctrlInfo.is_banner ? (this.bannerClassicEnd.destroy(), this.bannerClassicEnd = null) : this.bannerClassicEnd.hide());
    ...
    4: [function(t, e, i) {
        ...
        var u = function(t) {
            function e() {
                ...
                return e.descStr = [], e.descIndex = 0, e.headFirstY = 0, e.headSecondY = 0, e.toProcess = 1, e.progress = 0, e.scene3dUrl = "res3d/LayaScene_game/Conventional/game.ls", e.skinScene3dUrl = "res3d/LayaScene_skinStroe/Conventional/skinStroe.ls", e;
            }
            return __extends(e, t), e.prototype.onEnable = function() {
                var t = this;
                this.owner.height = Laya.stage.height;
                var e = this.owner.getChildByName("progressGroup");
                this.pro = e.getChildByName("progress"), this.proLabel = e.getChildByName("proLab"), this.logo = this.owner.getChildByName("logo"), this.headImg = e.getChildByName("show").getChildByName("headImg"), this.headImg1 = e.getChildByName("show").getChildByName("headImg1"), this.descLab = this.headImg.getChildByName("descLab"), this.descLab1 = this.headImg1.getChildByName("descLab1"), this.tipView = this.owner.getChildByName("tip"), this.tipViewMsg = this.tipView.getChildByName("tipMsg"), this.yad = this.owner.getChildByName("yad"), this.yad.visible = false, this.yad.on(Laya.Event.MOUSE_DOWN, this, () => {
                    platform.getInstance().navigate("LOADING", "LOGO");
                })
                this.tipViewOkButton = this.tipView.getChildByName("BtnOk"), this.tipView.on(Laya.Event.CLICK, this, this.okOnClick), Laya.timer.once(1, this, function() {
                    var i = Laya.stage.height - 1334;
                    0 > i && (i = 0), t.logo.y += i / 4, e.y += i / 4, t.owner.height = Laya.stage.height, t.tipView.y += i / 4;
                }), this.loadRes();
            }, e.prototype.okOnClick = function() {
                this.tipView.visible = !1;
            }, e.prototype.loadDesc = function(t, e) {
                t.skin = "loading/loading_toux" + Math.floor(c["default"].random(1, 5)) + ".png", e.text = this.descStr[this.descIndex];
                ...
                var t = this;
                a["default"].initConfigData(Laya.Loader.getRes("res/json/config.json")), a["default"].initSkinConfigData(Laya.Loader.getRes("res/json/skin.json")), a["default"].resLoadOk = !0, a["default"].isRedConfig = !0, Laya.Scene3D.load(t.skinScene3dUrl, Laya.Handler.create(t, function(e) {
                ...
                console.log("serverLoad"), Laya.Browser.onMiniGame ? (Laya.MiniAdpter.nativefiles = ["res3d/LayaScene_game", "res3d/LayaScene_skinStroe", "res/atlas", "loading/loading_bg.png", "loading/loading.png", "loading/logo.png", "res/sounds", "res/json", "res/language", "mainview", "game/bg_fuhuo_chaoyue.png", "game/di.png", "game/fuhuo_daojis_guang.png", "game/kuan@2x.png", "game/cainixh_tiao@2x.png", "settleCoin", "ConvergeAd.scene", "GameFighting.scene", "GameOverLevel.scene", "GetPropes.scene", "GoldenEggView.scene", "Launch.scene", "MainVertical.scene", "Rank.scene", "Resurgence.scene", "SettleCoin.scene", "Tip.scene", "skinStore.scene"], Laya.timer.once(1e4, this, function() {
                    ...
                    e.updateProgress(.99), e.serverScene3D = t, o["default"].instance.init(e.ganeScene3D, e.skinScene3D, e.serverScene3D), l["default"].instance.emit("goHome");
                }));
            }, e.prototype.updateProgress = function(t) {
                this.progress = t > this.progress ? t : this.progress, this.progress >= 1 ? (this.proLabel.text = "Loading...", this.pro.width = 500) : (this.pro.width = 500 * this.progress, this.proLabel.text = "Loading..." + Math.floor(100 * this.progress) + "%");
            }, e;
        }(Laya.Script);
        i["default"] = u;
    }, {
    ...
    6: [function(t, e, i) {
        ...
        var n, a = t("../../Datas/ConfigData"),
            o = t("../../Common/EventMgr");
        ! function(t) {
            t[t.event_showBannerAd_zhujiemian_erro_101 = 101] = "event_showBannerAd_zhujiemian_erro_101", t[t.event_showBannerAd_zhujiemianlingqujinbi_erro_102 = 102] = "event_showBannerAd_zhujiemianlingqujinbi_erro_102", t[t.event_showBannerAd_shiyongpifu_erro_103 = 103] = "event_showBannerAd_shiyongpifu_erro_103", t[t.event_showBannerAd_fuhuo_erro_104 = 104] = "event_showBannerAd_fuhuo_erro_104", t[t.event_showBannerAd_jiesuanjinbi_erro_105 = 105] = "event_showBannerAd_jiesuanjinbi_erro_105", t[t.event_showBannerAd_jiesuanjiemian_erro_106 = 106] = "event_showBannerAd_jiesuanjiemian_erro_106", t[t.event_show_lixianlingqujinbi_erro_107 = 107] = "event_show_lixianlingqujinbi_erro_107";
        ...
        var s = function() {
            ...
            return Object.defineProperty(t, "Instance", {
                ...
                Laya.Browser.onMiniGame && (a["default"].systemInfo.SDKVersion && this.compareVersion(a["default"].systemInfo.SDKVersion, "2.0.4") >= 0 && (this.isInited = !0, console.log("初始化广告"), this.showBannerAd_zhujiemian(!0), this.showBannerAd_zhujiemianlingqujinbi(-1, !0)), a["default"].systemInfo.SDKVersion && this.compareVersion(a["default"].systemInfo.SDKVersion, "2.6.0") >= 0 && (this.isInterstitial = !0));
                ...
                return null == i || 0 == i.ad_status ? !1 : (this.interstitialList[t] || (this.interstitialList[t] = window.wx.createInterstitialAd({
                    adUnitId: i.ad_id
                }), this.interstitialList[t] && this.interstitialList[t].load(), this.interstitialList[t].onLoad(function(t) {}), this.interstitialList[t].onError(function(t) {}), this.interstitialList[t].onClose(function(t) {})), void(e || this.interstitialList[t] && this.interstitialList[t].show()));
                ...
                return this.bannerAd_zhujiemian || (this.bannerAd_zhujiemian = window.wx.createBannerAd({
                    ...
                    i && (i.style.left = (s - i.style.realWidth) / 2, i.style.top = l - i.style.realHeight, l / s > 2 && (i.style.top = i.style.top - 10));
                ...
                if (this.bannerAd_zhujiemianlingqujinbi || (this.bannerAd_zhujiemianlingqujinbi = window.wx.createBannerAd({
                        ...
                        i && (i.style.left = (r - i.style.realWidth) / 2, i.style.top = h - i.style.realHeight, h / r > 2 && (i.style.top = i.style.top - 25));
                    ...
                    }), this.bannerAd_zhujiemianlingqujinbi.onLoad(function() {})), i) return console.log("预加载广告"), void 0 != this.bannerAd_zhujiemianlingqujinbi && this.bannerAd_zhujiemianlingqujinbi.hide(), !0;
                if (void 0 != this.bannerAd_zhujiemianlingqujinbi)
                    if (-1 != e && 0 != a["default"].wudianLevel[e] && 1 == a["default"].ctrlInfo.isWudian) {
                        var c = 0;
                        console.log("index:", e), a["default"].ctrlInfo.lateDelay[e] && (c = Number(a["default"].ctrlInfo.lateDelay[e])), console.log("lateDelay:", a["default"].ctrlInfo.lateDelay), Laya.timer.clear(this, this.show_zhujiemianlingqujinbi), Laya.timer.once(c, this, this.show_zhujiemianlingqujinbi);
                ...
                if (this.bannerAd_lixianlingqujinbi || (this.bannerAd_lixianlingqujinbi = window.wx.createBannerAd({
                        ...
                        i && (i.style.left = (s - i.style.realWidth) / 2, i.style.top = l - i.style.realHeight, l / s > 2 && (i.style.top = i.style.top - 25));
                    ...
                    }), this.bannerAd_lixianlingqujinbi.onLoad(function() {})), e) return console.log("预加载广告"), void 0 != this.bannerAd_lixianlingqujinbi && this.bannerAd_lixianlingqujinbi.hide(), !0;
                if (void 0 != this.bannerAd_lixianlingqujinbi)
                    if (0 != a["default"].wudianLevel[5] && 1 == a["default"].ctrlInfo.isWudian) {
                        ...
                        var h = 0;
                        a["default"].ctrlInfo.lateDelay[5] && (h = Number(a["default"].ctrlInfo.lateDelay[5])), Laya.timer.once(h, this, this.show_lixianlingqujinbi);
                ...
                if (void 0 != this.bannerAd_shiyongpifu)
                    if (0 != a["default"].wudianLevel[0] && 1 == a["default"].ctrlInfo.isWudian) {
                        ...
                        var h = 0;
                        a["default"].ctrlInfo.lateDelay[0] && (h = Number(a["default"].ctrlInfo.lateDelay[0])), Laya.timer.once(h, this, this.show_shiyongpifu);
                ...
                if (void 0 != this.bannerAd_fuhuo)
                    if (0 != a["default"].wudianLevel[1] && 1 == a["default"].ctrlInfo.isWudian) {
                        var h = 0;
                        a["default"].ctrlInfo.lateDelay[1] && (h = Number(a["default"].ctrlInfo.lateDelay[1])), Laya.timer.clear(this, this.show_fuhuo), Laya.timer.once(h, this, this.show_fuhuo);
                ...
                if (void 0 != this.bannerAd_jiesuanjinbi)
                    if (0 != a["default"].wudianLevel[2] && 1 == a["default"].ctrlInfo.isWudian) {
                        var h = 0;
                        a["default"].ctrlInfo.lateDelay[2] && (h = Number(a["default"].ctrlInfo.lateDelay[2])), Laya.timer.clear(this, this.show_jiesuanjinbi), Laya.timer.once(h, this, this.show_jiesuanjinbi);
                ...
                if (this.bannerAd_jiesuanjiemian || (this.bannerAd_jiesuanjiemian = window.wx.createBannerAd({
                    ...
                    }), this.bannerAd_jiesuanjiemian.onLoad(function() {})), e) return console.log("预加载广告"), void 0 != this.bannerAd_jiesuanjiemian && this.bannerAd_jiesuanjiemian.hide(), !0;
                if (void 0 != this.bannerAd_jiesuanjiemian)
                    if (0 != a["default"].wudianLevel[3] && 1 == a["default"].ctrlInfo.isWudian) {
                        var h = 0;
                        a["default"].ctrlInfo.lateDelay[3] && (h = Number(a["default"].ctrlInfo.lateDelay[3])), Laya.timer.clear(this, this.show_jiesuanjiemian), Laya.timer.once(h, this, this.show_jiesuanjiemian);
                ...
                Laya.timer.clear(this, this.show_zhujiemianlingqujinbi), Laya.timer.clear(this, this.show_shiyongpifu), Laya.timer.clear(this, this.show_fuhuo), Laya.timer.clear(this, this.show_jiesuanjinbi), Laya.timer.clear(this, this.show_jiesuanjiemian), Laya.timer.clear(this, this.show_lixianlingqujinbi), this.hideBannerAd_fuhuo(), this.hideBannerAd_jiesuanjiemian(), this.hideBannerAd_jiesuanjinbi(), this.hideBannerAd_shiyongpifu(), this.hideBannerAd_zhujiemian(), this.hideBannerAd_zhujiemianlingqujinbi(), this.hideBannerAd_lixianlingqujinbi();
                ...
                this.isInited && (this.caller_shuangbeikaiju = i, this.callBackSuc_shuangbeikaiju = n, this.callBackFail_shuangbeikaiju = a, this.callBackErro_shuangbeikaiju = o, this.hasAd_shuangbeikaiju ? (this.hasAd_shuangbeikaiju = !1, this.rewardedVideoAd_shuangbeikaiju.show()) : this.rewardedVideoAd_shuangbeikaiju.load().then(function() {
                ...
                this.isInited && (this.caller_zhujiemianduobeijinbi = i, this.callBackSuc_zhujiemianduobeijinbi = n, this.callBackFail_zhujiemianduobeijinbi = a, this.callBackErro_zhujiemianduobeijinbi = o, this.hasAd_zhujiemianduobeijinbi ? (this.hasAd_zhujiemianduobeijinbi = !1, this.rewardedVideoAd_zhujiemianduobeijinbi.show()) : this.rewardedVideoAd_zhujiemianduobeijinbi.load().then(function() {
                ...
                this.isInited && (this.caller_shiyongpifu = i, this.callBackSuc_shiyongpifu = n, this.callBackFail_shiyongpifu = a, this.callBackErro_shiyongpifu = o, this.hasAd_shiyongpifu ? (this.hasAd_shiyongpifu = !1, this.rewardedVideoAd_shiyongpifu.show()) : this.rewardedVideoAd_shiyongpifu.load().then(function() {
                ...
                this.isInited && (this.caller_fuhuo = i, this.callBackSuc_fuhuo = n, this.callBackFail_fuhuo = a, this.callBackErro_fuhuo = o, this.hasAd_fuhuo ? (this.hasAd_fuhuo = !1, this.rewardedVideoAd_fuhuo.show()) : this.rewardedVideoAd_fuhuo.load().then(function() {
                ...
                this.isInited && (this.caller_jiesuanjinbi = i, this.callBackSuc_jiesuanjinbi = n, this.callBackFail_jiesuanjinbi = a, this.callBackErro_jiesuanjinbi = o, this.hasAd_jiesuanjinbi ? (this.hasAd_jiesuanjinbi = !1, this.rewardedVideoAd_jiesuanjinbi.show()) : this.rewardedVideoAd_jiesuanjinbi.load().then(function() {
                ...
                this.isInited && (this.caller_shangcheng = i, this.callBackSuc_shangcheng = n, this.callBackFail_shangcheng = a, this.callBackErro_shangcheng = o, this.hasAd_shangcheng ? (this.hasAd_shangcheng = !1, this.rewardedVideoAd_shangcheng.show()) : this.rewardedVideoAd_shangcheng.load().then(function() {
            ...
            h = function() {
                ...
                return t.prototype.login = function(t) {
                    t.platform = window.navigator.platform, this._http.request({
                        ...
                        data: t,
                        callback: function(e) {
                            0 == e.code ? (e.sessionId && (o["default"].sessionId = e.sessionId), t.success && t.success(e)) : (o["default"].sessionId = "", t.fail && t.fail(e));
                        }
                    });
                    ...
                    this._http.request({
                        ...
                        callback: function(t) {
                            if (0 == t.code && (s["default"].ctrlInfo = {
                                    ...
                                    wOpen: t.w_open
                                }, s["default"].random_location = t.random_location, t.game_back_tolist && (s["default"].game_back_tolist = t.game_back_tolist.split(",")), t.ad_cancel_tolist && (s["default"].ad_cancel_tolist = t.ad_cancel_tolist.split(",")), t.btu_move && (s["default"].Btu_move = t.btu_move.split(",")), t.btu_appear && (s["default"].Btu_appear = t.btu_appear.split(",")), t.wudian_level && (s["default"].wudianLevel = t.wudian_level.split(",")), t.late_delay_new)) {
                    ...
                    this._http.request({
                        ...
                        callback: function(e) {
                            if (0 == e.code && t.success) {
                                var i = e.addMoney;
                                0 != i && n["default"].instance.emit("openTip", "Coin x" + i), t.success(e);
                            }
                        }
                    });
                }, t.prototype.getAllAdsControl = function() {}, t.prototype.statisticsbannerUpdateCount = function() {}, t.instance = new t(), t;
            }();
        i["default"] = h;
    }, {
                ...
                return t.prototype.playSound = function(t) {
                    if (n["default"].isSound) {
                        ...
                        if (Laya.Browser.onMiniGame) {
                            ...
                            null == i && (i = wx.createInnerAudioContext(), i.src = "res/sounds/" + t + ".mp3", i.onEnded(function() {
                    ...
                    if (n["default"].isSound) {
                        ...
                        Laya.Browser.onMiniGame ? this.bgm ? (this.bgm.loop = !0, this.bgm.play()) : (this.bgm = wx.createInnerAudioContext(), this.bgm.src = t, this.bgm.loop = !0, this.bgm.play()) : Laya.SoundManager.playMusic(t, 0);
                    }
        ...
        var n = t("../Datas/UserData"),
            ...
            o = function() {
                ...
                return t.setStorage = function(t) {
                    ...
                    var t;
                    return t = Laya.Browser.onMiniGame ? wx.getStorageSync("virbort") : localStorage.getItem("virbort"), "1" == t ? !1 : !0;
                    ...
                    var t;
                    return t = Laya.Browser.onMiniGame ? wx.getStorageSync("sound") : localStorage.getItem("sound"), "1" == t ? !1 : !0;
                    ...
                    if (!n["default"].isLogin) {
                        ...
                        if (e) {
                            ...
                            e = JSON.parse(e), n["default"].sessionId = e.sessionId, n["default"].openId = e.openId, n["default"].level = e.level || 1, n["default"].peopleSkin = e.peopleSkin || 1, n["default"].ballSkin = e.ballSkin || 101;
                        }
                    }
                }, t;
            }();
    ...
    14: [function(t, e, i) {
        ...
        var n = t("./EventMgr"),
            ...
            s = function() {
                function t() {
                    this.viewDic = {}, this.events = ["goHome", "openTip", "openResurgence", "openGameOverLevel", "openFighting", "openRank", "openGoldenEggView", "openGameOver", "openSettleCoin", "openSkinStore", "openGetPropes", "openConvergeAd"];
                }
                return t.prototype.init = function() {
    ...
    15: [function(t, e, i) {
        ...
        var l = function() {
            ...
            return t.initLocal = function() {
                t.isSound = o["default"].getLocalSound(), t.isVirbort = o["default"].getLocalVirbort(), Laya.Browser.onMiniGame && (this.releasePlatform = "wx", this.systemInfo = wx.getSystemInfoSync());
                ...
                t && (this.encryptDESKey1 = t.encry[0], this.encryptDESKey2 = t.encry[1], this.encryptDESKey3 = t.encry[2], this.serverUrl = t.serverUrl, this.statisticsUrl = t.statisticsUrl);
            }, t.getConfigData = function(t) {
                return this.ctrlInfo[t];
            }, t.setSound = function(e) {
                !e || e.length <= 0 ? (t.isSound = !0, o["default"].setLocalSound("")) : (o["default"].setLocalSound("1"), t.isSound = !1);
            }, t.setVirbort = function(e) {
                !e || e.length <= 0 ? (t.isVirbort = !0, o["default"].setLocalVirbort("")) : (o["default"].setLocalVirbort("1"), t.isVirbort = !1);
                ...
                return e = n > 111 ? a["default"].random(n - 111, n - 1) : a["default"].random(0, n - 1), this.configs[e];
            ...
            }, t.isRedConfig = !1, t.isLogin = !1, t.encryptDES = !0, t.encryptDESKey1 = "qire1", t.encryptDESKey2 = "qire2", t.encryptDESKey3 = "qire3", t.mainBtnsType = 0, t.beginnerGuide = 0, t.releasePlatform = "", t.myAppid = "", t.configs = null, t.skinConfig = null, t.language = "cn", t.languageData = null, t.version = "117", t.jsonVersion = "100", t.serverUrl = "", t.jsonVersionUrl = "", t.statisticsUrl = "", t.isCreateAuthorization = !1, t.repeatAuthorization = !1, t.isLog = !0, t.ctrlInfo = {}, t.systemInfo = {}, t.random_location = 0, t.Btu_move = 1900, t.Btu_appear = 700, t.ad_cancel_tolist = [], t.game_back_tolist = [], t.wudianLevel = [], t.bannerAdIds = [""], t.innerADId = "", t.rewardedAdId = "", t.resLoadOk = !1, t.remoteUrls = {}, t;
        }();
        i["default"] = l;
    }, {
    ...
    16: [function(t, e, i) {
        ...
        var n = t("./ConfigData"),
            a = function() {
                function t() {
                    this.pass = 0, this.sortType = n.SORTTYPE.ENDLESS, this.money = 0, this.reciverCount = 3, this.configMoney = 0, this.ballNum = 1, this.invincibleNum = 0, this.tryBallSkin = -1, this.tryRoleSkin = -1;
                }
                return t.prototype.reset = function() {
                    ...
                    this.money = 0, this.invincibleNum = 0, this.ballNum = 1, this.invincibleNum = 0, this.tryBallSkin = -1, this.tryRoleSkin = -1;
                }, t;
            }();
        i["default"] = a;
    }, {
        ...
        var n = t("../Common/EventMgr"),
            ...
            o = function() {
                ...
                return t.setMoney = function(e, i) {
                    void 0 === i && (i = !1);
                    var a = e || 0;
                    i ? t.money += a : t.money = a, platform.getInstance().setStorageSync("money", t.money);
                    ...
                    var i = t.findSkinDataById(e);
                    i.unlockView.moiveProcess += 1, i.unlockView.moiveProcess >= i.config.Video && (i.isHave = !0);
                    t.allView[e] = i;
                    platform.getInstance().setStorageSync("UserData_allview", t.allView);
                    ...
                    return e;
                }, t.roleDatas = [], t.ballDatas = [], t.peopleSkin = 1, t.ballSkin = 101, t.code = "", t.openId = "", t.sessionId = "", t.nickName = "", t.gender = 0, t.avatarUrl = "", t.score = 0, t.level = 1, t.index = 0, t.aladingStatus = 1, t.bannerTimes = 0, t.allView = {}, t.unlockView = new Array(), t.isNew = !0, t.isLogin = !1, t.shareCount = 0, t.money = 0, t.multipy = 1, t.offlineTimeSpent = 0, t.isDouble = !1, t.isFristOpenHome = !0, t.isShare = !1, t;
            }();
        i["default"] = o;
        var s = function() {
            function t() {}
        ...
        var n = t("./GameUtility"),
            ...
            f = function(t) {
                function e() {
                    ...
                    return e._isMove = !1, e._stopFindPath = !1, e._nextIndex = 0, e._ballSpeed = 0, e;
                }
                return __extends(e, t), e.prototype.initSelf = function() {
                    this._obj3D = this.owner, this._myTranform = this._obj3D.transform, this._meshObj = this._obj3D.getChildByName("ballMesh"), this._eff_fire = this._obj3D.getChildByName("eff_fire0"), this._meshTranform3D = this._meshObj.transform, this._gameCtrl = s["default"].instance.getGameCtrl(), this._eff_fire.active = !1, this._meshObj.meshRenderer.castShadow = a["default"].isShadow, this.addEvent();
                }, e.prototype.addEvent = function() {
                    h["default"].instance.onEvent(c.GameEvent.UPDATA_BALL_SKIN, this, this.changeSkin);
                }, e.prototype.changeSkin = function() {
                    var t = u["default"].ballSkin; - 1 != this._gameCtrl.getCurrGameData().tryBallSkin && (t = this._gameCtrl.getCurrGameData().tryBallSkin);
                    ...
                    this._isMove = !1, this._ballSpeed = a["default"].ballSpeed, this.setLocalPostion(a["default"].ballPos.clone()), this.getObj3D().active = !0, this._myTranform.localRotationEuler = n["default"].Vector3ZeroValue(), this._stopFindPath = !1, this._isInvincible = !1, this._eff_fire.active = !1;
                    ...
                    }), this._ballTrail = s["default"].instance.getObjectPoolMgr().instantiatePrefab("ball_trail1"), this._ballTrail.transform.localPosition = new Laya.Vector3(0, -.22, 0)) : (this._ballTrail = s["default"].instance.getObjectPoolMgr().instantiatePrefab("ball_trail0"), this._ballTrail.transform.localPosition = new Laya.Vector3(0, -.22, 0)), l["default"].instance.playSound("tiqiu"), this.owner.addChildren(this._ballTrail);
                    ...
                    this._targerQt = n["default"].lookAtTargetPosQuaternion(this._myTranform, this._targetPos), this._stepQt = this._myTranform.localRotation;
                    ...
                    if (this._stopFindPath) this._myTranform.translate(new Laya.Vector3(0, 0, this._ballSpeed), !0);
                        ...
                        this._myTranform.localRotation = t, this._myTranform.translate(new Laya.Vector3(0, 0, this._ballSpeed), !0), this._stepCount++, this._stepCount > this._farmCount && (this._nextIndex++, this.getMoveTarget());
                    }
                    ...
                    if (this._gameCtrl.getGameState() != o.GAME_STATE.SHOOT_READY) {
                        ...
                        if (0 != e.getLeftOBB().containsPoint(i)) return l["default"].instance.playSound("zhuangqiumen"), void this.refractionMove();
                        if (0 != e.getRightOBB().containsPoint(i) && (l["default"].instance.playSound("zhuangqiumen"), this.refractionMove()), 0 != e.getBehindOBB().containsPoint(i) && (l["default"].instance.playSound("zhuangqiumen"), this.refractionMove()), this.getPostion().z >= 14 || this.getPostion().x >= 5 || this.getPostion().x <= -5 || this.getPostion().z <= 0) return this._gameCtrl.checkOver(), void this._gameCtrl.changeGameState(o.GAME_STATE.SHOOT_OVER);
                        if (0 != e.getCenterOBB().containsPoint(i)) return this._gameCtrl.goNextPass(), this._isMove = !1, void this._gameCtrl.changeGameState(o.GAME_STATE.SHOOT_OVER);
    ...
    20: [function(t, e, i) {
        ...
        var n, a = t("./GameMgr"),
            ...
            g = t("../Util/MyUtils");
        ! function(t) {
            t[t.SHOOT_READY = 0] = "SHOOT_READY", t[t.TAKE_AIM = 1] = "TAKE_AIM", t[t.SHOOT = 2] = "SHOOT", t[t.SHOOT_OVER = 3] = "SHOOT_OVER";
        }(n = i.GAME_STATE || (i.GAME_STATE = {}));
        var _ = function(t) {
            function e() {
                var e = t.call(this) || this;
                return e._centerPointX = 0, e._endPointX = 0, e._endLeftToRightOffsetX = 0, e._endRightToLeftOffsetX = 0, e._isPlay = !1, e._obsRoleSkinId = -1, e;
            }
            return __extends(e, t), e.prototype.initSelf = function() {
                ...
                i.active = !0, this._ball = i.addComponent(l["default"]), this._ball.initSelf(), this.owner.addChild(i);
                var n = a["default"].instance.getObjectPoolMgr().instantiatePrefab("player");
                n.getChildByName("animator").getComponent(Laya.Animator);
                this._playerCtrl = n.addComponent(c["default"]), this.owner.addChild(n), this._playerCtrl.initSelf(), this.addEvent(), this.initGame();
            }, e.prototype.initGame = function() {
                this._currPass && this._currPass.destroySelf(), this._nextPass && this._nextPass.destroySelf(), this._isLeftVibrate = !1, this._isRightVibrate = !1, this._isPlay = !1, this._pathPoints = null, this._currGameData.reset(), this._currGameData.overReset();
                for (var t = 0; t < this._pathPointNodeArray.length; t++) {
                    var e = this._pathPointNodeArray[t];
                    e.active = !1;
                }
                d["default"].level = 0 == r["default"].testLevel ? d["default"].level : r["default"].testLevel, this._currGameData.pass = 0 == r["default"].testPass ? this._currGameData.pass : r["default"].testPass, this._levelData = f["default"].getLevelConfigByIndex(d["default"].level), this._currGameData.configMoney = Number(this._levelData.Reward || 0), this._obsRoleSkinId = this.getRandomObstacleRoleSkinId();
                var i = this.assmeblePassData(this._currGameData.pass);
                this._currPass = this.createLevel(i), this._currPass.initOtherOBB(), this._ball.reset(), this._playerCtrl.reset(), this.createNextPass(), p["default"].instance.emit(o.GameEvent.UPDATA_PLAYER_SKIN, d["default"].peopleSkin), p["default"].instance.emit(o.GameEvent.UPDATA_BALL_SKIN, d["default"].ballSkin);
                ...
                this._nextPass && (this.owner.addChild(this._nextPass.owner), this._nextPass.setLocalPostion(new Laya.Vector3(0, 0, 24.5)), this._nextPass.getObj3D().active = !0);
            }, e.prototype.addEvent = function() {
                p["default"].instance.onEvent(o.GameEvent.Input_TouchMoveLeft, this, this.cartesianPoints), p["default"].instance.onEvent(o.GameEvent.Input_TouchMoveRight, this, this.cartesianPoints), p["default"].instance.onEvent(o.GameEvent.Input_TouchUp, this, this.mouseUp), p["default"].instance.onEvent(o.GameEvent.Game_START, this, this.gameStart), p["default"].instance.onEvent(o.GameEvent.Game_INIT, this, this.initGame), p["default"].instance.onEvent(o.GameEvent.Game_RESURGENCE, this, this.gameReurgence), p["default"].instance.onEvent(o.GameEvent.Game_GoNextPass, this, this.goNextPass), p["default"].instance.onEvent(o.GameEvent.USE_INVINCIBTN, this, this.useInvincible), p["default"].instance.onEvent(o.GameEvent.ADD_INVINCIBLE, this, this.addInvincible), p["default"].instance.onEvent(o.GameEvent.ADD_BALLNUM, this, this.addBallNum), p["default"].instance.onEvent(o.GameEvent.TRY_SKIN, this, this.trySkin);
            }, e.prototype.trySkin = function(t) {
                var e = t.skiId,
                    i = t.type;
                1 == i ? (this._currGameData.tryRoleSkin = e, p["default"].instance.emit(o.GameEvent.UPDATA_PLAYER_SKIN, e)) : (this._currGameData.tryBallSkin = e, p["default"].instance.emit(o.GameEvent.UPDATA_BALL_SKIN, e));
            }, e.prototype.addInvincible = function() {
                this._currGameData.invincibleNum += 1, this._currGameData.invincibleNum = this._currGameData.invincibleNum > 1 ? 1 : this._currGameData.invincibleNum;
                console.log("this._currGameData.invincibleNum =", this._currGameData.invincibleNum);
            }, e.prototype.addBallNum = function(t) {
                this._currGameData.ballNum += t, this._currGameData.ballNum = this._currGameData.ballNum > 3 ? 3 : this._currGameData.ballNum;
                ...
                p["default"].instance.emit(o.GameEvent.UI_SHOW_FIGHT, !0), p["default"].instance.emit(o.GameEvent.UI_UPDATA_BALL_NUM, 0), p["default"].instance.emit(o.GameEvent.UI_UPDATA_JUMPBTN, !0), this._playerCtrl.reset(), this._ball.reset(), this._currPass.reset(), this.changeGameState(n.SHOOT_READY), this._isPlay = !0;
                ...
                p["default"].instance.emit(o.GameEvent.UI_NEXT_PASS, t), p["default"].instance.emit(o.GameEvent.UI_UPDATA_BALL_NUM, this._currGameData.ballNum - 1), p["default"].instance.emit(o.GameEvent.UI_UPDATA_INVINCIBTN, {
                    isHave: this._currGameData.invincibleNum > 0,
                    isShow: !0
                });
            }, e.prototype.checkOver = function() {
                var t = this;
                this._gameState != n.SHOOT_OVER && (this._ball.removeTrail(), m["default"].vibrateLong(), this._currGameData.ballNum -= 1, p["default"].instance.emit(o.GameEvent.UI_UPDATA_BALL_NUM, this._currGameData.ballNum - 1), Laya.timer.once(500, this, function() {
                    if (t._currGameData.ballNum > 0) t._playerCtrl.reset(), t._ball.reset(), t._currPass.reset(), t.changeGameState(n.SHOOT_READY), 1 == t._currGameData.ballNum && p["default"].instance.emit(o.GameEvent.UI_UPDATA_JUMPBTN, !0);
                    else {
                        var e = 1 == f["default"].ctrlInfo.marqueeBntSwitch || 1 == f["default"].ctrlInfo.shareBntSwitch || 1 == f["default"].ctrlInfo.videoBntSwitch;
                        if (e && t._currGameData.reciverCount > 0) t._isPlay = !1, p["default"].instance.emit("openResurgence", {
                            isPass: !1,
                ...
                if (t && t.isForceNext && (i = !0), (!i || this._gameState == n.SHOOT_READY) && (this._gameState != n.SHOOT_READY || i)) {
                    this._ball.getObj3D().active = !1, i || (m["default"].vibrateLong(), this._currPass.playEffect(this._ball.getPostion().clone())), this._ball.removeTrail(), this._currGameData.pass++;
                    ...
                    y["default"].instance.playSound("shengli"), Laya.timer.once(1500, this, function() {
                        if (a) {
                            ...
                            Laya.Tween.to(u, {
                                ...
                                e._currPass.destroySelf(), e._currPass = e._nextPass, e._currPass.initOtherOBB(), e._ball.reset(), e._playerCtrl.reset(), e._currPass.reset(), e._isLeftVibrate = !1, e._isRightVibrate = !1, e.changeGameState(n.SHOOT_READY), e.createNextPass(), p["default"].instance.emit(o.GameEvent.UI_UPDATA_MIN_PASS);
                            }));
                        }
                    });
                }
                ...
                if (this._isPlay && this._pathPoints && this._gameState == n.TAKE_AIM) {
                    ...
                    this._ball.setPathPoints(t), this._centerPointX = 0, this._endPointX = 0, this._endLeftToRightOffsetX = 0, this._endRightToLeftOffsetX = 0, this._playerCtrl.playShootAnim(), this.changeGameState(n.SHOOT);
                }
                ...
                switch (this._gameState = t, this._gameState) {
                    case n.SHOOT_READY:
                        ...
                        break;
                    case n.TAKE_AIM:
                        e == n.SHOOT_READY && (p["default"].instance.emit(o.GameEvent.UI_UPDATA_JUMPBTN, !1), p["default"].instance.emit(o.GameEvent.UI_UPDATA_INVINCIBTN, {
                            isHave: this._currGameData.invincibleNum > 0,
                            isShow: !1
                        }));
                        break;
                ...
                if (this._isPlay && (this._gameState == n.SHOOT_READY && this.changeGameState(n.TAKE_AIM), this._gameState == n.TAKE_AIM)) {
                    ...
                    if (0 > e && 0 != this._endLeftToRightOffsetX) {
                        ...
                        return this._endLeftToRightOffsetX += i, this._endLeftToRightOffsetX <= 0 ? (this._endLeftToRightOffsetX = 0, this._endPointX = r["default"].endLeftPoint.x, this._isLeftVibrate || (this._isLeftVibrate = !0)) : this._endPointX -= i, void this.showPathPoint();
                    }
                    if (e > 0 && 0 != this._endRightToLeftOffsetX) {
                        var i = e * (r["default"].endRightPoint.x - r["default"].endCenterLeft.x);
                        return this._endRightToLeftOffsetX -= i, this._endRightToLeftOffsetX >= 0 ? (this._endRightToLeftOffsetX = 0, this._endPointX = r["default"].endRightPoint.x, this._isRightVibrate || (this._isRightVibrate = !0)) : this._endPointX += i, void this.showPathPoint();
                    }
                    this._centerPointX -= e * (r["default"].centerRightPoint.x - r["default"].centerLeftPoint.x);
                    var a = !1;
                    if (this._centerPointX < r["default"].centerRightPoint.x && (this._centerPointX = r["default"].centerRightPoint.x, a = !0), this._centerPointX > r["default"].centerLeftPoint.x && (this._centerPointX = r["default"].centerLeftPoint.x, a = !0), a)
                        if (e = -e, e > 0) {
                            var i = e * (r["default"].endRightPoint.x - r["default"].endCenterLeft.x),
                                o = r["default"].endCenterLeft.x - this._endPointX;
                            0 >= o ? (i = 0, this._endPointX = r["default"].endCenterLeft.x, this._endRightToLeftOffsetX = r["default"].endRightPoint.x - r["default"].endCenterLeft.x) : (-o > i && (i = -o), this._endRightToLeftOffsetX -= i, this._endPointX -= i);
                        } else {
                            var i = e * (r["default"].endLeftPoint.x - r["default"].endCenterRight.x),
                                o = r["default"].endCenterRight.x - this._endPointX;
                            o >= 0 ? (i = 0, this._endPointX = r["default"].endCenterRight.x, this._endLeftToRightOffsetX = r["default"].endLeftPoint.x - r["default"].endCenterRight.x) : (o > i && (i = o), this._endLeftToRightOffsetX -= i, this._endPointX += i);
                        }
                ...
                for (var t = 0, e = 0; e < this._pathPointNodeArray.length; e++) {
                    var i = this._pathPointNodeArray[e];
                    i.transform.position = this._pathPoints[e], 0 == e || this._currPass.getGoal().checkPoint(this._pathPoints[e]) ? i.active = !1 : (i.active = !0, t++);
                }
                ...
                p["default"].instance.onOffEvent(o.GameEvent.Input_TouchMoveLeft, this, this.cartesianPoints), p["default"].instance.onOffEvent(o.GameEvent.Input_TouchMoveRight, this, this.cartesianPoints), p["default"].instance.onOffEvent(o.GameEvent.Input_TouchUp, this, this.mouseUp), p["default"].instance.onOffEvent(o.GameEvent.Game_START, this, this.gameStart), p["default"].instance.onOffEvent(o.GameEvent.Game_INIT, this, this.initGame), p["default"].instance.onOffEvent(o.GameEvent.ADD_INVINCIBLE, this, this.addInvincible), p["default"].instance.onOffEvent(o.GameEvent.ADD_BALLNUM, this, this.addBallNum);
                ...
                return -1 == this._obsRoleSkinId && (this._obsRoleSkinId = this.getRandomObstacleRoleSkinId()), this._obsRoleSkinId;
    ...
    21: [function(t, e, i) {
        ...
        var n;
        ! function(t) {
            t[t.None = 0] = "None", t[t.Input_TouchMoveRight = 101] = "Input_TouchMoveRight", t[t.Input_TouchMoveLeft = 102] = "Input_TouchMoveLeft", t[t.Input_TouchUp = 104] = "Input_TouchUp", t[t.UI_UPDATA_BALL_NUM = 121] = "UI_UPDATA_BALL_NUM", t[t.UI_UPDATA_MIN_PASS = 122] = "UI_UPDATA_MIN_PASS", t[t.UI_NEXT_PASS = 123] = "UI_NEXT_PASS", t[t.UI_SHOW_FIGHT = 124] = "UI_SHOW_FIGHT", t[t.UI_UPDATA_INVINCIBTN = 125] = "UI_UPDATA_INVINCIBTN", t[t.UI_UPDATA_JUMPBTN = 126] = "UI_UPDATA_JUMPBTN", t[t.UI_SHOW_PROVOCATION = 127] = "UI_SHOW_PROVOCATION", t[t.ADD_INVINCIBLE = 150] = "ADD_INVINCIBLE", t[t.ADD_BALLNUM = 151] = "ADD_BALLNUM", t[t.TRY_SKIN = 152] = "TRY_SKIN", t[t.USE_INVINCIBTN = 153] = "USE_INVINCIBTN", t[t.Game_INIT = 110] = "Game_INIT", t[t.Game_START = 111] = "Game_START", t[t.Game_OVER = 112] = "Game_OVER", t[t.Game_END = 113] = "Game_END", t[t.Game_RESURGENCE = 114] = "Game_RESURGENCE", t[t.Game_GoNextPass = 115] = "Game_GoNextPass", t[t.SKIN_SHOW_STORE = 300] = "SKIN_SHOW_STORE", t[t.SKIN_TRIAL = 304] = "SKIN_TRIAL", t[t.UPDATA_PLAYER_SKIN = 401] = "UPDATA_PLAYER_SKIN", t[t.UPDATA_BALL_SKIN = 402] = "UPDATA_BALL_SKIN", t[t.SKIN_CHANG_PLAYER_SKIN = 403] = "SKIN_CHANG_PLAYER_SKIN", t[t.SKIN_CHANG_BALL_SKIN = 404] = "SKIN_CHANG_BALL_SKIN", t[t.ADJUMP = 501] = "ADJUMP", t[t.ADBACK = 502] = "ADBACK";
        ...
        var n = t("./GameEvent"),
            ...
            o = function(t) {
                ...
                return __extends(e, t), e.prototype.closeInput = function() {
                    ...
                    this.clearInput(), this.owner.on(Laya.Event.MOUSE_UP, this, this.closeInput), this.owner.on(Laya.Event.MOUSE_OUT, this, this.closeInput), this.owner.on(Laya.Event.MOUSE_DOWN, this, this.onTouch);
                }, e.prototype.onDisable = function() {
                    this.clearInput(), this.owner.off(Laya.Event.MOUSE_UP, this, this.closeInput), this.owner.off(Laya.Event.MOUSE_DOWN, this, this.onTouch), this.owner.off(Laya.Event.FOCUS_CHANGE, this, this.closeInput);
                }, e.prototype.clearInput = function() {
                    this._isMouseDown = !1, this._lastMousePos = null;
                }, e.prototype.onTouch = function() {
                    this._lastMousePos = new Laya.Vector2(Laya.MouseManager.instance.mouseX, Laya.MouseManager.instance.mouseY), this._isMouseDown = !0;
                }, e.prototype.onUpdate = function() {
        ...
        var n = t("./MyGameEvent"),
            ...
            c = function() {
                ...
                return t.prototype.init = function(t, e, i) {
                    this._gameEvent = new n["default"](), this._currGameData = new r["default"](), this._scene3d = t, this._storeScene = e, this._serverScene = i, Laya.stage.addChildAt(this._scene3d, 0), Laya.stage.addChildAt(this._storeScene, 1), this._poolMgr = new o["default"](this._scene3d.getChildByName("prefabs")), h["default"].instance.init(this._poolMgr), this._camera = this._scene3d.getChildByName("Main Camera"), this._gameRoot = this._scene3d.getChildByName("gameRoot"), this._scene3d.addChild(this._gameRoot), this._gameCtrl = this._gameRoot.addComponent(a["default"]), this._gameCtrl.initSelf(), this._directionalLight = this._scene3d.getChildByName("Directional Light"), this._directionalLight.shadow = s["default"].isShadow, this._directionalLight.shadowDistance = 50, this._directionalLight.shadowResolution = 4096, this._directionalLight.shadowPSSMCount = 1, this._directionalLight.shadowPCFType = 1, this._storeScene.addComponent(l["default"]).init();
    ...
    24: [function(t, e, i) {
        ...
        var n = function() {
            ...
            return t.Vector3ZeroValue = function() {
                ...
                return r.y > 0 ? Laya.Quaternion.createFromYawPitchRoll(t.getRadian(e.localRotationEulerY) - s, 0, 0, l) : Laya.Quaternion.createFromYawPitchRoll(t.getRadian(e.localRotationEulerY) + s, 0, 0, l), l;
    ...
    25: [function(t, e, i) {
        ...
        var n = t("./GameMgr"),
            ...
            o = function(t) {
                ...
                return __extends(e, t), e.prototype.initSelf = function() {
                    this._centerNode = this.owner.getChildByName("centerBox"), this._leftNode = this.owner.getChildByName("leftBox"), this._rightNode = this.owner.getChildByName("rightBox"), this._behindNode = this.owner.getChildByName("behindBox"), this._leftPointTranform = this.owner.getChildByName("leftPoint").transform, this._rightPointTranform = this.owner.getChildByName("rightPoint").transform, this._skinNode = this.owner, this._myTranform = this.owner.transform, this._centerOBB = new Laya.OrientedBoundBox(new Laya.Vector3(.5, .5, .5), this._centerNode.transform.worldMatrix), this._leftOBB = new Laya.OrientedBoundBox(new Laya.Vector3(.5, .5, .5), this._leftNode.transform.worldMatrix), this._rightOBB = new Laya.OrientedBoundBox(new Laya.Vector3(.5, .5, .5), this._rightNode.transform.worldMatrix), this._behindOBB = new Laya.OrientedBoundBox(new Laya.Vector3(.5, .5, .5), this._behindNode.transform.worldMatrix), this._skinNode.meshRenderer.castShadow = a["default"].isShadow;
                    ...
                    return this._centerOBB.transformation = this._centerNode.transform.worldMatrix, this._centerOBB;
                    ...
                    return this._behindOBB.transformation = this._behindNode.transform.worldMatrix, this._behindOBB;
                }, e;
            }(Laya.Script3D);
        i["default"] = o;
    }, {
    ...
    26: [function(t, e, i) {
        ...
        var n = function() {
            ...
            return t.damageObstacleAnimName = {
                ...
                4: "obs_destroy_04",
                5: "obs_destroy_05"
            }, t.beAttackEffectName = "eff_zhuangji", t.roleAnimIdle = ["DH_dance_1", "DH_dance_2", "DH_dance_3", "DH_keep_1"], t.roleAnimDownToUp = ["DH_walk_1", "DH_run_1"], t.roleAnimCircle = ["DH_walk_1", "DH_run_1"], t.startPoint = new Laya.Vector3(0, .3, 3.15), t.endPoint = new Laya.Vector3(0, .3, 9.6), t.centerPoint = new Laya.Vector3(0, .3, 6), t.endLeftPoint = new Laya.Vector3(1, .3, 9.6), t.endCenterLeft = new Laya.Vector3(0, .3, 9.6), t.endRightPoint = new Laya.Vector3(-1, .3, 9.6), t.endCenterRight = new Laya.Vector3(0, .3, 9.6), t.centerLeftPoint = new Laya.Vector3(4, .3, 6), t.centerRightPoint = new Laya.Vector3(-4, .3, 6), t.asensitivity = 3.5, t.roleMoveMaxX = .25, t.roleMoveMinX = -.25, t.roleMoveMaxZ = 1, t.roleMoveMinZ = 1, t.isShadow = !0, t.ballSpeed = .18, t.ballPos = new Laya.Vector3(0, .361, 3.15), t.playerPos = new Laya.Vector3(.47, 0, 1.73), t.pathPointNum = 12, t.moveLeftToRightSpeed = .017, t.moveUpToDownSpeed = .0125, t.walkAngular = 1, t.runAngular = 1, t.testLevel = 0, t.testPass = 0, t;
        }();
        i["default"] = n;
    }, {}],
    27: [function(t, e, i) {
    ...
    29: [function(t, e, i) {
        ...
        var n;
        ! function(t) {
            t[t.Role1 = 1] = "Role1", t[t.Role2 = 2] = "Role2", t[t.Role3 = 3] = "Role3", t[t.Role4 = 4] = "Role4", t[t.Role5 = 5] = "Role5", t[t.Role6 = 6] = "Role6", t[t.Role7 = 7] = "Role7", t[t.Role8 = 8] = "Role8", t[t.Role9 = 9] = "Role9", t[t.Role10 = 10] = "Role10", t[t.Role11 = 11] = "Role11", t[t.Role12 = 12] = "Role12", t[t.Role13 = 13] = "Role13", t[t.Obstacle21 = 21] = "Obstacle21", t[t.Obstacle22 = 22] = "Obstacle22", t[t.Obstacle23 = 23] = "Obstacle23", t[t.Obstacle24 = 24] = "Obstacle24", t[t.Coin = 31] = "Coin";
        ...
        var n = t("./ObstacleBase"),
            ...
            r = function(t) {
                ...
                return __extends(e, t), e.prototype.initSelf = function(e) {
                    t.prototype.initSelf.call(this, e), this._box = this.owner.getChildByName("box"), this._animator = this.owner.getComponent(Laya.Animator);
                    ...
                    this._effect ? (this._effect.active = !1, this._effect.active = !0) : (this._effect = s["default"].instance.getObject(o["default"].beAttackEffectName), this.owner.addChild(this._effect), this._effect.transform.localPosition = new Laya.Vector3(0, 0, 0), this._effect.active = !1, this._effect.active = !0);
        ...
        var n = t("./NotBumpedObstacle"),
            ...
            r = function(t) {
                ...
                return __extends(e, t), e.prototype.initSelf = function(e) {
                    ...
                    return this._animator.play(n), console.log("distanceX:", i), console.log("localScaleX:", this._box.transform.localScaleX / 5 * 2), Math.abs(i) >= this._box.transform.localScaleX / 5 * 2 ? e = !1 : (t.refractionMove(), s["default"].instance.playSound("zhuangshu"), e = !0), e;
                }, e.prototype.reset = function() {
    ...
    32: [function(t, e, i) {
        ...
        var n = t("./NotBumpedObstacle"),
            ...
            o = function(t) {
                ...
                return __extends(e, t), e.prototype.initSelf = function(e) {
                    t.prototype.initSelf.call(this, e), this.rotate = .075, this.isRotate = !0, this.coinNode = this.owner.getChildByName("coin"), this.meshTranform = this.coinNode.transform, this.effect = this.owner.getChildByName("eff_gold"), this.effect.active = !1;
                }, e.prototype.colliderResult = function(t) {
        ...
        var n = t("./MoveBase"),
            ...
            s = function(t) {
                ...
                return __extends(e, t), e.prototype.initSelf = function(t, e, i) {
                    this._myTranform = this.owner.transform, this._animator = t, this._animName = e.animName, this._radius = e.radius, this._initAngle = e.angle, this._isReverse = i, this.reset();
                }, e.prototype.reset = function() {
                    t.prototype.reset.call(this), this._angle = this._initAngle, "DH_walk_1" == this._animName ? this._speed = o["default"].walkAngular : this._speed = o["default"].runAngular, this._animator.play(this._animName);
                }, e.prototype.myUpdata = function() {
                    if (this._isMove) {
                        ...
                        c.y > 0 ? Laya.Quaternion.createFromYawPitchRoll(a["default"].getRadian(this._myTranform.localRotationEulerY) - h, 0, 0, u) : Laya.Quaternion.createFromYawPitchRoll(a["default"].getRadian(this._myTranform.localRotationEulerY) + h, 0, 0, u), this._myTranform.localRotation = u;
                    }
                }, e;
            }(n["default"]);
        i["default"] = s;
    ...
    35: [function(t, e, i) {
        ...
        var n, a = t("./MoveBase"),
            o = t("../MyGameConfig");
        ! function(t) {
            t[t.LEFT = 0] = "LEFT", t[t.RIGHT = 1] = "RIGHT", t[t.MOVE_RIGHT = 2] = "MOVE_RIGHT", t[t.MOVE_LEFT = 3] = "MOVE_LEFT";
        ...
        var s = function(t) {
            ...
            return __extends(e, t), e.prototype.initSelf = function(t, e, i) {
                this._myTranform = this.owner.transform, this._initState = t, this._minX = i.minX, this._maxX = i.maxX, this._animator = e, this.reset();
            }, e.prototype.reset = function() {
                ...
                if (this._isMove) switch (this._state) {
                    case n.LEFT:
                        ...
                        this._myTranform.localPosition = new Laya.Vector3(this._maxX, t.y, t.z), this._state = n.MOVE_RIGHT, this._animator.play("DH_mkeep_1");
                        break;
                    case n.MOVE_RIGHT:
                    ...
                    case n.RIGHT:
                        ...
                        this._myTranform.localPosition = new Laya.Vector3(this._minX, i.y, i.z), this._animator.play("DH_mkeep_2"), this._state = n.MOVE_LEFT;
                        break;
                    case n.MOVE_LEFT:
                        this._myTranform.translate(new Laya.Vector3(-o["default"].moveLeftToRightSpeed, 0, 0));
    ...
    36: [function(t, e, i) {
        ...
        var s = function(t) {
            ...
            return __extends(e, t), e.prototype.initSelf = function(t, e, i) {
                this._myTranform = this.owner.transform, this._initState = t, this._state = this._initState, this._minZ = i.minZ, this._maxZ = i.maxZ, this._animator = e, this._animName = i.animName, this.reset();
            }, e.prototype.reset = function() {
    ...
    37: [function(t, e, i) {
        ...
        var n = t("./ObstacleBase"),
            ...
            r = function(t) {
                ...
                return __extends(e, t), e.prototype.initSelf = function(e) {
                    t.prototype.initSelf.call(this, e), this._box = this.owner.getChildByName("box"), (this._obType == o.ObstacleType.Obstacle22 || this._obType == o.ObstacleType.Obstacle23) && (this.owner.meshRenderer.castShadow = a["default"].isShadow);
                }, e.prototype.setLocalPostion = function(e) {
                    t.prototype.setLocalPostion.call(this, e), this._boundBox = new Laya.OrientedBoundBox(new Laya.Vector3(.55, .55, .55), this._box.transform.worldMatrix);
                }, e.prototype.checkCollider = function(e) {
                    if (!t.prototype.checkCollider.call(this, e)) return !1;
                    ...
                    this._effect ? (this._effect.active = !1, this._effect.active = !0) : (this._effect = s["default"].instance.getObject(a["default"].beAttackEffectName), this.owner.addChild(this._effect), this._effect.transform.localPosition = new Laya.Vector3(0, 0, 0), this._effect.active = !1, this._effect.active = !0);
                }, e.prototype.destroySelf = function() {
    ...
    38: [function(t, e, i) {
        ...
        var n = t("./ObstacleBase"),
            a = function(t) {
                ...
                return __extends(e, t), e.prototype.initSelf = function(e) {
                    t.prototype.initSelf.call(this, e), this._box = this.owner.getChildByName("box"), this._isBeAttack = !1;
                }, e.prototype.setLocalPostion = function(e) {
                    t.prototype.setLocalPostion.call(this, e), this._initPos = this._myTranform.localPosition.clone(), this._initEuler = this._myTranform.localRotationEuler.clone(), this._boundBox = new Laya.OrientedBoundBox(new Laya.Vector3(.6, .6, .6), this._box.transform.worldMatrix);
                }, e.prototype.checkCollider = function(e) {
                    if (!t.prototype.checkCollider.call(this, e)) return !1;
                    var i = 0 != this._boundBox.containsPoint(e.getPostion());
                    return i;
                    ...
                    this._myTranform.localRotationEuler = this._initEuler, this._myTranform.localPosition = this._initPos, this._isBeAttack = !1;
                }, e;
            }(n["default"]);
        i["default"] = a;
    }, {
        ...
        var n = t("../GameCtrl"),
            ...
            o = function(t) {
                ...
                return __extends(e, t), e.prototype.initSelf = function(t) {
                    this._obj3D = this.owner, this._myTranform = this._obj3D.transform, this._obType = t, this._gameCtrl = a["default"].instance.getGameCtrl();
                }, e.prototype.setLocalPostion = function(t) {
                    this._myTranform.localPosition = t;
                    ...
                    return !1;
                }, e.prototype.myUpdata = function() {}, e.prototype.reset = function() {}, e.prototype.destroySelf = function() {}, e;
            }(Laya.Script3D);
        i["default"] = o;
        var s = function() {
            function t() {}
    ...
    40: [function(t, e, i) {
        ...
        var n, a = t("./MoveLeftToRight"),
            ...
            h = t("../../Common/SoundMgr");
        ! function(t) {
            t[t.IDLE = 0] = "IDLE", t[t.MOVE_LEFT_TO_RIGHT = 1] = "MOVE_LEFT_TO_RIGHT", t[t.CIRCLE = 2] = "CIRCLE", t[t.RE_CIRCE = 3] = "RE_CIRCE", t[t.MOVE_UP_TO_DOWN = 4] = "MOVE_UP_TO_DOWN";
        ...
        var c = function(t) {
            ...
            return __extends(e, t), e.prototype.initSelf = function(t, e) {
                this._state = t, this._initData = e, this._farm = 0, this._isPAttacked = !1, this._myTranform = this.owner.transform, this._animator = this.owner.getChildByName("animator").getComponent(Laya.Animator), this._obb = new Laya.OrientedBoundBox(new Laya.Vector3(.4, .4, .4), this._myTranform.worldMatrix), this._animName = e.animName, this._skinNode = this.owner.getChildByName("animator").getChildByName("xiaokeai"), this._skinNode.skinnedMeshRenderer.castShadow = !1, this._beAttackEffect = this.owner.getChildByName("eff_shouji"), this._state = t, this._PAttackedSpeedZ = 0, this._PAttackedSpeedX = 0;
            }, e.prototype.changeSkin = function(t) {
                var e = this;
                ...
                this._initPos = t, this._initEuler = e, this._myTranform.localPosition = this._initPos.clone(), this._myTranform.localRotationEuler = this._initEuler.clone();
                ...
                if (Math.abs(i) >= .35) i > 0 ? this._animator.play("DH_hurt_2") : this._animator.play("DH_hurt_1"), e = !1;
                else {
                    h["default"].instance.playSound("zhuangren"), this.playBeAttackEffect(), t.refractionMove(), this._animator.play("DH_hit_1");
                    ...
                    this._PAttackedSpeedZ = n / this.hitFarm, this._PAttackedSpeedX = a / this.hitFarm, this._isPAttacked = !0, e = !0;
                }
                ...
                if (this._isPAttacked) {
                    ...
                    this._myTranform.position = new Laya.Vector3(t + this._PAttackedSpeedX, e, i + this._PAttackedSpeedZ), this._farm >= this.hitFarm && (this._isPAttacked = !1);
                }
            }, e.prototype.reset = function() {
                this._PAttackedSpeedZ = 0, this._PAttackedSpeedX = 0, this._isPAttacked = !1, this._farm = 0, this._state != n.CIRCLE && this._state != n.RE_CIRCE && (this._myTranform.localPosition = this._initPos.clone(), this._myTranform.localRotationEuler = this._initEuler.clone()), this._state == n.IDLE && this._animator.play(this._animName), this._moveBase && this._moveBase.reset();
            }, e;
        }(Laya.Script3D);
        i["default"] = c;
    }, {
                ...
                return __extends(e, t), e.prototype.initSelf = function(e) {
                    ...
                    switch (console.log("创建的小人类型为:", this._obType), this._obType) {
                        case l.ObstacleType.Role1:
                            i = 1, t = a.ROLE_STATE.IDLE, n.push(new Laya.Vector3(0, 0, 0)), h.push(new Laya.Vector3(0, 180, 0)), y = this._passMgr.getAnimIdleName();
                            break;
                        case l.ObstacleType.Role2:
                            t = a.ROLE_STATE.MOVE_LEFT_TO_RIGHT, i = 1, n.push(new Laya.Vector3(0, 0, 0)), h.push(new Laya.Vector3(0, 180, 0)), d.push(-.8), f.push(.8), g.push(s.MOVE_STATE.LEFT);
                            break;
                        case l.ObstacleType.Role3:
                            t = a.ROLE_STATE.MOVE_LEFT_TO_RIGHT, i = 2, n.push(new Laya.Vector3(0, 0, 0)), h.push(new Laya.Vector3(0, 180, 0)), d.push(-1), f.push(0), g.push(s.MOVE_STATE.LEFT), n.push(new Laya.Vector3(0, 0, -1)), h.push(new Laya.Vector3(0, 180, 0)), d.push(0), f.push(1), g.push(s.MOVE_STATE.RIGHT);
                            break;
                        case l.ObstacleType.Role4:
                            t = a.ROLE_STATE.MOVE_LEFT_TO_RIGHT, i = 3, n.push(new Laya.Vector3(-1.8, 0, 0)), h.push(new Laya.Vector3(0, 180, 0)), d.push(-1.8), f.push(-.8), g.push(s.MOVE_STATE.RIGHT), n.push(new Laya.Vector3(-1.2, 0, 0)), h.push(new Laya.Vector3(0, 180, 0)), d.push(-1.2), f.push(-.2), g.push(s.MOVE_STATE.MOVE_RIGHT), n.push(new Laya.Vector3(1.2, 0, 0)), h.push(new Laya.Vector3(0, 180, 0)), d.push(.2), f.push(1.2), g.push(s.MOVE_STATE.MOVE_LEFT);
                            break;
                        case l.ObstacleType.Role5:
                            t = a.ROLE_STATE.MOVE_LEFT_TO_RIGHT, i = 3, n.push(new Laya.Vector3(-.5, 0, 0)), h.push(new Laya.Vector3(0, 180, 0)), d.push(-1), f.push(0), g.push(s.MOVE_STATE.MOVE_RIGHT), n.push(new Laya.Vector3(0, 0, 0)), h.push(new Laya.Vector3(0, 180, 0)), d.push(-.5), f.push(.5), g.push(s.MOVE_STATE.MOVE_RIGHT), n.push(new Laya.Vector3(.5, 0, 0)), h.push(new Laya.Vector3(0, 180, 0)), d.push(0), f.push(1), g.push(s.MOVE_STATE.MOVE_RIGHT);
                            break;
                        case l.ObstacleType.Role6:
                            t = a.ROLE_STATE.MOVE_LEFT_TO_RIGHT, i = 4, n.push(new Laya.Vector3(-.5, 0, -.5)), h.push(new Laya.Vector3(0, 180, 0)), d.push(-1.3), f.push(-.5), g.push(s.MOVE_STATE.MOVE_LEFT), n.push(new Laya.Vector3(0, 0, -.5)), h.push(new Laya.Vector3(0, 180, 0)), d.push(-.8), f.push(0), g.push(s.MOVE_STATE.MOVE_LEFT), n.push(new Laya.Vector3(0, 0, .5)), h.push(new Laya.Vector3(0, 180, 0)), d.push(0), f.push(.8), g.push(s.MOVE_STATE.MOVE_RIGHT), n.push(new Laya.Vector3(.5, 0, .5)), h.push(new Laya.Vector3(0, 180, 0)), d.push(.5), f.push(1.3), g.push(s.MOVE_STATE.MOVE_RIGHT);
                            break;
                        case l.ObstacleType.Role7:
                            t = a.ROLE_STATE.CIRCLE, i = 1, y = this._passMgr.getAnimCircleName(), u.push(90), c = .8;
                            break;
                        case l.ObstacleType.Role8:
                            t = a.ROLE_STATE.RE_CIRCE, i = 1, y = this._passMgr.getAnimCircleName(), u.push(90), c = .8;
                            break;
                        case l.ObstacleType.Role9:
                            t = a.ROLE_STATE.CIRCLE, y = this._passMgr.getAnimCircleName(), i = 2, c = .8, u.push(90), u.push(270);
                            break;
                        case l.ObstacleType.Role10:
                            t = a.ROLE_STATE.RE_CIRCE, y = this._passMgr.getAnimCircleName(), i = 3, c = .8, u.push(0), u.push(120), u.push(240);
                            break;
                        case l.ObstacleType.Role11:
                            y = this._passMgr.getAnimCircleName(), t = a.ROLE_STATE.CIRCLE, i = 2, c = .8, u.push(0), u.push(45);
                            break;
                        case l.ObstacleType.Role12:
                            y = this._passMgr.getAnimCircleName(), t = a.ROLE_STATE.RE_CIRCE, i = 2, c = 1.2, u.push(180), u.push(210);
                            break;
                        case l.ObstacleType.Role13:
                            t = a.ROLE_STATE.MOVE_UP_TO_DOWN, i = 1, y = this._passMgr.getAnimDownToUpName(), n.push(new Laya.Vector3(0, 0, 5.8)), h.push(new Laya.Vector3(0, 180, 0)), p.push(-.8), m.push(.8), g.push(r.MOVE1_STATE.DOWN);
                    }
                    for (var _ = 0; i > _; _++) {
    ...
    42: [function(t, e, i) {
        ...
        var n = t("./GameMgr"),
            ...
            m = function(t) {
                ...
                return __extends(e, t), e.prototype.initSelf = function(t, e) {
                    this._obstacles = [], this._gameCtrl = n["default"].instance.getGameCtrl(), this._obj3D = this.owner, this._myTranform = this._obj3D.transform;
                    var i = this._obj3D.getChildByName("bg");
                    i.addChild(e), i.transform.localPosition = s["default"].Vector3ZeroValue(), e.active = !0, this._levelBg = e;
                    var o = e.getChildByName("dimian_0" + this._gameCtrl.getSceneId());
                    o.meshRenderer.receiveShadow = !0, this._goalEffect1 = this.owner.getChildByName("eff_jinqiu"), this._goalEffect2 = this.owner.getChildByName("eff_jiesuan"), this._goalEffect1.active = !1, this._goalEffect2.active = !1;
                    ...
                    this._animCircleName = c["default"].roleAnimCircle[h], console.log("_animCircleName:", this._animCircleName), this._goal = this._obj3D.getChildByName("qiumen").addComponent(a["default"]), this._goal.initSelf(), this._goal.setRotate(t.goalAngle), this.createObstacle(t.stageObs), this._goal.changeSkin(this._gameCtrl.getSceneId()), this.addEvent();
                    var u = this._gameCtrl.getObstacleRoleSkinId();
                    this.updataSkin(u);
                }, e.prototype.addEvent = function() {}, e.prototype.onDisable = function() {}, e.prototype.updataSkin = function(t) {
                    ...
                    this._goalEffect1.transform.position = t, this._goalEffect1.active = !1, this._goalEffect2.active = !1, this._goalEffect1.active = !0, this._goalEffect2.active = !0;
    ...
    43: [function(t, e, i) {
        ...
        var c = function(t) {
            ...
            return __extends(e, t), e.prototype.initSelf = function() {
                this._obj3D = this.owner, this._myTranform = this._obj3D.transform, this._ball = o["default"].instance.getGameCtrl().getBall(), this._playerAnimator = this.owner.getChildByName("animator").getComponent(Laya.Animator), this._skinNode = this.owner.getChildByName("animator").getChildByName("xiaokeai"), this._skinNode.skinnedMeshRenderer.castShadow = !1, this.addEvent(), this.reset();
            }, e.prototype.addEvent = function() {
                r["default"].instance.onEvent(l.GameEvent.UPDATA_PLAYER_SKIN, this, this.changeSkin);
            }, e.prototype.changeSkin = function() {
                console.log("修改玩家皮肤");
                var t = h["default"].peopleSkin; - 1 != o["default"].instance.getGameCtrl().getCurrGameData().tryRoleSkin && (t = o["default"].instance.getGameCtrl().getCurrGameData().tryRoleSkin);
                ...
                this._myTranform.localPosition = a["default"].playerPos.clone(), this._playerAnimator.play("DH_ready_1"), console.log("播放准备动画"), this._currState = null, this._nextState = n.READT, this._obj3D.active = !0, this.changeSkin();
            }, e.prototype.playShootAnim = function() {
                this._nextState = n.RUN;
            }, e.prototype.getObj3D = function() {
                return this._obj3D;
            }, e.prototype.animationStateMachine = function() {
                if (this._currState != this._nextState) switch (this._currState = this._nextState, this._currState) {
                    case n.READT:
                        console.log("播放准备动画"), this._playerAnimator.crossFade("DH_ready_1", .1), this._farm = 0;
                        break;
                    case n.RUN:
                        this._targetPos = new Laya.Vector3(this._ball.getPostion().x + .25, this._myTranform.position.y, this._ball.getPostion().z - .5), console.log("targetPos:", this._targetPos);
                        var t = s["default"].lookAtTargetPosQuaternion(this._myTranform, this._targetPos);
                        this._myTranform.localRotation = t, this._playerAnimator.crossFade("DH_run_1", .1), this._farm = 0;
                        break;
                    case n.SHOOT:
                ...
                switch (this._currState) {
                    ...
                    case n.RUN:
                        ...
                        break;
                    case n.SHOOT:
                        this._farm++, this._farm >= 14 && (this._nextState = n.IDLE, this._ball.shoot()), this._farm >= 24 && (this._nextState = n.IDLE);
                        break;
                    case n.IDLE:
                }
            }, e.prototype.myUpdata = function() {
        ...
        var n = t("./GameMgr"),
            ...
            l = function(t) {
                ...
                return __extends(e, t), e.prototype.init = function() {
                    ...
                    var o = -.2;
                    t.transform.localPosition = new Laya.Vector3(.08, o, 0), t.transform.localRotationEuler = new Laya.Vector3(0, 180, 0), e.transform.localPosition = new Laya.Vector3(-.37, o + .4, 0), e.transform.localRotationEuler = new Laya.Vector3(0, 0, 0), this.ballSkinNode = e.getChildByName("ballMesh"), this.ballSkinNode.transform.localScale = new Laya.Vector3(1, 1, 1), this.ballSkinNode.meshRenderer.castShadow = !0, this.playerSkinNode = t.getChildByName("animator").getChildByName("xiaokeai"), a["default"].instance.onEvent(s.GameEvent.SKIN_CHANG_BALL_SKIN, this, this.changeBallSkin), a["default"].instance.onEvent(s.GameEvent.SKIN_CHANG_PLAYER_SKIN, this, this.changePlayerSkin), a["default"].instance.onEvent(s.GameEvent.SKIN_SHOW_STORE, this, this.showStore), this.owner.active = !1, this.isShow = !1;
                }, e.prototype.showStore = function(t) {
                    this.owner.active = t, this.isShow = t, console.log("显示商店"), t && (this.changeBallSkin(o["default"].ballSkin), this.changePlayerSkin(o["default"].peopleSkin));
    ...
    46: [function(t, e, i) {
        ...
        var n = t("./LoginGame"),
            ...
            c = function() {
                function t() {}
                return t.init = function() {
                    a["default"].initLocal(), o["default"].getLocalUserData(), s["default"].initPlatform(), r["default"].instance.init(), l["default"].instance.init(), h["default"].instance.getAllAdsControl(), new n["default"]().login();
                }, t;
            }();
        i["default"] = c;
    }, {
        ...
        var n = t("../Datas/ConfigData"),
            ...
            o = function() {
                ...
                return t.prototype.request = function(t) {
                    ...
                    var r = function(e) {
                            e && (e = e.data, e = JSON.parse(e)), t.callback && t.callback(e), t.callback = null, t = null;
                        },
                        l = function(i) {
                ...
                }, t.prototype.requestStatistics = function(t) {}, t.prototype.getRemoteJson = function(t) {
                    var e = this,
                        i = new Laya.HttpRequest();
                    i.once(Laya.Event.COMPLETE, this, function(a) {
                        a && "string" != typeof a && "object" == typeof a && n["default"].jsonVersion != a.vision && (i = new Laya.HttpRequest(), i.once(Laya.Event.COMPLETE, e, function(e) {
                ...
                }, t.prototype.getConfig = function(t, e) {}, t;
            }();
        i["default"] = o;
    }, {
        "../Datas/ConfigData": 15,
    ...
    48: [function(t, e, i) {
        ...
        var s = function(t) {
            function e() {
                var e = t.call(this) || this;
                return e._cellWidth = 101, e._cellHeight = 128, e._spaceX = 20, e.speedTime = 500, e.itemWidth = 101, e;
            }
            return __extends(e, t), e.prototype.init = function(t) {
                this._cellWidth = t._cellWidth || 101, this._spaceX = t._spaceX || 20, this.speedTime = t.speedTime || 500, this._cellHeight = t._cellHeight || 128, this.viewType = t.viewType;
                ...
                if (t) {
                    ...
                    for (var s, r = function() {
                            ...
                            l.owner.addChild(n), o ? n.pos((h - 1) * (l._cellWidth + l._spaceX), l.posY) : n.pos(h * (l._cellWidth + l._spaceX), l.posY), n.skin = s.param, n.width = l._cellWidth, n.height = l._cellHeight;
                            var r = h;
                ...
                for (var t = -(this._cells[0].x - this.fristPosX), e = (Math.abs(this.speedTime / (this._cellWidth + this._spaceX) * t), 0); e < this._cells.length; e++) {
                    var i = this._cells[e];
            ...
            s = function(t) {
                ...
                return __extends(e, t), e.prototype.onAwake = function() {
                    ...
                    this.addMinProgram && (this._speed = -1, Laya.timer.frameLoop(1, this, function() {
                        t.addMinProgram.x += t._speed, t.addMinProgram.x <= t._minX ? (t._speed = 1, t.addMinProgram.x = t._minX) : t.addMinProgram.x >= t._maxX && (t._speed = -1, t.addMinProgram.x = t._maxX);
                    }));
                }, e.prototype.removeEvent = function() {
                    this._isClick = null, this.addMinProgram && Laya.timer.clearAll(this.addMinProgram), Laya.timer.clearAll(this);
                }, e.prototype.closeView = function(t) {
                    if (this.owner) {
                        var e = this.owner.url;
                        t && t.notDestroy ? o["default"].instance.hideView(e) : o["default"].instance.closeView(e), "Rank.scene" == e && a["default"].callAPIMethodByProxy("setAuthorizationCheck", !0), this._data && this._data.callback && this._data.callback(t), this._data = null;
                    }
                }, e;
            }(Laya.Script);
        i["default"] = s;
    ...
    51: [function(t, e, i) {
        ...
        ! function(t) {
            t[t.PROPES = 0] = "PROPES", t[t.RESTRGENCE = 1] = "RESTRGENCE", t[t.SETTL_COIN = 2] = "SETTL_COIN", t[t.GAMEOVER = 3] = "GAMEOVER", t[t.ONLINE_COIN = 4] = "ONLINE_COIN", t[t.OFFLINE_COIN = 5] = "OFFLINE_COIN", t[t.HOME = 6] = "HOME", t[t.FIGHTING = 7] = "FIGHTING", t[t.CONVERGE = 8] = "CONVERGE", t[t.NONE = 9] = "NONE";
        ...
        var u = function(t) {
            ...
            return __extends(e, t), e.prototype.onAwake = function() {
                t.prototype.onAwake.call(this), o["default"].autoScreenSize([this.homeBtn]), this.adList = this.owner.getChildByName("list"), this.adList.vScrollBarSkin = "", this.adList.selectEnable = !0, this.adList.y = 20, this.adList.renderHandler = new Laya.Handler(this, this.onRender), this.adList.mouseHandler = new Laya.Handler(this, this.onClickItem), Laya.stage.height > 1334 && (this.adList.y = 20 + (Laya.stage.height - 1334) / 2), this.okBtn.y += this.offset.y / 2, h["default"].callAPIMethodByProxy("destoryAllBannerAd");
            }, e.prototype.addEvent = function() {
                t.prototype.addEvent.call(this), this.okBtn.on(Laya.Event.CLICK, this, this.okClick), this.homeBtn.on(Laya.Event.CLICK, this, this.onClickHome);
            }, e.prototype.removeEvent = function() {
                t.prototype.removeEvent.call(this), this.okBtn.off(Laya.Event.CLICK, this, this.okClick), this.homeBtn.off(Laya.Event.CLICK, this, this.onClickHome);
            }, e.prototype.openView = function(e) {
                var i = this;
                t.prototype.openView.call(this, e), console.log("data:", e), this.mainViewJumpToOtherGame = e.mainViewJumpToOtherGame, this.lastViewType = e.viewType;
                var a = this.lastViewType == n.GAMEOVER || this.lastViewType == n.HOME;
                this.okBtn.visible = a, this.homeBtn.visible = !1;
                var o = [];
                null == this.adList.array && (o = s["default"].getAdData(1004), this.adList.array = o), this.adList.refresh(), this.adList.scrollTo(0), Laya.timer.once(1e3, this, function() {
            ...
            }, e.prototype.onClickItem = function(t, e) {}, e.prototype.onRender = function(t, e) {
        ...
        var n = t("./BaseView"),
            ...
            m = function(t) {
                ...
                return __extends(e, t), e.prototype.onAwake = function() {
                    ...
                    this.mouseTouch = this.owner.getChildByName("mouseTouch"), this.progressNode = this.owner.getChildByName("progress"), this.passNodeParent = this.progressNode.getChildByName("passNodeParent"), this.nextLevelImg = this.progressNode.getChildByName("imgNextLevel"), this.currLevelImg = this.progressNode.getChildByName("imgCurrLevel"), this.nextLevelLab = this.nextLevelImg.getChildByName("nextLevelLab"), this.currLevelLab = this.currLevelImg.getChildByName("currLevelLab"), this.surpassOtherText = this.owner.getChildByName("surpassOtherText"), this.ballParent = this.owner.getChildByName("ballNum"), this.ballNum = this.ballParent.getChildByName("num"), this.jumpBtn = this.owner.getChildByName("jumpBtn");
                    var i = this.touchBeginnerGuide.getChildByName("hand");
                    this.adImageLeft = this.owner.getChildByName("AD1"), this.adImageRight = this.owner.getChildByName("AD2"), this.invincibleBtn = this.owner.getChildByName("invincibleBtn"), this.yad = this.owner.getChildByName("yad"), this.yad.visible = false, this.yad.on(Laya.Event.MOUSE_DOWN, this, () => {
                        platform.getInstance().navigate("GAME", "LOGO");
                    })
                    this.haveInvincible = this.invincibleBtn.getChildByName("have"), this.noHaveInvincible = this.invincibleBtn.getChildByName("noHave"), this.nextLevelImg.visible = !1, this.currLevelImg.visible = !1, this.ballParent.visible = !1, this.surpassOtherText.visible = !1, this.progressNode.visible = !1, this.touchBeginnerGuide.visible = !0, this.progressNode.y += this.offset.y / 4, e.y += this.offset.y / 4, i.y += this.offset.y / 3, this.adImageLeft.y += this.offset.y / 3 * 2, this.adImageRight.y += this.offset.y / 3 * 2, this.invincibleBtn.y += this.offset.y / 2, this.jumpBtn.y += this.offset.y / 2, this.ballParent.y += this.offset.y / 2;
                }, e.prototype.showUI = function(t) {
                    this.currLevelImg.visible = t, this.nextLevelImg.visible = t, this.invincibleBtn.visible = t, t || (this.jumpBtn.visible = t, this.closeSurpassOther());
                }, e.prototype.FigerAnim = function() {
                    this.finger.x = 90 + 500 * Math.abs((Laya.timer.currTimer - this.fingerStartTime + 500) % 2e3 - 1e3) / 1e3;
                }, e.prototype.openView = function(e) {
                    t.prototype.openView.call(this, e), console.log("打开GameFight"), this.progressNode.visible = !0, r["default"].level <= 1 ? this.touchBeginnerGuide.visible = !0 : this.mouseTouchFun();
                }, e.prototype.mouseTouchFun = function() {
                    var t = this;
                    this.touchBeginnerGuide.visible = !1, this.mouseTouch.visible = !1, l["default"].instance.emit(a.GameEvent.Game_START), Laya.timer.frameOnce(1, this, function() {
                    ...
                    t.prototype.addEvent.call(this), this.mouseTouch.on(Laya.Event.CLICK, this, this.mouseTouchFun), this.jumpBtn.on(Laya.Event.CLICK, this, this.goJumpNextPass), this.invincibleBtn.on(Laya.Event.CLICK, this, this.invincibleClick), l["default"].instance.onEvent(a.GameEvent.UI_UPDATA_BALL_NUM, this, this.updataBallNum), l["default"].instance.onEvent(a.GameEvent.UI_NEXT_PASS, this, this.nextLevel), l["default"].instance.onEvent(a.GameEvent.UI_UPDATA_MIN_PASS, this, this.updataPass), l["default"].instance.onEvent(a.GameEvent.UI_SHOW_FIGHT, this, this.showUI), l["default"].instance.onEvent(a.GameEvent.UI_UPDATA_JUMPBTN, this, this.updataJumpBtn), l["default"].instance.onEvent(a.GameEvent.UI_UPDATA_INVINCIBTN, this, this.updataInvinciBtn), l["default"].instance.onEvent(a.GameEvent.UI_SHOW_PROVOCATION, this, this.openProvocationOther);
                    ...
                    if (this.haveInvincible.visible) {
                        ...
                        platform.getInstance().showReward(() => {
                            l["default"].instance.emit(a.GameEvent.ADD_INVINCIBLE), l["default"].instance.emit(a.GameEvent.USE_INVINCIBTN), t.invincibleBtn.visible = !1;
                        }, () => {
                            l["default"].instance.emit("openTip", "No ads temporarily.");
                        })
                    }
                }, e.prototype.removeEvent = function() {
                    t.prototype.removeEvent.call(this), this.mouseTouch.off(Laya.Event.CLICK, this, this.mouseTouchFun), this.jumpBtn.off(Laya.Event.CLICK, this, this.goJumpNextPass), this.invincibleBtn.off(Laya.Event.CLICK, this, this.invincibleClick), l["default"].instance.onOffEvent(a.GameEvent.UI_UPDATA_BALL_NUM, this, this.updataBallNum), l["default"].instance.onOffEvent(a.GameEvent.UI_NEXT_PASS, this, this.updataPass), l["default"].instance.onOffEvent(a.GameEvent.UI_UPDATA_MIN_PASS, this, this.updataPass), l["default"].instance.onOffEvent(a.GameEvent.UI_SHOW_FIGHT, this, this.showUI), l["default"].instance.onOffEvent(a.GameEvent.UI_UPDATA_JUMPBTN, this, this.updataJumpBtn), l["default"].instance.onOffEvent(a.GameEvent.UI_UPDATA_INVINCIBTN, this, this.updataInvinciBtn), l["default"].instance.onOffEvent(a.GameEvent.UI_SHOW_PROVOCATION, this, this.openProvocationOther);
                    ...
                    for (var t = s["default"].instance.getGameCtrl().getCurrGameData().pass, e = 0; e < this.passNodeParent._children.length; e++) {
                        var i = this.passNodeParent._children[e],
                            n = "";
                        n = t - 1 > e ? "game/1@2x.png" : e == t - 1 ? "game/2@2x.png" : "game/3@2x.png", i.skin = n;
                    }
                }, e.prototype.updataBallNum = function(t) {
                    return console.log("ballNum:", t), 1 > t ? void(this.ballParent.visible = !1) : (this.ballNum.skin = "SkinTrial/shenyu" + t + "@2x.png", void(this.ballParent.visible = !0));
                }, e.prototype.nextLevel = function(t) {
                    console.log("num:", t);
                    var e = r["default"].level;
                    this.currLevelLab.value = e.toString(), this.nextLevelLab.value = (e + 1).toString(), this.currLevelImg.visible = !0, this.nextLevelImg.visible = !0;
                    var i = 0;
                    i = 1 == t ? 0 : t % 2 == 0 ? -22.5 - 45 * (t / 2 - 1) : -45 - 45 * (Math.floor(t / 2) - 1), this.currLevelImg.x = i - 55, this.nextLevelImg.x = -this.currLevelImg.x;
                    for (var n = 0; t > n; n++) {
                        var a = "game/3@2x.png";
                        0 == n && (a = "game/2@2x.png");
                    ...
                    Laya.timer.clear(this, this.closeProvocationOther), this.closeSurpassOther(), this.provocationOther || (this.provocationOther = new Laya.WXOpenDataViewer(), this.owner.addChild(this.provocationOther), this.provocationOther.width = 750, this.provocationOther.height = 62, this.provocationOther.pos(0, 252)), h["default"].callSubDomainMethodByProxy("setOpenView", this.provocationOther), h["default"].callSubDomainMethodByProxy("openProvocationOther", {
                        _type: t
                    }), Laya.timer.once(2500, this, this.closeProvocationOther);
                }, e.prototype.closeProvocationOther = function() {
                    this.provocationOther && (this.provocationOther.destroy(), this.provocationOther = null), h["default"].callSubDomainMethodByProxy("closeProvocationOther");
                }, e.prototype.openSurpassOther = function() {
                    var t = this,
                        e = o.SORTTYPE.ENDLESS;
                    this.closeProvocationOther(), this.surpassOther || (this.surpassOther = new Laya.WXOpenDataViewer(), this.owner.addChild(this.surpassOther), this.surpassOther.width = 60, this.surpassOther.height = 100, this.surpassOther.pos(570, 304), this.surpassOther.y += this.offset.y / 2), this.surpassOtherText.visible = !1, h["default"].callSubDomainMethodByProxy("setOpenView", this.surpassOther), h["default"].callSubDomainMethodByProxy("openSurpassOther", {
                        _type: e,
                        val: r["default"].level
                    ...
                    this.surpassOtherText.visible = !1, this.surpassOther && (this.surpassOther.destroy(), this.surpassOther = null), h["default"].callSubDomainMethodByProxy("closeSurpassOther");
                }, e.prototype.onDisable = function() {
                    t.prototype.onDisable.call(this), Laya.timer.clearAll(this.provocationOther), this.closeProvocationOther(), this.closeSurpassOther();
                }, e;
            }(n["default"]);
        i["default"] = m;
    }, {
        ...
        var n = t("./BaseView"),
            ...
            g = function(t) {
                ...
                return __extends(e, t), e.prototype.onAwake = function() {
                    ...
                    this.btnAnchor = i, this.btnNext = i.getChildByName("btnNext"), this.btnHome = i.getChildByName("btnHome"), this.btnAgain = i.getChildByName("btnAgain");
                    var n = e.getChildByName("levelPanel");
                    this.passNum = n.getChildByName("passNum"), this.imgFail = n.getChildByName("imgFail"), this.imgPass = n.getChildByName("imgPass"), this.levePanel = n, this.imgFail.visible = !1, this.imgPass.visible = !1;
                    ...
                    this.coinNum = c.getChildByName("coinNum"), this.coinUnit = c.getChildByName("coinUnit"), o["default"].autoScreenSize([c]), c.y += 10;
                }, e.prototype.goFighting = function() {
                    platform.getInstance().showInterstitial(() => {
                        h["default"].instance.emit(r.GameEvent.Game_INIT), h["default"].instance.emit("openGetPropes"), this.closeView();
                    })
                        ...
                        e = {
                            ...
                            callback: function(e) {
                                e.success ? u["default"].instance.shareCallback({
                                    success: function(e) {
                                        if (l["default"].shareCount = e.shareCount, l["default"].money = e.userMoney, 0 == s["default"].ctrlInfo.inviteFriendsControl || l["default"].shareCount >= 8) t.inviteLabel.text = "一起玩", t.inviteCoinImg.visible = !1, t.inviteLabel.x = 23;
                                        else {
                    ...
                    this.btnNext.on(Laya.Event.CLICK, this, this.nextLevelFunc), this.btnHome.on(Laya.Event.CLICK, this, this.goHome), this.btnAgain.on(Laya.Event.CLICK, this, this.goFighting), h["default"].instance.onEvent("UpdataMoney", this, this.updateCoinNum), h["default"].instance.onEvent(m.AdEvent.event_showBannerAd_jiesuanjiemian_erro_106, this, this.showADPanel), h["default"].instance.onEvent(r.GameEvent.ADBACK, this, this.showAd), t.prototype.addEvent.call(this);
                    ...
                    this.btnNext.off(Laya.Event.CLICK, this, this.nextLevelFunc), this.btnHome.off(Laya.Event.CLICK, this, this.goHome), this.btnAgain.off(Laya.Event.CLICK, this, this.goFighting), h["default"].instance.onOffEvent(r.GameEvent.ADBACK, this, this.showAd), h["default"].instance.onOffEvent("UpdataMoney", this, this.updateCoinNum), h["default"].instance.onOffEvent(m.AdEvent.event_showBannerAd_jiesuanjiemian_erro_106, this, this.showADPanel), t.prototype.removeEvent.call(this);
                    ...
                    var i = this;
                    if (t.prototype.openView.call(this, e), console.log("跳转到结算:", e), e = e || {
                            isPass: !1
                        }, 0 == s["default"].ctrlInfo.inviteFriendsControl || l["default"].shareCount >= 8) this.inviteLabel.text = "一起玩", this.inviteCoinImg.visible = !1, this.inviteLabel.x = 23;
                    else {
                        var n = s["default"].ctrlInfo.inviteFriendsGolds || 0;
                    }
                    var a = e.addMoney;
                    if (a && 0 != a && h["default"].instance.emit("openTip", "Coin x" + a), l["default"].isDouble = !1, l["default"].multipy = 1, 0 == s["default"].ctrlInfo.inviteFriendsControl || l["default"].shareCount >= 8) this.inviteLabel.text = "一起玩";
                    else {
                        var n = s["default"].ctrlInfo.inviteFriendsGolds || 0;
                    }
                    c["default"].callAPIMethodByProxy("showInterstitialAD"), this.scorePanel.visible = !1, this.levePanel.visible = !0, this.imgFail.visible = !e.isPass, this.imgPass.visible = e.isPass, this.btnNext.visible = e.isPass, this.btnAgain.visible = !e.isPass, this.passNum.value = l["default"].level.toString();
                    var r = l["default"].level.toString().length - 1;
                    if (this.passNum.x = 10 + 14 * r, e.isPass && (l["default"].level += 1, platform.getInstance().setStorageSync("level", l["default"].level)), c["default"].callAPIMethodByProxy("uploadRankDate", {
                            level: l["default"].level
                        }), c["default"].callSubDomainMethodByProxy("upSelfScore", l["default"].level), s["default"].ctrlInfo.isWudian && 1 == s["default"].wudianLevel[3]) {
                ...
                }, e.prototype.onClickItem = function(t, e) {}, e.prototype.showADPanel = function() {
                    var t = this;
        ...
        var n = t("./BaseView"),
            ...
            y = function(t) {
                ...
                return __extends(e, t), e.prototype.onAwake = function() {
                    ...
                    this.box3 = e.getChildByName("box3"), this.unClick1 = i.getChildByName("unClick"), this.unClick2 = n.getChildByName("unClick"), this.unClick3 = this.box3.getChildByName("unClick"), this.invincibleBtn = i.getChildByName("btnBuy"), this.addBallNumBtn = n.getChildByName("btnBuy"), this.buySkinBtn = this.box3.getChildByName("btnBuy"), this.buyAllBtn = e.getChildByName("btnAll"), this.skipBtn = e.getChildByName("btnJump"), this.ballIco = this.box3.getChildByName("ico"), this.disTrySkin = this.box3.getChildByName("dis"), this.ballNumLbl = n.getChildByName("dis"), this.ballNumPricelbl = n.getChildByName("price");
                    ...
                    this.adPlane = this.owner.getChildByName("ADPlane").getComponent(c["default"]), s.visible = !1, this.trySkinPriceLbl = this.box3.getChildByName("price"), this.updateCoinNum(), e.y += this.offset.y / 3, o["default"].autoScreenSize([a]), a.y += 10;
                }, e.prototype.updateCoinNum = function() {
                    console.log("new:" + a["default"].money);
                    ...
                    this.invincibleBtn.on(Laya.Event.CLICK, this, this.invincibleClick), this.addBallNumBtn.on(Laya.Event.CLICK, this, this.addBallNumClick), this.buySkinBtn.on(Laya.Event.CLICK, this, this.buySkinClick), this.buyAllBtn.on(Laya.Event.CLICK, this, this.buyAllClick), this.skipBtn.on(Laya.Event.CLICK, this, this.closeView), s["default"].instance.onEvent("UpdataMoney", this, this.updateCoinNum), s["default"].instance.onEvent(f.AdEvent.event_showBannerAd_shiyongpifu_erro_103, this, this.showADPanel), s["default"].instance.onEvent(r.GameEvent.ADBACK, this, this.showAd);
                }, e.prototype.removeEvent = function() {
                    this.invincibleBtn.off(Laya.Event.CLICK, this, this.invincibleClick), this.addBallNumBtn.off(Laya.Event.CLICK, this, this.addBallNumClick), this.buySkinBtn.off(Laya.Event.CLICK, this, this.buySkinClick), this.buyAllBtn.off(Laya.Event.CLICK, this, this.buyAllClick), this.skipBtn.off(Laya.Event.CLICK, this, this.closeView), s["default"].instance.onOffEvent("UpdataMoney", this, this.updateCoinNum), s["default"].instance.onOffEvent(f.AdEvent.event_showBannerAd_shiyongpifu_erro_103, this, this.showADPanel), s["default"].instance.onOffEvent(r.GameEvent.ADBACK, this, this.showAd);
                }, e.prototype.showAd = function() {
                    this.owner.visible && (f["default"].Instance.showBannerAd_zhujiemianlingqujinbi(0) ? this.hideADPanel() : this.showADPanel());
                }, e.prototype.showADPanel = function() {}, e.prototype.hideADPanel = function() {
                    ...
                    if (this.ballNumLbl.text = "Amount of ball +" + this.ballNum, this.ballNumPricelbl.text = this.ballNumPrice.toString(), this.trySkinPriceLbl.text = this.trySkinPrice.toString(), this.unClick1.visible = !1, this.unClick2.visible = !1, this.unClick3.visible = !1, this.invincibleBtn.visible = !0, this.addBallNumBtn.visible = !0, this.buySkinBtn.visible = !0, Laya.Tween.clearTween(this.buyAllBtn), this.tweenAniDown(this.buyAllBtn, {
                            scaleX: 1.05,
                            scaleY: 1.05
                        }, {
                            scaleX: .95,
                        ...
                        var l = 0,
                            ...
                            u = 595,
                            d = u;
                        h["default"].random_location && (c = o["default"].random(l - 30, l + 30), d = o["default"].random(u, u + 30)), this.skipBtn.pos(c, d);
                        var f = 1900;
                    ...
                    this.currTrySkinType = 2, this.ballIco.skin = a, this.ballIco.scaleX = .7, this.ballIco.scaleY = .7, this.disTrySkin.text = "try:" + n;
                    ...
                    this.ballIco.skin = r, this.ballIco.scaleX = .56, this.ballIco.scaleY = .56, this.currTrySkinType = 1, this.disTrySkin.text = "Try：" + n;
                    ...
                    var t = this;
                    console.log("m:" + (a["default"].money - this.ballNumPrice));
                    a["default"].setMoney(a["default"].money - this.ballNumPrice);
                    t.addBallNumBtn.visible = !1, t.unClick2.visible = !0, t.addBallNum(), t.updateCoinNum();
                    ...
                    t.trySkin(), t.updateCoinNum();
                }, e.prototype.buyAllClick = function() {
                    var t = this;
                    platform.getInstance().showReward(() => {
                        s["default"].instance.emit(r.GameEvent.ADD_INVINCIBLE), t.invincibleBtn.visible = !1, t.unClick1.visible = !0, t.addBallNum(), t.trySkin(), t.closeView();
                    }, () => {
                        s["default"].instance.emit("openTip", "No ads temporarily."), t._isClick = null;
                    });
                }, e.prototype.getInvincibleBall = function() {
                    var t = this;
                    platform.getInstance().showReward(() => {
                        s["default"].instance.emit(r.GameEvent.ADD_INVINCIBLE), t.invincibleBtn.visible = !1, t.unClick1.visible = !0
                    }, () => {
                        s["default"].instance.emit("openTip", "No ads temporarily."), t._isClick = null;
                    });
        ...
        var n = t("./BaseView"),
            ...
            o = function(t) {
                ...
                return __extends(e, t), e.prototype.onAwake = function() {
                    ...
                    var e = this.owner.getChildByName("anchor");
                    e.y = e.y + this.offset.y, this.okBtn = e.getChildByName("btnClick"), this.closeBtn = this.owner.getChildByName("closeBtn"), this.bar = this.owner.getChildByName("bar"), this.hammerAnim = this.owner.hammerAnim;
                }, e.prototype.addEvent = function() {
                    this.okBtn.on(Laya.Event.CLICK, this, this.btnClick), this.closeBtn.on(Laya.Event.CLICK, this, this.closeView), t.prototype.addEvent.call(this);
                }, e.prototype.removeEvent = function() {
                    this.okBtn.off(Laya.Event.CLICK, this, this.btnClick), this.closeBtn.off(Laya.Event.CLICK, this, this.closeView), t.prototype.removeEvent.call(this);
                }, e.prototype.openView = function(e) {
                    t.prototype.openView.call(this, e), a["default"].callAPIMethodByProxy("loadBannerAdHome");
                }, e.prototype.btnClick = function() {
                    return this.clickCount++, this.clickCount > 14 ? void this.close() : (this.progressNum += .1, this.progressNum >= 1 ? void this.close() : (this.hammerAnim.play(0, !1), void this.updataProgress()));
                }, e.prototype.updataProgress = function() {
                    this.progressNum >= 1 ? this.progressNum = 1 : this.progressNum <= .07 && (this.progressNum = .07), this.bar.height = 375 * this.progressNum;
    ...
    56: [function(t, e, i) {
        ...
        var n = t("./BaseView"),
            ...
            v = function(t) {
                function e() {
                    var e = t.call(this) || this;
                    return e.isLoadAD = !1, e.goShareAdc = !1, e.inviteHintY = -39, e.goalHintY = -52, e.drawPie = [], e.maskTargetRot = -90, e.DIX = 0, e.DIXMAX = 6, e;
                }
                return __extends(e, t), e.prototype.onAwake = function() {
                    t.prototype.onAwake.call(this), this.btnsetting = this.owner.getChildByName("btnSet"), this.settingS = this.owner.getChildByName("settingS"), this.settingPop = this.settingS.getChildByName("list"), this.btnSound = this.settingPop.getChildByName("btnSound"), this.soundOpen = this.btnSound.getChildByName("open"), this.soundClose = this.btnSound.getChildByName("close"), this.aladingBtn = this.owner.getChildByName("aladingBtn");
                    var e = this.owner.getChildByName("coinBg");
                    this.coinNum = e.getChildByName("coinNum"), this.coinUnit = e.getChildByName("coinUnit"), this.adPlane = this.owner.getChildByName("ADPlane").getComponent(a["default"]), this.soundClose.visible = !s["default"].isSound, this.soundOpen.visible = s["default"].isSound, this.doubleCoin = this.owner.getChildByName("btnDoubleStart"), this.img_startHit = this.doubleCoin.getChildByName("hit"), this.btnSkin = this.owner.getChildByName("btnSkin"), this.adImageLeft = this.owner.getChildByName("AD1"), this.adImageRight = this.owner.getChildByName("AD2"), this.title = this.owner.getChildByName("title"), this.btnStart = this.owner.getChildByName("btnStart");
                    var i = this.owner.getChildByName("startImg");
                    this.btnSkin.y += this.offset.y / 3 * 2, i.y += this.offset.y / 3 * 2, this.doubleCoin.y += this.offset.y / 3 * 2, this.adImageLeft.y += this.offset.y / 3 * 2, this.adImageRight.y += this.offset.y / 3 * 2, this.title.y += this.offset.y / 4, this.btnsetting.y += this.offset.y / 4, this.settingS.pos(this.btnsetting.x, this.btnsetting.y), this.InitSetting(), this.offlineGoldInit(), o["default"].autoScreenSize([e]), e.y += 10, this.isLoadAD = !1, this.goShareAdc = !1, this.updateCoinNum(), Laya.Tween.clearTween(this.doubleCoin), this.tweenAniDown(this.doubleCoin, {
                        scaleX: 1.05,
                        scaleY: 1.05
                    }, {
                        scaleX: .95,
                    ...
                    this.yad.visible = false, this.yad.on(Laya.Event.MOUSE_DOWN, this, () => {
                    ...
                    this.offlineGoldLoop(), Laya.timer.clear(this, this.offlineGoldLoop), Laya.timer.loop(1e3 * s["default"].ctrlInfo.onlineItemSecond, this, this.offlineGoldLoop), Laya.timer.clear(this, this.goldImgMaskUpdate), Laya.timer.frameLoop(5, this, this.goldImgMaskUpdate);
                }, e.prototype.onDisable = function() {
                    ...
                    return e > 0 ? (this.maskTargetRot = -90, Laya.Tween.to(this, {
                        maskTargetRot: 270
                    }, 1e3 * s["default"].ctrlInfo.onlineItemSecond - 100), i = Math.floor((c["default"].offlineTimeSpent + (t - s["default"].ctrlInfo.startOfflineTime) / 1e3) / s["default"].ctrlInfo.onlineItemSecond) * s["default"].ctrlInfo.onlineItemGold) : i = Math.floor(60 * s["default"].ctrlInfo.onlineTimes / s["default"].ctrlInfo.onlineItemSecond) * s["default"].ctrlInfo.onlineItemGold, i;
                    ...
                    var i = this;
                    if (t.prototype.openView.call(this, e), console.log("重新打开主页0"), 0 == s["default"].ctrlInfo.inviteFriendsControl || c["default"].shareCount >= 8) this.inviteLabel.text = "一起玩", this.inviteCoinImg.visible = !1, this.inviteLabel.x = 23;
                    else {}
                    console.log("重新打开主页1"), this.showAd(), Laya.timer.frameOnce(1, this, function() {
                        ...
                        if (c["default"].isFristOpenHome) {
                            if (c["default"].isFristOpenHome = !1, !c["default"].isNew) {
                                ...
                                if (console.log("离线奖励:", e), e > 0) return r["default"].callAPIMethodByProxy("destoryAllBannerAd"), h["default"].instance.emit("openSettleCoin", {
                                    isFree: !0,
                                    freeCoin: e,
                                    isAutoOpen: !0
                                }), void(t = !1);
                    ...
                    this.owner.getChildByName("ADPlane").visible = !1;
                }, e.prototype.showADPanel = function() {}, e.prototype.addEvent = function() {
                    console.log("addEvent"), t.prototype.addEvent.call(this), this.btnSound.on(Laya.Event.CLICK, this, this.soundBtnClick), this.btnStart.on(Laya.Event.CLICK, this, this.btnStartFunc), this.btnSkin.on(Laya.Event.CLICK, this, this.btnSkinFunc), this.doubleCoin.on(Laya.Event.CLICK, this, this.btnDoubleStartFunc), this.btnsetting.on(Laya.Event.CLICK, this, this.onClickSetting), this.aladingBtn.on(Laya.Event.CLICK, this, this.testTiaozhuang), h["default"].instance.onEvent(p.AdEvent.event_showBannerAd_zhujiemian_erro_101, this, this.showADPanel), h["default"].instance.onEvent(_.GameEvent.ADBACK, this, this.showAd), h["default"].instance.onEvent("UpdataMoney", this, this.updateCoinNum);
                }, e.prototype.showAd = function() {
                    this.owner.visible && (p["default"].Instance.showBannerAd_zhujiemian() ? (this.hideADPanel(), console.log("重新打开主页3")) : (this.showADPanel(), console.log("重新打开主页2")));
                }, e.prototype.updateCoinNum = function() {
                    ...
                    var t = this;
                    this._isClick || (r["default"].callAPIMethodByProxy("destoryAuthorization"), this._isClick = !0, Laya.timer.once(500, this, function() {
                        t._isClick = null;
                    }), this.isLoadAD = !0, this.goShareAdc = !0, platform.getInstance().showReward(() => {
                        t.isLoadAD = !1, t.goShareAdc = !1, c["default"].adCount += 1, c["default"].multipy = 2, t.btnStartFunc(), h["default"].instance.emit("openTip", "BENIFIT x 2"), h["default"].instance.emit("openSkinTrial"), h["default"].instance.emit("gameStart");
                    }, () => {
                        h["default"].instance.emit("openTip", "No ads temporarily."), t.isLoadAD = !1, t.goShareAdc = !1, t._isClick = null;
                    }));
                    ...
                    s["default"].isVirbort = !s["default"].isVirbort, this.virbortClose.visible = !s["default"].isVirbort, this.virbortOpen.visible = s["default"].isVirbort, s["default"].setVirbort(s["default"].isVirbort ? "" : "1");
                }, e.prototype.soundBtnClick = function() {
                    s["default"].isSound = !s["default"].isSound, this.soundClose.visible = !s["default"].isSound, this.soundOpen.visible = s["default"].isSound, s["default"].isSound ? (s["default"].setSound(""), l["default"].instance.playBGM()) : (s["default"].setSound("1"), l["default"].instance.stopBGM());
                        ...
                        var e = {
                            ...
                            callback: function(e) {
                                e.success ? d["default"].instance.shareCallback({
                                    success: function(e) {
                                        if (c["default"].shareCount = e.shareCount, c["default"].money = e.userMoney, 0 == s["default"].ctrlInfo.inviteFriendsControl || c["default"].shareCount >= 8) t.inviteLabel.text = "一起玩", t.inviteCoinImg.visible = !1, t.inviteLabel.x = 23;
                                        else {
                                            var i = s["default"].ctrlInfo.inviteFriendsGolds || 0;
                    ...
                    var t = this;
                    platform.getInstance().showInterstitial(() => {
                        this._isClick || (r["default"].callAPIMethodByProxy("destoryAuthorization"), r["default"].callAPIMethodByProxy("destoryAllBannerAd"), this._isClick = !0, Laya.timer.once(500, this, function() {
                            t._isClick = null;
                        }), h["default"].instance.emit("gameStart"), h["default"].instance.emit("openGetPropes"));
                    });
                }, e.prototype.serverFunc = function() {
                    Laya.Browser.onMiniGame && window.wx.openCustomerServiceConversation();
                }, e.prototype.removeEvent = function() {
                    console.log("removeEvent"), this.btnSound.off(Laya.Event.CLICK, this, this.soundBtnClick), this.btnSkin.off(Laya.Event.CLICK, this, this.btnSkinFunc), this.btnStart.off(Laya.Event.CLICK, this, this.btnStartFunc), this.btnsetting.off(Laya.Event.CLICK, this, this.onClickSetting), this.doubleCoin.off(Laya.Event.CLICK, this, this.btnDoubleStartFunc), this.aladingBtn.off(Laya.Event.CLICK, this, this.testTiaozhuang), h["default"].instance.onOffEvent(p.AdEvent.event_showBannerAd_zhujiemian_erro_101, this, this.showADPanel), h["default"].instance.onOffEvent(_.GameEvent.ADBACK, this, this.showAd), h["default"].instance.onOffEvent("UpdataMoney", this, this.updateCoinNum), r["default"].callAPIMethodByProxy("destoryAllBannerAd"), t.prototype.removeEvent.call(this);
    ...
    57: [function(t, e, i) {
        ...
        var s = function(t) {
            function e() {
                var e = t.call(this) || this;
                return e.moveSpeed = .5, e._itemHeight = 134, e._itemWidth = 184, e._spaceX = 14, e._spaceY = 14, e._repeatX = 3, e._repeatY = 3, e.speedTime = 500, e.viewHeight = 503, e;
            }
            return __extends(e, t), e.prototype.start = function(t, e, i) {
                if (t) {
                    this.viewType = i, this.owner.removeChildren(), this._cells = [], this.adInfos = t;
                    for (var a = 0, o = new r(), s = this, l = function() {
                            var t = s.adInfos[c],
                                i = new Laya.Image();
                            h.owner.addChild(i);
                            var n = h._cells.length * (h._itemHeight + h._spaceY);
                            i.pos(a * (h._itemWidth + h._spaceX), n), i.skin = t.thumb, i.width = h._itemWidth, i.height = h._itemHeight, i.offAll(Laya.Event.MOUSE_DOWN);
                            i.on(Laya.Event.MOUSE_DOWN, h, function() {
                                s.startTime = Laya.timer.currTimer;
                                platform.getInstance().navigate("GAME", "MORE", t.id);
                            }), i.name = c.toString(), i.on(Laya.Event.MOUSE_UP, h, function() {
                                var t = Number(i.name),
                                    n = s.adInfos[t];
                ...
                for (var t = -(this._cells[0].getPosY() - this.fristPosY), e = (Math.abs(this.speedTime / (this._itemHeight + this._spaceY) * t), 0); e < this._cells.length; e++) {
                    var i = this._cells[e];
                    i.setPosY(i.getPosY() + this.moveSpeed);
                }
                this.moveDirection == n.DOWN && this._cells[0].getPosY() > this.fristPosY && this.setDirtion(n.UP), this.moveDirection == n.UP && this._cells[this._cells.length - 1].getPosY() < this.endPosY && this.setDirtion(n.DOWN);
                ...
                if (this._mouseDown) {
                    ...
                    t = t > 30 ? 30 : -30 > t ? -30 : t, this._mouseY = Laya.MouseManager.instance.mouseY, t > 0 && this._cells[0].getPosY() + t > this.fristPosY && (t = this.fristPosY - this._cells[0].getPosY()), 0 > t && this._cells[this._cells.length - 1].getPosY() + t < this.endPosY && (t = this.endPosY - this._cells[this._cells.length - 1].getPosY());
                    for (var e = 0; e < this._cells.length; e++) {
                        var i = this._cells[e];
    ...
    58: [function(t, e, i) {
        ...
        var n = t("../Datas/ConfigData"),
            ...
            s = function(t) {
                function e() {
                    var e = t.call(this) || this;
                    return e.isClick = !1, e.toLinks = "", e.toAppId = "", e.thePosition = 1, e.nowidx = 0, e.maxdix = 0, e.isAnim = !0, e.isChange = !1, e;
                }
                return __extends(e, t), e.prototype.onAwake = function() {
                    ...
                    return !a || a.length <= 0 ? void(this.owner.visible = !1) : (this.owner.rotation = 0, this.owner.scale(1, 1), this.isAnim = t, this.isChange = e, this.thePosition = i, this.nowidx = 0, this.maxdix = a.length - 1, this.randomAD(), this.isAnim && this.adAnim(), Laya.timer.clearAll(this), void this.startAnim());
                    ...
                    if (t) {
                        t.length;
                        this.owner.skin = t[this.nowidx].param, this.toAppId = t[this.nowidx].appid, this.toLinks = t[this.nowidx].toLinks, this.nowidx = this.nowidx + 1, this.nowidx > this.maxdix && (this.nowidx = 0);
                    }
                    ...
                    if (Laya.Browser.onMiniGame) {
                        ...
                        if (e) {
                            ...
                            }, console.log("跳转 _d:", i), a["default"].callAPIMethodByProxy("navigateToMiniProgram", i), Laya.timer.clearAll(this), Laya.Tween.clearAll(this.owner), this.adAnim(), this.changeAD();
                        }
    ...
    59: [function(t, e, i) {
        ...
        var n = t("./BaseView"),
            ...
            m = function(t) {
                function e() {
                    var e = t.call(this) || this;
                    return e.downTime = 7, e.startAngle = -90, e.isLoadAD = !1, e.goShareAdc = !1, e.startCountDown = !1, e.endAngle = -90, e.useTime = 0, e.stateTime = 1e4, e.seconds = 10, e.lastT = 0, e;
                }
                return __extends(e, t), e.prototype.onAwake = function() {
                    t.prototype.onAwake.call(this), this.btnAnchor = this.owner.getChildByName("btnAnchor"), this.btnShare = this.btnAnchor.getChildByName("shareBtn"), this.btnVideo = this.btnAnchor.getChildByName("videoBtn"), this.btnJump = this.btnAnchor.getChildByName("skipBtn"), this.progressBg = this.owner.getChildByName("progressBg"), this.progressMask = this.progressBg.getChildByName("progressBg").mask, this.reviveCount = this.progressBg.getChildByName("reviveCount"), this.ADPlaneBG = this.owner.getChildByName("ADPlaneBG"), this.adListloop = this.ADPlaneBG.getChildByName("ADPlane").getComponent(a["default"]), this.bannerADPanel = this.owner.getChildByName("bannerADPanel"), this.bannnerAdListloop = this.bannerADPanel.getComponent(a["default"]), this.bannerADPanel.visible = !1, this.progressBg.y += this.offset.y, this.ADPlaneBG.y += this.offset.y / 2, this.isLoadAD = !1, this.startCountDown = !1;
                }, e.prototype.addEvent = function() {
                    this.btnShare.on(Laya.Event.CLICK, this, this.shareClick), this.btnVideo.on(Laya.Event.CLICK, this, this.videoClick), this.btnJump.on(Laya.Event.CLICK, this, this.jumpClick), h["default"].instance.onEvent(r.GameEvent.ADBACK, this, this.showAd), h["default"].instance.onEvent(d.AdEvent.event_showBannerAd_fuhuo_erro_104, this, this.showADPanel), h["default"].instance.onEvent(r.GameEvent.ADJUMP, this, this.stopDownTime), h["default"].instance.onEvent(r.GameEvent.ADBACK, this, this.continueDownTime), t.prototype.addEvent.call(this);
                }, e.prototype.removeEvent = function() {
                    this.btnShare.off(Laya.Event.CLICK, this, this.shareClick), this.btnVideo.off(Laya.Event.CLICK, this, this.videoClick), this.btnJump.off(Laya.Event.CLICK, this, this.jumpClick), h["default"].instance.onOffEvent(r.GameEvent.ADBACK, this, this.showAd), h["default"].instance.onOffEvent(r.GameEvent.ADJUMP, this, this.stopDownTime), h["default"].instance.onOffEvent(d.AdEvent.event_showBannerAd_fuhuo_erro_104, this, this.showADPanel), h["default"].instance.onOffEvent(r.GameEvent.ADBACK, this, this.continueDownTime), t.prototype.removeEvent.call(this);
                }, e.prototype.showAd = function() {
                    ...
                    if (!this.goShareAdc) {
                        var t = parseInt(this.reviveCount.text),
                            e = t - 1;
                        1 > e ? (this.reviveCount.text = e.toString(), this.progressMask.graphics.drawPie(149, 149, 149, 250, this.endAngle, "#ff0000"), f["default"].instance.playSound("djs"), this.openOver()) : (this.reviveCount.text = e.toString(), this.endAngle += 360 / this.downTime, this.progressMask.graphics.drawPie(149, 149, 149, -90, this.endAngle, "#ff0000"), f["default"].instance.playSound("djs"));
                    }
                }, e.prototype.openView = function(e) {
                    var i = this,
                        n = e.noRefresh;
                    if (n) return void(this.goShareAdc = !1);
                    if (t.prototype.openView.call(this, e), this.seconds = 10, this.startAngle = -90, this.endAngle = -90, this.progressMask.graphics.drawPie(149, 149, 149, -90, this.endAngle, "#ff0000"), this.bannerADPanel.visible = !1, this.adListloop.init({
                            _cellWidth: 144,
                            _cellHeight: 144,
                            viewType: p.UI_VIEW_TYPE.RESTRGENCE
                        }), this.adListloop.start(s["default"].getAdData(1006), 1006, "复活页"), Laya.Tween.clearTween(this.btnVideo), this.tweenAniDown(this.btnVideo, {
                            scaleX: 1.05,
                            scaleY: 1.05
                        }, {
                            scaleX: .95,
                            scaleY: .95
                        }, 400), Laya.timer.clearAll(this), this.reviveCount.text = this.downTime.toString(), Laya.timer.loop(1e3, this, this.countDown), this.btnVideo.visible = !1, this.btnShare.visible = !1, this.ADPlaneBG.visible = !1, 1 == s["default"].ctrlInfo.marqueeBntSwitch && 1 != s["default"].ctrlInfo.shareBntSwitch && 1 != s["default"].ctrlInfo.videoBntSwitch ? (this.ADPlaneBG.visible = !1, this.progressBg.y = 339 + this.offset.y / 2, this.btnVideo.y = 240) : 1 == s["default"].ctrlInfo.marqueeBntSwitch && 1 == s["default"].ctrlInfo.videoBntSwitch ? (this.ADPlaneBG.visible = !1, this.btnVideo.visible = !0, this.btnVideo.y = 240, this.progressBg.y = 339 + this.offset.y / 2) : 1 == s["default"].ctrlInfo.marqueeBntSwitch && 1 == s["default"].ctrlInfo.shareBntSwitch ? (this.ADPlaneBG.visible = !1, this.btnShare.visible = !0, this.btnShare.y = 237, this.progressBg.y = 339 + this.offset.y / 2) : 1 != s["default"].ctrlInfo.marqueeBntSwitch && 1 == s["default"].ctrlInfo.shareBntSwitch && 1 == s["default"].ctrlInfo.videoBntSwitch ? (this.progressBg.y = 438 + this.offset.y / 2, this.openGoingSurpassOther(s.SORTTYPE.ENDLESS), this.btnShare.visible = !0, this.btnVideo.visible = !0, this.btnVideo.y = 240, this.btnShare.y = 77) : 1 != s["default"].ctrlInfo.marqueeBntSwitch && 1 != s["default"].ctrlInfo.shareBntSwitch && 1 == s["default"].ctrlInfo.videoBntSwitch ? (this.progressBg.y = 438 + this.offset.y / 2, this.openGoingSurpassOther(s.SORTTYPE.ENDLESS), this.btnVideo.visible = !0, this.btnVideo.y = 240) : 1 != s["default"].ctrlInfo.marqueeBntSwitch && 1 == s["default"].ctrlInfo.shareBntSwitch && 1 != s["default"].ctrlInfo.videoBntSwitch && (this.progressBg.y = 438 + this.offset.y / 2, this.openGoingSurpassOther(s.SORTTYPE.ENDLESS), this.btnShare.visible = !0, this.btnShare.y = 237), this.showAd(), Laya.Tween.clearTween(this.progressBg), this.tweenAniDown(this.progressBg, {
                            scaleX: 1.05,
                            scaleY: 1.05
                        }, {
                            scaleX: .95,
                        ...
                        var a = 530 + this.offset.y / 2,
                            ...
                            l = 0,
                            h = l;
                        s["default"].random_location && (h = o["default"].random(l - 30, l + 30), r = o["default"].random(a, a + 30)), this.btnJump.pos(h, r), this.btnJump.alpha = 0;
                        var c = 700;
                    ...
                    l["default"].subDomain && (this.goingSurpassOther || (this.goingSurpassOther = new Laya.WXOpenDataViewer(), this.owner.addChild(this.goingSurpassOther)), this.goingSurpassOther.pos(0, 131), this.goingSurpassOther.width = 750, this.goingSurpassOther.height = 92, l["default"].subDomain.setOpenView(this.goingSurpassOther), l["default"].subDomain.openGoingSurpassOther(t));
                }, e.prototype.closeGoingSurpassOther = function() {
                    l["default"].subDomain && (l["default"].subDomain.closeGoingSurpassOther(), this.goingSurpassOther && (this.goingSurpassOther.destroy(), this.goingSurpassOther = null));
                }, e.prototype.onEnable = function() {
                    t.prototype.onEnable.call(this);
                }, e.prototype.onDisable = function() {
                    t.prototype.onDisable.call(this), l["default"].callAPIMethodByProxy("destoryAllBannerAd"), this.closeGoingSurpassOther();
                    ...
                    this._isClick || (this._isClick = !0, Laya.timer.once(500, this, function() {
                        t._isClick = null;
                    }), l["default"].ptAPI ? (l["default"].callAPIMethodByProxy("CanPlayVideo") ? (this.isLoadAD = !0, this.goShareAdc = !0, l["default"].callAPIMethodByProxy("showVideo", {
                        posID: 204,
                        _type: c.SHARE_VIDEO_TYPE.RESURGENCE,
                        caller: this,
                        callBackSuc: function() {
    ...
    60: [function(t, e, i) {
        ...
        var n = t("./BaseView"),
            ...
            _ = function(t) {
                function e() {
                    var e = t.call(this) || this;
                    return e.isMySettleCoin = !0, e.isLoadAD = !1, e.goShareAdc = !1, e.isSelect = !1, e.coinNum = 0, e.isOpenSkinPop = !1, e.isFreeCoin = !1, e.goldState = 0, e.startGoldTime = 0, e.isAutoOpen = !1, e.DIX = 0, e.DIXMAX = 6, e;
                }
                return __extends(e, t), e.prototype.onAwake = function() {
                    t.prototype.onAwake.call(this), this.anchor = this.owner.getChildByName("anchor"), this.coinPanel = this.anchor.getChildByName("coinPanel"), this.congratulation = this.coinPanel.getChildByName("congratulation"), this.coinLbl = this.anchor.getChildByName("coinLabel"), this.shine = this.anchor.getChildByName("shine"), this.coinBg = this.owner.getChildByName("coinBg"), this.coinNumLbl = this.coinBg.getChildByName("coinNum"), this.coinUnit = this.coinBg.getChildByName("coinUnit"), this.closeBtn = this.anchor.getChildByName("closeBtn"), this.noVideoButton = this.owner.getChildByName("noVedio"), this.anchor.y += this.offset.y / 2, this.gameCtrl = o["default"].instance.getGameCtrl(), this.bannerADPanel = this.owner.getChildByName("bannerADPanel"), this.bannnerAdListloop = this.bannerADPanel.getComponent(f["default"]), this.closeBtn.visible = !1, s["default"].autoScreenSize([this.coinBg]), this.coinBg.y += 10, this.updateCoinNum();
                }, e.prototype.addEvent = function() {
                    this.noVideoButton.on(Laya.Event.CLICK, this, this.clickButton), this.closeBtn.on(Laya.Event.CLICK, this, this.goHome), r["default"].instance.onEvent("UpdataMoney", this, this.updateCoinNum), r["default"].instance.onEvent(p.AdEvent.event_show_lixianlingqujinbi_erro_107, this, this.showADPanel), r["default"].instance.onEvent(p.AdEvent.event_showBannerAd_zhujiemianlingqujinbi_erro_102, this, this.showADPanel), r["default"].instance.onEvent(p.AdEvent.event_showBannerAd_jiesuanjinbi_erro_105, this, this.showADPanel), r["default"].instance.onEvent(g.GameEvent.ADBACK, this, this.showAd), t.prototype.addEvent.call(this);
                }, e.prototype.removeEvent = function() {
                    this.noVideoButton.off(Laya.Event.CLICK, this, this.clickButton), this.closeBtn.off(Laya.Event.CLICK, this, this.goHome), r["default"].instance.onOffEvent("UpdataMoney", this, this.updateCoinNum), r["default"].instance.onOffEvent(p.AdEvent.event_show_lixianlingqujinbi_erro_107, this, this.showADPanel), r["default"].instance.onOffEvent(p.AdEvent.event_showBannerAd_zhujiemianlingqujinbi_erro_102, this, this.showADPanel), r["default"].instance.onOffEvent(p.AdEvent.event_showBannerAd_jiesuanjinbi_erro_105, this, this.showADPanel), r["default"].instance.onOffEvent(g.GameEvent.ADBACK, this, this.showAd), t.prototype.removeEvent.call(this);
                }, e.prototype.showAd = function() {
                    ...
                    this.goldState = t ? 1 : 2, this.coinLbl.text = t ? (5 * this.coinNum).toString() : this.coinNum.toString(), this.startGoldTime = Laya.timer.currTimer, this.btnselectMark.visible = !t;
                }, e.prototype.clickButton = function() {
                    var t = this;
                    console.log("clickButton ==", this.isLoadAD);
                    if (!this._isClick && !this.isLoadAD) {
                        this._isClick = !0, this.noVideoButton.visible = !1;
                        var e = 205;
                        ...
                        if (false) {
                            ...
                            this.goShareAdc = !0;
                            platform.getInstance().showReward(() => {
                                t.coinNum = 5 * t.coinNum, c["default"].setMoney(t.coinNum, !0), u["default"].instance.settle({
                                ...
                                r["default"].instance.emit("openTip", "No ads temporarily"), t.noVideoButton.visible = !0, t.isLoadAD = !1, t.goShareAdc = !1, t._isClick = null;
                            })
                        } else {
                            c["default"].setMoney(this.coinNum, !0), u["default"].instance.settle({
                    ...
                    if (t.prototype.openView.call(this, e), this.coinPanel.skin = "settleCoin/huode_baoxiang_open.png", this.congratulation.skin = "settleCoin/huode_biaoti.png", e) this.isFreeCoin = e.isFree, this.coinNum = Math.floor(e.freeCoin), this.coinLbl.text = (1 * this.coinNum).toString(), this.isAutoOpen = true, this.isAutoOpen ? (this.coinPanel.skin = "settleCoin/baoxiang@2x.png", this.congratulation.skin = "settleCoin/lixian_biaoti.png", this.closeBtn.visible = !0) : (this.congratulation.skin = "settleCoin/huode_biaoti.png", this.showAd()), this.noVideoButton.y = 1013 + this.offset.y / 2;
                    else {
                        ...
                        this.coinNum = Math.floor(this.coinNum * c["default"].multipy), this.coinLbl.text = (1 * this.coinNum).toString(), this.noVideoButton.y = 1013 + this.offset.y / 2, this.showAd();
                    }
                    this.updateCoinNum();
                }, e.prototype.showADPanel = function() {}, e.prototype.hideADPanel = function() {
                    this.bannerADPanel.visible = !1;
                    ...
                    if (this.shine.rotation += .5, this.shine.rotation > 360 && (this.shine.rotation -= 360), this.goldState) {
                        var t = parseInt(this.coinLbl.text);
                        1 == this.goldState ? (t -= 100, (t <= this.coinNum || this.startGoldTime + 2e3 < Laya.timer.currTimer) && (t = this.coinNum, this.goldState = 0)) : 2 == this.goldState && (t += 100, (t >= 5 * this.coinNum || this.startGoldTime + 2e3 < Laya.timer.currTimer) && (t = 5 * this.coinNum, this.goldState = 0)), this.coinLbl.text = t.toString();
                    }
                }, e.prototype.OVERhuoquAIn = function() {
                    this.DIX = 0, Laya.timer.clear(this, this.goldFlyAniLoop), Laya.timer.loop(50, this, this.goldFlyAniLoop);
                }, e.prototype.goldFlyAniLoop = function() {
    ...
    61: [function(t, e, i) {
        ...
        var p = function(t) {
            ...
            return __extends(e, t), e.prototype.onAwake = function() {
                t.prototype.onAwake.call(this), this.anchor = this.owner.getChildByName("anchor"), this.ballList = this.anchor.getChildByName("ballList"), this.roleList = this.anchor.getChildByName("roleList"), this.ballList.array = [], this.ballList.renderHandler = new Laya.Handler(this, this.ballRender), this.ballList.mouseHandler = new Laya.Handler(this, this.ballMouse), this.ballList.vScrollBarSkin = "", this.roleList.array = [], this.roleList.renderHandler = new Laya.Handler(this, this.roleRender), this.roleList.mouseHandler = new Laya.Handler(this, this.roleMouse), this.roleList.vScrollBarSkin = "", this.coinBtn = this.anchor.getChildByName("coinBtn"), this.videoBtn = this.anchor.getChildByName("videoBtn"), this.videoHit = this.videoBtn.getChildByName("hit"), Laya.Tween.clearTween(this.videoBtn), this.tweenAniDown(this.videoBtn, {
                    scaleX: 1.05,
                    scaleY: 1.05
                }, {
                    scaleX: .95,
                    scaleY: .95
                }, 400), this.equipmentBtn = this.anchor.getChildByName("equipmentBtn"), this.equipment = this.anchor.getChildByName("equipment"), this.roleBtn = this.anchor.getChildByName("roleBtn"), this.role_0 = this.roleBtn.getChildByName("0"), this.role_1 = this.roleBtn.getChildByName("1"), this.ballBtn = this.anchor.getChildByName("ballBtn"), this.ball_0 = this.ballBtn.getChildByName("0"), this.ball_1 = this.ballBtn.getChildByName("1"), this.coinImg = this.owner.getChildByName("coinBg"), this.coinNum = this.coinImg.getChildByName("coinNum"), this.coinUnit = this.coinImg.getChildByName("coinUnit"), this.coinBuyLable = this.coinBtn.getChildByName("Label"), this.videoBuyLable = this.videoBtn.getChildByName("Label"), r["default"].autoScreenSize([this.coinImg, this.homeBtn]), this.coinImg.y += 10, this.anchor.y += this.offset.y / 2, this.isLoadAD = !1, this.ballSelectIndex = 0, this.roleSelectIndex = 0;
            }, e.prototype.addEvent = function() {
                this.coinBtn.on(Laya.Event.CLICK, this, this.coinBuyClick), this.videoBtn.on(Laya.Event.CLICK, this, this.videoBuyClick), this.equipmentBtn.on(Laya.Event.CLICK, this, this.equipmentClick), this.homeBtn.on(Laya.Event.CLICK, this, this.goHome), this.ballBtn.on(Laya.Event.CLICK, this, this.showBallList), this.roleBtn.on(Laya.Event.CLICK, this, this.showRoleList), o["default"].instance.onEvent("UpdataMoney", this, this.updateCoinNum);
            }, e.prototype.removeEvent = function() {
                o["default"].instance.onOffEvent("UpdataMoney", this, this.updateCoinNum), this.coinBtn.off(Laya.Event.CLICK, this, this.coinBuyClick), this.videoBtn.off(Laya.Event.CLICK, this, this.videoBuyClick), this.equipmentBtn.off(Laya.Event.CLICK, this, this.equipmentClick), this.homeBtn.off(Laya.Event.CLICK, this, this.goHome), this.ballBtn.off(Laya.Event.CLICK, this, this.showBallList), this.roleBtn.off(Laya.Event.CLICK, this, this.showRoleList);
            }, e.prototype.openView = function(e) {
                t.prototype.openView.call(this, e), this.showType = n.ROLE, this.setSkinData(), this.ballSelectIndex = 0, this.roleSelectIndex = 0, this.updateSelectIndex(h["default"].peopleSkin), this.updateSelectIndex(h["default"].ballSkin);
                ...
                s = s - 2 > 0 ? s : 0, this.ballList.scrollTo(s), this.roleList.refresh(), this.ballList.refresh(), o["default"].instance.emit(l.GameEvent.SKIN_SHOW_STORE, !0), this.updataListShow(), this.updataButton(), this.updateCoinNum();
            }, e.prototype.setSkinData = function() {
                h["default"].sortRoleData(), h["default"].sortBallData(), this.ballListData = h["default"].ballDatas, this.roleListData = h["default"].roleDatas, this.ballList.array = this.ballListData, this.roleList.array = this.roleListData;
                ...
                var n = this;
                var m = h["default"].money - i;
                s["default"].instance.buyView({
                    systemViewId: e,
                    success: function(t) {
                        var e = t.systemViewId;
                        h["default"].setMoney(m), n.rewordSkin(e);
                    }
                });
            }, e.prototype.rewordSkin = function(t) {
                var e = this;
                h["default"].addSkin(t), e.setSkinData(), e.updateSelectIndex(t), e.updataButton(), e.ballList.refresh(), e.roleList.refresh();
                ...
                var t = this,
                    ...
                    i = e.config.Id,
                    n = this;
                this.isLoadAD = !0, platform.getInstance().showReward(() => {
                    t.isLoadAD = !1, s["default"].instance.unlockView({
                        type: 1,
                        systemViewId: i,
                        success: function(t) {
                            if (t.isUnlock) n.rewordSkin(i);
                                ...
                                h["default"].unLockSkin(i), n.setSkinData(), n.updateSelectIndex(i), n.updataButton(), n.ballList.refresh(), n.roleList.refresh();
                            }
                        }
                    });
                }, () => {
                    o["default"].instance.emit("openTip", "No ads temporarily."), t.isLoadAD = !1;
                })
            }, e.prototype.getCurrSelectSkinData = function() {
                var t;
                return this.showType == n.ROLE ? t = this.roleListData[this.roleSelectIndex] : this.showType == n.BALL && (t = this.ballListData[this.ballSelectIndex]), t;
                ...
                s["default"].instance.changeView({
                    success: function() {
                        var i = systemViewId;
                        e.showType == n.ROLE ? h["default"].peopleSkin = systemViewId : e.showType == n.BALL && (h["default"].ballSkin = systemViewId), platform.getInstance().setStorageSync("peopleSkin", h["default"].peopleSkin);
                        platform.getInstance().setStorageSync("ballSkin", h["default"].ballSkin);
                        e.updateSelectIndex(h["default"].peopleSkin), e.updateSelectIndex(h["default"].ballSkin), e.roleList.scrollTo(e.roleSelectIndex), e.ballList.scrollTo(e.ballSelectIndex), e.updataButton(), e.resetCurrSkin(), e.roleList.refresh(), e.ballList.refresh();
                    }
                });
            }, e.prototype.showBallList = function() {
                this.showType != n.BALL && (this.showType = n.BALL, this.resetCurrSkin(), this.updataListShow(), this.ballList.refresh(), this.updataButton());
            }, e.prototype.showRoleList = function() {
                this.showType != n.ROLE && (this.showType = n.ROLE, this.resetCurrSkin(), this.updataListShow(), this.roleList.refresh(), this.updataButton());
            }, e.prototype.updataListShow = function() {
                this.role_0.visible = this.showType == n.ROLE, this.role_1.visible = this.showType != n.ROLE, this.ball_0.visible = this.showType == n.BALL, this.ball_1.visible = this.showType != n.BALL, this.roleList.visible = this.showType == n.ROLE, this.ballList.visible = this.showType == n.BALL;
                ...
                console.log("url:", u), n.skin = u, o.visible = !i.isHave, s.visible = !i.isHave, a.visible = e == this.roleSelectIndex;
                ...
                o["default"].instance.emit(l.GameEvent.SKIN_SHOW_STORE, !1), o["default"].instance.emit(l.GameEvent.UPDATA_PLAYER_SKIN, h["default"].peopleSkin), this.closeView(), o["default"].instance.emit("goHome");
                ...
                if (t.isHave) {
                    ...
                    var e = t.config.Id;
                    h["default"].peopleSkin == e || h["default"].ballSkin == e ? (this.equipment.visible = !0, this.equipmentBtn.visible = !1) : (this.equipment.visible = !1, this.equipmentBtn.visible = !0);
                } else {
                    ...
                    var i = t.config.Gold,
                        ...
                        o = a.value,
                        s = ["T", "B", "M", "K"];
                    a.isK && (o += s[a.isK]), this.coinBuyLable.text = o, this.videoBuyLable.text = t.unlockView.moiveProcess + "/" + t.config.Video, 0 != t.config.Video && c["default"].ctrlInfo.isVideo ? (this.videoBtn.visible = !0, this.coinBtn.x = -155, this.videoBtn.x = 155) : (this.videoBtn.visible = !1, this.coinBtn.x = 0), this.coinBtn.visible = !0;
                }
            }, e.prototype.resetCurrSkin = function() {
                o["default"].instance.emit(l.GameEvent.UPDATA_PLAYER_SKIN, h["default"].peopleSkin), o["default"].instance.emit(l.GameEvent.UPDATA_BALL_SKIN, h["default"].ballSkin);
    ...
    63: [function(t, e, i) {
        ...
        var n = function(t) {
            function e() {
                var e = t.call(this) || this;
                return e.M_left = 0, e.M_right = 0, e.L_OR_R = !1, e.zuoyou = !1, e.Addcionain = new Laya.Tween(), e.Addcionain1 = new Laya.Tween(), e.shezhi_thefish(), e;
            }
            return __extends(e, t), e.prototype.shezhi_thefish = function() {
                this.skin = "mainview/gb@2x.png", this.anchorX = .5, this.anchorY = .5, this.rotation = 0, this.alpha = 1;
                ...
                this.pos(a, o), this.scale(0, 0), this.rotation = 0, this.visible = !0, this.Addcionain1.to(this, {
                    ...
                    n.Addcionain.to(n, {
                        ...
                        n.Addcionain.to(n, {
                            ...
                            n.visible = !1, n.rotation = 0, n.scale(1, 1), n.pos(300, 640), n.removeSelf(), Laya.Pool.recover("CONINAIN", n);
                        }));
                    }));
    ...
    64: [function(t, e, i) {
        ...
        var n = function(t) {
            ...
            return __extends(e, t), e.prototype.onAwake = function() {
                this.bgImg = this.owner.getChildByName("imgBg"), this.rankImg = this.owner.getChildByName("rankImg"), this.rankLab = this.owner.getChildByName("rankLab"), this.avatarImg = this.owner.getChildByName("avatarImg"), this.nameLab = this.owner.getChildByName("nameLab"), this.scoreLab = this.owner.getChildByName("scoreLab");
            }, e.prototype.updateItem = function(t) {
                switch (this.owner.active = !0, this.rankImg.visible = !1, this.rankLab.text = t.index || "-", t.index) {
                    case 1:
                        this.rankLab.text = "", this.rankImg.skin = "rank/img_rank" + t.index + ".png", this.rankImg.visible = !0;
                }
        ...
        var n = t("../BaseView"),
            ...
            c = function(t) {
                ...
                return __extends(e, t), e.prototype.onAwake = function() {
                    ...
                    var e = this.owner.getChildByName("content");
                    this.friendBtn = e.getChildByName("friendBtn"), this.worldBtn = e.getChildByName("worldBtn"), this.normalFriendRank = e.getChildByName("normalFriendRank"), this.normalWorldRank = e.getChildByName("normalWorldRank"), this.selectFriendRank = this.normalFriendRank.getChildByName("selectFriendRank"), this.selectWorldRank = this.normalWorldRank.getChildByName("selectWorldRank"), e.y = e.y + this.offset.y / 2, this.worldRankList = e.getChildByName("worldRankList"), this.worldRankList.array = [], this.worldRankList.renderHandler = new Laya.Handler(this, this.onRender), this.worldRankList.vScrollBarSkin = "", this.selfRankSprite = e.getChildByName("selfRankItem"), this.selfRankITem = this.selfRankSprite.getComponent(a["default"]), o["default"].autoScreenSize([this.closeBtn]), this.selfRankSprite.visible = !1;
                    ...
                    t.prototype.addEvent.call(this), this.closeBtn.on(Laya.Event.CLICK, this, this.closeView), this.worldBtn.on(Laya.Event.CLICK, this, this.worldRankClick), this.friendBtn.on(Laya.Event.CLICK, this, this.friendRankClick);
                    ...
                    this.selectFriendRank.visible = !1, this.selectWorldRank.visible = !0, this.worldRankList.visible = !0, this.selfRankSprite.visible = !0, this.closeFriendRank(), this.worldData ? this.setWorldRankDta() : this.getWorldData();
                }, e.prototype.friendRankClick = function() {
                    this.selectFriendRank.visible = !0, this.selectWorldRank.visible = !1, this.worldRankList.visible = !1, this.selfRankSprite.visible = !1, l["default"].subDomain && (this.wxOpenDataView || (this.wxOpenDataView = new Laya.WXOpenDataViewer(), this.owner.addChild(this.wxOpenDataView)), this.wxOpenDataView.width = 561, this.wxOpenDataView.height = 828, this.wxOpenDataView.pos(95, 279), this.wxOpenDataView.y = this.wxOpenDataView.y + this.offset.y / 2, l["default"].callSubDomainMethodByProxy("setOpenView", this.wxOpenDataView), l["default"].callSubDomainMethodByProxy("openFriendRank", {
                        _type: this._data._type
                    }));
                }, e.prototype.closeFriendRank = function() {
                    l["default"].subDomain && (this.wxOpenDataView && (this.wxOpenDataView.destroy(), this.wxOpenDataView = null), l["default"].callSubDomainMethodByProxy("closeFriendRank"));
                }, e.prototype.removeEvent = function() {
                    this.closeBtn.off(Laya.Event.CLICK, this, this.closeView), this.worldBtn.off(Laya.Event.CLICK, this, this.worldRankClick), this.friendBtn.off(Laya.Event.CLICK, this, this.friendRankClick), t.prototype.removeEvent.call(this);
                }, e.prototype.openView = function(e) {
                    t.prototype.openView.call(this, e), this.worldRankClick(), l["default"].callAPIMethodByProxy("destoryAllBannerAd");
                }, e.prototype.closeView = function() {
                    this.worldData = null, l["default"].subDomain && this.closeFriendRank(), h["default"].instance.emit("goHome"), t.prototype.closeView.call(this);
                }, e;
            }(n["default"]);
        i["default"] = c;
    }, {
                ...
                return t.random = function(t, e) {
                    ...
                    if (Laya.Browser.onMiniGame) {
                        var e = n["default"].systemInfo,
                            i = 20;
                        20 == e.statusBarHeight || (44 == e.statusBarHeight || 27 == e.statusBarHeight) && (i += 70), t.forEach(function(t) {
                            t.y = i + t.height / 2;
                        });
                    }
