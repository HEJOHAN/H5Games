    ...
    function(t, e) {
        ...
        class s {
            ...
            static core_hmac_md5(t, e) {
                ...
                for (var i = Array(16), r = Array(16), a = 0; a < 16; a++) i[a] = 909522486 ^ s[a], r[a] = 1549556828 ^ s[a];
            ...
            static binl2b64(t) {
                for (var e = "", s = 0; s < 4 * t.length; s += 3)
                    for (var i = (t[s >> 2] >> s % 4 * 8 & 255) << 16 | (t[s + 1 >> 2] >> (s + 1) % 4 * 8 & 255) << 8 | t[s + 2 >> 2] >> (s + 2) % 4 * 8 & 255, r = 0; r < 4; r++) 8 * s + 6 * r > 32 * t.length ? e += this.b64pad : e += "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(i >> 6 * (3 - r) & 63);
                return e;
            }
        }
        s.hexcase = 0, s.b64pad = "", s.chrsz = 8, e.ILaya.regClass(s), e.ClassUtils.regClass("zs.laya.MiscUtils", s), e.ClassUtils.regClass("Zhise.MiscUtils", s);
        class i {
            constructor() {}
            ...
            static xhrPost(t, s) {
                if (0 != zs.laya.sdk.DeviceService.IsNetValid()) {
                    if (null == i.xhrRequestList[t]) {
                        ...
                        var r = zs.laya.MiscUtils.object2UrlStrArgs(s),
                            a = new e.HttpRequest();
                        a.http.timeout = 1e4, a.once(e.Event.ERROR, this, this.onXHRError, [t, s]), a.once(e.Event.COMPLETE, this, this.onXHRCompleted, [t, s]), a.send(t, r, "post", "text");
                    }
            ...
            static xhrPostWithSign(t, s, r) {
                if (0 != zs.laya.sdk.DeviceService.IsNetValid()) {
                    if (null == i.xhrRequestList[t]) {
                        ...
                        var a = zs.laya.MiscUtils.object2UrlStrArgs(s),
                            n = new e.HttpRequest();
                        n.http.timeout = 1e4, n.once(e.Event.ERROR, this, this.onXHRError, [t, s]), n.once(e.Event.COMPLETE, this, this.onXHRCompleted, [t, s]), n.send(t, a, "post", "text");
                    }
            ...
            static xhrPostWithSignAndHeader(t, s, r, a) {
                if (0 != zs.laya.sdk.DeviceService.IsNetValid()) {
                    if (null == i.xhrRequestList[t]) {
                        i.xhrRequestList[t] = Date.now(), s.sign = this.getArgsSign(s, r);
                        for (var n = ["Content-Type", "application/x-www-form-urlencoded"], l = Object.keys(a), o = 0; o < l.length; o++) n.push(l[o]), n.push(a[l[o]]);
                        var h = zs.laya.MiscUtils.object2UrlStrArgs(s),
                            c = new e.HttpRequest();
                        c.http.timeout = 1e4, c.once(e.Event.ERROR, this, this.onXHRError, [t, s]), c.once(e.Event.COMPLETE, this, this.onXHRCompleted, [t, s]), c.send(t, h, "post", "text", n);
                    }
                } else e.stage.event(this.NET_XHR_RESPONSE, [0, t, s, null]);
            }
            static onXHRError(t, s, r) {
                i.xhrRequestList[t] = null, console.log("onXHRError:" + t + ",params:" + JSON.stringify(s) + ",response:" + r), e.stage.event(this.NET_XHR_RESPONSE, [0, t, s, r]);
            }
        ...
        i.NET_XHR_RESPONSE = "NET_XHR_RESPONSE", i.xhrRequestList = {}, e.ILaya.regClass(i), e.ClassUtils.regClass("zs.laya.XHRUtils", i), e.ClassUtils.regClass("Zhise.XHRUtils", i);
        class r {
            constructor() {}
        ...
        r.localStorage = {}, e.ILaya.regClass(r), e.ClassUtils.regClass("zs.laya.DataCache", r), e.ClassUtils.regClass("Zhise.DataCache", r);
        class a extends e.Script {
            ...
            static LoadScene3d(t) {
                ...
                return s && (s.removeSelf(), s.destroy(), s = null), this.curScene3d = e.loader.getRes(this.Get3dSceneUrl(t)), this.curScene3d && (this.curScene3d.zs_res_url = t), i && this.unloadSceneRes(i), this.curScene3d;
            }
            static LoadScene3dAsyn(t, s, i) {
                this.curDownloadSceneUrl != t && e.loader.cancelLoadByUrl(this.curDownloadSceneUrl), this.curDownloadSceneUrl = null;
                ...
                if (this.curScene3d = e.loader.getRes(n), this.curScene3d) return this.curScene3d.zs_res_url = t, a && this.unloadSceneRes(a), i && i.runWith(1), s && s.runWith(this.curScene3d), this.curScene3d;
                this.curDownloadSceneUrl = n;
                var l = this;
                return e.loader.create(n, e.Handler.create(null, function(e) {
                    l.curDownloadSceneUrl = null, l.curScene3d = e, l.curScene3d && (l.curScene3d.zs_res_url = t), a && l.unloadSceneRes(a), s && s.runWith(l.curScene3d);
                }), i), null;
            }
            ...
            static printScene3dRes(t) {
                ...
                if (null != s)
                    for (var i = {}, r = s.length - 1; r > -1; r--) {
                        var a = this.Get3dResUrl(s[r]),
                            n = e.loader.getRes(a);
            ...
            static DestroyScene3dRes(t) {
                ...
                if (null != s)
                    for (var i = s.length - 1; i > -1; i--) {
                        var r = this.Get3dResUrl(s[i]),
                            a = e.loader.getRes(r);
                        null == a || a.referenceCount > 0 || (a.destroy(), e.loader.clearRes(r));
                    }
            }
        }
        a.curScene3d = null, a.curDownloadSceneUrl = null, a.threeDResRootPath = "3dres/Conventional/", e.ILaya.regClass(a), e.ClassUtils.regClass("zs.laya.Resource", a), e.ClassUtils.regClass("zs.laya.ZSResource", a), e.ClassUtils.regClass("Zhise.Resource", a);
        class n extends e.Script {
            ...
            static playMusic(t) {
                ...
                Laya.SoundManager.playMusic(t);
            }
            static stopMusic() {
                Laya.SoundManager.stopMusic();
            }
        }
        n.curMusic = null, n.bgPlaying = !1, e.ILaya.regClass(n), e.ClassUtils.regClass("zs.laya.SoundService", n), e.ClassUtils.regClass("Zhise.SoundService", n);
        class l extends e.Script {
            ...
            clearCache() {
                ...
                for (var s in this.recoverArr.forEach(function(s) {
                        s.__InPool || (t.poolStatus[s._zs_sign] || (t.poolStatus[s._zs_sign] = {}), t.poolStatus[s._zs_sign].free ? t.poolStatus[s._zs_sign].free += 1 : t.poolStatus[s._zs_sign].free = 1, e.Pool.recover(s._zs_sign, s));
                    }), this.recoverArr.splice(0, this.recoverArr.length), console.log("ObjectPool.poolStatus:" + JSON.stringify(this.poolStatus)), this.poolStatus) this.poolStatus.hasOwnProperty(s) && e.Pool.clearBySign(s);
                this.poolStatus = {};
            }
            recoverSprite3d(t, s) {
                if (t.removeSelf(), null != t._zs_sign)
                    if (s) {
                        if (t.__InPool) return;
                        this.poolStatus[t._zs_sign] || (this.poolStatus[t._zs_sign] = {}), this.poolStatus[t._zs_sign].free ? this.poolStatus[t._zs_sign].free += 1 : this.poolStatus[t._zs_sign].free = 1, e.Pool.recover(t._zs_sign, t);
            ...
            onLateUpdate() {
                if (0 != this.recoverArr.length) {
                    ...
                    this.recoverArr.forEach(function(s) {
                        s.__InPool || (t.poolStatus[s._zs_sign].free ? t.poolStatus[s._zs_sign].free += 1 : t.poolStatus[s._zs_sign].free = 1, e.Pool.recover(s._zs_sign, s));
        ...
        l.sInstance = null, e.ILaya.regClass(l), e.ClassUtils.regClass("zs.laya.ObjectPool", l), e.ClassUtils.regClass("Zhise.ObjectPool", l);
        class o {
            constructor(t, s, i, r, a, n, l) {
                this.customId = t, this.sign = s, this.duaration = i, this.parent = r, null != a && (this.isWorldSpace = a, this.position = n ? n.clone() : null, this.rotation = l ? l.clone() : null), this.createTime = e.timer.currTimer;
            }
        }
        class h extends e.Script {
            ...
            instanceEffect(t) {
                ...
                e.timer.currTimer - s.createTime > s.duaration ? this.effectWaitingList.length > 0 && this.instanceEffectDelay(t) : (zs.laya.Resource.LoadSpriteAsyn(s.sign, e.Handler.create(this, this.onEffectReady, [s])), this.effectWaitingList.length > 0 && this.instanceEffectDelay(t));
            }
            onEffectReady(t, s) {
                if (!(e.timer.currTimer - t.createTime > t.duaration)) {
                    ...
                    if (null != i && !t.parent.destroyed && null != t.parent.parent) {
                        t.parent.addChild(i), i.name = t.customId, null == t.isWorldSpace || (t.isWorldSpace ? (!t.position || (i.transform.position = t.position), !t.rotation || (i.transform.rotation = t.rotation)) : (!t.position || (i.transform.localPosition = t.position), !t.rotation || (i.transform.localRotation = t.rotation)));
                        var r = i.getComponent(c);
                        null == r && (r = i.addComponent(c)), r.delay = t.duaration;
                    }
                }
            }
        }
        h.sInstance = null, e.ILaya.regClass(h), e.ClassUtils.regClass("zs.laya.EffectFactory", h), e.ClassUtils.regClass("Zhise.EffectFactory", h);
        class c extends e.Script3D {
            ...
            onUpdate() {
                this.delay < 0 || (this.delay -= e.timer.delta, this.delay <= 0 && (this.delay = Number.MAX_VALUE, zs.laya.ObjectPool.RecoverSprite3d(this.owner)));
            }
            onDestroy() {
                this.delay = null;
            }
        ...
        class u extends e.Script3D {
            ...
            static init(t, e, s) {
                ...
                null == i && (i = t.addComponent(u)), i.sign = e, i.loadedCb = s, i.sleep = !1, i.sprite && zs.laya.ObjectPool.RecoverSprite3d(i.sprite, !0);
            }
            static release(t) {
            ...
            onLateUpdate() {
                if (this.sign && (zs.laya.Resource.LoadSpriteAsyn(this.sign, e.Handler.create(this, this.onSpriteReady, [this.sign])), this.sign = null), this.sprite) {
                    this.owner.parent.addChild(this.sprite);
                    var t = this.owner;
                    this.sprite.transform.position = t.transform.position.clone(), this.sprite.transform.rotationEuler = t.transform.rotationEuler.clone(), this.sprite.transform.localScale = t.transform.localScale.clone(), this.loadedCb && (this.loadedCb.runWith(this.sprite), this.loadedCb = null), this.sprite = null, zs.laya.ObjectPool.RecoverSprite3d(t);
                }
            }
        }
        ...
        class S extends e.AnimatorStateScript {
            constructor() {
                super(), this.stateName = "", this.animator = null, this.listener = null, this.onEnter = null, this.onExit = null;
            }
            static setListener(t, e, s, i, r) {
                var a = t.getControllerLayer(0).getAnimatorState(e);
                if (null != a) {
                    var n = a.getScript(S);
                    null == n && (n = a.addScript(S)), n.stateName = e, n.animator = t, n.listener = s, n.onEnter = i, n.onExit = r;
                }
            }
            static init(t, e, s) {
                ...
                if (null != i) {
                    var r = i.getScript(S);
                    null == r && (r = i.addScript(S)), r.stateName = e, r.animator = t, r.listener = s, r.onEnter = null, r.onExit = null;
                }
            }
            static remove(t, e) {
                ...
                if (null != s) {
                    var i = s.getScript(S);
                    null != i && (i.stateName = null, i.animator = null, i.listener = null, i.onEnter = null, i.onExit = null);
                }
            }
            onStateEnter() {
                this.listener && this.onEnter && this.onEnter.call(this.listener, this.stateName, this.animator), this.listener && this.listener.zsAnimStateEnter && this.listener.zsAnimStateEnter(this.stateName, this.animator);
            }
            onStateExit() {
                this.listener && this.onExit && this.onExit.call(this.listener, this.stateName, this.animator), this.listener && this.listener.zsAnimStateExit && this.listener.zsAnimStateExit(this.stateName, this.animator);
            }
        }
        e.ILaya.regClass(S), e.ClassUtils.regClass("zs.laya.AnimStateListener", S), e.ClassUtils.regClass("Zhise.AnimStateListener", S), t.DataCache = r, t.XHRUtils = i, t.MiscUtils = s, t.Resource = a, t.SoundService = n, t.ObjectPool = l, t.EffectScript3d = c, t.EffectFactory = h, t.TriggerScript3d = d, t.Sprite3dAgent = u, t.Sprite3dRecover = g, t.AnimStateListener = S;
    }(window.zs.laya, Laya);