window.zs = window.zs || {}, window.zs.laya = window.zs.laya || {},
    function(e, t) {
        ...
        s.instance = null, s.initialized = !1, s.event_startup_id = "startup", s.event_startup_label = "微信加载完成游戏启动", s.event_login_id = "login", s.event_login_label = "登陆成功", s.event_game_start_id = "gameStart", s.event_game_start_label = "游戏开始", s.event_game_over_id = "gameOver", s.event_game_over_label = "游戏结束", s.event_level_complete_id = "levelComplete", s.event_level_complete_label = "通关关卡", t.ClassUtils.regClass("zs.laya.tdapp.tdAppSdk", s);
        class a {
            constructor() {
        ...
        t.ClassUtils.regClass("zs.laya.tdapp.levelCompletedExEvt", d), e.tdAppSdk = s, e.tdAppEvent = a, e.startupEvt = l, e.loginEvt = i, e.gameStartEvt = n, e.gameOverEvt = p, e.levelCompletedEvt = r, e.levelCompletedExEvt = d;
