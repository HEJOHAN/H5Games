    ...
    function(t, i) {
        ...
        class e {
            ...
            static showInsertAd(t) {
                this._instance ? this._instance.showInsertAd ? this._instance.showInsertAd(t) : this._instance.loadFullScreenAD && this._instance.showFullScreenAD(t) : (t && t.runWith("not in wx"), console.log("showFullScreenAD:" + Date.now()));
            }
        ...
        e._instance = null, e.EVENT_AD_VIDEO_PLAY = "EVENT_AD_VIDEO_PLAY", e.EVENT_AD_VIDEO_CLOSED = "EVENT_AD_VIDEO_CLOSED", i.ILaya.regClass(e), i.ClassUtils.regClass("zs.laya.sdk.SdkService", e), i.ClassUtils.regClass("Zhise.SdkService", e);
        class n {
            constructor() {}
            static initDevice() {
        ...
        n.device = null, n.EVENT_ON_RESUME = "DEVICE_ON_RESUME", n.EVENT_ON_HIDE = "DEVICE_ON_HIDE", n.EVENT_ON_SHOW = "DEVICE_ON_SHOW", i.ILaya.regClass(n), i.ClassUtils.regClass("zs.laya.sdk.DeviceService", n), i.ClassUtils.regClass("Zhise.DeviceService", n);
        class s {
            constructor() {}
        ...
        s.instance = null, s.initialized = !1, i.ClassUtils.regClass("zs.laya.sdk.ZSReportSdk", s), t.SdkService = e, t.DeviceService = n, t.ZSReportSdk = s;
