window.zs = window.zs || {}, window.zs.laya = window.zs.laya || {},
    function(e, r) {
        ...
        class s {
            ...
            initData() {
                this.baseSize = {
                    w: 750,
                    h: 1334
                }, this.bannerAd = null, this.adUnitId = null, this.showType = s.BOTTOM_RIGHT, this.showMode = s.MODE_BOTTOM_TOUCH, this.exposureSize = {
                    w: 1,
                    h: 1
            ...
            createBanner() {
                if (this.canShowBannerAd) {
                    var e = window.screen.availHeight,
                        r = window.screen.availWidth / this.baseSize.w,
                        s = e / this.baseSize.h,
                        t = this.preStyle.top * s,
                        i = this.preStyle.height * s,
                        n = this.preStyle.left * r,
                        h = this.preStyle.width * r;
                    if (console.log("=============createBanner start...:=============", this.adUnitId, t, n, h), null == this.bannerAd && (this.bannerAd = wx.createBannerAd({
                        ...
                        })), !this.bannerAd) return console.error("Banner 创建失败!", this.bannerAd), void(this.errorReLoadTimes > 0 && (this.errorReLoadTimes--, setTimeout(function() {
                        this.createBanner();
                    }, this.reLoadDelay)));
                    this.showTimes = 0, this.showExposureTimes = 0, this.bannerAd.onError(function(e) {
                        console.error("Banner err:", e), this.errorReLoadTimes > 0 && (this.errorReLoadTimes--, setTimeout(function() {
                            this.createBanner();
                        }, this.reLoadDelay));
            ...
            show() {
                null != this.adUnitId && (null == this.bannerAd && this.createBanner(), this.showMode = s.MODE_BOTTOM_TOUCH, this.bannerAd && this.bannerAd.show(), this.showTimes++);
            }
            updateBottonTouch() {
                this.bannerAd && this.realSize && (this.bannerAd.style.left = .5 * (window.screen.availWidth - this.realSize.w), this.bannerAd.style.top = window.screen.availHeight - this.realSize.h - this.getOffsetY());
            }
            updatePosition() {
                this.bannerAd && this.realSize && (this.bannerAd.style.left = .5 * (window.screen.availWidth - this.realSize.w), this.bannerAd.style.top = window.screen.availHeight - this.realSize.h);
            }
            updateExposure() {}
            showExposure(e, t, i) {}
            compareVersion(e, r) {
        ...
        s.NONE = 0, s.HCENTER = 1, s.VCENTER = 2, s.LEFT = 4, s.RIGHT = 8, s.TOP = 16, s.TOP_LEFT = 20, s.TOP_RIGHT = 24, s.TOP_HCENTER = 17, s.VCENTER_LEFT = 6, s.VCENTER_RIGHT = 10, s.VCENTER_HCENTER = 3, s.BOTTOM_LEFT = 36, s.BOTTOM_RIGHT = 40, s.BOTTEOM_HCENTER = 33, s.MODE_NONE = 0, s.MODE_EXPOSURE = 1, s.MODE_BOTTOM_TOUCH = 2;
        class t {
            constructor(e, r) {
                this.initData(), this.bannerArray = e, this.autoChange = r, this.bannerIds = [];
                for (var s = 0; s < e.length; s++) this.bannerIds[s] = s;
                this.curShowId = zs.laya.platform.MathUtils.random(0, this.bannerArray.length), this.isChanged = !0;
            }
            initData() {
                this.bannerArray = [], this.autoChange = !1, this.curShowId = -1, this.bannerIds = [], this.exposureType = [], this.showExposureIds = [], this.isChanged = !1, this.isLockHide = !1, this.showCountRefresh = zs.laya.platform.ADConfig.zs_banner_show_number;
            }
            onAppShow() {
                console.log("======================== onAppShow start ========================================="), r.stage.off(zs.laya.platform.PlatformMgr.APP_SHOW, this, this.onAppShow), this.show(), console.log("======================== onAppShow end =========================================");
            }
            onAppHide() {
                if (console.log("======================== onAppHide start ========================================="), !(this.curShowId >= this.bannerArray.length)) {
            ...
            getCurrentShowBanner() {
                return this.curShowId >= this.bannerArray.length ? null : this.curShowBanner ? this.curShowBanner : (this.autoChange && !this.isChanged && this.changeBanner(), this.curShowBanner = this.bannerArray[this.curShowId]);
            }
            changeBanner() {
                this.isChanged = !0;
                var e = this.curShowId;
                this.curShowId = (this.curShowId + 1) % this.bannerArray.length, this.bannerArray[this.curShowId] && this.bannerArray[this.curShowId].updateBottonTouch(), this.bannerArray[this.curShowId] && this.bannerArray[this.curShowId].hide();
            ...
            show() {
                ...
                e && !this.isLockHide && (r.stage.on(zs.laya.platform.PlatformMgr.APP_HIDE, this, this.onAppHide), e.show());
            }
            updateY(e) {
            ...
            showExposure(e) {
                ...
                if (r.length > 0) {
                    var t = r[zs.laya.platform.MathUtils.random(0, r.length)],
                        i = this.showExposureIds.length;
            ...
            remove(e, r) {
                var s = e.indexOf(r); - 1 != s && e.splice(s, 1);
            }
            hide() {
                if (r.stage.off(zs.laya.platform.PlatformMgr.APP_HIDE, this, this.onAppHide), r.stage.off(zs.laya.platform.PlatformMgr.APP_SHOW, this, this.onAppShow), !(this.curShowId >= this.bannerArray.length)) {
                    var e = this.bannerArray[this.curShowId];
        ...
        class i {
            constructor() {
                this.bannerAdExposureList = [], this.adUnitIdData = [], this.wxbannerArray = [], this.bannerIds = [], this.bannerGroupArray = [];
            }
            setAdUnitId(...e) {}
