! function(t, e) {
    ...
    var e = function(t, r, n) {
        if (void 0 === t && (t = e.DEFAULT_CAPACITY), void 0 === r && (r = e.DEFAULT_ENDIAN), void 0 === n && (n = e.DEFAULT_NOASSERT), !n) {
            if ((t |= 0) < 0) throw RangeError("Illegal capacity");
            r = !!r, n = !!n;
        }
        this.buffer = 0 === t ? i : new ArrayBuffer(t), this.view = 0 === t ? null : new Uint8Array(this.buffer), this.offset = 0, this.markedOffset = -1, this.limit = t, this.littleEndian = r, this.noAssert = n;
    };
    ...
    function ieee754_read(t, e, r, i, n) {
        var f, o, s = 8 * n - i - 1,
            ...
            g = r ? -1 : 1,
            w = t[e + u];
        for (u += g, f = w & (1 << -l) - 1, w >>= -l, l += s; l > 0; f = 256 * f + t[e + u], u += g, l -= 8);
        for (o = f & (1 << -l) - 1, f >>= -l, l += i; l > 0; o = 256 * o + t[e + u], u += g, l -= 8);
        if (0 === f) f = 1 - a;
        else {
    ...
    function ieee754_write(t, e, r, i, n, f) {
        var o, s, h, a = 8 * f - n - 1,
            ...
            b = i ? 1 : -1,
            v = e < 0 || 0 === e && 1 / e < 0 ? 1 : 0;
        for (e = Math.abs(e), isNaN(e) || e === 1 / 0 ? (s = isNaN(e) ? 1 : 0, o = l) : (o = Math.floor(Math.log(e) / Math.LN2), e * (h = Math.pow(2, -o)) < 1 && (o--, h *= 2), (e += o + u >= 1 ? g / h : g * Math.pow(2, 1 - u)) * h >= 2 && (o++, h /= 2), o + u >= l ? (s = 0, o = l) : o + u >= 1 ? (s = (e * h - 1) * Math.pow(2, n), o += u) : (s = e * Math.pow(2, u - 1) * Math.pow(2, n), o = 0)); n >= 8; t[r + w] = 255 & s, w += b, s /= 256, n -= 8);
    ...
    e.accessor = function() {
        ...
        for (var f, o = 0, s = 0, h = t.length; s < h; ++s) e.isByteBuffer(t[s]) || (t[s] = e.wrap(t[s], r)), (f = t[s].limit - t[s].offset) > 0 && (o += f);
        if (0 === o) return new e(0, i, n);
        var a, l = new e(o, i, n);
        for (s = 0; s < h;)(f = (a = t[s++]).limit - a.offset) <= 0 || (l.view.set(a.view.subarray(a.offset, a.limit), l.offset), l.offset += f);
        ...
        if ("string" != typeof i && (f = n, n = i, i = void 0), "string" == typeof t) switch (void 0 === i && (i = "utf8"), i) {
            case "base64":
        ...
        if (t instanceof Uint8Array) o = new e(0, n, f), t.length > 0 && (o.buffer = t.buffer, o.offset = t.byteOffset, o.limit = t.byteOffset + t.byteLength, o.view = new Uint8Array(t.buffer));
        else if (t instanceof ArrayBuffer) o = new e(0, n, f), t.byteLength > 0 && (o.buffer = t, o.offset = 0, o.limit = t.byteLength, o.view = t.byteLength > 0 ? new Uint8Array(t) : null);
        else {
        ...
        return e > i && this.resize((i *= 2) > e ? i : e), e -= 1, this.view[e] = t, r && (this.offset += 1), this;
        ...
        e += 2;
        var i = this.buffer.byteLength;
        return e > i && this.resize((i *= 2) > e ? i : e), e -= 2, this.littleEndian ? (this.view[e + 1] = (65280 & t) >>> 8, this.view[e] = 255 & t) : (this.view[e] = (65280 & t) >>> 8, this.view[e + 1] = 255 & t), r && (this.offset += 2), this;
        ...
        e += 4;
        var i = this.buffer.byteLength;
        return e > i && this.resize((i *= 2) > e ? i : e), e -= 4, this.littleEndian ? (this.view[e + 3] = t >>> 24 & 255, this.view[e + 2] = t >>> 16 & 255, this.view[e + 1] = t >>> 8 & 255, this.view[e] = 255 & t) : (this.view[e] = t >>> 24 & 255, this.view[e + 1] = t >>> 16 & 255, this.view[e + 2] = t >>> 8 & 255, this.view[e + 3] = 255 & t), r && (this.offset += 4), this;
        ...
        var f = e.low,
            o = e.high;
        return this.littleEndian ? (this.view[r + 3] = f >>> 24 & 255, this.view[r + 2] = f >>> 16 & 255, this.view[r + 1] = f >>> 8 & 255, this.view[r] = 255 & f, r += 4, this.view[r + 3] = o >>> 24 & 255, this.view[r + 2] = o >>> 16 & 255, this.view[r + 1] = o >>> 8 & 255, this.view[r] = 255 & o) : (this.view[r] = o >>> 24 & 255, this.view[r + 1] = o >>> 16 & 255, this.view[r + 2] = o >>> 8 & 255, this.view[r + 3] = 255 & o, r += 4, this.view[r] = f >>> 24 & 255, this.view[r + 1] = f >>> 16 & 255, this.view[r + 2] = f >>> 8 & 255, this.view[r + 3] = 255 & f), i && (this.offset += 8), this;
        ...
        var i = 0,
            n = 0;
        this.littleEndian ? (i = this.view[e + 2] << 16, i |= this.view[e + 1] << 8, i |= this.view[e], i += this.view[e + 3] << 24 >>> 0, e += 4, n = this.view[e + 2] << 16, n |= this.view[e + 1] << 8, n |= this.view[e], n += this.view[e + 3] << 24 >>> 0) : (n = this.view[e + 1] << 16, n |= this.view[e + 2] << 8, n |= this.view[e + 3], n += this.view[e] << 24 >>> 0, e += 4, i = this.view[e + 1] << 16, i |= this.view[e + 2] << 8, i |= this.view[e + 3], i += this.view[e] << 24 >>> 0);
        var f = new t(i, n, !1);
        ...
        e += 4;
        var i = this.buffer.byteLength;
        return e > i && this.resize((i *= 2) > e ? i : e), e -= 4, ieee754_write(this.view, t, e, this.littleEndian, 23, 4), r && (this.offset += 4), this;
        ...
        e += 8;
        var i = this.buffer.byteLength;
        return e > i && this.resize((i *= 2) > e ? i : e), e -= 8, ieee754_write(this.view, t, e, this.littleEndian, 52, 8), r && (this.offset += 8), this;
        ...
        for (r > o && this.resize((o *= 2) > r ? o : r), r -= f, t >>>= 0; t >= 128;) n = 127 & t | 128, this.view[r++] = n, t >>>= 7;
        ...
        return "object" == typeof r ? r.value = e.zigZagDecode32(r.value) : r = e.zigZagDecode32(r), r;
        ...
        var i = e,
            ...
            o = 0,
            s = 0;
        if (n = 127 & (s = this.view[e++]), 128 & s && (n |= (127 & (s = this.view[e++])) << 7, (128 & s || this.noAssert && void 0 === s) && (n |= (127 & (s = this.view[e++])) << 14, (128 & s || this.noAssert && void 0 === s) && (n |= (127 & (s = this.view[e++])) << 21, (128 & s || this.noAssert && void 0 === s) && (f = 127 & (s = this.view[e++]), (128 & s || this.noAssert && void 0 === s) && (f |= (127 & (s = this.view[e++])) << 7, (128 & s || this.noAssert && void 0 === s) && (f |= (127 & (s = this.view[e++])) << 14, (128 & s || this.noAssert && void 0 === s) && (f |= (127 & (s = this.view[e++])) << 21, (128 & s || this.noAssert && void 0 === s) && (o = 127 & (s = this.view[e++]), (128 & s || this.noAssert && void 0 === s) && (o |= (127 & (s = this.view[e++])) << 7, 128 & s || this.noAssert && void 0 === s)))))))))) throw Error("Buffer overrun");
        ...
        return i && i.value instanceof t ? i.value = e.zigZagDecode64(i.value) : i = e.zigZagDecode64(i), i;
        ...
        var f = this.buffer.byteLength;
        if (e > f && this.resize((f *= 2) > e ? f : e), e -= 4 + i, this.littleEndian ? (this.view[e + 3] = i >>> 24 & 255, this.view[e + 2] = i >>> 16 & 255, this.view[e + 1] = i >>> 8 & 255, this.view[e] = 255 & i) : (this.view[e] = i >>> 24 & 255, this.view[e + 1] = i >>> 16 & 255, this.view[e + 2] = i >>> 8 & 255, this.view[e + 3] = 255 & i), e += 4, o.encodeUTF16toUTF8(stringSource(t), function(t) {
                this.view[e++] = t;
        ...
        var i = t,
            n = this.readUint32(t),
            f = this.readUTF8String(n, e.METRICS_BYTES, t += 4);
        ...
        var n, f, s = r;
        n = o.calculateUTF16asUTF8(stringSource(t), this.noAssert)[1], f = e.calculateVarint32(n), r += f + n;
        var h = this.buffer.byteLength;
        if (r > h && this.resize((h *= 2) > r ? h : r), r -= f + n, r += this.writeVarint32(n, r), o.encodeUTF16toUTF8(stringSource(t), function(t) {
                this.view[r++] = t;
        ...
        var i = t,
            ...
            f = this.readUTF8String(n.value, e.METRICS_BYTES, t += n.length);
        return t += f.length, r ? (this.offset = t, f.string) : {
            string: f.string,
            length: t - i
        };
        ...
        i += f;
        var o = this.buffer.byteLength;
        return i > o && this.resize((o *= 2) > i ? o : i), i -= f, this.view.set(t.view.subarray(t.offset, t.limit), i), t.offset += f, n && (this.offset += f), this;
        ...
        return t ? (r.buffer = new ArrayBuffer(this.buffer.byteLength), r.view = new Uint8Array(r.buffer)) : (r.buffer = this.buffer, r.view = this.view), r.offset = this.offset, r.markedOffset = this.markedOffset, r.limit = this.limit, r;
        ...
        var r = e - t;
        if (0 === r) return this.buffer = i, this.view = null, this.markedOffset >= 0 && (this.markedOffset -= t), this.offset = 0, this.limit = 0, this;
        var n = new ArrayBuffer(r),
            f = new Uint8Array(n);
        return f.set(this.view.subarray(t, e)), this.buffer = n, this.view = f, this.markedOffset >= 0 && (this.markedOffset -= t), this.offset = 0, this.limit = r, this;
    }, r.copy = function(t, r) {
        ...
        return n.offset = 0, n.limit = i, n.markedOffset >= 0 && (n.markedOffset -= t), this.copyTo(n, 0, t, r), n;
    }, r.copyTo = function(t, r, i, n) {
        var f, o;
        if (!this.noAssert && !e.isByteBuffer(t)) throw TypeError("Illegal target: Not a ByteBuffer");
        if (r = (o = void 0 === r) ? t.offset : 0 | r, i = (f = void 0 === i) ? this.offset : 0 | i, n = void 0 === n ? this.limit : 0 | n, r < 0 || r > t.buffer.byteLength) throw RangeError("Illegal target range: 0 <= " + r + " <= " + t.buffer.byteLength);
        if (i < 0 || n > this.buffer.byteLength) throw RangeError("Illegal source range: 0 <= " + i + " <= " + this.buffer.byteLength);
        var s = n - i;
        return 0 === s ? t : (t.ensureCapacity(r + s), t.view.set(this.view.subarray(i, n), r), f && (this.offset += s), o && (t.offset += s), this);
    }, r.ensureCapacity = function(t) {
        var e = this.buffer.byteLength;
        return e < t ? this.resize((e *= 2) > t ? e : t) : this;
    }, r.fill = function(t, e, r) {
        var i = void 0 === e;
        if (i && (e = this.offset), "string" == typeof t && t.length > 0 && (t = t.charCodeAt(0)), void 0 === e && (e = this.offset), void 0 === r && (r = this.limit), !this.noAssert) {
            if ("number" != typeof t || t % 1 != 0) throw TypeError("Illegal value: " + t + " (not an integer)");
        ...
        if (o > 0) {
            var s = new ArrayBuffer(this.buffer.byteLength + o),
                h = new Uint8Array(s);
            h.set(this.view.subarray(i, this.buffer.byteLength), f), this.buffer = s, this.view = h, this.offset += o, this.markedOffset >= 0 && (this.markedOffset += o), this.limit += o, i += o;
        } else new Uint8Array(this.buffer);
        return this.view.set(t.view.subarray(t.offset, t.limit), i - f), t.offset = t.limit, n && (this.offset -= f), this;
    ...
    var f = function() {
        ...
        return t.encode = function(t, r) {
            for (var i, n; null !== (i = t());) r(e[i >> 2 & 63]), n = (3 & i) << 4, null !== (i = t()) ? (r(e[63 & ((n |= i >> 4 & 15) | i >> 4 & 15)]), n = (15 & i) << 2, null !== (i = t()) ? (r(e[63 & (n | i >> 6 & 3)]), r(e[63 & i])) : (r(e[63 & n]), r(61))) : (r(e[63 & n]), r(61), r(61));
            ...
            for (; null !== (i = t());)
                if (void 0 === (n = r[i]) && fail(i), null !== (i = t()) && (void 0 === (f = r[i]) && fail(i), e(n << 2 >>> 0 | (48 & f) >> 4), null !== (i = t()))) {
                    if (void 0 === (n = r[i])) {
                        if (61 === i) break;
                        fail(i);
                    }
    ...
    r.toBase64 = function(t, e) {
        ...
        if (void 0 === t && (t = this.offset), void 0 === e && (e = this.limit), e |= 0, (t |= 0) < 0 || e > this.capacity() || t > e) throw RangeError("begin, end");
        if (t === e) return "";
        for (var r = [], i = []; t < e;) r.push(this.view[t++]), r.length >= 1024 && (i.push(String.fromCharCode.apply(String, r)), r = []);
        ...
        for (var e, r = -1, i = this.buffer.byteLength, n = "", f = "", o = ""; r < i;) {
            if (-1 !== r && (n += (e = this.view[r]) < 16 ? "0" + e.toString(16).toUpperCase() : e.toString(16).toUpperCase(), t && (f += e > 32 && e < 127 ? String.fromCharCode(e) : ".")), ++r, t && r > 0 && r % 16 == 0 && r !== i) {
                for (; n.length < 51;) n += " ";
                o += n + f + "\n", n = f = "";
            }
        ...
        var t = {
            ...
            decodeUTF8: function(t, e) {
                for (var r, i, n, f, o = function(t) {
                    ...
                    if (0 == (128 & r)) e(r);
                    else if (192 == (224 & r)) null === (i = t()) && o([r, i]), e((31 & r) << 6 | 63 & i);
                else if (224 == (240 & r))(null === (i = t()) || null === (n = t())) && o([r, i, n]), e((15 & r) << 12 | (63 & i) << 6 | 63 & n);
                else {
            ...
            UTF16toUTF8: function(t, e) {
                for (var r, i = null; null !== (r = null !== i ? i : t());) r >= 55296 && r <= 57343 && null !== (i = t()) && i >= 56320 && i <= 57343 ? (e(1024 * (r - 55296) + i - 56320 + 65536), i = null) : e(r);
                null !== i && e(i);
            },
    ...
    return r.toUTF8 = function(t, e) {
        ...
        var n = new e(o.calculateUTF16asUTF8(stringSource(t), !0)[1], r, i),
            f = 0;
