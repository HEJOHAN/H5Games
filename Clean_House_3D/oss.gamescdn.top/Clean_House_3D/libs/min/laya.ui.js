! function(s, r, _) {
    ...
    var n = _.static,
        h = _.class,
        o = _.getset,
        a = (_.__newvec, laya.display.Animation),
    ...
    var T = (h(D, "UIConfig"), D.touchScrollEnable = !0, D.mouseWheelEnable = !0, D.showButtons = !0, D.popupBgColor = "#000000", D.popupBgAlpha = .5, D.closeDialogOnSide = !0, D);

    function D() {}
    var H = (h(O, "laya.ui.Styles"), O.labelColor = "#000000", O.buttonStateNum = 3, O.scrollBarMinNum = 15, O.scrollBarDelayTime = 500, n(O, ["defaultSizeGrid", function() {
    ...
    function O() {}
    var P = (h(Y, "laya.ui.UIUtils"), Y.fillArray = function(t, i, e) {
        var s = t.concat();
        if (i)
        ...
        return s
    }, Y.toColor = function(t) {
        return M.toHexColor(t)
    }, Y.gray = function(t, i) {
        void 0 === i && (i = !0), i ? Y.addFilter(t, Y.grayFilter) : Y.clearFilter(t, e)
    }, Y.addFilter = function(t, i) {
        var e = t.filters || [];
        e.push(i), t.filters = e
    }, Y.clearFilter = function(t, i) {
        var e = t.filters;
    ...
    }, Y._getReplaceStr = function(t) {
        return Y.escapeSequence[t]
    }, Y.adptString = function(t) {
        return t.replace(/\\(\w)/g, Y._getReplaceStr)
    }, Y.getBindFun = function(t) {
        var i = Y._funMap.get(t);
        if (null == i) {
            var e = '"' + t + '"',
                s = "(function(data){if(data==null)return;with(data){try{\nreturn " + (e = e.replace(/^"\${|}"$/g, "").replace(/\${/g, '"+').replace(/}/g, '+"')) + "\n}catch(e){}}})";
            i = _._runScript(s), Y._funMap.set(t, i)
        }
        return i
    }, n(Y, ["grayFilter", function() {
    ...
    var A = function() {
        function t() {
            t.__super.call(this), this._top = NaN, this._bottom = NaN, this._left = NaN, this._right = NaN, this._centerX = NaN, this._centerY = NaN
        }
        h(t, "laya.ui.Widget", u);
        var i = t.prototype;
    ...
    h(N, "laya.ui.UIEvent", f), N.SHOW_TIP = "showtip", N.HIDE_TIP = "hidetip";
    ...
    var X = function(t) {
        ...
        E = function(i) {
            function t() {
                this._dataSource = null, this._toolTip = null, this._tag = null, this._disabled = !1, this._gray = !1, t.__super.call(this), this._anchorX = NaN, this._anchorY = NaN, this._widget = A.EMPTY, this.preinitialize(), this.createChildren(), this.initialize()
            }
            h(t, "laya.ui.UIComponent", i);
            var e = t.prototype;
            return e.destroy = function(t) {
                ...
                isNaN(this._anchorX) || (this.pivotX = this.anchorX * this.width), isNaN(this._anchorY) || (this.pivotY = this.anchorY * this.height), this.event("resize"), this._widget !== A.EMPTY && this._widget.resetLayout()
        ...
        G = function() {
            function t() {
                ...
                }, t.__super.call(this), this.maskLayer = new x, this.popupEffectHandler = new g(this, this.popupEffect), this.closeEffectHandler = new g(this, this.closeEffect), this.mouseEnabled = this.maskLayer.mouseEnabled = !0, this.zOrder = 1e3, _.stage.addChild(this), _.stage.on("resize", this, this._onResize), T.closeDialogOnSide && this.maskLayer.on("click", this, this._closeOnSide), this._onResize(null)
            }
            h(t, "laya.ui.DialogManager", x);
            var i = t.prototype;
            return i._closeOnSide = function() {
                ...
                this.lockLayer || (this.lockLayer = new W, this.lockLayer.mouseEnabled = !0, this.lockLayer.size(_.stage.width, _.stage.height)), this.lockLayer.removeChildren(), t && (t.centerX = t.centerY = 0, this.lockLayer.addChild(t))
        ...
        R = function(i) {
            function e() {
                this._watchMap = {}, this._widget = null, this._dataSource = null, this._anchorX = NaN, this._anchorY = NaN, this._widget = A.EMPTY, e.__super.call(this)
            }
            h(e, "laya.ui.View", i);
            var t = e.prototype;
            return t.destroy = function(t) {
            ...
            }, o(0, t, "anchorX", function() {
                return this._anchorX
            }, function(t) {
                this._anchorX != t && (this._anchorX = t, this.callLater(this._sizeChanged))
            }), o(0, t, "centerX", function() {
                return this._widget.centerX
            }, function(t) {
                t != this._widget.centerX && (this._getWidget().centerX = t)
            }), o(0, t, "top", function() {
                ...
                t != this._widget.top && (this._getWidget().top = t)
            }), o(0, t, "bottom", function() {
                return this._widget.bottom
            }, function(t) {
                t != this._widget.bottom && (this._getWidget().bottom = t)
            }), o(0, t, "dataSource", function() {
                return this._dataSource
            }, function(t) {
                ...
                t != this._widget.left && (this._getWidget().left = t)
            }), o(0, t, "right", function() {
                return this._widget.right
            }, function(t) {
                t != this._widget.right && (this._getWidget().right = t)
            }), o(0, t, "anchorY", function() {
                return this._anchorY
            }, function(t) {
                this._anchorY != t && (this._anchorY = t, this.callLater(this._sizeChanged))
            }), o(0, t, "centerY", function() {
                return this._widget.centerY
            }, function(t) {
                t != this._widget.centerY && (this._getWidget().centerY = t)
                ...
                c.regShortClassName([it, V, Bt, J, W, lt, V, nt, j, F, E, mt, yt, U, $, rt, ot, q, ct, St, Q, K, kt, at, e, tt, _t, ft, ht, bt, xt, x, a, B, ut])
            }, e
        }(i),
        W = (function(t) {
            function i() {
            ...
            h(i, "laya.ui.WXOpenDataViewer", t);
            var e = i.prototype;
            e.onEnable = function() {
                this.postMsg({
                    type: "display",
            ...
            }, o(0, e, "x", t.prototype._$get_x, function(t) {
                _.superSet(E, this, "x", t), this.callLater(this._postMsg)
            }), o(0, e, "width", t.prototype._$get_width, function(t) {
                _.superSet(E, this, "width", t), s.sharedCanvas && (s.sharedCanvas.width = t), this.callLater(this._postMsg)
            }), o(0, e, "height", t.prototype._$get_height, function(t) {
                _.superSet(E, this, "height", t), s.sharedCanvas && (s.sharedCanvas.height = t), this.callLater(this._postMsg)
            }), o(0, e, "y", t.prototype._$get_y, function(t) {
                _.superSet(E, this, "y", t), this.callLater(this._postMsg)
            })
        }(E), function(t) {
            function i() {
        ...
        V = function(i) {
            ...
            return _.imps(t, {
                ...
                this.createText(), this._text.padding = P.fillArray(H.labelPadding, t, Number)
                ...
                this._strokeColors = P.fillArray(H.buttonLabelColors, t, String), this._setStateChanged()
            }), o(0, t, "labelColors", function() {
                return this._labelColors.join(",")
            }, function(t) {
                this._labelColors = P.fillArray(H.buttonLabelColors, t, String), this._setStateChanged()
                ...
                this._bitmap.sizeGrid = P.fillArray(H.defaultSizeGrid, t, Number)
            }), o(0, t, "width", i.prototype._$get_width, function(t) {
                _.superSet(E, this, "width", t), this._autoSize && (this._bitmap.width = t, this._text && (this._text.width = t))
            }), o(0, t, "height", i.prototype._$get_height, function(t) {
                _.superSet(E, this, "height", t), this._autoSize && (this._bitmap.height = t, this._text && (this._text.height = t))
            }), o(0, t, "dataSource", i.prototype._$get_dataSource, function(t) {
                "number" == typeof(this._dataSource = t) || "string" == typeof t ? this.label = t + "" : _.superSet(E, this, "dataSource", t)
        ...
        U = function(i) {
            ...
            return t.destroy = function(t) {
                ...
                "string" == typeof(this._dataSource = t) ? this.skin = t: _.superSet(E, this, "dataSource", t)
                ...
                _.superSet(E, this, "width", t), this._bitmap.width = 0 == t ? 1e-7 : t
            }), o(0, t, "height", i.prototype._$get_height, function(t) {
                _.superSet(E, this, "height", t), this._bitmap.height = 0 == t ? 1e-7 : t
            }), e
        }(E),
        $ = function(i) {
            function e(t) {
            ...
            return t.destroy = function(t) {
                ...
                this._tf.padding = P.fillArray(H.labelPadding, t, Number)
            }), o(0, t, "bold", function() {
                ...
                this._tf.text != t && (t && (t = P.adptString(t + "")), this._tf.text = t, this.event("change"), this._width && this._height || this.onCompResize())
                ...
                "number" == typeof(this._dataSource = t) || "string" == typeof t ? this.text = t + "" : _.superSet(E, this, "dataSource", t)
                ...
                return this._width || this._tf.text ? _.superGet(E, this, "width") : 0
            }, function(t) {
                _.superSet(E, this, "width", t), this._tf.width = t
            }), o(0, t, "height", function() {
                return this._height || this._tf.text ? _.superGet(E, this, "height") : 0
            }, function(t) {
                _.superSet(E, this, "height", t), this._tf.height = t
        ...
        F = function(i) {
            function e(t, i) {
                this._visibleNum = 6, this._button = null, this._list = null, this._isOpen = !1, this._itemSize = 12, this._labels = [], this._selectedIndex = -1, this._selectHandler = null, this._itemHeight = NaN, this._listHeight = NaN, this._listChanged = !1, this._itemChanged = !1, this._scrollBarSkin = null, this._isCustomList = !1, this.itemRender = null, e.__super.call(this), this._itemColors = H.comboBoxItemColors, this.skin = t, this.labels = i
            }
            ...
            return t.destroy = function(t) {
                ...
                this._list = new rt, this._scrollBarSkin && (this._list.vScrollBarSkin = this._scrollBarSkin), this._setListEvent(this._list)
                ...
                _.superSet(E, this, "width", t), this._button.width = this._width, this._itemChanged = !0, this._listChanged = !0
                ...
                _.superSet(E, this, "height", t), this._button.height = this._height
                ...
                "number" == typeof(this._dataSource = t) && Math.floor(t) == t || "string" == typeof t ? this.selectedIndex = parseInt(t) : t instanceof Array ? this.labels = t.join(",") : _.superSet(E, this, "dataSource", t)
            }), o(0, t, "labelColors", function() {
                ...
                this._button.text.padding = P.fillArray(H.labelPadding, t, Number)
            }), o(0, t, "labelSize", function() {
        ...
        j = (function() {
            ...
            return t.destroy = function(t) {
                ...
                _.superSet(E, this, "width", t), this._bitmap.width = t
            }), o(0, t, "height", i.prototype._$get_height, function(t) {
                _.superSet(E, this, "height", t), this._bitmap.height = t
                ...
                "number" == typeof(this._dataSource = t) && Math.floor(t) == t || "string" == typeof t ? this.index = parseInt(t) : _.superSet(E, this, "dataSource", t)
        ...
        J = function(i) {
            ...
            return e.destroy = function(t) {
                ...
                this.addChild(this._colorButton = new V), this._colorPanel = new W, this._colorPanel.size(230, 166), this._colorPanel.addChild(this._colorTiles = new x), this._colorPanel.addChild(this._colorBlock = new x), this._colorPanel.addChild(this._colorInput = new m)
        ...
        q = function(i) {
            ...
            return t.destroy = function(t) {
                ...
                "number" == typeof(this._dataSource = t) || "string" == typeof t ? this.value = Number(t) : _.superSet(E, this, "dataSource", t)
            }), o(0, t, "skin", function() {
                return this._skin
            }, function(t) {
                ...
                _.superSet(E, this, "height", t), this._bg.height = this._height, this._bar.height = this._height
            }), o(0, t, "bar", function() {
                return this._bar
                ...
                _.superSet(E, this, "width", t), this._bg.width = this._width, this.callLater(this.changeValue)
            }), e
        }(E),
        Q = function(i) {
            function e(t) {
            ...
            return t.destroy = function(t) {
                ...
                this.slide(i), _.timer.once(H.scrollBarDelayTime, this, this.startLoop, [i]), _.stage.once("mouseup", this, this.onStageMouseUp)
                ...
                this.runCallLater(this.changeScrollBar), this.runCallLater(this._sizeChanged), t = 1 <= t ? .99 : t, this._thumbPercent = t, this.scaleBar && (this.slider.isVertical ? this.slider.bar.height = Math.max(this.slider.height * t, H.scrollBarMinNum) : this.slider.bar.width = Math.max(this.slider.width * t, H.scrollBarMinNum))
            }), o(0, t, "dataSource", i.prototype._$get_dataSource, function(t) {
                "number" == typeof(this._dataSource = t) || "string" == typeof t ? this.value = Number(t) : _.superSet(E, this, "dataSource", t)
            }), o(0, t, "skin", function() {
                return this._skin
        ...
        K = function(i) {
            ...
            return t.destroy = function(t) {
                ...
                v.getRes(t) && (this._progress || (this.addChild(this._progress = new U), this._progress.sizeGrid = this._bar.sizeGrid, this.setChildIndex(this._progress, 1)), this._progress.skin = t), this.setBarPoint(), this.callLater(this.changeValue), this._sizeChanged(), this.event("loaded")
        ...
        Z = function() {
            ...
            return t.getLocalDateString = function(t) {
                ...
                if (this._moreBox) this._moreBox.visible = !0;
                    ...
                    this._moreBox = new W, _.stage.addChild(this._moreBox), this._moreBox.zOrder = 99999, this._moreBox.left = this._moreBox.right = this._moreBox.top = this._moreBox.bottom = 0;
            ...
            }, u._moreGameData = null, n(u, ["_http", function() {
        ...
        tt = function(i) {
            ...
            }, o(0, t, "dragArea", function() {
                return this._dragArea ? this._dragArea.toString() : null
            }, function(t) {
                if (t) {
                    var i = P.fillArray([0, 0, 0, 0], t, Number);
            ...
            }), o(0, t, "isPopup", function() {
                return null != this.parent
            }), o(0, t, "zOrder", i.prototype._$get_zOrder, function(t) {
                _.superSet(R, this, "zOrder", t), s.manager._checkMask()
            }), o(1, s, "manager", function() {
                return s._manager = s._manager || new G
            }, function(t) {
                s._manager = t
        ...
        st = function(t) {
            ...
            return _.imps(i, {
                ...
                "number" == typeof(this._dataSource = t) && Math.floor(t) == t || "string" == typeof t ? this.selectedIndex = parseInt(t) : t instanceof Array ? this.labels = t.join(",") : _.superSet(W, this, "dataSource", t)
            }), e
        }(W),
        nt = function(t) {
            function e(t, i) {
            ...
            return i.preinitialize = function() {
                ...
                "boolean" == typeof(this._dataSource = t) ? this.selected = t: "string" == typeof t ? this.selected = "true" === t : _.superSet(V, this, "dataSource", t)
            }), e
        }(V),
        ht = function(t) {
            function i() {
            ...
            return _.imps(e, {
                ...
                this.addChild(this._list = new rt), this._list.renderHandler = g.create(this, this.renderItem, null, !1), this._list.repeatX = 1, this._list.on("change", this, this.onListChange)
                ...
                this._dataSource = t, _.superSet(W, this, "dataSource", t)
                ...
                _.superSet(W, this, "width", t), this._list.width = t
            }), o(0, e, "height", t.prototype._$get_height, function(t) {
                _.superSet(W, this, "height", t), this._list.height = t
        ...
        ot = function(t) {
            ...
            return e.destroy = function(t) {
                ...
                this._usedCache || (this._usedCache = _.superGet(W, this, "cacheAs")), _.superSet(W, this, "cacheAs", "none"), this._hScrollBar && this._hScrollBar.once("end", this, this.onScrollEnd), this._vScrollBar && this._vScrollBar.once("end", this, this.onScrollEnd)
            }, e.onScrollEnd = function() {
                _.superSet(W, this, "cacheAs", this._usedCache)
                ...
                null == this._hScrollBar && (laya.display.Node.prototype.addChild.call(this, this._hScrollBar = new mt), this._hScrollBar.on("change", this, this.onScrollBarChange, [this._hScrollBar]), this._hScrollBar.target = this._content, this._hScrollBar.elasticDistance = this._elasticEnabled ? 200 : 0, this._setScrollChanged()), this._hScrollBar.skin = t
                ...
                _.superSet(W, this, "width", t), this._setScrollChanged()
            }), o(0, e, "hScrollBar", function() {
                return this._hScrollBar
            }), o(0, e, "content", function() {
                return this._content
            }), o(0, e, "height", t.prototype._$get_height, function(t) {
                _.superSet(W, this, "height", t), this._setScrollChanged()
            }), o(0, e, "vScrollBarSkin", function() {
                return this._vScrollBar ? this._vScrollBar.skin : null
            }, function(t) {
                null == this._vScrollBar && (laya.display.Node.prototype.addChild.call(this, this._vScrollBar = new _t), this._vScrollBar.on("change", this, this.onScrollBarChange, [this._vScrollBar]), this._vScrollBar.target = this._content, this._vScrollBar.elasticDistance = this._elasticEnabled ? 200 : 0, this._setScrollChanged()), this._vScrollBar.skin = t
            }), o(0, e, "vScrollBar", function() {
                return this._vScrollBar
            }), o(0, e, "cacheAs", t.prototype._$get_cacheAs, function(t) {
                _.superSet(W, this, "cacheAs", t), this._usedCache = null, "none" !== t ? (this._hScrollBar && this._hScrollBar.on("start", this, this.onScrollStart), this._vScrollBar && this._vScrollBar.on("start", this, this.onScrollStart)) : (this._hScrollBar && this._hScrollBar.off("start", this, this.onScrollStart), this._vScrollBar && this._vScrollBar.off("start", this, this.onScrollStart))
            }), o(0, e, "elasticEnabled", function() {
        ...
        rt = function(t) {
            ...
            return _.imps(e, {
                ...
                this._usedCache || (this._usedCache = _.superGet(W, this, "cacheAs")), _.superSet(W, this, "cacheAs", "none"), this._scrollBar.once("end", this, this.onScrollEnd)
            }, e.onScrollEnd = function() {
                _.superSet(W, this, "cacheAs", this._usedCache)
                ...
                _.superSet(W, this, "cacheAs", t), this._scrollBar && (this._usedCache = null, "none" !== t ? this._scrollBar.on("start", this, this.onScrollStart) : this._scrollBar.off("start", this, this.onScrollStart))
            }), o(0, e, "content", function() {
                return this._content
            }), o(0, e, "height", t.prototype._$get_height, function(t) {
                t != this._height && (_.superSet(W, this, "height", t), this._setCellChanged())
            }), o(0, e, "itemRender", function() {
                ...
                t != this._width && (_.superSet(W, this, "width", t), this._setCellChanged())
                ...
                if (this.totalPage = Math.ceil(i / (this.repeatX * this.repeatY)), this._selectedIndex = this._selectedIndex < i ? this._selectedIndex : i - 1, this.startIndex = this._startIndex, this._scrollBar) {
                    ...
                    var e = this._isVertical ? this.repeatX : this.repeatY,
                        s = this._isVertical ? this.repeatY : this.repeatX,
                        n = Math.ceil(i / e);
                    1 < (0 < this._cellOffset ? this.totalPage + 1 : this.totalPage) && s <= n ? (this._scrollBar.scrollSize = this._cellSize, this._scrollBar.thumbPercent = s / n, this._scrollBar.setScroll(0, (n - s) * this._cellSize + this._cellOffset, this._scrollBar.value)) : this._scrollBar.setScroll(0, 0, 0), this._scrollBar.target = this._content
                }
            }), o(0, e, "dataSource", t.prototype._$get_dataSource, function(t) {
                "number" == typeof(this._dataSource = t) && Math.floor(t) == t || "string" == typeof t ? this.selectedIndex = parseInt(t) : t instanceof Array ? this.array = t : _.superSet(W, this, "dataSource", t)
        ...
        at = function(i) {
            ...
            return t.preinitialize = function() {
                ...
                this.addChild(this._tf = new m), this._tf.padding = H.inputLabelPadding, this._tf.on("input", this, this._onInput), this._tf.on("enter", this, this._onEnter), this._tf.on("blur", this, this._onBlur), this._tf.on("focus", this, this._onFocus)
            }, t._onFocus = function() {
                ...
                this._bg || (this.graphics = this._bg = new X), this._bg.source = v.getRes(this._skin), this._width && (this._bg.width = this._width), this._height && (this._bg.height = this._height), this._sizeChanged(), this.event("loaded")
            }, t.select = function() {
                this._tf.select()
                ...
                this._bg || (this.graphics = this._bg = new X), this._bg.sizeGrid = P.fillArray(H.defaultSizeGrid, t, Number)
            }), o(0, t, "width", i.prototype._$get_width, function(t) {
                _.superSet($, this, "width", t), this._bg && (this._bg.width = t)
            }), o(0, t, "height", i.prototype._$get_height, function(t) {
                _.superSet($, this, "height", t), this._bg && (this._bg.height = t)
        ...
        lt = function(t) {
            ...
            return e.onEnable = function() {
                ...
                if (0 < this.width && 0 < this.height) {
                    ...
                    _.superSet(W, this, "width", _.stage.width), _.superSet(W, this, "height", _.stage.height), this.scale(t, t)
                }
            }, o(0, e, "width", t.prototype._$get_width, function(t) {
                _.superSet(W, this, "width", t), this._oldW = t
            }), o(0, e, "height", t.prototype._$get_height, function(t) {
                _.superSet(W, this, "height", t), this._oldH = t
            }), i
        }(W),
        ct = function(i) {
            function e(t, i) {
        ...
        ut = function(i) {
            ...
            return t.createChildren = function() {
                ...
                _.superSet(j, this, "height", t), this.callLater(this.changeValue)
                ...
                _.superSet(j, this, "width", t), this.callLater(this.changeValue)
        ...
        }(U), h(dt, "laya.ui.VScrollBar", Q), dt);

    function dt() {
        dt.__super.call(this)
    }
    var ft = (h(gt, "laya.ui.VSlider", K), gt);

    function gt() {
        gt.__super.call(this)
    }
    var pt, mt = (h(vt, "laya.ui.HScrollBar", pt = Q), vt.prototype.initialize = function() {
        pt.prototype.initialize.call(this), this.slider.isVertical = !1
    }, vt);

    function vt() {
        vt.__super.call(this)
    }
    var yt = (h(Ct, "laya.ui.HSlider", K), Ct);

    function Ct(t) {
        Ct.__super.call(this, t), this.isVertical = !1
    }
    var bt = function(t) {
            function i() {
                i.__super.call(this)
            ...
            return e.sortItem = function(t) {
                ...
                this._height != t && (_.superSet(et, this, "height", t), this.callLater(this.changeItems))
            }), i.NONE = "none", i.TOP = "top", i.MIDDLE = "middle", i.BOTTOM = "bottom", i
        }(et),
        St = (h(wt, "laya.ui.RadioGroup", st), wt.prototype.createItem = function(t, i) {
            return new ct(t, i)
        }, wt);

    function wt() {
        wt.__super.call(this)
    }
    var xt = function(t) {
            function i() {
                i.__super.call(this)
            ...
            return e.changeItems = function() {
                ...
                this._width != t && (_.superSet(et, this, "width", t), this.callLater(this.changeItems))
        ...
        Bt = function(i) {
            ...
            return t._onTextChange = function() {
                ...
                var t = this._vScrollBar && 0 < this._tf.maxScrollY,
                    ...
                    n = this._tf.padding || H.labelPadding;
                ...
                _.superSet(at, this, "width", t), this.callLater(this.changeScroll)
            }), o(0, t, "hScrollBar", function() {
                return this._hScrollBar
            }), o(0, t, "height", i.prototype._$get_height, function(t) {
                _.superSet(at, this, "height", t), this.callLater(this.changeScroll)
                ...
                null == this._hScrollBar && (this.addChild(this._hScrollBar = new mt), this._hScrollBar.on("change", this, this.onHBarChanged), this._hScrollBar.mouseWheelEnable = !1, this._hScrollBar.target = this._tf, this.callLater(this.changeScroll)), this._hScrollBar.skin = t
        ...
        kt = (h(It, "laya.ui.Tab", st), It.prototype.createItem = function(t, i) {
            return new V(t, i)
        }, It);

    function It() {
        It.__super.call(this)
    }
    _.__init([Z, R])
