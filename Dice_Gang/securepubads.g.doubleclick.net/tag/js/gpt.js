(function(sttc) {
    ...
    */
    ...
    function Gb(a, b, c) {
        if (null != a && "object" === typeof a && a.Y === hb) return a;
        if (Array.isArray(a)) {
            var d = G(a),
                e = d;
            0 === e && (e |= c & 32);
    ...
    function Pb(a, b, c) {
        ...
        if (null != a) {
            ...
            a.Y === hb && (c = a.h, d = H(c), a = d & 2 ? a : Ib(a.constructor, Qb(c, d, !0)));
            return a
        }
    }
    ...
    var fc = function(a, b) {
            (a = ec(a, b, 1, !1)) ? b = a: (a = b[cb]) ? b = a : (a = new b, db(a.h, 34), b = b[cb] = a);
            return b
        },
        R = function(a, b, c) {
            var d = void 0 === d ? !1 : d;
    ...
    function pc(a, b, c) {
        var d = Ba ? void 0 : a.constructor.o;
        var e = H(c ? a.h : b);
        a = b.length;
        if (!a) return b;
        var f;
    ...
    */
    function Tc(a, b) {
        ...
        b.async && (a += " async");
        b.Ca && (a += ' custom-element="' + Uc(b.Ca) + '"');
        b.defer && (a += " defer");
        b.id && (a += ' id="' + Uc(b.id) + '"');
        b.nonce && (a += ' nonce="' + Uc(b.nonce) + '"');
        b.type && (a += ' type="' + Uc(b.type) + '"');
        b.qa && (a += ' crossorigin="' + Uc(b.qa) + '"');
    ...
    ue.prototype.G = function() {
        var a = ra.apply(0, arguments),
            b = this;
        try {
            this.M && 65536 <= Sd(this.g.concat(a), this.j).length && ve(this), this.l && !this.s && (this.s = !0, this.l.g(function() {
                ve(b)
            })), this.g.push.apply(this.g, y(a)), this.g.length >= this.L && ve(this), this.g.length && null === this.i && (this.i = setTimeout(function() {
                ve(b)
            }, this.K))
        } catch (c) {
            Td(c, this.j)
    ...
    var Xe = function(a) {
            ...
            this.i = (c = He(a.document)) && null != Fb(Tb(c, 1)) ? T(c, 1) : null;
            this.j = (a = He(a.document)) && null != Fb(Tb(a, 2)) ? T(a, 2) : null
        },
        $e = function(a) {
            a !== a.top || a.__uspapi || a.frames.__uspapiLocator || (a = new Xe(a), Ye(a), Ze(a))
        },
        Ye = function(a) {
            !a.l || a.g.__uspapi || a.g.frames.__uspapiLocator || (a.g.__uspapiManager = "fc", Ue(a.g, "__uspapiLocator"), wa("__uspapi", function() {
    ...
    var Ve = function(a) {
        ...
        Ze = function(a) {
            !a.i || a.g.__tcfapi || a.g.frames.__tcfapiLocator || (a.g.__tcfapiManager = "fc", Ue(a.g, "__tcfapiLocator"), a.g.__tcfapiEventListeners = a.g.__tcfapiEventListeners || [], wa("__tcfapi", function() {
                return a.s.apply(a, y(ra.apply(0, arguments)))
            }, a.g), Pe(a.g))
        };
    Xe.prototype.s = function(a, b, c, d) {
        d = void 0 === d ? null : d;
        if ("function" === typeof c)
            if (b && (2.2 < b || 1 >= b)) c(null, !1);
                ...
                case "addEventListener":
                    a = b.push(c) - 1;
                    this.i ? (d = Kd(this.i), d.addtlConsent = null != this.j ? this.j : void 0, d.cmpStatus = "loaded", d.eventStatus = "tcloaded", null != a && (d.listenerId = a), a = d) : a = null;
                    c(a, !0);
                    break;
    ...
    function Af(a, b, c, d) {
        var e = d = void 0 === d ? 0 : d,
            f, g;
        W(Bf).j[e] = null != (g = null == (f = W(Bf).j[e]) ? void 0 : f.add(b)) ? g : (new t.Set).add(b);
        e = zf();
    ...
    function Lf() {
        return Ia(u(Object, "keys").call(Object, W(Bf).i), function(a) {
            return Number(a)
        })
    }
    ...
    function Pf(a) {
        ...
        Y(14, function(b) {
            for (var c = W(vf), d = w([3, 4, 5]), e = d.next(); !e.done; e = d.next()) e = e.value, u(Object, "assign").call(Object, c.A[e], b[e])
        }, a)
    }
    ...
    var ig = [12, 13, 20],
        ...
        lg = function(a, b, c, d) {
            ...
            if (f) return sf(a.B, b, c, e, [], 4), e;
            f = u(ig, "includes").call(ig, b);
            for (var g = [], h = W(vf).A, k = [], l = w([0, 1, 2]), m = l.next(); !m.done; m = l.next()) {
                m = m.value;
                for (var q = w(u(a.H[m], "entries").call(a.H[m])), p = q.next(); !p.done; p = q.next()) {
                    ...
                    r = x.filter(function(Ub) {
                        return Ub.ra === b && !!a.i[Ub.F.getId()] && kf(R(Ub.O, cf, 3), h) && kf(R(Ub.F, cf, 3), h)
                    });
                    if (r.length)
                        for (p = w(r), r = p.next(); !r.done; r = p.next()) k.push(r.value.F);
                    else if (!a.U) {
                        r = void 0;
                        ...
                        if (void 0 !== r) {
                            ...
                            for (x = J.next(); !x.done; x = J.next())
                                if (x = x.value, x.ra === b) {
                                    ...
                                    var Me = qa.xa;
                                    qa = qa.Ka;
                                    0 <= E && E < I * Me && E % Me === qa && kf(R(x.O, cf, 3), h) && kf(R(x.F, cf, 3), h) && (E = U(x.O, 13), 0 !== E && void 0 !== E && (I = a.j[String(E)], void 0 !== I && I !== x.F.getId() ? uf(a.B, a.j[String(E)], x.F.getId(), E) : a.j[String(E)] = x.F.getId()), k.push(x.F))
                                }
            ...
            d = w(k);
            for (k = d.next(); !k.done; k = d.next()) k = k.value, l = k.getId(), e.push(l), kg(a, l, f ? 4 : c), Jf(S(k, nf, 2), f ? Lf() : [c], a.B, l);
            sf(a.B, b, c, e, g, 1);
            return e
        },
        kg = function(a, b, c) {
    ...
    function xg(a) {
        var b = a.Fa,
            c = a.A,
            d = a.config,
            e = void 0 === a.Ba ? Zf() : a.Ba,
            f = void 0 === a.na ? 0 : a.na,
            g = void 0 === a.B ? new qf(null != (ug = null == (rg = R(b, cg, 5)) ? void 0 : nc(rg, 2)) ? ug : 0, null != (vg = null == (sg = R(b, cg, 5)) ? void 0 : nc(sg, 4)) ? vg : 0, null != (wg = null == (tg = R(b, cg, 5)) ? void 0 : kc(tg, 3)) ? wg : !1) : a.B;
        a = void 0 === a.H ? eg(S(b, bg, 2)) : a.H;
        e.hasOwnProperty("init-done") ? (Nf(12, e, function() {})(S(b, bg, 2).map(function(h) {
            return h.toJSON()
        })), Nf(13, e, function() {})(S(b, nf, 1).map(function(h) {
            return h.toJSON()
        }), f), c && Nf(14, e, function() {})(c), yg(f, e)) : (ng(new jg(a, f, g, d), e), Of(e), Pf(e), Qf(e), yg(f, e), Jf(S(b, nf, 1), [f], g, void 0, !0), wf = wf || !(!d || !d.ib), qg(Yf), c && qg(c))
    }
    ...
    var Pg = function() {
        ...
        Sg = function(a) {
            a.B || (a.B = new PerformanceObserver(Fg(640, function(b) {
                Vg(a, b)
            })));
            return a.B
        },
        ...
        Wg = function(a) {
            if (!a.ia) {
                ...
                window.LayoutShift && (b += Gg("cls", a.L), b += Gg("mls", a.J), b += Z("nls", a.P), window.LayoutShiftAttribution && (b += Gg("cas", a.s), b += Z("nas", a.ha), b += Gg("was", a.ma)), b += Gg("wls", a.S), b += Gg("tls", a.la));
                window.LargestContentfulPaint && (b += Z("lcp", a.fa), b += Z("lcps", a.ea));
                window.PerformanceEventTiming && a.ca && (b += Z("fid", a.ba));
                window.PerformanceLongTaskTiming && (b += Z("cbt", a.G), b += Z("mbt", a.I), b += Z("nlt", a.R));
                ...
                b += "&top=" + (B === B.top ? 1 : 0);
                b += a.ka ? "&qqid=" + encodeURIComponent(a.ka) : Z("pvsid", qd(B));
        ...
        Xg = function(a, b, c, d) {
            if (!b.hadRecentInput) {
                ...
                a.P += 1;
                if (c = Jg(b, c, d)) a.s += b.value, a.ha++;
        ...
        ah = function(a, b) {
            b.interactionId && (a.K = Math.min(a.K, b.interactionId), a.l = Math.max(a.l, b.interactionId), a.da = a.l ? (a.l - a.K) / 7 + 1 : 0)
        },
        Zg = function() {
    ...
    function Bh(a, b, c, d, e) {
        ...
        if (a) {
            ...
            f = "";
            for (b = 0; b < c.length; b++) g = c[b], f += g instanceof Bc && g.constructor === Bc && g.i === Ac ? g.g : "type_error:Const";
            c = new Mc(f, Pc);
        ...
        if (!$h(h)) {
            ...
            try {
                $c(h, Tc(l, {
                    id: e,
                    nonce: Yc(window),
                    crossorigin: Ic(ye) ? "anonymous" : void 0
                }))
            } catch (x) {}
