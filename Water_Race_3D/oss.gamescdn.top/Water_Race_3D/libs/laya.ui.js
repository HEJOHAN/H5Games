!function(t, i, e) {
    ...
    laya.display.Text)
      ...
      , k = laya.utils.TimeLine
      , L = laya.utils.Tween
      , M = laya.utils.Utils
      , T = laya.utils.WeakObject;
    e.interface("laya.ui.IBox"),
    e.interface("laya.ui.IItem"),
    e.interface("laya.ui.ISelect"),
    e.interface("laya.ui.IRender");
    var z = function() {
        function UIConfig() {}
        return n(UIConfig, "UIConfig"),
        UIConfig.touchScrollEnable = !0,
        UIConfig.mouseWheelEnable = !0,
        UIConfig.showButtons = !0,
        UIConfig.popupBgColor = "#000000",
        UIConfig.popupBgAlpha = .5,
        UIConfig.closeDialogOnSide = !0,
        UIConfig;
    }()
      , D = function() {
        function Styles() {}
        return n(Styles, "laya.ui.Styles"),
        Styles.labelColor = "#000000",
        Styles.buttonStateNum = 3,
        Styles.scrollBarMinNum = 15,
        Styles.scrollBarDelayTime = 500,
        s(Styles, ["defaultSizeGrid", function() {
      ...
      , G = function() {
        function UIUtils() {}
        return n(UIUtils, "laya.ui.UIUtils"),
        UIUtils.fillArray = function(t, i, e) {
            var s = t.concat();
            if (i)
                for (var n = i.split(","), h = 0, o = Math.min(s.length, n.length); h < o; h++) {
                    var r = n[h];
                    s[h] = "true" == r || "false" != r && r,
                    null != e && (s[h] = e(r));
                }
            return s;
        }
        ...
        UIUtils.gray = function(t, i) {
            void 0 === i && (i = !0),
            i ? UIUtils.addFilter(t, UIUtils.grayFilter) : UIUtils.clearFilter(t, l);
        }
        ,
      ...
      , H = function(t) {
        ...
        i._onDisable = function() {
            ...
            this.owner.parent && this.owner.parent.off("resize", this, this._onParentResize);
        }
        ,
        i._onAdded = function() {
        ...
        i.resetLayoutX = function() {
            ...
            if (i)
                if (isNaN(this.centerX)) {
                    if (isNaN(this.left))
                        isNaN(this.right) || (t.x = Math.round(i.width - t.displayWidth - this.right + t.pivotX * t.scaleX));
                    ...
                    t.x = Math.round(.5 * (i.width - t.displayWidth) + this.centerX + t.pivotX * t.scaleX);
            return !1;
        }
        ,
        i.resetLayoutY = function() {
            ...
            if (i)
                if (isNaN(this.centerY)) {
                    if (isNaN(this.top))
                        isNaN(this.bottom) || (t.y = Math.round(i.height - t.displayHeight - this.bottom + t.pivotY * t.scaleY));
                    ...
                    t.y = Math.round(.5 * (i.height - t.displayHeight) + this.centerY + t.pivotY * t.scaleY);
            return !1;
        }
        ,
    ...
    function(t) {
        ...
        i.changeSource = function() {
            ...
            if (t && t.bitmap) {
                ...
                if (!s || n === i && h === e)
                    this.clear(),
                    this.drawTexture(t, this._offset ? this._offset[0] : 0, this._offset ? this._offset[1] : 0, i, e);
                else {
                    this.clear();
                    var o = s[0]
                      , r = s[1]
                    ...
                    l + r > i) {
                        ...
                        i = l + r,
                        this.save(),
                        this.clipRect(0, 0, _, e);
                    }
                    l && o && this.drawImage(AutoBitmap.getTexture(t, 0, 0, l, o), 0, 0, l, o),
                    r && o && this.drawImage(AutoBitmap.getTexture(t, n - r, 0, r, o), i - r, 0, r, o),
        ...
        i.drawBitmap = function(t, i, e, s, n, h) {
            void 0 === n && (n = 0),
            void 0 === h && (h = 0),
            n < .1 || h < .1 || (!t || i.width == n && i.height == h ? this.drawImage(i, e, s, n, h) : this.fillTexture(i, e, s, n, h));
        }
        ,
        ...
        AutoBitmap.getTexture = function(t, i, e, s, n) {
            ...
            h && h._getSource() || (h = I.createFromTexture(t, i, e, s, n)),
            h;
        }
        ,
        AutoBitmap;
      ...
      , P = function(t) {
        ...
        i._sizeChanged = function() {
            ...
            this.event("resize"),
            this._widget !== H.EMPTY && this._widget.resetLayout();
        }
        ,
        ...
        i._getWidget = function() {
            return this._widget === H.EMPTY && (this._widget = this.addComponent(H)),
            this._widget;
        }
        ,
        ...
        i._childChanged = function(i) {
            ...
            t.prototype._childChanged.call(this, i);
        }
        ,
        h(0, i, "centerY", function() {
        ...
        h(0, i, "width", function() {
            ...
            e.superGet(x, this, "width") != t && (e.superSet(x, this, "width", t),
            this.callLater(this._sizeChanged));
        }),
        h(0, i, "bottom", function() {
        ...
        h(0, i, "height", function() {
            ...
            e.superGet(x, this, "height") != t && (e.superSet(x, this, "height", t),
            this.callLater(this._sizeChanged));
        }),
        h(0, i, "left", function() {
        ...
        h(0, i, "scaleX", t.prototype._$get_scaleX, function(t) {
            e.superGet(x, this, "scaleX") != t && (e.superSet(x, this, "scaleX", t),
            this.event("resize"));
        }),
        h(0, i, "scaleY", t.prototype._$get_scaleY, function(t) {
            e.superGet(x, this, "scaleY") != t && (e.superSet(x, this, "scaleY", t),
            this.event("resize"));
        }),
      ...
      , O = function(t) {
        function DialogManager() {
            ...
            z.closeDialogOnSide && this.maskLayer.on("click", this, this._closeOnSide),
            this._onResize(null);
        }
        ...
        i.setLockView = function(t) {
            this.lockLayer || (this.lockLayer = new X(),
        ...
        i._onResize = function(t) {
            ...
            this.maskLayer.graphics.drawRect(0, 0, i, s, z.popupBgColor),
            this.maskLayer.alpha = z.popupBgAlpha;
        ...
        i.open = function(t, i, s) {
            ...
            this.addChild(t),
            (t.isModal || this._getBit(32)) && e.timer.callLater(this, this._checkMask),
            s && null != t.popupEffect ? t.popupEffect.runWith(t) : this.doOpen(t),
            this.event("open");
        }
        ,
        i._clearDialogEffect = function(t) {
            t._effectTween && (L.clear(t._effectTween),
            t._effectTween = null);
        }
        ,
        i.doOpen = function(t) {
      ...
      , X = (function(i) {
        ...
        h(0, s, "x", i.prototype._$get_x, function(t) {
            e.superSet(P, this, "x", t),
            this.callLater(this._postMsg);
        }),
        h(0, s, "width", i.prototype._$get_width, function(i) {
            e.superSet(P, this, "width", i),
            t.sharedCanvas && (t.sharedCanvas.width = i),
            this.callLater(this._postMsg);
        }),
        h(0, s, "height", i.prototype._$get_height, function(i) {
            e.superSet(P, this, "height", i),
            t.sharedCanvas && (t.sharedCanvas.height = i),
            this.callLater(this._postMsg);
        }),
        h(0, s, "y", i.prototype._$get_y, function(t) {
            e.superSet(P, this, "y", t),
            this.callLater(this._postMsg);
        });
    }(P),
    function(t) {
        ...
        h(0, i, "bgColor", function() {
            ...
            this.on("resize", this, this._onResize)) : (this.graphics.clear(),
      ...
      , N = function(t) {
        function Button(t, i) {
            ...
            this._labelColors = D.buttonLabelColors,
            this._stateNum = D.buttonStateNum,
            void 0 === i && (i = ""),
            this.skin = t,
            this.label = i;
        }
                ...
                n)
                    ...
                    1 === this._stateNum)
                        ...
                        for (var h = 0; h < this._stateNum; h++)
                            this._sources.push(I.createFromTexture(t, 0, e * h, i, e));
                    T.I.set(s, this._sources);
                }
                this._autoSize ? (this._bitmap.width = this._width || i,
                this._bitmap.height = this._height || e,
                this._text && (this._text.width = this._bitmap.width,
                this._text.height = this._bitmap.height)) : this._text && (this._text.x = i);
            } else
        ...
        h(0, i, "skin", function() {
            ...
            t ? m.getRes(t) ? this._skinLoaded() : e.loader.load(this._skin, f.create(this, this._skinLoaded), null, "image", 1) : this._skinLoaded());
        }),
        h(0, i, "labelPadding", function() {
            ...
            this.createText(),
            this._text.padding = G.fillArray(D.labelPadding, t, Number);
        }),
        ...
        h(0, i, "strokeColors", function() {
            ...
            this._strokeColors = G.fillArray(D.buttonLabelColors, t, String),
            this._setStateChanged();
        }),
        h(0, i, "labelColors", function() {
            return this._labelColors.join(",");
        }, function(t) {
            this._labelColors = G.fillArray(D.buttonLabelColors, t, String),
            this._setStateChanged();
        }),
      ...
      , E = function(t) {
        ...
        h(0, i, "dataSource", t.prototype._$get_dataSource, function(t) {
            this._dataSource = t,
            "string" == typeof t ? this.skin = t : e.superSet(P, this, "dataSource", t);
        }),
        h(0, i, "source", function() {
        ...
        h(0, i, "skin", function() {
            ...
            if (this._skin != t)
                ...
                t) {
                    var i = m.getRes(t);
                    i ? (this.source = i,
                    this.onCompResize()) : e.loader.load(this._skin, f.create(this, this.setSource, [this._skin]), null, "image", 1, !0, this._group);
                } else
                    this.source = null;
        }),
        h(0, i, "sizeGrid", function() {
      ...
      , R = function(t) {
        ...
        h(0, i, "text", function() {
            ...
            this._tf.text != t && (t && (t = G.adptString(t + "")),
            this._tf.text = t,
            this.event("change"),
        ...
        h(0, i, "dataSource", t.prototype._$get_dataSource, function(t) {
            this._dataSource = t,
            "number" == typeof t || "string" == typeof t ? this.text = t + "" : e.superSet(P, this, "dataSource", t);
        }),
      ...
      , U = function(t) {
        function ComboBox(t, i) {
            ...
            this._itemColors = D.comboBoxItemColors,
            this.skin = t,
            this.labels = i;
        }
        ...
        i.onlistItemMouse = function(t, i) {
            ...
            if ("mouseover" === e || "mouseout" === e) {
                ...
                n && ("mouseover" === e ? (n.bgColor = this._itemColors[0],
                n.color = this._itemColors[1]) : (n.bgColor = null,
                n.color = this._itemColors[2]));
            } else
                "click" === e && (this.selectedIndex = i,
                this.isOpen = !1);
        }
        ,
        ...
        h(0, i, "itemColors", function() {
            ...
            this._itemColors = G.fillArray(this._itemColors, t, String),
            this._listChanged = !0;
        }),
        ...
        h(0, i, "isOpen", function() {
            ...
            if (this._isOpen != t)
                ...
                this._isOpen) {
                    ...
                    s = s + this._listHeight <= e.stage.height ? s : i.y - this._listHeight,
        ...
        h(0, i, "dataSource", t.prototype._$get_dataSource, function(t) {
            this._dataSource = t,
            "number" == typeof t && Math.floor(t) == t || "string" == typeof t ? this.selectedIndex = parseInt(t) : t instanceof Array ? this.labels = t.join(",") : e.superSet(P, this, "dataSource", t);
        }),
        h(0, i, "labelColors", function() {
      ...
      , V = (function(t) {
        ...
        i._showToStage = function(t, i, s) {
            ...
            t._x + n.width > e.stage.width && (t.x -= n.width + i),
        ...
        i._showDefaultTip = function(t) {
            ...
            i.clear(!0),
            i.drawRect(0, 0, this._tipText.width + 10, this._tipText.height + 10, TipManager.tipBackColor),
    ...
    function(t) {
                ...
                h)
                    ...
                    for (var o = 0; o < this._clipY; o++)
                        for (var r = 0; r < this._clipX; r++)
                            this._sources.push(I.createFromTexture(i, e * r, s * o, e, s));
        ...
        h(0, i, "skin", function() {
            ...
            this._skin != t && (this._skin = t,
            t ? m.getRes(t) ? this._skinLoaded() : e.loader.load(this._skin, f.create(this, this._skinLoaded), null, "image", 1) : this._bitmap.source = null);
        }),
        ...
        h(0, i, "dataSource", t.prototype._$get_dataSource, function(t) {
            this._dataSource = t,
            "number" == typeof t && Math.floor(t) == t || "string" == typeof t ? this.index = parseInt(t) : e.superSet(P, this, "dataSource", t);
        }),
      ...
      , $ = function(t) {
        ...
        ,
        i.createChildren = function() {
            this.addChild(this._bg = new E()),
            this.addChild(this._bar = new E()),
        ...
        h(0, i, "dataSource", t.prototype._$get_dataSource, function(t) {
            this._dataSource = t,
            "number" == typeof t || "string" == typeof t ? this.value = Number(t) : e.superSet(P, this, "dataSource", t);
        }),
        h(0, i, "skin", function() {
            return this._skin;
        }, function(t) {
            this._skin != t && (this._skin = t,
            this._skin && !m.getRes(this._skin) ? e.loader.load(this._skin, f.create(this, this._skinLoaded), null, "image", 1) : this._skinLoaded());
        }),
        h(0, i, "height", t.prototype._$get_height, function(t) {
            e.superSet(P, this, "height", t),
      ...
      , F = function(t) {
        function ScrollBar(t) {
            ...
            this._showButtons = z.showButtons,
            this._touchScrollEnable = z.touchScrollEnable,
            this._mouseWheelEnable = z.mouseWheelEnable,
            this.skin = t,
            this.max = 1;
        }
        ...
        ,
        i.createChildren = function() {
            this.addChild(this.slider = new j()),
        ...
        i.onButtonMouseDown = function(t) {
            ...
            this.slide(i),
            e.timer.once(D.scrollBarDelayTime, this, this.startLoop, [i]),
        ...
        i.onStageMouseUp = function(t) {
            e.timer.clear(this, this.startLoop),
            e.timer.clear(this, this.slide);
        }
        ,
        i._skinLoaded = function() {
        ...
        ,
        i._sizeChanged = function() {
            t.prototype._sizeChanged.call(this),
            this.repaint(),
            this.resetPositions(),
            this.event("change"),
        ...
        i.onTargetMouseDown = function(t) {
            this.isLockedFun && !this.isLockedFun(t) || (this.event("end"),
            this._clickOnly = !0,
            this._lastOffset = 0,
            this._checkElastic = !1,
            this._lastPoint || (this._lastPoint = new C()),
        ...
        i.checkTriggers = function(t) {
            return void 0 === t && (t = !1),
            this.value >= 0 && this.value - this._lastOffset <= 0 && this.triggerDownDragLimit && this.triggerDownDragLimit(t) ? (this.cancelDragOp(),
            this.value = 0,
        ...
        i.startTweenMoveForce = function(t) {
            this._lastOffset = t,
            e.timer.frameLoop(1, this, this.tweenMove, [200]);
        }
        ,
        i.loop = function() {
            ...
            this._clickOnly) {
                if (!(Math.abs(this._lastOffset * (this.isVertical ? e.stage._canvasTransform.getScaleY() : e.stage._canvasTransform.getScaleX())) > 1))
                    return;
        ...
        i.onStageMouseUp2 = function(t) {
            ...
            !(this._clickOnly && this._value >= this.min && this._value <= this.max))
                ...
                this._isElastic)
                    ...
                    for (var i = 0, s = Math.min(this._offsets.length, 3), n = 0; n < s; n++)
                        i += this._offsets[this._offsets.length - 1 - n];
                    if (this._lastOffset = i / s,
        ...
        i.elasticOver = function() {
            this._isElastic = !1,
            !this.hide && this.autoHide && L.to(this, {
                alpha: 0
            }, 500),
            this.event("end");
        }
        ...
        i.tweenMove = function(t) {
            ...
            !this.checkTriggers(!0)) {
                var i = NaN;
                if (t > 0 && (this._lastOffset > 0 && this.value <= this.min ? (this._isElastic = !0,
                i = .5 * -(this.min - t - this.value),
                this._lastOffset > i && (this._lastOffset = i)) : this._lastOffset < 0 && this.value >= this.max && (this._isElastic = !0,
                i = .5 * -(this.max + t - this.value),
                this._lastOffset < i && (this._lastOffset = i))),
                this.value -= this._lastOffset,
                Math.abs(this._lastOffset) < .1) {
                    if (e.timer.clear(this, this.tweenMove),
                    this._isElastic)
                        return void (this._value < this.min ? L.to(this, {
                            value: this.min
                        }, this.elasticBackTime, u.sineOut, f.create(this, this.elasticOver)) : this._value > this.max ? L.to(this, {
                            value: this.max
        ...
        h(0, i, "skin", function() {
            ...
            this._skin && !m.getRes(this._skin) ? e.loader.load([this._skin, this._skin.replace(".png", "$up.png"), this._skin.replace(".png", "$down.png"), this._skin.replace(".png", "$bar.png")], f.create(this, this._skinLoaded)) : this._skinLoaded());
        }),
        h(0, i, "max", function() {
      ...
      , j = function(t) {
        ...
        i.onBarMouseDown = function(t) {
            this._globalSacle || (this._globalSacle = new C()),
        ...
        i._skinLoaded = function() {
            ...
            m.getRes(t) && (this._progress || (this.addChild(this._progress = new E()),
        ...
        i.changeValue = function() {
            ...
            0 === i && (i = 1),
            this.isVertical ? (this._bar.y = (this._value - this._min) / i * (this.height - this._bar.height),
        ...
        h(0, i, "skin", function() {
            ...
            this._skin != t && (this._skin = t,
            this._skin && !m.getRes(this._skin) ? e.loader.load([this._skin, this._skin.replace(".png", "$bar.png")], f.create(this, this._skinLoaded)) : this._skinLoaded());
        }),
        h(0, i, "tick", function() {
            return this._tick;
        }, function(t) {
      ...
      , J = function(t) {
        ...
        a.reportError = function(t, e, s) {
            ...
            var n = Date.now()
              , h = new Date(n + 0);
            s.date = h.toLocaleString(),
            s.etype = t,
            "error" != t && "statistics" != t && (t = "statistics"),
            s.version = "V0.0.1",
            s.gameId = 10100,
            s.dinfo = this.dinfo,
            s.channel = -1e3,
            s.msg = e,
            s["@timestamp"] = h.toISOString(),
            s.user = this.getUserId(),
            s.openid = this.getOpenId();
            var o = MoreGame.getDay(h);
            s.rdate = o,
            s.day = h.getDate() + "",
            s.hour = h.getHours() + "",
            s.minute = h.getMinutes() + "",
            s.gameurl = i.baseURI,
            s.regTime = 0,
            "error" == t ? this.sendLog(s, this.tongjiType + "error-" + o.substring(0, 6) + "/" + t + "/", t) : this.sendLog(s, this.tongjiType + "-" + o.substring(0, 6) + "/" + t + "/", t);
        }
        ,
        a.getUserId = function() {
            var t = parseInt(v.getItem("layauserid") + "") || -1;
            return -1 == t && (t = this.randRange(0, 1e9),
            v.setItem("layauserid", t + "")),
            t;
        }
        ,
        ...
        a.sendLog = function(t, i, e) {
            ...
            r.onBDMiniGame && (t.gameurl = ""),
            n.send(this.ErrorUrlHttps + i, JSON.stringify(t), "post", "text", ["Content-Type", "application/json"]);
        }
        ,
        ...
        a.onStageResize = function() {
            ...
            e.stage.width < 720 && (t = .9),
            this._moreBox && this._moreBox.scale(t, t),
            this._gameBox && this._gameBox.scale(t, t);
        }
        ,
        ...
        a.dispose = function() {
            ...
            this.clickCallBack = null,
            this.closeCallBack = null,
            this.iconImgTl && (this.iconImgTl.offAll("complete"),
            this.iconImgTl = null),
            this._moreBox && (this._moreBox.removeChildren(),
            this._moreBox = null),
            this._gameBox && (this._gameBox.removeChildren(),
            this._gameBox = null),
            this._iconImage && (this._iconImage.removeSelf(),
            this._iconImage = null);
        }
        ,
        ...
        a.onTlComplete = function() {
            if (this.parent) {
                if (this._iconImage.scale(.9, .9),
                this._iconImage.rotation = 0,
                this.gameStopHD && this.iconImgTl)
                    return this.iconImgTl.offAll("complete"),
                    void (this.iconImgTl = null);
                e.timer.once(1e3, this, this.onYanChiPlay);
            } else
                this.iconImgTl && (this.iconImgTl.offAll(),
                this.iconImgTl = null);
        }
        ,
        ...
        a.onIconClick = function() {
            this.isShow = !0,
            null != this.clickCallBack && this.clickCallBack.run();
            var t = v.getItem("currentTime")
              , i = this.getLocalDateString();
            t != i ? (v.setItem("currentTime", i),
            this.reportError(MoreGame._moreGameData.statid1)) : this.reportError(MoreGame._moreGameData.statid2),
            this.onResLoaded();
        }
        ,
        a.onResLoaded = function() {
            if (this._moreBox)
                this._moreBox.visible = !0;
            else {
                this._moreBox = new X(),
                e.stage.addChild(this._moreBox),
                ...
                t.top = t.left = t.right = t.bottom = 0,
                t.sizeGrid = "1,1,1,1,1";
                ...
                s.on("click", this, this.onJiantouImgClick),
                this.isQMP() && this.screenType ? s.pos(15, 70) : s.pos(15, 45);
                var n = new st();
                this._moreBox.addChild(n),
                n.itemRender = h,
                n.selectEnable = !0,
                n.vScrollBarSkin = "",
                n.scrollBar.autoHide = !0,
                n.scrollBar.elasticDistance = 250,
                n.renderHandler = new f(this,this.onGameListRender);
                var o = MoreGame._moreGameData.marvellousGame.gameList
                  , r = [];
                r.push(o[0]),
                r.push(o[1]);
                ...
                try {
                    ...
                    MoreGame._moreGameData.marvellousGame.gameList = r,
                    n.array = MoreGame._moreGameData.marvellousGame.gameList;
                } catch (t) {
                    n.array = MoreGame._moreGameData.marvellousGame.gameList;
                }
                this.screenType && (n.spaceY = 10,
                n.width = 690,
                this.isQMP() ? n.height = e.stage.height + 130 : n.height = 1139,
                n.y = 139,
                n.centerX = 0),
                this.onStageResize();
            }
        ...
        a.isQMP = function() {
            var t = !1
              , i = 0;
            if (i = "horizontal" == e.stage.screenMode ? r.height % 9 : r.width % 9,
            r.onAndroid && 0 == i) {
                var s = 0;
                s = "horizontal" == e.stage.screenMode ? r.width : r.height,
                -1 != [2280, 2160, 2244, 3120, 2248, 2340, 2310].indexOf(s) && (t = !0);
            }
        ...
        a.onCreateMaskImg = function(t, i) {
            var e = this.onCreateImage(MoreGame.onGetAtlasDanImgUrl("dayuan"), i)
              , s = this.onCreateImage(t, e);
            s.pos(11, 10);
            var n = new x();
            return n.graphics.drawCircle(71, 74, 68, "#ff0000"),
            s.mask = n,
            e.scale(.7, .7),
            e;
        }
        ...
        a.onJiantouImgClick = function(t) {
            this.isShow = !1,
            this._moreBox && (this._moreBox.visible = !1),
            null != this.closeCallBack && this.closeCallBack.run();
        }
        ,
        ...
        a.init = function() {
            ...
            this.visible = !1,
            t && (this.dinfo = JSON.stringify(laya.bd.mini.BMiniAdapter.systemInfo),
        ...
        a.complete = function() {
            try {
                ...
                MoreGame._moreGameData = JSON.parse(t),
                this.initUI();
            } catch (t) {
                !1,
        ...
        a.initUI = function() {
            ...
            this.initEvent(),
            this.gameStopHD = !1,
            this.checkIconImgHD()) : this.visible = !1;
        }
        ,
        a.setIconSize = function(t, i) {
            this._iconImage && (this._iconImage.size(t, i),
            this._iconImage.pivot(t / 2, i / 2),
            this._iconImage.pos(t / 2, i / 2)),
            this._iconImageObj = {
                width: t,
                height: i
            };
        ...
        MoreGame.__init$ = function() {
            h = function(t) {
                ...
                return i.init = function(t, i, e) {
                    ...
                    this.gameListBox)
                        for (s = 0,
                        n = this.gameListBox._children.length; s < n; s++)
                            (h = this.gameListBox._children[s]).init(t.gameList[s], i, e);
                    else {
                        this.gameListBox = new X(),
                        this.addChild(this.gameListBox);
                        for (var s = 0, n = t.gameList.length; s < n; s++) {
                            var h = new o();
                            h.init(t.gameList[s], i, e),
                            h.x = 0 + 175 * s,
                            h.y = 65,
                            this.gameListBox.addChild(h);
                        }
                    }
                    this.size(695, 340);
                }
            ...
            o = function(t) {
                ...
                return i.MoveGameItem = function() {}
                ,
                ...
                i.init = function(t, i, e) {
                    ...
                    this.kuangImg ? this.kuangImg.skin = MoreGame.onGetAtlasDanImgUrl("dayuan") : this.kuangImg = this.onCreateImage(MoreGame.onGetAtlasDanImgUrl("dayuan"), this),
                    this.iconImg)
                        this.iconImg.skin = MoreGame.onGetIconImgSkinUrl(t.icon);
                    else {
                    ...
                    this.playImg ? this.playImg.skin = MoreGame.onGetAtlasDanImgUrl("img_play") : (this.playImg = this.onCreateImage(MoreGame.onGetAtlasDanImgUrl("img_play"), this),
      ...
      , q = function(t) {
        ...
        i.open = function(t, i) {
            ...
            this._dealDragArea(),
            this._param = i,
            Dialog.manager.open(this, t, this.isShowEffect),
        ...
        h(0, i, "dragArea", function() {
            ...
            if (t) {
                ...
                this._dragArea = new S(i[0],i[1],i[2],i[3]),
        ...
        i.initItems = function() {
            ...
            for (var t = 0; t < 1e4; t++) {
                ...
                if (null == i)
                    break;
                this._items.push(i),
                i.visible = t == this._selectedIndex;
            }
        }
        ,
      ...
      , Z = function(t) {
        ...
        i.destroy = function(t) {
            void 0 === t && (t = !0),
            laya.ui.UIComponent.prototype.destroy.call(this, t),
        ...
        i.delItem = function(t, i) {
            ...
            if (-1 != e) {
                ...
                for (var n = e + 1, h = this._items.length; n < h; n++) {
                    var o = this._items[n];
                    o.name = "item" + (n - 1),
                    i && ("horizontal" == this._direction ? o.x -= s.width + this._space : o.y -= s.height + this._space);
                }
                if (this.initItems(),
                this._selectedIndex > -1) {
                    var r;
        ...
        h(0, i, "dataSource", t.prototype._$get_dataSource, function(t) {
            this._dataSource = t,
            "number" == typeof t && Math.floor(t) == t || "string" == typeof t ? this.selectedIndex = parseInt(t) : t instanceof Array ? this.labels = t.join(",") : e.superSet(X, this, "dataSource", t);
        }),
        UIGroup;
    }(X)
      , tt = function(t) {
        function CheckBox(t, i) {
            void 0 === i && (i = ""),
            CheckBox.__super.call(this, t, i);
        }
        ...
        h(0, i, "dataSource", t.prototype._$get_dataSource, function(t) {
            this._dataSource = t,
            "boolean" == typeof t ? this.selected = t : "string" == typeof t ? this.selected = "true" === t : e.superSet(N, this, "dataSource", t);
        }),
        CheckBox;
    }(N)
      , it = function(t) {
        ...
        ,
        i.createChildren = function() {
            this.addChild(this._list = new st()),
        ...
        i.setItemState = function(t, i) {
            this._list.array[t] && (this._list.array[t].isOpen = i,
            this._list.array = this.getArray());
        }
        ,
        i.fresh = function() {
        ...
        i.filter = function(t) {
            if (Boolean(t)) {
                var i = [];
                this.getFilterSource(this._source, i, t),
                this._list.array = i;
            } else
                this._list.array = this.getArray();
        }
        ...
        i.getFilterSource = function(t, i, e) {
            var s;
            for (var n in e = e.toLocaleLowerCase(),
            t)
                !(s = t[n]).isDirectory && String(s.label).toLowerCase().indexOf(e) > -1 && (s.x = 0,
                i.push(s)),
                s.child && s.child.length > 0 && this.getFilterSource(s.child, i, e);
        }
        ,
        ...
        h(0, i, "dataSource", t.prototype._$get_dataSource, function(t) {
            this._dataSource = t,
            e.superSet(X, this, "dataSource", t);
        }),
        h(0, i, "source", function() {
            return this._source;
        }),
        ...
        h(0, i, "width", t.prototype._$get_width, function(t) {
            e.superSet(X, this, "width", t),
            this._list.width = t;
        }),
        h(0, i, "height", t.prototype._$get_height, function(t) {
            e.superSet(X, this, "height", t),
            this._list.height = t;
        }),
        h(0, i, "xml", null, function(t) {
            var i = [];
            this.parseXml(t.childNodes[0], i, null, !0),
            this.array = i;
        }),
      ...
      , et = function(t) {
        ...
        i.changeScroll = function() {
            ...
            e && (e.x = this._width - e.width,
            e.y = 0,
            e.height = this._height - (h ? s.height : 0),
            e.scrollSize = Math.max(.033 * this._height, 1),
            e.thumbPercent = r / i,
            e.setScroll(0, i - r, e.value)),
            s && (s.x = 0,
            s.y = this._height - s.height,
            s.width = this._width - (n ? e.width : 0),
        ...
        i.setContentSize = function(t, i) {
            ...
            e.width = t,
            e.height = i,
            e._style.scrollRect || (e.scrollRect = S.create()),
            e._style.scrollRect.setTo(0, 0, t, i),
        ...
        i.onScrollStart = function() {
            this._usedCache || (this._usedCache = e.superGet(X, this, "cacheAs")),
            e.superSet(X, this, "cacheAs", "none"),
      ...
      , st = function(t) {
        ...
        i.changeCells = function() {
            ...
            this._itemRender) {
                ...
                this._cellOffset = this._isVertical ? e * Math.max(this._repeatY2, this._repeatY) - n - this._spaceY : i * Math.max(this._repeatX2, this._repeatX) - s - this._spaceX,
        ...
        i._createItems = function(t, i, e) {
            ...
            if (this.cacheContent) {
                var r = new X();
                r.cacheAs = "normal",
                r.pos((this._isVertical ? 0 : t) * h, (this._isVertical ? t : 0) * o),
            ...
            for (var u = t; u < e; u++)
                for (var _ = 0; _ < i; _++)
                    (n = a && a.length ? a.pop() : this.createItem()).x = (this._isVertical ? _ : u) * h - s._x,
                    n.y = (this._isVertical ? u : _) * o - s._y,
                    n.name = "item" + (u * i + _),
                    s.addChild(n),
                    this.addCell(n);
        }
        ...
        i.createItem = function() {
            ...
            if ("function" == typeof this._itemRender)
                ...
                i = w.createComp(this._itemRender, null, null, t);
            ...
            return t.length && (i._$bindData = t),
            i;
        }
        ,
        ...
        i.setContentSize = function(t, i) {
            ...
            (this._scrollBar || 0 != this._offset.x || 0 != this._offset.y) && (this._content._style.scrollRect || (this._content.scrollRect = S.create()),
            this._content._style.scrollRect.setTo(-this._offset.x, -this._offset.y, t, i),
        ...
        i.onScrollBarChange = function(t) {
            ...
            if (this.cacheContent)
                o = s + 1,
                this._createdLine - n < o && (this._createItems(this._createdLine, e, this._createdLine + o),
                ...
                if (h > this._startIndex) {
                    ...
                    h < this._startIndex && (o = this._startIndex - h,
                    r = !1,
            ...
            this._isVertical ? (d.y = i - this._offset.y,
            d.x = -this._offset.x) : (d.y = -this._offset.y,
            d.x = i - this._offset.x),
        ...
        ,
        i.renderItem = function(t, i) {
            this._array && i >= 0 && i < this._array.length ? (t.visible = !0,
            t._$bindData ? (t._dataSource = this._array[i],
            this._bindData(t, this._array[i])) : t.dataSource = this._array[i],
            this.cacheContent || this.posCell(t, i),
            this.hasListener("render") && this.event("render", [t, i]),
            this.renderHandler && this.renderHandler.runWith([t, i])) : (t.visible = !1,
            t.dataSource = null);
        }
        ,
        ...
        i.updateArray = function(t) {
            ...
            this._scrollBar) {
                var e = t.length
                  ...
                  , h = Math.ceil(e / s);
                h >= n && (this._scrollBar.thumbPercent = n / h,
                this._scrollBar.slider._max = (h - n) * this._cellSize + this._cellOffset);
            }
        }
        ,
        i.refresh = function() {
        ...
        i.changeItem = function(t, i) {
            t > -1 && t < this._array.length && (this._array[t] = i,
        ...
        h(0, i, "height", t.prototype._$get_height, function(t) {
            t != this._height && (e.superSet(X, this, "height", t),
        ...
        h(0, i, "vScrollBarSkin", function() {
            ...
            i.right = 0,
            i.skin = t,
            i.elasticDistance = this._elasticEnabled ? 200 : 0,
            this.scrollBar = i,
            this.addChild(i),
            this._setCellChanged();
        }),
        ...
        h(0, i, "width", t.prototype._$get_width, function(t) {
            t != this._width && (e.superSet(X, this, "width", t),
            this._setCellChanged());
        }),
        ...
        h(0, i, "array", function() {
            ...
            if (this.totalPage = Math.ceil(i / (this.repeatX * this.repeatY)),
            this._selectedIndex = this._selectedIndex < i ? this._selectedIndex : i - 1,
            this.startIndex = this._startIndex,
            this._scrollBar) {
                this._scrollBar.stopScroll();
                var e = this._isVertical ? this.repeatX : this.repeatY
        ...
        h(0, i, "dataSource", t.prototype._$get_dataSource, function(t) {
            this._dataSource = t,
            "number" == typeof t && Math.floor(t) == t || "string" == typeof t ? this.selectedIndex = parseInt(t) : t instanceof Array ? this.array = t : e.superSet(X, this, "dataSource", t);
        }),
      ...
      , nt = function(t) {
        ...
        h(0, i, "sizeGrid", function() {
            ...
            this._bg || (this.graphics = this._bg = new A()),
            this._bg.sizeGrid = G.fillArray(D.defaultSizeGrid, t, Number);
        }),
        h(0, i, "width", t.prototype._$get_width, function(t) {
            e.superSet(R, this, "width", t),
            this._bg && (this._bg.width = t);
        }),
        h(0, i, "height", t.prototype._$get_height, function(t) {
            e.superSet(R, this, "height", t),
      ...
      , ht = function(t) {
        ...
        return i.onEnable = function() {
            e.stage.on("resize", this, this.onResize),
            this.onResize();
        }
        ,
        ...
        i.onResize = function() {
            if (this.width > 0 && this.height > 0) {
                ...
                e.superSet(X, this, "width", e.stage.width),
                e.superSet(X, this, "height", e.stage.height),
                this.scale(t, t);
            }
        }
        ,
      ...
      , rt = function(t) {
        ...
        i.changeValue = function() {
            ...
            t = this._sources[0]))) {
                ...
                i ? (this._wordsW = this._valueArr.length * (t.sourceWidth + this.spaceX),
                ...
                for (var s = 0, n = this._valueArr.length; s < n; s++) {
                    ...
                    this.sources[h] && (t = this.sources[h],
                    i ? this.graphics.drawImage(t, e + s * (t.sourceWidth + this.spaceX), 0, t.sourceWidth, t.sourceHeight) : this.graphics.drawImage(t, 0 + e, s * (t.sourceHeight + this.spaceY), t.sourceWidth, t.sourceHeight));
                }
        ...
        h(0, i, "sheet", function() {
            ...
            for (var e = 0; e < this._clipY; e++)
                for (var s = i[e].split(""), n = 0, h = s.length; n < h; n++)
                    this._indexMap[s[n]] = e * this._clipX + n;
        }),
        h(0, i, "height", t.prototype._$get_height, function(t) {
            e.superSet(V, this, "height", t),
            this.callLater(this.changeValue);
        }),
        h(0, i, "direction", function() {
            return this._direction;
      ...
      , at = (function(t) {
        ...
        i.updateAdvsInfo = function() {
            this.visible = !1,
            this.onLunbo(),
            e.timer.loop(this._lunboTime, this, this.onLunbo);
        }
        ,
        i.onLunbo = function() {
        ...
        i.onGetAdvsListData = function() {
            var t = this
              , i = AdvImage.randRange(1e4, 1e6)
              , e = this.resUrl + "?" + i;
            this._http.open("get", e, !0),
            this._http.setRequestHeader("Content-Type", "application/x-www-form-urlencoded"),
            this._http.responseType = "text",
            this._http.onerror = function(i) {
                t._onError(i);
            }
            ,
        ...
        i.complete = function() {
            try {
                ...
                r.onLimixiu ? (this.advsListArr = this.getAdvsQArr(this._data),
                this.advsListArr.length ? (this.updateAdvsInfo(),
        ...
        i.destroy = function(i) {
            void 0 === i && (i = !0),
            e.timer.clear(this, this.onLunbo),
            t.prototype.destroy.call(this, !0),
            this.clear(),
            e.timer.clear(this, this.onGetAdvsListData);
        }
        ,
    ...
    function(t) {
        ...
        return n(VScrollBar, "laya.ui.VScrollBar", F),
        VScrollBar;
    }())
      , lt = function(t) {
        function VSlider() {
        ...
        return n(VSlider, "laya.ui.VSlider", j),
        VSlider;
    }()
      , ct = function(t) {
        function HScrollBar() {
        ...
        return n(HScrollBar, "laya.ui.HScrollBar", t),
      ...
      , ut = function(t) {
        function HSlider(t) {
            HSlider.__super.call(this, t),
            this.isVertical = !1;
        }
        return n(HSlider, "laya.ui.HSlider", j),
        HSlider;
    }()
      , _t = function(t) {
        function HBox() {
        ...
        i.changeItems = function() {
            ...
            for (var t = [], i = 0, e = 0, s = this.numChildren; e < s; e++) {
                ...
                n && (t.push(n),
                i = this._height ? this._height : Math.max(i, n.height * n.scaleY));
            }
            this.sortItem(t);
            var h = 0;
            for (e = 0,
        ...
        ,
        h(0, i, "height", t.prototype._$get_height, function(t) {
            this._height != t && (e.superSet(K, this, "height", t),
            this.callLater(this.changeItems));
        }),
        HBox.NONE = "none",
        HBox.TOP = "top",
      ...
      , dt = function(t) {
        ...
        return n(RadioGroup, "laya.ui.RadioGroup", Z),
        RadioGroup.prototype.createItem = function(t, i) {
            return new ot(t,i);
        }
        ,
        RadioGroup;
      ...
      , ft = function(t) {
        ...
        return i.changeItems = function() {
            ...
            for (var t = [], i = 0, e = 0, s = this.numChildren; e < s; e++) {
                var n = this.getChildAt(e);
                n && (t.push(n),
                i = this._width ? this._width : Math.max(i, n.width * n.scaleX));
            }
            this.sortItem(t);
            var h = 0;
            for (e = 0,
        ...
        ,
        h(0, i, "width", t.prototype._$get_width, function(t) {
            this._width != t && (e.superSet(K, this, "width", t),
            this.callLater(this.changeItems));
        }),
        VBox.NONE = "none",
        VBox.LEFT = "left",
      ...
      , gt = function(t) {
        ...
        i.changeScroll = function() {
            ...
            this._vScrollBar.height = this._height - (i ? this._hScrollBar.height : 0) - n[1] - n[3],
            ...
            this._hScrollBar.scrollSize = Math.max(.033 * e, 1),
            this._hScrollBar.thumbPercent = e / Math.max(this._tf.textWidth, e),
        ...
        h(0, i, "vScrollBarSkin", function() {
            ...
            null == this._vScrollBar && (this.addChild(this._vScrollBar = new at()),
        ...
        h(0, i, "hScrollBarSkin", function() {
            ...
            null == this._hScrollBar && (this.addChild(this._hScrollBar = new ct()),
      ...
      , pt = function(t) {
        ...
        return n(Tab, "laya.ui.Tab", Z),
        Tab.prototype.createItem = function(t, i) {
            return new N(t,i);
        }
        ,
        Tab;
