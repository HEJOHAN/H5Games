        ...
        class: function(e, n, s, r) {
            if (s && i.__extend(e, s), n)
                if (i.__package(n, e), i.__classmap[n] = e, n.indexOf(".") > 0) {
                    ...
                    "Main" == n ? t.Main = e : (i[n] && console.log("Error!,this class[" + n + "] already exist:", i[n]), i[n] = e);
            var a = i.un,
                h = e.prototype;
...
function(t, e, i) {
    ...
    var o = function() {
            ...
            return s(e, "laya.utils.RunDriver"), e.FILTER_ACTIONS = [], e.pixelRatio = -1, e._charSizeTestDiv = null, e.now = function() {
                ...
                var o = yt.create("2D"),
                    a = new D(i, n, o);
                return F.renders[e]._fun(t, a, s, r), o
        ...
        a = (r(1, i, "alertGlobalError", null, function(t) {
            ...
            for (var s = [], r = 2, o = arguments.length; r < o; r++)
                s.push(arguments[r]);
            if (!i._isinit) {
                ArrayBuffer.prototype.slice || (ArrayBuffer.prototype.slice = i._arrayBufferSlice), i._isinit = !0, N.__init__(), k.__init__(), f.__init__(), i.timer = new V, i.scaleTimer = new V, i.loader = new at, Q.__init__();
        ...
        h = function() {
            ...
            return i.hasListener = function(t) {
                ...
                if (null != i)
                    if (s.run)
                        e && s.caller !== e || s.method !== i || n && !s.once || (delete this._events[t], s.recover());
                    else {
            ...
            return n.destroy = function() {
                ...
                if (t) {
                    ...
                    if (this._cmds) {
                        ...
                        s && (!s || s.callee !== R._context._drawTexture && s.callee !== R._context._drawTextureWithTransform || (s[0] = null, e._cache.push(s)))
                } else
                    this._cmds = null;
                ...
                if (this._one && this._render === this._renderOneImg) {
                    ...
                    this.clear(), t && this.drawTexture(t, e, i, n, s)
                ...
                if (e) {
                    for (var i = e.length - 1; i > -1; i--)
                        if (this._isTextCmd(e[i].callee))
                            return e[i][0].toUpperCase ? e[i][0] = t : e[i][0].setText(t), !0
                } else if (this._one && this._isTextCmd(this._one.callee))
                    return this._one[0].toUpperCase ? this._one[0] = t : this._one[0].setText(t), !0;
                return !1
                ...
                if (e)
                    ...
                    this._one && this._isTextCmd(this._one.callee) && (this._one[4] = t, this._one[0].toUpperCase || (this._one[0].changed = !0))
                ...
                var o = 0,
                    a = !1;
                R.isWebGL && (o = q.getInstance().getId(), null == this._vectorgraphArray && (this._vectorgraphArray = []), this._vectorgraphArray.push(o), a = !(i.length > 6));
                var h = s ? r % 2 == 0 ? 0 : .5 : 0,
        ...
        p = function() {
            ...
            return e.destroy = function() {
                ...
                if (i = this._temp || (this._temp = []), i.length = 0, s || null == this._graphics._one || (t._tempCmds.length = 0, t._tempCmds.push(this._graphics._one), s = t._tempCmds), !s)
                    return i;
                var r;
        ...
        v = (function() {
            ...
            return e.__init__ = function(e, i) {
                ...
                var n = !1;
                if (t.scrollRect && (e -= t.scrollRect.x, i -= t.scrollRect.y), t.hitArea instanceof laya.utils.HitArea)
        ...
        y = function() {
            ...
            return e._clearTempArrs = function() {
                ...
                var i;
                return i = X.getItem("TouchData") || {}, i.id = e, i.tar = t, i
            }, e.onMouseDown = function(e, i, n) {
                if (void 0 === n && (n = !1), this.enable) {
                    var s, r, o;
                    s = this.getTouchFromArr(i, this.preOvers), o = this.getEles(e, null, t._tEleArr), s ? s.tar = e : (r = this.createTouchO(e, i), this.preOvers.push(r)), N.onMobile && this.sendEvents(o, "mouseover", i);
                    var a;
                    a = n ? this.preDowns : this.preRightDowns, (s = this.getTouchFromArr(i, a)) ? s.tar = e : (r = this.createTouchO(e, i), a.push(r)), this.sendEvents(o, n ? "mousedown" : "rightmousedown", i), this._clearTempArrs()
                }
                ...
                for (n = 0; n < s; n++) {
                    if ((o = t[n]).destroyed)
                        return;
                    if (o.event(e, this._event.setTo(e, o, r)), this._event._stoped)
                        break
                }
                ...
                if (void 0 === n && (n = 0), i != e) {
                    var s, r, o = 0,
                        a = 0;
                    if (i.contains(e))
                        r = this.getEles(e, i, t._tEleArr), this.sendEvents(r, "mouseover", n);
                    else if (e.contains(i))
                        r = this.getEles(i, e, t._tEleArr), this.sendEvents(r, "mouseout", n);
                    else {
                ...
                if (this.enable) {
                    var n, s;
                    (n = this.getTouchFromArr(i, this.preOvers)) ? (this.checkMouseOutAndOverOfMove(e, n.tar), n.tar = e, s = this.getEles(e, null, t._tEleArr)) : (s = this.getEles(e, null, t._tEleArr), this.sendEvents(s, "mouseover", i), this.preOvers.push(this.createTouchO(e, i))), this.sendEvents(s, "mousemove", i), this._clearTempArrs()
                }
                ...
                if (void 0 === n && (n = !1), this.enable) {
                    ...
                    if (_ = n ? this.preDowns : this.preRightDowns, s = this.getTouchFromArr(i, _)) {
                        var d = !1,
                            f = N.now();
                        if (d = f - this._lastClickTime < 300, this._lastClickTime = f, e == s.tar)
                            h = r;
                        else
                            for (o = this.getEles(s.tar, null, t._oldArr), (h = t._newArr).length = 0, u = o.length, l = 0; l < u; l++)
                    ...
                    (s = this.getTouchFromArr(i, this.preOvers)) && c && ((h = this.getEles(s.tar, null, h)) && h.length > 0 && this.sendEvents(h, "mouseout", i), this.removeTouchFromArr(i, this.preOvers), s.tar = null, X.recover("TouchData", s)), this._clearTempArrs()
                }
        ...
        b = function() {
            ...
            return s(t, "laya.maths.GrahamScan"), t.multiply = function(t, e, i) {
                ...
                var i, n, s, r = 0,
                    ...
                    h = e.length,
                    l = {};
                for ((n = t._temArr).length = 0, r = (h = e.length) - 1; r >= 0; r--)
        ...
        C = function() {
            ...
            return s(t, "laya.maths.MathUtil"), t.subtractVector3 = function(t, e, i) {
                ...
                var a, h, l, u, c, _ = t[e + 0],
                    ...
                    v = i[n + 2],
                    y = i[n + 3];
                return (h = _ * g + d * m + f * v + p * y) < 0 && (h = -h, g = -g, m = -m, v = -v, y = -y), 1 - h > 1e-6 ? (a = Math.acos(h), l = Math.sin(a), u = Math.sin((1 - s) * a) / l, c = Math.sin(s * a) / l) : (u = 1 - s, c = s), r[o + 0] = u * _ + c * g, r[o + 1] = u * d + c * m, r[o + 2] = u * f + c * v, r[o + 3] = u * p + c * y, r
        ...
        E = function() {
            ...
            return s(t, "laya.media.SoundManager"), r(1, t, "useAudioMusic", function() {
                ...
                if (void 0 === n && (n = 1), void 0 === o && (o = 0), !t._isActive || !e)
                    return null;
                if (t._muted)
                    return null;
                if (t._recoverWebAudio(), (e = L.formatURL(e)) == t._tMusic) {
                    if (t._musicMuted)
                        return null
                } else {
                    if (R.isConchApp) {
                ...
                var h;
                N.onMiniGame || (h = i.loader.getRes(e)), r || (r = t._soundClass), h || ((h = new r).load(e), ot.cacheRes(e, h));
                var l;
                return (l = h.play(o, n)) ? (l.url = e, l.volume = e == t._tMusic ? t.musicVolume : t.soundVolume, l.completeHandler = s, l) : null
                ...
                if (i)
                    i = L.formatURL(i), t._setVolume(i, e);
                else {
                    t.soundVolume = e;
                    var n, s = 0;
        ...
        A = (function() {
            ...
            return e.load = function(t) {
                ...
                t.fontFamily = this.fontName, t.position = "absolute", t.left = "-100px", t.top = "-100px", N.document.body.appendChild(this._div)
            }, e._loadWithCSS = function() {
                var t = this,
                    e = N.createElement("style");
                e.type = "text/css", N.document.body.appendChild(e), e.textContent = "@font-face { font-family:'" + this.fontName + "'; src:url('" + this._url + "');}", this._fontTxt = "40px " + this.fontName, this._txtWidth = o.measureText("LayaTTFFont", this._fontTxt).width;
                var n = this;
                e.onload = function() {
        ...
        R = function() {
            function e(t, n) {
                ...
                e._mainCanvas.source.width = t, e._mainCanvas.source.height = n, o && e.WebGL.init(e._mainCanvas, t, n), N.container.appendChild(e._mainCanvas.source), (e._context = new D(t, n, o ? null : e._mainCanvas)).ctx.setIsMainContext(), N.window.requestAnimationFrame(s), i.stage.on("visibilitychange", this, this._onVisibilitychange)
            }
        ...
        D = function() {
            function t(e, i, n) {
                this.x = 0, this.y = 0, this._drawTexture = function(t, e, i) {
                    ...
                    var s = this.ctx;
                    R.isWebGL && s.setPathId(n[6]), $.drawCall++, s.beginPath(), R.isWebGL && s.movePath(n[0] + e, n[1] + i), s.arc(n[0] + e, n[1] + i, n[2], 0, t.PI2), s.closePath(), this._fillAndStroke(n[3], n[4], n[5], !0)
                    ...
                    var n = this.ctx,
                        ...
                        o = s.length;
                    if (R.isWebGL)
                        for (n.setPathId(i[6]), n.beginPath(), t += i[0], e += i[1], n.movePath(t, e), n.moveTo(s[0], s[1]); r < o;)
                            n.lineTo(s[r++], s[r++]);
                    else
                        for (n.beginPath(), t += i[0], e += i[1], n.moveTo(t + s[0], e + s[1]); r < o;)
                            n.lineTo(t + s[r++], e + s[r++]);
            ...
            return e.onCreate = function(t) {}, e._style = function(t, e, i, n) {
                ...
                if (r) {
                    var a, h, l, u, c = r.ctx,
                        _ = t._needRepaint() || !c,
                        d = r.type;
                    if ("bitmap" === d ? $.canvasBitmap++ : $.canvasNormal++, _) {
                        r._cacheRec || (r._cacheRec = new P);
                        var f, p;
                        R.isWebGL && "bitmap" !== d ? r._cacheRec.setTo(-t.pivotX, -t.pivotY, 1, 1) : ((u = t.getSelfBounds()).x = u.x - t.pivotX, u.y = u.y - t.pivotY, u.x = u.x - 16, u.y = u.y - 16, u.width = u.width + 32, u.height = u.height + 32, u.x = Math.floor(u.x + n) - n, u.y = Math.floor(u.y + s) - s, u.width = Math.floor(u.width), u.height = Math.floor(u.height), r._cacheRec.copyFrom(u)), u = r._cacheRec;
                        ...
                        if (f = u.width * g, p = u.height * m, h = u.x, l = u.y, R.isWebGL && "bitmap" === d && (f > 2048 || p > 2048))
                            return console.warn("cache bitmap size larger than 2048,cache ignored"), r.ctx && (X.recover("RenderContext", r.ctx), r.ctx.canvas.size(0, 0), r.ctx = null), void o._fun.call(o, t, e, n, s);
                        c || (c = r.ctx = X.getItem("RenderContext") || new D(f, p, yt.create("AUTO"))), c.ctx.sprite = t, (a = c.canvas).clear(), (a.width != f || a.height != p) && a.size(f, p), "bitmap" === d ? a.context.asBitmap = !0 : "normal" === d && (a.context.asBitmap = !1);
                        var T;
                        if (1 != g || 1 != m) {
                            var b = c.ctx;
                            b.save(), b.scale(g, m), !R.isConchWebGL && R.isConchApp && (T = t._$P.cf) && b.setFilterMatrix && b.setFilterMatrix(T._mat, T._alpha), o._fun.call(o, t, c, -h, -l), b.restore(), R.isConchApp && !R.isConchWebGL || t._applyFilters()
                        } else
                            b = c.ctx, !R.isConchWebGL && R.isConchApp && (T = t._$P.cf) && b.setFilterMatrix && b.setFilterMatrix(T._mat, T._alpha), o._fun.call(o, t, c, -h, -l), R.isConchApp && !R.isConchWebGL || t._applyFilters();
                        t._$P.staticCache && (r.reCache = !1), $.canvasReCache++
                    } else
                        h = (u = r._cacheRec).x, l = u.y, a = c.canvas;
                    e.drawCanvas(a, n + h, s + l, u.width, u.height)
                } else
                    o._fun.call(o, t, c, n, s)
            }, t.__init__ = function() {
                var e, i = 0,
                    n = 0;
                for (e = o.createRenderSprite(69905, null), n = t.renders.length = 4096, i = 0; i < n; i++)
                    t.renders[i] = e;
        ...
        N = (function() {
            ...
            return s(n, "laya.utils.Browser"), r(1, n, "pixelRatio", function() {
                ...
                if (t.data && "size" == t.data.name) {
                    if (n.window.innerWidth = t.data.width, n.window.innerHeight = t.data.height, n.window.__innerHeight = t.data.clientHeight, !n.document.createEvent)
            ...
            return s(t, "laya.utils.CacheManager"), t.regCacheByFunction = function(e, i) {
                ...
                if (!(e.length < 1)) {
                    var i = N.now(),
                        n = 0,
                        s = 0;
                    for (s = n = e.length; n > 0 && (t._index++, t._index = t._index % s, e[t._index].tryDispose(!1), !(N.now() - i > t.loopTimeLimit));)
                        n--
                }
        ...
        G = function() {
            ...
            return s(t, "laya.utils.ClassUtils"), t.regClass = function(e, i) {
                ...
                return 1 == n && 1 == s && 0 == r || ((i = i || new M).scale(n, s), i.rotate(.0174532922222222 * r)), i
                ...
                if (n = e.props) {
                    ...
                    if (s = t.DrawTypeDic[e.type]) {
                        ...
                        ((o = t._tM) || 1 != t._alpha) && (r.save(), o && r.transform(o), 1 != t._alpha && r.alpha(t._alpha)), r[s[0]].apply(r, a), (o || 1 != t._alpha) && r.restore()
                    }
                }
                ...
                var h;
                return (h = t._getTransformData(e)) ? (n || (n = 0), h.translate(r[n], r[n + 1]), r[n] = r[n + 1] = 0, t._tM = h) : t._tM = null, s && t[s] && (r = t[s](r)), r
        ...
        U = function() {
            function t(e) {
                if (this._color = [], "string" == typeof e) {
                    ...
                    r = this.numColor = e, this.strColor = K.toHexColor(r);
        ...
        z = (function() {
            ...
            return e.start = function(t, e, n, s, r, o, a, h) {
                ...
                if (this.elasticDistance <= 0)
                    ...
                    if (this._elasticRateX = Math.max(0, 1 - t / this.elasticDistance), this.target.y < this.area.y)
                ...
                var t = NaN,
                    e = NaN;
                if (this.target.x < this.area.x ? t = this.area.x : this.target.x > this.area.x + this.area.width && (t = this.area.x + this.area.width), this.target.y < this.area.y ? e = this.area.y : this.target.y > this.area.y + this.area.height && (e = this.area.y + this.area.height), isNaN(t) && isNaN(e))
                    this.clear();
                else {
                    var i = {};
        ...
        Y = function() {
            ...
            return s(t, "laya.utils.Ease"), t.linearNone = function(t, e, i, n) {
                ...
                var a;
                return 0 == e ? i : 1 == (e /= s) ? i + n : (o || (o = .3 * s), !r || n > 0 && r < n || n < 0 && r < -n ? (r = n, a = o / 4) : a = o / t.PI2 * Math.asin(n / r), -r * Math.pow(2, 10 * (e -= 1)) * Math.sin((e * s - a) * t.PI2 / o) + i)
            }, t.elasticInOut = function(e, i, n, s, r, o) {
                void 0 === r && (r = 0), void 0 === o && (o = 0);
                var a;
                return 0 == e ? i : 2 == (e /= .5 * s) ? i + n : (o || (o = s * (.3 * 1.5)), !r || n > 0 && r < n || n < 0 && r < -n ? (r = n, a = o / 4) : a = o / t.PI2 * Math.asin(n / r), e < 1 ? r * Math.pow(2, 10 * (e -= 1)) * Math.sin((e * s - a) * t.PI2 / o) * -.5 + i : r * Math.pow(2, -10 * (e -= 1)) * Math.sin((e * s - a) * t.PI2 / o) * .5 + n + i)
            }, t.elasticOut = function(e, i, n, s, r, o) {
                void 0 === r && (r = 0), void 0 === o && (o = 0);
                var a;
                return 0 == e ? i : 1 == (e /= s) ? i + n : (o || (o = .3 * s), !r || n > 0 && r < n || n < 0 && r < -n ? (r = n, a = o / 4) : a = o / t.PI2 * Math.asin(n / r), r * Math.pow(2, -10 * e) * Math.sin((e * s - a) * t.PI2 / o) + n + i)
        ...
        H = function() {
            ...
            return e.isHit = function(e, i) {
                ...
                if (!n)
                    return !1;
                var s;
                if (!(s = n.cmds) && n._one && ((s = t._cmds).length = 1, s[0] = n._one), !s)
                    return !1;
                var r = 0,
                    o = 0;
                o = s.length;
        ...
        $ = (function() {
            ...
            e.getCacheList = function() {
                ...
                var e;
                (e = X.getPoolBySign(this.sign)).length > this.maxCount && e.splice(this.maxCount, e.length - this.maxCount)
            }, t.addPoolCacheManager = function(e, i) {
                void 0 === i && (i = 100);
                var n;
                (n = new t).sign = e, n.maxCount = i, W.regCacheByFunction(K.bind(n.tryDispose, n), K.bind(n.getCacheList, n))
            }
        }(), function() {
            function t() {}
            return s(t, "laya.utils.Stat"), r(1, t, "onclick", null, function(e) {
                ...
                void 0 === e && (e = 0), void 0 === i && (i = 0), !R.isConchApp || R.isConchWebGL ? (R.isConchWebGL || N.onMiniGame || N.onLimixiu || (t._useCanvas = !0), t._show = !0, t._fpsData.length = 60, t._view[0] = {
                    title: "FPS(Canvas)",
                    value: "_fpsStr",
                    color: "yellow",
                    units: "int"
                ...
                var n = t._sp,
                    s = N.pixelRatio;
                n || (n = new ct, (t._leftText = new gt).pos(5, 5), t._leftText.color = "#ffffff", n.addChild(t._leftText), (t._txt = new gt).pos(80 * s, 5), t._txt.color = "#ffffff", n.addChild(t._txt), t._sp = n), n.pos(e, i);
                ...
                t._txt.fontSize = t._fontSize * s, t._leftText.fontSize = t._fontSize * s, n.size(a, h), n.graphics.clear(), n.graphics.setAlpha(.5), n.graphics.drawRect(0, 0, a, h, "#999999"), n.graphics.setAlpha(1), t.loop()
            }, t.enable = function() {
        ...
        V = (function() {
            ...
            return n._init = function() {
                ...
                if (this.scale <= 0)
                    ...
                    for (this._count = 0, o = 0, a = n.length; o < a; o++)
                            ...
                            if (s >= h.exeTime)
                                if (h.repeat)
                                    if (h.jumpFrame)
                                        ...
                                        h.exeTime += h.delay, h.run(!1), s > h.exeTime && (h.exeTime += Math.ceil((s - h.exeTime) / h.delay) * h.delay);
                            else
                                h.run(!0)
                        } else
                            this._count++;
                ...
                if (!s)
                    return o.apply(r, a), null;
                if (h) {
                    var l = this._getHandler(r, o);
                    if (l)
                        return l.repeat = n, l.userFrame = i, l.delay = s, l.caller = r, l.method = o, l.args = a, l.exeTime = s + (i ? this.currFrame : this.currTimer + this._now() - this._lastTimer), l
                }
        ...
        j = function() {
            ...
            return e.to = function(t, e, i, n, s, r, o) {
                ...
                this._target = e, this._duration = s, this._ease = r || n.ease || t.easeNone, this._complete = o || n.complete, this._delay = a, this._props = [], this._usedTimer = 0, this._startTimer = N.now(), this._usedPool = u, this._delayParam = null, this.update = n.update;
                var _ = e.$_GID || (e.$_GID = K.getGID());
                return t.tweenMap[_] ? (h && t.clearTween(e), t.tweenMap[_].push(this)) : t.tweenMap[_] = [this], c ? a <= 0 ? this.firstStart(e, n, l) : (this._delayParam = [e, n, l], i.scaleTimer.once(a, this, this.firstStart, this._delayParam)) : this._initProps(e, n, l), this
                ...
                if (this.pause(), this._usedTimer = 0, this._startTimer = N.now(), this._delayParam)
        ...
        K = function() {
            ...
            return s(t, "laya.utils.Utils"), t.toRadian = function(e) {
                ...
                var e;
                if (t = t.replace(/>\s+</g, "><"), (e = (new DOMParser).parseFromString(t, "text/xml")).firstChild.textContent.indexOf("This page contains the following errors") > -1)
            ...
            return e.set = function(e, i) {
                if (null != e)
                    if (t.supportWeakMap) {
                        ...
                        "string" == typeof e || "number" == typeof e ? this._obj[e] = i : (e.$_GID || (e.$_GID = K.getGID()), this._obj[e.$_GID] = i)
            }, e.get = function(e) {
                if (null == e)
                    return null;
                if (t.supportWeakMap) {
        ...
        Z = function(t) {
            ...
            return n._setBit = function(t, e) {
                ...
                if (t.zOrder && this._set$P("hasZorder", !0), t._parent === this) {
                    ...
                    t.parent && t.parent.removeChild(t), this._childs === e.ARRAY_EMPTY && (this._childs = []), this._childs.push(t), this.conchModel && this.conchModel.addChildAt(t.conchModel, this._childs.length - 1), t.parent = this, this._childChanged();
                return t
                ...
                if (t.zOrder && this._set$P("hasZorder", !0), i >= 0 && i <= this._childs.length) {
                    if (t._parent === this) {
                        ...
                        t.parent && t.parent.removeChild(t), this._childs === e.ARRAY_EMPTY && (this._childs = []), this._childs.splice(i, 0, t), this.conchModel && this.conchModel.addChildAt(t.conchModel, i), t.parent = this;
                    return t
                }
        ...
        tt = function(t) {
            ...
            return i.destroy = function() {
                ...
                function n(t) {
                    var e = r.width,
                        n = s.width;
                    o.width && (s.width = i(e, n, o.width)), o.height && (s.height = i(e, n, o.height)), o.left && (s.x = i(e, n, o.left)), o.top && (s.y = i(e, n, o.top))
                }
                if (e.indexOf("%") < 0)
                    return !1;
                var s = this._ower,
                ...
                var a = e.split(" ");
                return a[0] = parseFloat(a[0]) / 100, 1 == a.length ? a[1] = a[2] = 0 : (a[1] = parseFloat(a[1]) / 100, a[2] = parseFloat(a[2])), o[t] = a, o.input[t] = e, n(), !0
                ...
                if (this._type |= 8, "string" == typeof t) {
                    ...
                    if (e >= 0 && (this._type |= 262144, t = t.substr(0, e)), this._calculation("width", t))
                        return;
                    t = parseInt(t)
                }
                this.size(t, -1)
                ...
                var e = this._ower;
                if ("string" == typeof t) {
                    if ("center" === t ? t = "50% -50% 0" : "right" === t && (t = "100% -100% 0"), this._calculation("left", t))
                        return;
                    t = parseInt(t)
                }
                e.x = t
                ...
                var e = this._ower;
                if ("string" == typeof t) {
                    if ("middle" === t ? t = "50% -50% 0" : "bottom" === t && (t = "100% -100% 0"), this._calculation("top", t))
                        return;
                    t = parseInt(t)
                }
                e.y = t
                ...
                if ("none" != t) {
                    ...
                    var e = t.split(" ");
                    if (this._border.color = U.create(e[e.length - 1]), 1 == e.length)
                        return this._border.size = 1, void(this._border.type = "solid");
                    var i = 0;
        ...
        et = function(t) {
            ...
            return i.dispose = function() {
                ...
                var r;
                if (t == E._tMusic ? (e._initMusicAudio(), (r = e._musicAudio).src != t && (e._audioCache[r.src] = null, r = null)) : r = e._audioCache[t], r && r.readyState >= 2)
                    this.event("complete");
                else {
                    r || (t == E._tMusic ? (e._initMusicAudio(), r = e._musicAudio) : r = N.createElement("audio"), e._audioCache[t] = r, r.src = t), r.addEventListener("canplaythrough", i), r.addEventListener("error", n);
                    var o = this;
                ...
                if (!(n = this.url == E._tMusic ? e._musicAudio : e._audioCache[this.url]))
                    return null;
                var s;
                s = X.getItem("audio:" + this.url), R.isConchApp ? s || ((s = N.createElement("audio")).src = this.url) : this.url == E._tMusic ? (e._initMusicAudio(), (s = e._musicAudio).src = this.url) : s = s || n.cloneNode(!0);
                var r = new _t(s);
        ...
        st = function(t) {
            ...
            return i.load = function(t) {
                var i = this;
                if (t = L.formatURL(t), this.url = t, this.audioBuffer = e._dataCache[t], this.audioBuffer)
        ...
        ot = function(t) {
            ...
            return n.load = function(t, i, n, s, r) {
                if (void 0 === n && (n = !0), void 0 === r && (r = !1), this._url = t, 0 === t.indexOf("data:image") ? this._type = i = "image" : (this._type = i || (i = this.getTypeFromUrl(t)), t = L.formatURL(t)), this._cache = n, this._data = null, !r && e.loadedMap[t])
                ...
                if (s && e.setGroup(t, s), null != e.parserMap[i])
                    return this._customParse = !0, void(e.parserMap[i] instanceof laya.utils.Handler ? e.parserMap[i].runWith(this) : e.parserMap[i].call(null, this));
                ...
                e.preLoadedMap[t] ? this.onLoaded(e.preLoadedMap[t]) : (this._http || (this._http = new rt, this._http.on("progress", this, this.onProgress), this._http.on("error", this, this.onError), this._http.on("complete", this, this.onLoaded)), this._http.send(t, null, "get", o))
                ...
                "nativeimage" === this._type ? ((n = new N.window.Image).crossOrigin = "", n.onload = r, n.onerror = o, n.src = t, e.imgCache[t] = n) : new Tt.create(t, {
                    onload: r,
                    onerror: o,
                    onCreate: function(i) {
                        n = i, e.imgCache[t] = i
                ...
                if ("plf" == i)
                    ...
                    if (this._data.meta && this._data.meta.scale && 1 != this._data.meta.scale) {
                        ...
                        for (var v in c) {
                            var y = c[v],
                                ...
                                x = L.formatURL(d + v);
                            w.scaleRate = m, e.cacheRes(x, lt.create(w, y.frame.x, y.frame.y, y.frame.w, y.frame.h, y.spriteSourceSize.x, y.spriteSourceSize.y, y.sourceSize.w, y.sourceSize.h)), e.loadedMap[x].url = x, g.push(x)
                        }
                    } else
                        for (v in c)
                    ...
                    var b = this._url.split(".fnt")[0].split("/"),
                        C = b[b.length - 1];
                    gt.registerBitmapFont(C, T), this._data = T, this.complete(this._data)
                } else if ("pkm" == i) {
                ...
                for (i in t)
                    switch (s = t[i], i) {
                        ...
                        case "text":
                            for (n in s)
                                e.preLoadedMap[L.formatURL(n)] = s[n];
                            break;
                        default:
                            for (n in s)
                                e.preLoadedMap[L.formatURL(n)] = s[n]
                ...
                for (var t = N.now(); e._startIndex < e._loaders.length;)
                    if (N.now(), e._loaders[e._startIndex].endLoad(), e._startIndex++, N.now() - t > e.maxTimeOut)
                        return console.warn("loader callback cost a long time:" + (N.now() - t) + " url=" + e._loaders[e._startIndex - 1].url), void i.timer.frameOnce(1, null, e.checkNext);
                e._loaders.length = 0, e._startIndex = 0, e._isWorking = !1
            }, e.clearRes = function(t, i) {
                void 0 === i && (i = !1), t = L.formatURL(t);
                var n = e.getAtlas(t);
                if (n) {
        ...
        at = function(t) {
            ...
            return o.create = function(t, e, i, n, s, r, o, a) {
                ...
                var c = L.formatURL(t),
                    _ = this.getRes(c);
                if (_)
                    !_.hasOwnProperty("loaded") || _.loaded ? (s && s.runWith(1), n && n.run()) : n && i.loader._createListener(t, n.caller, n.method, n.args, !0, !1);
                else {
                    ...
                    r || (r = f[0]);
                    var p = f[1];
                    "atlas" == d ? this.load(t, n, s, p, a, h) : (r === lt && (p = "htmlimage"), (_ = r ? new r : null).hasOwnProperty("_loaded") && (_._loaded = !1), _._setUrl(t), u && _._setGroup(u), this._createLoad(_, t, l.create(null, function(e) {
                ...
                var c = this;
                if (void 0 === a && (a = 1), void 0 === h && (h = !0), void 0 === u && (u = !1), t instanceof Array)
                ...
                var _ = this;
                if (void 0 === h && (h = 1), void 0 === l && (l = !0), void 0 === c && (c = !1), n instanceof Array)
                ...
                if (null == n) {
                    ...
                    if (r < this.retryNum)
                        return console.warn("[warn]Retry to load:", s), this._failRes[s] = r + 1, void i.timer.once(this.retryDelay, this, this._addReTry, [t], !1);
                ...
                for (var a = t.length, h = 0, u = 0, c = [], _ = !0, d = 0; d < a; d++) {
                    var f = t[d];
                    "string" == typeof f && (f = {
                        url: f,
                        type: n,
        ...
        ht = (function(t) {
            ...
            i.connect = function(t, e) {
                var i = "ws://" + t + ":" + e;
                i = "https:" == N.window.location.protocol ? "wss://" + t + ":" + e : "ws://" + t + ":" + e, this.connectByUrl(i)
            }, i.connectByUrl = function(t) {
                var e = this;
                null != this._socket && this.close(), this._socket && this.cleanSocket(), this.protocols && 0 != this.protocols.length ? this._socket = new N.window.WebSocket(t, this.protocols) : this._socket = new N.window.WebSocket(t), this._socket.binaryType = "arraybuffer", this._output = new this._byteClass, this._output.endian = this.endian, this._input = new this._byteClass, this._input.endian = this.endian, this._addInputPosition = 0, this._socket.onopen = function(t) {
                    e._onOpen(t)
            ...
            i.workerMessage = function(t) {
                ...
                if (t && t.buffer && t.buffer.length < 10)
                    return e._enable = !1, this._myTrace("buffer lost when postmessage ,disable workerloader"), this.event(t.url, null), void this.event("image_err", t.url + "\n" + t.msg);
                if (!t.dataType)
                    return this.event(t.url, null), void this.event("image_err", t.url + "\n" + t.msg);
                var i, n, s;
                switch (t.dataType) {
                    case "buffer":
                        (s = (n = (i = new yt("2D")).source.getContext("2d")).createImageData(t.width, t.height)).data.set(t.buffer), i.size(s.width, s.height), n.putImageData(s, 0, 0), i.memorySize = 0;
                        break;
                    case "imagedata":
                        n = (i = new yt("2D")).source.getContext("2d"), s = t.imagedata, i.size(s.width, s.height), n.putImageData(s, 0, 0), s = t.imagedata, i.memorySize = 0;
                        break;
                    case "imageBitmap":
                        s = t.imageBitmap, R.isWebGL ? i = s : (n = (i = new yt("2D")).source.getContext("2d"), i.size(s.width, s.height), n.drawImage(s, 0, 0), i.src = t.url)
                }
            ...
            return i.imps(n, {
                ...
                if (!this._destroyed) {
                    ...
                    var t;
                    this._url && ((t = e._urlResourcesMap[this._url]) && (t.splice(t.indexOf(this), 1), 0 === t.length && delete e._urlResourcesMap[this.url]), ot.clearRes(this._url), this.__loaded || o.cancelLoadByUrl(this._url)), this._group && ((t = e._groupResourcesMap[this._group]).splice(t.indexOf(this), 1), 0 === t.length && delete e._groupResourcesMap[this.url])
                }
        ...
        lt = function(e) {
            ...
            return a._setUrl = function(t) {
                ...
                if (R.isWebGL)
                    return o.getTexturePixels(this, t, e, i, n);
                N.canvas.size(i, n), N.canvas.clear(), N.context.drawTexture(this, -t, -e, this.width, this.height, 0, 0);
                return N.context.getImageData(0, 0, i, n).data
        ...
        ut = function(t) {
            ...
            return o.to = function(t, e, i, n, s) {
                ...
                if (null != this._tweenDataList && 0 != this._tweenDataList.length) {
                    ...
                    var r;
                    null == this._endTweenDataList || this._endTimeSort ? (this._endTimeSort = !1, this._endTweenDataList = r = this._tweenDataList.concat(), r.sort(function(t, e) {
                ...
                if (0 != this._tweenDataList.length && this._index < this._tweenDataList.length) {
                    ...
                    n >= r.startTime && (this._index++, 0 == r.type ? (this._gidIndex++, (s = X.getItemByClass("tween", j))._create(r.target, r.data, r.duration, r.ease, l.create(this, this._animComplete, [this._gidIndex]), 0, !1, r.isTo, !0, !1), s.setStartTime(n), s.gid = this._gidIndex, this._tweenDic[this._gidIndex] = s, s._updateEase(n)) : this.event("label", r.data))
                }
        ...
        ct = function(e) {
            ...
            return i.imps(h, {
                ...
                if (!n || n.length < 1)
                    return n;
                if (8 != n.length && (n = t ? b.scanPList(n) : P._getWrapRec(n, P.TEMP)._getBoundPoints()), !this.transform)
                    return K.transPointList(n, this._x - e, this._y - i), n;
                var s = S.TEMP,
                    r = 0,
                    o = n.length;
                for (r = 0; r < o; r += 2)
                ...
                if (R.isConchNode) {
                    var s = yt.create("2D");
                    return new D(t, e, s).ctx.setCanvasType(1), this.conchModel.drawToCanvas(s.source, i, n), s
                }
                ...
                void 0 === e && (e = !1), !0 === e && (t = new S(t.x, t.y));
                ...
                if (this._$P) {
                    ...
                    t && t.ctx && (X.recover("RenderContext", t.ctx), t.ctx.canvas.size(0, 0), t.ctx = null);
                ...
                t = i.x, e = i.y;
                return (this._$P.hitArea ? this._$P.hitArea : this._width > 0 && this._height > 0 ? P.TEMP.setTo(0, 0, this._width, this._height) : this.getSelfBounds()).contains(t, e)
                ...
                if (t !== (e ? e.type : "none")) {
                    if ("none" !== t)
                        this._getBit(1) || this._setUpNoticeType(1), e || (e = this._set$P("cacheCanvas", X.getItemByClass("cacheCanvas", Object))), e.type = t, e.reCache = !0, this._renderType |= 16, "bitmap" == t && this.conchModel && this.conchModel.cacheAs(1), this._set$P("cacheForFilters", !1);
                        ...
                        if (e) {
                            var i = e;
                            i && i.ctx && (X.recover("RenderContext", i.ctx), i.ctx.canvas.size(0, 0), i.ctx = null), X.recover("cacheCanvas", e)
                        }
        ...
        _t = function(t) {
            ...
            return n.__onEnd = function() {
                if (1 == this.loops)
                    return this.completeHandler && (i.timer.once(10, this, this.__runComplete, [this.completeHandler], !1), this.completeHandler = null), this.stop(), void this.event("complete");
        ...
        gt = function(t) {
            ...
            return o.destroy = function(e) {
                ...
                if (t = e.langPacks && e.langPacks[t] ? e.langPacks[t] : t, arguments.length < 2)
                    this._text = t;
                else {
                ...
                for (var m = 0, v = 0, y = Math.min(this._lines.length, e + t) || 1, w = t; w < y; w++) {
                    ...
                    if (m = r - (this._clipPoint ? this._clipPoint.x : 0), v = u + h * w - (this._clipPoint ? this._clipPoint.y : 0), this.underline && this.drawUnderline(o, m, v, w), l) {
                        ...
                        R.isWebGL ? (this._words || (this._words = []), (x = this._words.length > w - t ? this._words[w - t] : new J).setText(T)) : x = T, _.stroke ? i.fillBorderText(x, m, v, n, this.color, _.strokeColor, _.stroke, o) : i.fillText(x, m, v, n, this.color, o)
                }
                if (l && l.autoScaleSize) {
                    var S = 1 / d;
                    this.scale(S, S)
                ...
                N.context.font = this._getCSSStyle().font, this._lines.length = 0, this._lineWidths.length = 0, this._isPassWordMode() ? this.parseLines(this._getPassWordTxt(this._text)) : this.parseLines(this._text), this.evalTextSize(), this.checkEnabledViewportOrNot() ? this._clipPoint || (this._clipPoint = new S(0, 0)) : this._clipPoint = null;
                ...
                if (this._currBitmapFont)
                    this._charSize.width = this._currBitmapFont.getMaxWidth(), this._charSize.height = this._currBitmapFont.getMaxHeight();
                else {
                ...
                if ((o = this.getTextWidth(t)) <= i)
                    return s.push(t), void this._lineWidths.push(o);
                ...
                for (var l = r, u = t.length; l < u; l++)
                    if (o = this.getTextWidth(t.charAt(l)), (a += o) > i)
                        if (this.wordWrap) {
                            ...
                            if (c.charCodeAt(c.length - 1) < 255 ? (n = /(?:\w|-)+$/.exec(c)) && (l = n.index + h, 0 == n.index ? l += c.length : c = t.substring(h, l)) : e.RightToLeft && (n = /([\u0600-\u06FF])+$/.exec(c)) && (l = n.index + h, 0 == n.index ? l += c.length : c = t.substring(h, l)), s.push(c), this._lineWidths.push(a - o), h = l, !(l + r < u)) {
                    ...
                    return s.push(t.substring(0, l)), void this._lineWidths.push(this.getTextWidth(s[s.length - 1]));
                ...
                var t = this.padding,
                    e = NaN;
                return (e = this._currBitmapFont && this._currBitmapFont.autoScaleSize ? this._width * (this._currBitmapFont.fontSize / this.fontSize) : this._width) <= 0 && (e = this.wordWrap ? 100 : N.width), e <= 0 && (e = 100), e - t[3] - t[1]
                ...
                var t;
                (t = N.canvas.source.style).display = "none", t.position = "absolute", t.direction = "rtl", R._mainCanvas.source.style.direction = "rtl", laya.display.Text.RightToLeft = !0, N.document.body.appendChild(N.canvas.source)
        ...
        mt = function(t) {
            function e() {
                this.focus = null, this.designWidth = 0, this.designHeight = 0, this.canvasRotation = !1, this.canvasDegree = 0, this.renderingEnabled = !0, this.screenAdaptationEnabled = !0, this._screenMode = "none", this._scaleMode = "noscale", this._alignV = "top", this._alignH = "left", this._bgColor = "black", this._mouseMoveTime = 0, this._renderCount = 0, this._frameStartTime = NaN, this._isFocused = !1, this._isVisibility = !1, this._scenes = null, this._frameRate = "fast", e.__super.call(this), this.offset = new S, this._canvasTransform = new M, this._previousOrientation = N.window.orientation;
                var t = this;
                ...
                var s = "visibilityState",
                    r = "visibilitychange",
                    o = i.document;
                void 0 !== o.hidden ? (r = "visibilitychange", s = "visibilityState") : void 0 !== o.mozHidden ? (r = "mozvisibilitychange", s = "mozVisibilityState") : void 0 !== o.msHidden ? (r = "msvisibilitychange", s = "msVisibilityState") : void 0 !== o.webkitHidden && (r = "webkitvisibilitychange", s = "webkitVisibilityState"), i.document.addEventListener(r, function() {
                    ...
                    null != e && e != t._previousOrientation && n._isInputting() && (xt.inputElement.target.focus = !1), t._previousOrientation = e, n._isInputting() || n._resetCanvas()
            ...
            return a._setStageVisible = function(t) {
                ...
                if (this._renderCount++, R.isFlash && this.repaint(), this._style.visible) {
                    ...
                    if ($.renderSlow = !a, a || h || R.isConchApp) {
                        $.loopCount++, v.instance.runEvent(), i.timer._update(), o.update3DLoop();
                        var l, u = 0,
                            c = 0;
                        if (R.isConchNode)
                            for (u = 0, c = this._scenes.length; u < c; u++)
                    ...
                    this._renderCount % 5 == 0 && ($.loopCount++, v.instance.runEvent(), i.timer._update())
                ...
                if (this._frameRate = t, R.isConchApp)
        ...
        yt = function(t) {
            function e(t, i) {
                ...
                if (this._source = this, "2D" === t || "AUTO" === t && !R.isWebGL) {
                    this._is2D = !0, this._source = i || N.createElement("canvas"), this._w = this._source.width, this._h = this._source.height;
                    var s = this;
                    s.getContext = function(t, e) {
                        if (n._ctx)
                            return n._ctx;
                        var i = n._ctx = n._source.getContext(t, e);
                        return i && (i._canvas = s, R.isFlash || N.onLimixiu || (i.size = function(t, e) {})), i
                    }
                }
                this.lock = !0
            }
        ...
        wt = (function(t) {
            ...
            n.destroy = function(t) {
                ...
                var o = this;
                return o._setFramesFromCache(s) || (ot.getAtlas(t) ? r(t) : i.loader.load(t, l.create(null, r, [t]), null, "atlas")), this
            }, n.loadAnimation = function(t, e, n) {
                this._url = t;
                return this._actionName || (this._actionName = ""), this._setFramesFromCache("") ? (this._setFramesFromCache(this._actionName, !0), this.index = 0, e && e.run()) : !n || ot.getAtlas(n) ? this._loadAnimationData(t, e, n) : i.loader.load(n, l.create(this, this._loadAnimationData, [t, e, n]), null, "atlas"), this
            }, n._loadAnimationData = function(t, n, s) {
                function r(i) {
                    if (ot.getRes(i) && t === i) {
                        var s;
                        if (e.framesMap[t + "#"])
                            a._setFramesFromCache(o._actionName, !0), o.index = 0, o._checkResumePlaying();
                        else {
                ...
                if (!s || ot.getAtlas(s)) {
                    var a = this;
                    ot.getRes(t) ? r(t) : i.loader.load(t, l.create(null, r, [t]), null, "json"), ot.clearRes(t)
                } else
            ...
            return i._setUp = function(t, e) {
                ...
                if (o > this._count && (this._count = o), t.tween)
                    for (null == (n = Y[t.tweenMethod]) && (n = Y.linearNone), s = r; s < o; s++)
        ...
        xt = function(t) {
            ...
            return o.setSelection = function(t, e) {
                ...
                this.padding;
                if (t.type = this._type, t.value = this._content, t.placeholder = this._prompt, i.stage.off("keydown", this, this._onKeyDown), i.stage.on("keydown", this, this._onKeyDown), i.stage.focus = this, this.event("focus"), N.onPC && t.focus(), !N.onMiniGame) {
                    this._text;
                    this._text = null
                }
                ...
                this._focus !== t && (t ? (i.target ? i.target._focusOut() : this._setInputMethod(), i.target = this, this._focusIn()) : (i.target = null, this._focusOut(), N.document.body.scrollTop = 0, i.blur(), R.isConchApp ? i.setPos(-1e4, -1e4) : e.inputContainer.contains(i) && e.inputContainer.removeChild(i)))
                ...
                if (this._needReleaseAgain = !1, this._source) {
                    ...
                    this._source = new N.window.Image, this._source.crossOrigin = "", this._source.onload = function() {
                        if (e._needReleaseAgain)
                            return e._needReleaseAgain = !1, e._source.onload = null, void(e._source = null);
        ...
        bt = (function(t) {
            ...
            return r._parseNodeList = function(t) {
                ...
                if (!(o < .01)) {
                    ...
                    var h;
                    r.skin && (h = this._getTextureByUrl(r.skin)) && (a._checkTransform() ? (n.drawTexture(h, 0, 0, r.width, r.height, a, o), r.resultTransform = null) : n.drawTexture(h, a.tx, a.ty, r.width, r.height, null, o));
                    var l;
                    if (l = t.child) {
                        var u = 0,
                            c = 0;
                        for (c = l.length, u = 0; u < c; u++)
                ...
                if (n = this._nodeGDic[t.compId] = this._getNodeGraphicData(t.compId, e, this._nodeGDic[t.compId]), t.child) {
                    ...
                    var a = !1;
                    (a = s.bTransform || 1 != n.alpha) && i.save(), 1 != n.alpha && i.alpha(n.alpha), r ? o && i.translate(s.tx, s.ty) : i.transform(s.clone());
                    var h;
                    h = t.child;
                    var l;
                ...
                var w;
                s.skin = h, s.width = l, s.height = u, h && ((w = this._getTextureByUrl(h)) ? (l || (l = w.sourceWidth), u || (u = w.sourceHeight)) : console.warn("lost skin:", h, ",you may load pics first")), s.alpha = a[10];
                var x;
                ...
                if (m || 1 !== p || 1 !== g || v || y) {
                    ...
                    var b = .0174532922222222 * (m - v),
                        ...
                        E = Math.sin(b),
                        I = Math.cos(b);
                    T.a = p * S, T.b = p * P, T.c = -g * E, T.d = g * I, T.tx = T.ty = 0
                }
                ...
                if (t.animations) {
                    ...
                    for (a = 0; a < h; a++)
                        if (n = o[a], this._labels = null, (!i || i == n.name) && n) {
                            ...
                            var l = {};
                            l.interval = 1e3 / n.frameRate, l.frames = this._gList, l.labels = this._labels, l.name = n.name, r.push(l), s[n.name] = l
                        }
