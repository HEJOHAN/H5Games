(function() {
    ...
    */
    ...
    function Ca(a, b, c) {
        ...
        } else return b = c + (+!!(b & 512) - 1), a = 0 > b || b >= a.length || b >= d ? void 0 : a[b], a
    }
            ...
            try {
                ...
                if (k.location && k.location.ancestorOrigins && k.location.ancestorOrigins.length == l.length - 1)
                    for (m = 1; m < l.length; ++m) {
                        var q = l[m];
                        q.url || (q.url = k.location.ancestorOrigins[m - 1] || "", q.X = !0)
                    }
                var p = l;
    ...
    var Fb = class {
        ...
        I() {
            if (this.s = Cb(this)) {
                if (this.J(), J(this.config, 1)) {
                    var a = this.g,
                        b = J(this.config, 1);
                    a.parent.postMessage(b,
                        "*")
                }
            } else this.i ? .notifyError("freq_cap")
        }
        u() {
            if (!this.m) {
                this.A && L(this.g, "storage", this.A);
                var a = this.m = Date.now();
                if (!I(this.config, 2) && !this.D) try {
                    this.g.localStorage.setItem("LAST_INTERSTITIAL_TIME", "" + a)
                } catch (b) {}
                this.V();
                this.l && (a = this.g.document.createEvent("Event"), a.initEvent("i-creative-view", !0, !1), this.l.dispatchEvent(a), a = this.g.document.createEvent("Event"), a.initEvent("onshow", !0, !1), this.g.dispatchEvent(a))
            }
        }
        G() {}
        J() {
        ...
        V(a) {
            ...
            try {
                ...
                T.B(533, c, void 0, void 0);
                return
            }
            a = a || 1;
            b ? (Y(this, {
                vf: a
            }), 3 <= a || this.g.setTimeout(r(Fb.prototype.V, this, a + 1), 3E3)) : 1 < a && Y(this, {
                vs: a
            })
        }
    };
    ...
    function Mb(a, b) {
        b.some(c => "intervention" === c.type && "HeavyAdIntervention" === c.body ? .id) && (Y(a, {
            hai: "1"
        }, 1), a.P ? .l(), a.m ? a.dismiss(8) : a.i ? a.i.notifyError("heavy_ads") : X(a.g, "i_iif"))
    }
    ...
    function Rb(a) {
        ...
        a.U && K(a.U, "click", W(261, c => Qb(a, c)));
    ...
    var Ub = class extends Fb {
        ...
        I() {
            super.I();
            if (this.v = this.g.ReportingObserver ? new this.g.ReportingObserver((a, b) => {
                    Mb(this, a) && b.disconnect()
                }, {
                    buffered: !0
                }) : null) this.P && this.v.observe(), K(this.g, "pagehide", () => {
        ...
        disableDismissListeners(a) {
            this.o = !0;
            this.O = a;
            L(this.j, "click", this.T);
            L(this.g.document, "click", this.R)
        }
        enableDismissListeners() {
            this.o = !1;
            K(this.j, "click", this.T);
            K(this.g.document, "click", this.R);
            Ob(this)
        }
        dismiss(a) {
            ...
            this.N++ ||
                Nb(this);
            let b = 0;
            for (let d = 0; d < this.C.length; d++) b = Math.max(b, this.C[d]());
            b = Math.min(b, 1E3);
            let c = "i-dismiss";
        ...
        u() {
            ...
            const f = Math.floor(c - a),
                g = Math.floor(d - e);
            if (0 <= f || 5 < g) c -= b.top, d -= b.left, b = this.g, Y(this, {
                dhb: f >= c ? 1 : 0,
                dhr: g >= d ? 1 : 0,
                h: a,
                w: e,
